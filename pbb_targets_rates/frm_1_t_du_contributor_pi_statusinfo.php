...
$frm_1_t_du_contributor_pi_status = NULL;

//
// Table class for frm_1_t_du_contributor_pi_status
//
class cfrm_1_t_du_contributor_pi_status {
	var $TableVar = 'frm_1_t_du_contributor_pi_status';
	...
	//
	function cfrm_1_t_du_contributor_pi_status() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// cu_sequence
		$this->cu_sequence = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// focal_person_id
		$this->focal_person_id = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// unit_contributor_id
		$this->unit_contributor_id = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_unit_contributor_id', 'unit_contributor_id', '`unit_contributor_id`', 3, -1, FALSE, '`unit_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// CU
		$this->CU = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// Contributing Unit
		$this->Contributing_Unit = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_Contributing_Unit', 'Contributing Unit', '`Contributing Unit`', 200, -1, FALSE, '`Contributing Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Contributing Unit'] =& $this->Contributing_Unit;

		// MFO SEQ
		$this->MFO_SEQ = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_MFO_SEQ', 'MFO SEQ', '`MFO SEQ`', 3, -1, FALSE, '`MFO SEQ`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->MFO_SEQ->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MFO SEQ'] =& $this->MFO_SEQ;

		// MFO
		$this->MFO = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// PI Count per MFO
		$this->PI_Count_per_MFO = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_PI_Count_per_MFO', 'PI Count per MFO', '`PI Count per MFO`', 20, -1, FALSE, '`PI Count per MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Not_Applicable_PI_Count = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_Not_Applicable_PI_Count', 'Not Applicable PI Count', '`Not Applicable PI Count`', 20, -1, FALSE, '`Not Applicable PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Completed_Target_PI_Count = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_Completed_Target_PI_Count', 'Completed Target PI Count', '`Completed Target PI Count`', 20, -1, FALSE, '`Completed Target PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// No Target PI Count
		$this->No_Target_PI_Count = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_No_Target_PI_Count', 'No Target PI Count', '`No Target PI Count`', 20, -1, FALSE, '`No Target PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Remarks
		$this->Remarks = new cField('frm_1_t_du_contributor_pi_status', 'frm_1_t_du_contributor_pi_status', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_1_t_du_contributor_pi_status_Highlight";
	}
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "frm_1_t_du_contributor_mfo_status") {
	...
	// Master filter
	function SqlMasterFilter_frm_1_t_du_contributor_mfo_status() {
		return "`unit_contributor_id`=@unit_contributor_id@";
	}

	// Detail filter
	function SqlDetailFilter_frm_1_t_du_contributor_mfo_status() {
		return "`unit_contributor_id`=@unit_contributor_id@";
	}
	...
	function SqlFrom() { // From
		return "`frm_1_t_du_contributor_pi_status`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_1_t_du_contributor_pi_status` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_1_t_du_contributor_pi_status` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_1_t_du_contributor_pi_status` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_1_t_du_contributor_pi_statuslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_1_t_du_contributor_pi_statusview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_1_t_du_contributor_pi_statusadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_1_t_du_contributor_pi_statusedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_1_t_du_contributor_pi_statusadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_1_t_du_contributor_pi_statusdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_1_t_du_contributor_pi_status" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_1_t_du_contributor_pi_status` WHERE " . $this->AddUserIDFilter("");
	...
	function AddMasterUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "frm_1_t_du_contributor_mfo_status") {
			$sFilterWrk = $GLOBALS["frm_1_t_du_contributor_mfo_status"]->AddUserIDFilter($sFilterWrk);
		}
		return $sFilterWrk;
	}
	...
	function AddDetailUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "frm_1_t_du_contributor_mfo_status") {
			$sSubqueryWrk = $GLOBALS["frm_1_t_du_contributor_mfo_status"]->GetUserIDSubquery($this->unit_contributor_id, $GLOBALS["frm_1_t_du_contributor_mfo_status"]->unit_contributor_id);
			if ($sSubqueryWrk <> "") {
				if ($sFilterWrk <> "") {
