...
class cfrm_2_a_conu_rep_form_a_raw_data_du_conu {
	...
	function cfrm_2_a_conu_rep_form_a_raw_data_du_conu() {
		...
		// CU
		$this->CU = new cField('frm_2_a_conu_rep_form_a_raw_data_du_conu', 'frm_2_a_conu_rep_form_a_raw_data_du_conu', 'x_CU', 'CU', '`CU`', 201, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
