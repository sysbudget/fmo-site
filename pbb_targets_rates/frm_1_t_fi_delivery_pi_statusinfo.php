...
$frm_1_t_fi_delivery_pi_status = NULL;

//
// Table class for frm_1_t_fi_delivery_pi_status
//
class cfrm_1_t_fi_delivery_pi_status {
	var $TableVar = 'frm_1_t_fi_delivery_pi_status';
	...
	//
	function cfrm_1_t_fi_delivery_pi_status() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// cu_sequence
		$this->cu_sequence = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// focal_person_id
		$this->focal_person_id = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// unit_contributor_id
		$this->unit_contributor_id = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_unit_contributor_id', 'unit_contributor_id', '`unit_contributor_id`', 201, -1, FALSE, '`unit_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_contributor_id'] =& $this->unit_contributor_id;

		// CU
		$this->CU = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// Contributor Unit
		$this->Contributor_Unit = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_Contributor_Unit', 'Contributor Unit', '`Contributor Unit`', 201, -1, FALSE, '`Contributor Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Contributor Unit'] =& $this->Contributor_Unit;

		// MFO
		$this->MFO = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// PI Count
		$this->PI_Count = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_PI_Count', 'PI Count', '`PI Count`', 131, -1, FALSE, '`PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->PI_Count->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['PI Count'] =& $this->PI_Count;

		// Not Applicable PI Count
		$this->Not_Applicable_PI_Count = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_Not_Applicable_PI_Count', 'Not Applicable PI Count', '`Not Applicable PI Count`', 131, -1, FALSE, '`Not Applicable PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Completed_Target_PI_Count = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_Completed_Target_PI_Count', 'Completed Target PI Count', '`Completed Target PI Count`', 131, -1, FALSE, '`Completed Target PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// No Target PI Count
		$this->No_Target_PI_Count = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_No_Target_PI_Count', 'No Target PI Count', '`No Target PI Count`', 131, -1, FALSE, '`No Target PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Remarks
		$this->Remarks = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_1_t_fi_delivery_pi_status_Highlight";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_1_t_fi_contributor_pi_status") {
			$sDetailUrl = $GLOBALS["frm_1_t_fi_contributor_pi_status"]->ListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlFrom() { // From
		return "`frm_1_t_fi_delivery_pi_status`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_1_t_fi_delivery_pi_status` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_1_t_fi_delivery_pi_status` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_1_t_fi_delivery_pi_status` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_1_t_fi_delivery_pi_statuslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_1_t_fi_delivery_pi_statusview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_1_t_fi_delivery_pi_statusadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_1_t_fi_delivery_pi_statusedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_1_t_fi_delivery_pi_statusadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_1_t_fi_delivery_pi_statusdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_1_t_fi_delivery_pi_status" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		$this->unit_contributor_id->CellCssStyle = "white-space: nowrap;";
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_1_t_fi_delivery_pi_status` WHERE " . $this->AddUserIDFilter("");
