...
// Create page object
$frm_1_t_fi_pbb_detail_contributor_edit = new cfrm_1_t_fi_pbb_detail_contributor_edit();
$Page =& $frm_1_t_fi_pbb_detail_contributor_edit;

// Page init
$frm_1_t_fi_pbb_detail_contributor_edit->Page_Init();

// Page main
$frm_1_t_fi_pbb_detail_contributor_edit->Page_Main();
?>
...
// Create page object
var frm_1_t_fi_pbb_detail_contributor_edit = new up_Page("frm_1_t_fi_pbb_detail_contributor_edit");

// page properties
frm_1_t_fi_pbb_detail_contributor_edit.PageID = "edit"; // page ID
frm_1_t_fi_pbb_detail_contributor_edit.FormID = "ffrm_1_t_fi_pbb_detail_contributoredit"; // form ID
var UP_PAGE_ID = frm_1_t_fi_pbb_detail_contributor_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_1_t_fi_pbb_detail_contributor_edit.ValidateForm = function(fobj) {
...
frm_1_t_fi_pbb_detail_contributor_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_1_t_fi_pbb_detail_contributor_edit.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_1_t_fi_pbb_detail_contributor_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_1_t_fi_pbb_detail_contributor_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_1_t_fi_pbb_detail_contributor->TableCaption() ?></p>
<p class="upbudgetofficeclass"><a href="<?php echo $frm_1_t_fi_pbb_detail_contributor->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $frm_1_t_fi_pbb_detail_contributor_edit->ShowPageHeader(); ?>
<?php
$frm_1_t_fi_pbb_detail_contributor_edit->ShowMessage();
?>
<form name="ffrm_1_t_fi_pbb_detail_contributoredit" id="ffrm_1_t_fi_pbb_detail_contributoredit" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_1_t_fi_pbb_detail_contributor_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="frm_1_t_fi_pbb_detail_contributor">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="upGrid"><tr><td class="upGridContent">
<div class="upGridMiddlePanel">
<table cellspacing="0" class="upTable">
<?php if ($frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->Visible) { // Delivery Unit ?>
	<tr id="r_Delivery_Unit"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->CellAttributes() ?>><span id="el_Delivery_Unit">
<div<?php echo $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->ViewAttributes() ?>><?php echo $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->EditValue ?></div>
<input type="hidden" name="x_Delivery_Unit" id="x_Delivery_Unit" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->CurrentValue) ?>">
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Contributing_Unit->Visible) { // Contributing Unit ?>
	<tr id="r_Contributing_Unit"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Contributing_Unit->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Contributing_Unit->CellAttributes() ?>><span id="el_Contributing_Unit">
...
<input type="hidden" name="x_Contributing_Unit" id="x_Contributing_Unit" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->Contributing_Unit->CurrentValue) ?>">
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Contributing_Unit->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->MFO->Visible) { // MFO ?>
	<tr id="r_MFO"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->MFO->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->MFO->CellAttributes() ?>><span id="el_MFO">
...
<input type="hidden" name="x_MFO" id="x_MFO" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->MFO->CurrentValue) ?>">
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->MFO->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Question->Visible) { // Question ?>
	<tr id="r_Question"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Question->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Question->CellAttributes() ?>><span id="el_Question">
...
<input type="hidden" name="x_Question" id="x_Question" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->Question->CurrentValue) ?>">
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Question->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Applicable->Visible) { // Applicable ?>
	<tr id="r_Applicable"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Applicable->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Applicable->CellAttributes() ?>><span id="el_Applicable">
<div id="tp_x_Applicable" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_Applicable" id="x_Applicable" value="{value}"<?php echo $frm_1_t_fi_pbb_detail_contributor->Applicable->EditAttributes() ?>></label></div>
...
<label><input type="radio" name="x_Applicable" id="x_Applicable" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_1_t_fi_pbb_detail_contributor->Applicable->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Applicable->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Target->Visible) { // Target ?>
	<tr id="r_Target"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Target->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Target->CellAttributes() ?>><span id="el_Target">
<input type="text" name="x_Target" id="x_Target" size="30" value="<?php echo $frm_1_t_fi_pbb_detail_contributor->Target->EditValue ?>"<?php echo $frm_1_t_fi_pbb_detail_contributor->Target->EditAttributes() ?>>
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Target->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Target_Remarks->Visible) { // Target Remarks ?>
	<tr id="r_Target_Remarks"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Remarks->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Remarks->CellAttributes() ?>><span id="el_Target_Remarks">
<textarea name="x_Target_Remarks" id="x_Target_Remarks" cols="0" rows="0"<?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Remarks->EditAttributes() ?>><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Remarks->EditValue ?></textarea>
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Remarks->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Target_Cut2DOff_Date->Visible) { // Target Cut-Off Date ?>
	<tr id="r_Target_Cut2DOff_Date"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Cut2DOff_Date->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Cut2DOff_Date->CellAttributes() ?>><span id="el_Target_Cut2DOff_Date">
...
<input type="hidden" name="x_Target_Cut2DOff_Date" id="x_Target_Cut2DOff_Date" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->Target_Cut2DOff_Date->CurrentValue) ?>">
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Cut2DOff_Date->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_1_t_fi_pbb_detail_contributor->Target_Message->Visible) { // Target Message ?>
	<tr id="r_Target_Message"<?php echo $frm_1_t_fi_pbb_detail_contributor->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Message->FldCaption() ?></td>
		<td<?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Message->CellAttributes() ?>><span id="el_Target_Message">
...
<input type="hidden" name="x_Target_Message" id="x_Target_Message" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->Target_Message->CurrentValue) ?>">
</span><?php echo $frm_1_t_fi_pbb_detail_contributor->Target_Message->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</div>
</td></tr></table>
<input type="hidden" name="x_pbb_contributor_id" id="x_pbb_contributor_id" value="<?php echo up_HtmlEncode($frm_1_t_fi_pbb_detail_contributor->pbb_contributor_id->CurrentValue) ?>">
<p>
<input type="submit" name="btnAction" id="btnAction" value="<?php echo up_BtnCaption($Language->Phrase("EditBtn")) ?>">
</form>
<?php
$frm_1_t_fi_pbb_detail_contributor_edit->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_1_t_fi_pbb_detail_contributor_edit->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_1_t_fi_pbb_detail_contributor_edit {
	...
	// Page object name
	var $PageObjName = 'frm_1_t_fi_pbb_detail_contributor_edit';
	...
	//
	function cfrm_1_t_fi_pbb_detail_contributor_edit() {
	...
	//
	function Page_Main() {
		global $objForm, $Language, $gsFormError, $frm_1_t_fi_pbb_detail_contributor;

		// Load key from QueryString
		if (@$_GET["pbb_contributor_id"] <> "")
			$frm_1_t_fi_pbb_detail_contributor->pbb_contributor_id->setQueryStringValue($_GET["pbb_contributor_id"]);

		// Set up master detail parameters
		$this->SetUpMasterParms();
		if (@$_POST["a_edit"] <> "") {
			$frm_1_t_fi_pbb_detail_contributor->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate form
			if (!$this->ValidateForm()) {
				$frm_1_t_fi_pbb_detail_contributor->CurrentAction = ""; // Form error, reset action
				$this->setFailureMessage($gsFormError);
				$frm_1_t_fi_pbb_detail_contributor->EventCancelled = TRUE; // Event cancelled
				$this->RestoreFormValues();
			}
		} else {
			$frm_1_t_fi_pbb_detail_contributor->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($frm_1_t_fi_pbb_detail_contributor->pbb_contributor_id->CurrentValue == "")
			$this->Page_Terminate("frm_1_t_fi_pbb_detail_contributorlist.php"); // Invalid key, return to list
		switch ($frm_1_t_fi_pbb_detail_contributor->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					$this->setFailureMessage($Language->Phrase("NoRecord")); // No record found
					$this->Page_Terminate("frm_1_t_fi_pbb_detail_contributorlist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$frm_1_t_fi_pbb_detail_contributor->SendEmail = TRUE; // Send email on update success
				if ($this->EditRow()) { // Update record based on key
					$this->setSuccessMessage($Language->Phrase("UpdateSuccess")); // Update success
					$sReturnUrl = $frm_1_t_fi_pbb_detail_contributor->getReturnUrl();
		...
		// Render the record
		$frm_1_t_fi_pbb_detail_contributor->RowType = UP_ROWTYPE_EDIT; // Render as Edit
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm, $frm_1_t_fi_pbb_detail_contributor;
		if (!$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->FldIsDetailKey) {
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->setFormValue($objForm->GetValue("x_Delivery_Unit"));
		}
		...
		if (!$frm_1_t_fi_pbb_detail_contributor->pbb_contributor_id->FldIsDetailKey)
	...
	function RestoreFormValues() {
		...
		$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->CurrentValue = $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->FormValue;
	...
	function RenderRow() {
		...
		if ($frm_1_t_fi_pbb_detail_contributor->RowType == UP_ROWTYPE_VIEW) { // View row
			...
			// Delivery Unit
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->ViewValue = $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->CurrentValue;
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->ViewCustomAttributes = "";
			...
			// Delivery Unit
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->LinkCustomAttributes = "";
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->HrefValue = "";
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->TooltipValue = "";
			...
			// Delivery Unit
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->EditCustomAttributes = "";
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->EditValue = $frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->CurrentValue;
			$frm_1_t_fi_pbb_detail_contributor->Delivery_Unit->ViewCustomAttributes = "";
