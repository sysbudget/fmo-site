...
/**
 * MySQL API for PBB2016 V1
 * University of the Philippines (C) 2016 UP Budget Office
 *
 * This script (upmysql*.php) is based on:
 * V1.42 ADOdb Lite 11 January 2007 (C) 2005-2007 Mark Dickenson. Released LGPL.
 */
$UPPBB2016_vers = 'PBB2016 V1 University of the Philippines (C) 2016 UP Budget Office';
define('ADODB_FETCH_DEFAULT', 0);
define('ADODB_FETCH_NUM', 1);
define('ADODB_FETCH_ASSOC', 2);
define('ADODB_FETCH_BOTH', 3);
define('UP_USE_MYSQLI', FALSE && extension_loaded("mysqli"), TRUE);
...
class ADOConnection
{
	...
	/**
	 * Returns floating point version number of UPPBB2016
	 * Usage: $db->Version();
	 * 
	 * @access public 
	 */
	...
	function Version()
	{
		global $UPPBB2016_vers;
		return (float) substr($UPPBB2016_vers,1);
	}
