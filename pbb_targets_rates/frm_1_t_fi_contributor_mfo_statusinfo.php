...
$frm_1_t_fi_contributor_mfo_status = NULL;

//
// Table class for frm_1_t_fi_contributor_mfo_status
//
class cfrm_1_t_fi_contributor_mfo_status {
	var $TableVar = 'frm_1_t_fi_contributor_mfo_status';
	...
	//
	function cfrm_1_t_fi_contributor_mfo_status() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// unit_contributor_id
		$this->unit_contributor_id = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_unit_contributor_id', 'unit_contributor_id', '`unit_contributor_id`', 3, -1, FALSE, '`unit_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// focal_person_id
		$this->focal_person_id = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_id
		$this->cu_id = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// CU
		$this->CU = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// Contributing Unit
		$this->Contributing_Unit = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_Contributing_Unit', 'Contributing Unit', '`Contributing Unit`', 200, -1, FALSE, '`Contributing Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Contributing Unit'] =& $this->Contributing_Unit;

		// Participated MFO Count
		$this->Participated_MFO_Count = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_Participated_MFO_Count', 'Participated MFO Count', '`Participated MFO Count`', 20, -1, FALSE, '`Participated MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Not_Started_MFO_Count = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_Not_Started_MFO_Count', 'Not Started MFO Count', '`Not Started MFO Count`', 20, -1, FALSE, '`Not Started MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->In_Progress_MFO_Count = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_In_Progress_MFO_Count', 'In Progress MFO Count', '`In Progress MFO Count`', 20, -1, FALSE, '`In Progress MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Completed_Target_MFO_Count = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_Completed_Target_MFO_Count', 'Completed Target MFO Count', '`Completed Target MFO Count`', 20, -1, FALSE, '`Completed Target MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Remarks
		$this->Remarks = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks'] =& $this->Remarks;

		// cu_sequence
		$this->cu_sequence = new cField('frm_1_t_fi_contributor_mfo_status', 'frm_1_t_fi_contributor_mfo_status', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_1_t_fi_contributor_mfo_status_Highlight";
	}
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "frm_1_t_fi_delivery_status") {
	...
	// Master filter
	function SqlMasterFilter_frm_1_t_fi_delivery_status() {
		return "`unit_delivery_id`=@unit_delivery_id@";
	}

	// Detail filter
	function SqlDetailFilter_frm_1_t_fi_delivery_status() {
		return "`unit_delivery_id`=@unit_delivery_id@";
	}
	...
	function SqlFrom() { // From
		return "`frm_1_t_fi_contributor_mfo_status`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_1_t_fi_contributor_mfo_status` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_1_t_fi_contributor_mfo_status` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_1_t_fi_contributor_mfo_status` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_1_t_fi_contributor_mfo_statuslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_1_t_fi_contributor_mfo_statusview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_1_t_fi_contributor_mfo_statusadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_1_t_fi_contributor_mfo_statusedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_1_t_fi_contributor_mfo_statusadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_1_t_fi_contributor_mfo_statusdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_1_t_fi_contributor_mfo_status" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_1_t_fi_contributor_mfo_status` WHERE " . $this->AddUserIDFilter("");
	...
	function AddMasterUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "frm_1_t_fi_delivery_status") {
			$sFilterWrk = $GLOBALS["frm_1_t_fi_delivery_status"]->AddUserIDFilter($sFilterWrk);
		}
		return $sFilterWrk;
	}
	...
	function AddDetailUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "frm_1_t_fi_delivery_status") {
			$sSubqueryWrk = $GLOBALS["frm_1_t_fi_delivery_status"]->GetUserIDSubquery($this->unit_delivery_id, $GLOBALS["frm_1_t_fi_delivery_status"]->unit_delivery_id);
			if ($sSubqueryWrk <> "") {
				if ($sFilterWrk <> "") {
