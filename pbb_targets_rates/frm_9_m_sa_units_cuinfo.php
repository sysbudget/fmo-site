...
$frm_9_m_sa_units_cu = NULL;

//
// Table class for frm_9_m_sa_units_cu
//
class cfrm_9_m_sa_units_cu {
	var $TableVar = 'frm_9_m_sa_units_cu';
	...
	//
	function cfrm_9_m_sa_units_cu() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// cu_id
		$this->cu_id = new cField('frm_9_m_sa_units_cu', 'frm_9_m_sa_units_cu', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_9_m_sa_units_cu', 'frm_9_m_sa_units_cu', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_9_m_sa_units_cu', 'frm_9_m_sa_units_cu', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// cu_short_name
		$this->cu_short_name = new cField('frm_9_m_sa_units_cu', 'frm_9_m_sa_units_cu', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// focal_person_office
		$this->focal_person_office = new cField('frm_9_m_sa_units_cu', 'frm_9_m_sa_units_cu', 'x_focal_person_office', 'focal_person_office', '`focal_person_office`', 200, -1, FALSE, '`focal_person_office`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_9_m_sa_units_cu_Highlight";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_9_m_sa_units_delivery") {
			$sDetailUrl = $GLOBALS["frm_9_m_sa_units_delivery"]->ListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&cu_id=" . $this->cu_id->CurrentValue;
		}
		return $sDetailUrl;
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_9_m_sa_units_cu` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_9_m_sa_units_cu` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_9_m_sa_units_cu` WHERE ";
		$SQL .= up_QuotedName('cu_id') . '=' . up_QuotedValue($rs['cu_id'], $this->cu_id->FldDataType) . ' AND ';
	...
	function KeyFilter() {
		...
		if (!is_numeric($this->cu_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@cu_id@", up_AdjustSql($this->cu_id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_9_m_sa_units_culist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_9_m_sa_units_cuview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_9_m_sa_units_cuadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_9_m_sa_units_cuedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_9_m_sa_units_cuedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_9_m_sa_units_cuadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_9_m_sa_units_cuadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_9_m_sa_units_cudelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->cu_id->CurrentValue)) {
			$sUrl .= "cu_id=" . urlencode($this->cu_id->CurrentValue);
		} else {
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_9_m_sa_units_cu" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
