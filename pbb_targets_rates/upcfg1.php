...
define("UP_PROJECT_NAME", "PBB_2016_ConU", TRUE); // Project name
define("UP_RANDOM_KEY", 'ufnuJB0i9iy8cVtT', TRUE); // Random key for encryption
define("UP_PROJECT_STYLESHEET_FILENAME", "phpcss/PBB_2016_ConU.css", TRUE); // Project stylesheet file name
...
define("UP_CONN_DB", 'db_pbb_2016_web', TRUE);
 ...
 */
define("UP_ENCRYPTED_PASSWORD", TRUE, TRUE); // Use encrypted password
define("UP_CASE_SENSITIVE_PASSWORD", TRUE, TRUE); // Case-sensitive password
...
// Security
define("UP_ADMIN_USER_NAME", "sysadbudget", TRUE); // Administrator user name
define("UP_ADMIN_PASSWORD", "fyt4urryt4ever", TRUE); // Administrator password
...
// User table filters
define("UP_USER_TABLE", "`frm_9_m_sa_users`",  TRUE);
define("UP_USER_NAME_FILTER", "(`Login Name` = '%u')",  TRUE);
define("UP_USER_ID_FILTER", "(`users_id` = %u)",  TRUE);
