...
<div class="commonbody">
		...
		U.P. Academic Programs Profile</strong></div>
	  ...
	  <tr>
		...
		<ul id="MenuBar1" class="MenuBarVertical">
  			<li><a class="MenuBarItemSubmenu" href="#">Academic</a>
      			<ul>
                  <a href="forms/view-paginated-template.php" target="myFrame"><li>Select Template</li></a>
              	  <a href="forms/input-acad.php" target="myFrame"><li>Input Data</li></a>
                  <a href="forms/view-acad.php" target="myFrame"><li>View Data</li></a>
                </ul>
  			</li>
		</ul>
        </td>
