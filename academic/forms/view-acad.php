...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
				...
				$acad_yr = $acad_yr+1;
				print $acad_yr;?>)</h2>
                <div class="viewlinks"><p><a href="input-acad.php">Add New Record</a> | <b>View All</b> | <a href="view-paginated-acad.php">View Page</a> </p></div>
                <?php
						...
						{									
                                ...
                                if ($result->num_rows > 0)
                                {
										...
										while ($row = $result->fetch_object())
                                        {
                                                ...
                                                echo "<td><a href='edit-acad.php?id=" . $row->pid . "'>Edit</a></td>";
