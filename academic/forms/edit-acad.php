...
$query7 = $mysqli->query("SELECT * FROM `tbl_educ_lvl` ORDER BY `eid` ASC");
...
<form id="edit_acad_form" method="post" action="save-edited-acad.php" onsubmit="return validateForm()">
<table>
...
<tr>
    ...
    <td><select name="educ_lvl" size="1" required id="categoriesSelect1">
	<option value="<?php print $educ_lvl; ?>"><?php print $educ_lvl; ?></option>
    </select></td>
</tr>
<tr>
    <td><div align="right">Years to Complete</br><b>Last Selected: <?php echo $prog_len ?></b></div></td>
    <td><select name="prog_len" size="1" required id="subcatsSelect1">
	<option value="<?php print $prog_len; ?>">Please Select :</option>
      <?php foreach($array12 as $option12) : ?>
    <option value="<?php echo $option12->yr_comp; ?>"><?php echo $option12->yr_comp; ?></option>
      <?php endforeach; ?>
    </select></td>
</tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <tr>
    <td><input name='new_male_ft' type='text' value='<?php print $new_male_ft;?>'/></td>
    <td><input name='new_male_pt' type='text' value='<?php print $new_male_pt;?>'/></td>
    <td><input name='new_fem_ft' type='text' value='<?php print $new_fem_ft;?>'/></td>
    <td><input name='new_fem_pt' type='text' value='<?php print $new_fem_pt;?>'/></td>
    <td><input name='new_ft' type='text' value='<?php print $new_ft;?>'/></td>
    <td><input name='new_pt' type='text' value='<?php print $new_pt;?>'/></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <tr>
    <td><input name='int_new_male_ft' type='text' value='<?php print $int_new_male_ft;?>'/></td>
    <td><input name='int_new_male_pt' type='text' value='<?php print $int_new_male_pt;?>'/></td>
    <td><input name='int_new_fem_ft' type='text' value='<?php print $int_new_fem_ft;?>'/></td>
    <td><input name='int_new_fem_pt' type='text' value='<?php print $int_new_fem_pt;?>'/></td>
    <td><input name='int_new_ft' type='text' value='<?php print $int_new_ft;?>'/></td>
    <td><input name='int_new_pt' type='text' value='<?php print $int_new_pt;?>'/></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <td><input name='male1_ft' type='text' value='<?php print $male1_ft;?>'/></td>
    <td><input name='male1_pt' type='text' value='<?php print $male1_pt;?>'/></td>
    <td><input name='fem1_ft' type='text' value='<?php print $fem1_ft;?>'/></td>
    <td><input name='fem1_pt' type='text' value='<?php print $fem1_pt;?>'/></td>
    <td><input name='ft1' type='text' value='<?php print $ft1;?>'/></td>
    <td><input name='pt1' type='text' value='<?php print $pt1;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">2nd</td>
    <td><input name='male2_ft' type='text' value='<?php print $male2_ft;?>'/></td>
    <td><input name='male2_pt' type='text' value='<?php print $male2_pt;?>'/></td>
    <td><input name='fem2_ft' type='text' value='<?php print $fem2_ft;?>'/></td>
    <td><input name='fem2_pt' type='text' value='<?php print $fem2_pt;?>'/></td>
    <td><input name='ft2' type='text' value='<?php print $ft2;?>'/></td>
    <td><input name='pt2' type='text' value='<?php print $pt2;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">3rd</td>
    <td><input name='male3_ft' type='text' value='<?php print $male3_ft;?>'/></td>
    <td><input name='male3_pt' type='text' value='<?php print $male3_pt;?>'/></td>
    <td><input name='fem3_ft' type='text' value='<?php print $fem3_ft;?>'/></td>
    <td><input name='fem3_pt' type='text' value='<?php print $fem3_pt;?>'/></td>
    <td><input name='ft3' type='text' value='<?php print $ft3;?>'/></td>
    <td><input name='pt3' type='text' value='<?php print $pt3;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">4th</td>
    <td><input name='male4_ft' type='text' value='<?php print $male4_ft;?>'/></td>
    <td><input name='male4_pt' type='text' value='<?php print $male4_pt;?>'/></td>
    <td><input name='fem4_ft' type='text' value='<?php print $fem4_ft;?>'/></td>
    <td><input name='fem4_pt' type='text' value='<?php print $fem4_pt;?>'/></td>
    <td><input name='ft4' type='text' value='<?php print $ft4;?>'/></td>
    <td><input name='pt4' type='text' value='<?php print $pt4;?>'/></td>
    </tr>
    <td width="100" align="Center">5th</td>
    <td><input name='male5_ft' type='text' value='<?php print $male5_ft;?>'/></td>
    <td><input name='male5_pt' type='text' value='<?php print $male5_pt;?>'/></td>
    <td><input name='fem5_ft' type='text' value='<?php print $fem5_ft;?>'/></td>
    <td><input name='fem5_pt' type='text' value='<?php print $fem5_pt;?>'/></td>
    <td><input name='ft5' type='text' value='<?php print $ft5;?>'/></td>
    <td><input name='pt5' type='text' value='<?php print $pt5;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">6th</td>
    <td><input name='male6_ft' type='text' value='<?php print $male6_ft;?>'/></td>
    <td><input name='male6_pt' type='text' value='<?php print $male6_pt;?>'/></td>
    <td><input name='fem6_ft' type='text' value='<?php print $fem6_ft;?>'/></td>
    <td><input name='fem6_pt' type='text' value='<?php print $fem6_pt;?>'/></td>
    <td><input name='ft6' type='text' value='<?php print $ft6;?>'/></td>
    <td><input name='pt6' type='text' value='<?php print $pt6;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">7th</td>
    <td><input name='male7_ft' type='text' value='<?php print $male7_ft;?>'/></td>
    <td><input name='male7_pt' type='text' value='<?php print $male7_pt;?>'/></td>
    <td><input name='fem7_ft' type='text' value='<?php print $fem7_ft;?>'/></td>
    <td><input name='fem7_pt' type='text' value='<?php print $fem7_pt;?>'/></td>
    <td><input name='ft7' type='text' value='<?php print $ft7;?>'/></td>
    <td><input name='pt7' type='text' value='<?php print $pt7;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">Beyond 7 Years</td>
    <td><input name='male8_ft' type='text' value='<?php print $male8_ft;?>'/></td>
    <td><input name='male8_pt' type='text' value='<?php print $male8_pt;?>'/></td>
    <td><input name='fem8_ft' type='text' value='<?php print $fem8_ft;?>'/></td>
    <td><input name='fem8_pt' type='text' value='<?php print $fem8_pt;?>'/></td>
    <td><input name='ft8' type='text' value='<?php print $ft8;?>'/></td>
    <td><input name='pt8' type='text' value='<?php print $pt8;?>'/></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <tr>
    <td width="100" align="center">Other 1st Year</td>
    <td><input name='int_male1_ft' type='text' value='<?php print $int_male1_ft;?>'/></td>
    <td><input name='int_male1_pt' type='text' value='<?php print $int_male1_pt;?>'/></td>
    <td><input name='int_fem1_ft' type='text' value='<?php print $int_fem1_ft;?>'/></td>
    <td><input name='int_fem1_pt' type='text' value='<?php print $int_fem1_pt;?>'/></td>
    <td><input name='int_ft1' type='text' value='<?php print $int_ft1;?>'/></td>
    <td><input name='int_pt1' type='text' value='<?php print $int_pt1;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">2nd</td>
    <td><input name='int_male2_ft' type='text' value='<?php print $int_male2_ft;?>'/></td>
    <td><input name='int_male2_pt' type='text' value='<?php print $int_male2_pt;?>'/></td>
    <td><input name='int_fem2_ft' type='text' value='<?php print $int_fem2_ft;?>'/></td>
    <td><input name='int_fem2_pt' type='text' value='<?php print $int_fem2_pt;?>'/></td>
    <td><input name='int_ft2' type='text' value='<?php print $int_ft2;?>'/></td>
    <td><input name='int_pt2' type='text' value='<?php print $int_pt2;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">3rd</td>
    <td><input name='int_male3_ft' type='text' value='<?php print $int_male3_ft;?>'/></td>
    <td><input name='int_male3_pt' type='text' value='<?php print $int_male3_pt;?>'/></td>
    <td><input name='int_fem3_ft' type='text' value='<?php print $int_fem3_ft;?>'/></td>
    <td><input name='int_fem3_pt' type='text' value='<?php print $int_fem3_pt;?>'/></td>
    <td><input name='int_ft3' type='text' value='<?php print $int_ft3;?>'/></td>
    <td><input name='int_pt3' type='text' value='<?php print $int_pt3;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">4th</td>
    <td><input name='int_male4_ft' type='text' value='<?php print $int_male4_ft;?>'/></td>
    <td><input name='int_male4_pt' type='text' value='<?php print $int_male4_pt;?>'/></td>
    <td><input name='int_fem4_ft' type='text' value='<?php print $int_fem4_ft;?>'/></td>
    <td><input name='int_fem4_pt' type='text' value='<?php print $int_fem4_pt;?>'/></td>
    <td><input name='int_ft4' type='text' value='<?php print $int_ft4;?>'/></td>
    <td><input name='int_pt4' type='text' value='<?php print $int_pt4;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">5th</td>
    <td><input name='int_male5_ft' type='text' value='<?php print $int_male5_ft;?>'/></td>
    <td><input name='int_male5_pt' type='text' value='<?php print $int_male5_pt;?>'/></td>
    <td><input name='int_fem5_ft' type='text' value='<?php print $int_fem5_ft;?>'/></td>
    <td><input name='int_fem5_pt' type='text' value='<?php print $int_fem5_pt;?>'/></td>
    <td><input name='int_ft5' type='text' value='<?php print $int_ft5;?>'/></td>
    <td><input name='int_pt5' type='text' value='<?php print $int_pt5;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">6th</td>
    <td><input name='int_male6_ft' type='text' value='<?php print $int_male6_ft;?>'/></td>
    <td><input name='int_male6_pt' type='text' value='<?php print $int_male6_pt;?>'/></td>
    <td><input name='int_fem6_ft' type='text' value='<?php print $int_fem6_ft;?>'/></td>
    <td><input name='int_fem6_pt' type='text' value='<?php print $int_fem6_pt;?>'/></td>
    <td><input name='int_ft6' type='text' value='<?php print $int_ft6;?>'/></td>
    <td><input name='int_pt6' type='text' value='<?php print $int_pt6;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">7th</td>
    <td><input name='int_male7_ft' type='text' value='<?php print $int_male7_ft;?>'/></td>
    <td><input name='int_male7_pt' type='text' value='<?php print $int_male7_pt;?>'/></td>
    <td><input name='int_fem7_ft' type='text' value='<?php print $int_fem7_ft;?>'/></td>
    <td><input name='int_fem7_pt' type='text' value='<?php print $int_fem7_pt;?>'/></td>
    <td><input name='int_ft7' type='text' value='<?php print $int_ft7;?>'/></td>
    <td><input name='int_pt7' type='text' value='<?php print $int_pt7;?>'/></td>
    </tr>
    <tr>
    <td width="100" align="center">Beyond 7 Years</td>
    <td><input name='int_male8_ft' type='text' value='<?php print $int_male8_ft;?>'/></td>
    <td><input name='int_male8_pt' type='text' value='<?php print $int_male8_pt;?>'/></td>
    <td><input name='int_fem8_ft' type='text' value='<?php print $int_fem8_ft;?>'/></td>
    <td><input name='int_fem8_pt' type='text' value='<?php print $int_fem8_pt;?>'/></td>
    <td><input name='int_ft8' type='text' value='<?php print $int_ft8;?>'/></td>
    <td><input name='int_pt8' type='text' value='<?php print $int_pt8;?>'/></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <td><input name='male9_ft' type='text' value='<?php print $male9_ft;?>'/></td>
    <td><input name='male9_pt' type='text' value='<?php print $male9_pt;?>'/></td>
    <td><input name='fem9_ft' type='text' value='<?php print $fem9_ft;?>'/></td>
    <td><input name='fem9_pt' type='text' value='<?php print $fem9_pt;?>'/></td>
    <td><input name='ft9' type='text' value='<?php print $ft9;?>'/></td>
    <td><input name='pt9' type='text' value='<?php print $pt9;?>'/></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <tr>
    <td><input name='int_exch_in' type='text' value='<?php print $int_exch_in;?>' /></td>
    <td><input name='int_exch_out' type='text' value='<?php print $int_exch_out;?>' /></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <tr>
    <td><input name='non_up_scho' type='text' value='<?php print $non_up_scho;?>' /></td>
    <td><input name='up_scho' type='text' value='<?php print $up_scho;?>' /></td>
    </tr>
</table>
<table>
<tr>
...
<table border="1" cellpadding="1" cellspacing="0">
    ...
    <td><input name='grad_1term_male' type='text' value='<?php print $grad_1term_male;?>' /></td>
    <td><input name='grad_1term_fem' type='text' value='<?php print $grad_1term_fem;?>' /></td>
    <td><input name='grad_1term_ns' type='text' value='<?php print $grad_1term_ns;?>' /></td>
    </tr>
    <tr>
    <td width="100" align="center">2nd</div></td>
    <td><input name='grad_2term_male' type='text' value='<?php print $grad_2term_male;?>' /></td>
    <td><input name='grad_2term_fem' type='text' value='<?php print $grad_2term_fem;?>' /></td>
    <td><input name='grad_2term_ns' type='text' value='<?php print $grad_2term_ns;?>' /></td>
    </tr>
    <td width="100" align="center">3rd</div></td>
    <td><input name='grad_3term_male' type='text' value='<?php print $grad_3term_male;?>' /></td>
    <td><input name='grad_3term_fem' type='text' value='<?php print $grad_3term_fem;?>' /></td>
    <td><input name='grad_3term_ns' type='text' value='<?php print $grad_3term_ns;?>' /></td>
    </tr>
    <tr>
    <td width="100" align="center">4th</div></td>
    <td><input name='grad_4term_male' type='text' value='<?php print $grad_4term_male;?>' /></td>
    <td><input name='grad_4term_fem' type='text' value='<?php print $grad_4term_fem;?>' /></td>
    <td><input name='grad_4term_ns' type='text' value='<?php print $grad_4term_ns;?>' /></td>
    </tr>
    <tr>
    <td width="100" align="center">Summer/Midyear</div></td>
    <td><input name='grad_sumr_male' type='text' value='<?php print $grad_sumr_male;?>' /></td>
    <td><input name='grad_sumr_fem' type='text' value='<?php print $grad_sumr_fem;?>' /></td>
    <td><input name='grad_sumr_ns' type='text' value='<?php print $grad_sumr_ns;?>' /></td>
    </tr>
</table>
<table>    
    <tr>
