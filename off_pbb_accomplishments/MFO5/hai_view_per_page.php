...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>Hospital-Acquired Infection Rates - View Per Page</title>
                ...
                <?php
						if ($result)
						{
							...
							if ($result->num_rows != 0)
							{
								...
								// <a href="hai_input.php">Add New Record</a> | ';
								echo '<a href="hai_view_all.php">View All</a> | <b>View Page:</b> ';
								...
								for ($i = 1; $i <= $total_pages; $i++)
								{
									...
									{
										echo "<a href='hai_view_per_page.php?page=$i'>$i</a> ";
									}
                                 }
                                 echo "</p>";
                                 echo "</div>";
