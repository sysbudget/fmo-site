...
else
{
	...
	// header('Location: pssurvey_view_use_all.php');
	// exit;
...
<body>
    ...
    <div class="viewbody">
    <h2>MFO 5: Patient Satisfaction Survey - Input Form</h2>
    <div class="viewlinks"><p><a href="pssurvey_view_all.php">View All Records</a></p></div>
    <hr/>

    <!-- Edit form here -->
    <form name="inputForm" id="inputForm" action="pssurvey_insert_update.php" method="post" onsubmit="return isValidForm()" enctype="multipart/form-data">
