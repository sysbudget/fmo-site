...
else
{
	...
	// header('Location: deathrates_view_use_all.php');
	// exit;
...
<body>
    ...
    <div class="viewbody">
    <h2>MFO 5: In-Patient Net Death Rates - Input Form</h2>
    <div class="viewlinks"><p><a href="deathrates_view_all.php">View All Records</a></p></div>
    <hr/>

    <!-- Edit form here -->
    <form name="inputForm" id="inputForm" action="deathrates_insert_update.php" method="post" onsubmit="return isValidForm()">
