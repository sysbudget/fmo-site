...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>Mental and Drug Rehab Readmission Rates - View Per Page</title>
                ...
                <?php
						if ($result)
						{
							...
							if ($result->num_rows != 0)
							{
								...
								// <a href="re-admit_input.php">Add New Record</a> | ';
								echo '<a href="re-admit_view_all.php">View All</a> | <b>View Page:</b> ';
								...
								for ($i = 1; $i <= $total_pages; $i++)
								{
									...
									{
										echo "<a href='re-admit_view_per_page.php?page=$i'>$i</a> ";
									}
                                 }
                                 echo "</p>";
                                 echo "</div>";
