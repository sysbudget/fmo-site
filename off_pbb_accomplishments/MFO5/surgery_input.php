...
else
{
	...
	// header('Location: surgery_view_use_all.php');
	// exit;
...
<body>
    ...
    <div class="viewbody">
    <h2>MFO 5: Surgical Operations - Input Form</h2>
    <div class="viewlinks"><p><a href="surgery_view_all.php">View All Records</a></p></div>
    <hr/>

    <!-- Edit form here -->
    <form name="inputForm" id="inputForm" action="surgery_insert_update.php" method="post" onsubmit="return isValidForm()">
