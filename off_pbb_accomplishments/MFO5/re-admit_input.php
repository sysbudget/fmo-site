...
else
{
	...
	// header('Location: re-admit_view_use_all.php');
	// exit;
...
<body>
    ...
    <div class="viewbody">
    <h2>MFO 5: Mental and Drug Rehabilitation Readmission Rates - Input Form</h2>
    <div class="viewlinks"><p><a href="re-admit_view_all.php">View All Records</a></p></div>
    <hr/>

    <!-- Edit form here -->
    <form name="inputForm" id="inputForm" action="re-admit_insert_update.php" method="post" onsubmit="return isValidForm()">
