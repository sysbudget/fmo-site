...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
                <div class="viewbody">
                <h2>MFO3: Patent - Select Research to Patent</h2>
                <div class="viewlinks">
                <p><!--<a href="research_input.php">Add New Research</a> | --><b>View All</b> | <a href="patent_view_use_per_page.php">View Page</a> </p>
                </div>
                <?php
...
//                                              echo "<td><a href='delete.php?id=" . $row->mfo3_form_program_id . "' onclick='return checkDelete()'>Delete</a></td>";
                                                echo "<td nowrap='nowrap'><a href='patent_input.php?id=" . $row->mfo3_form_program_id . "'>Select</a></td>";
												// counter
                                                ...
                                                echo "<td><a href='patent_input.php?id=" . $row->mfo3_form_program_id . "'>Select</a></td>";
//                                              echo "<td><a href='delete.php?id=" . $row->mfo3_form_program_id . "' onclick='return checkDelete()'>Delete</a></td>";
                                        }
