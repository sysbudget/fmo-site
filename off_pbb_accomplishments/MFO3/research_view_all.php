...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
                <div class="viewbody">
                <h2>MFO3: Research Project - View Records</h2>
                <?php
				// connect to the database
					include('../connect-db.php');
						...
						$query = "SELECT unit_delivery_name_cu, unit_contributor_name, research_type_name, mfo3_form_research_title, mfo3_form_research_duration_in_months_plan,  mfo3_form_research_month_year_started, mfo3_form_research_month_year_completed, mfo3_form_research_completed, mfo3_form_research_name_of_authors, mfo3_form_research_attachment, mfo3_form_research_considered_in_gaa, mfo3_form_program_id FROM tbl_sd_3_mfo3_form_research ORDER BY mfo3_form_research_title ASC, mfo3_form_program_id DESC" ;
}
else {
						...
						{									
                                ...
                                if ($result->num_rows > 0)
                                {
										...
										echo "<b>View All</b> | <a href='research_view_per_page.php'>View Page:</a> ";
										echo "</div>";
                                        ...
                                        while ($row = $result->fetch_object())
                                        {
                                                ...
                                                echo "<td><a href='research_delete.php?id=" . $row->mfo3_form_program_id . "' onclick='return checkDelete()'>Delete</a></td>";
                                                echo "<td><a href='research_edit.php?id=" . $row->mfo3_form_program_id . "'>Edit</a></td>";
												// counter
												...
												echo "<td nowrap='nowrap'><a href = " . "uploads/" . $cu_short_name . "/" . $row->mfo3_form_research_attachment . ">" . $row->mfo3_form_research_attachment . "</a></td>";
														...
														$temp2 = $row->mfo3_form_research_considered_in_gaa;
														if ( $temp2 == 'Y'){
															$temp2 = 'Yes';
															}
															else
