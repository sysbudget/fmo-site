						...
						$unit_contributor_name_short = $_SESSION['unit_contributor_name_short'];
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<a href='presented_view_use_per_page.php'>Add New Record</a> | ";
														echo "<a href='presented_view_all.php'>View All</a> | <b>View Page:</b> ";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='presented_view_per_page.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</div>";
                                                        echo "</p>";
                                        ...
                                        echo "<tr>
												...
												<th></th>												
														...
														echo '<td><a href="presented_delete.php?id=' . $row[14] . '" onclick="return checkDelete()">Delete</a></td>';
                                                        echo '<td><a href="presented_edit.php?id=' . $row[14] . '">Edit</a></td>';
														...
														$presented_date = strtotime($row[7]);
