						...
						$unit_contributor_name_short = $_SESSION['unit_contributor_name_short'];
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<a href='research_view_all.php'>View All</a> | <b>View Page:</b> ";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='research_view_per_page.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</div>";
                                                        echo "</p>";
                                        		...
                                        		echo "<tr>
														...
														echo '<td><a href="research_delete.php?id=' . $row[11] . '" onclick="return checkDelete()">Delete</a></td>';
                                                        echo '<td><a href="research_edit.php?id=' . $row[11] . '">Edit</a></td>';
