						...
						$unit_contributor_name_short = $_SESSION['unit_contributor_name_short'];
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<a href='patent_view_use_per_page.php'>Add New Patent</a> | ";
														echo "<a href='patent_view_all.php'>View All</a> | <b>View Page:</b> ";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='patent_view_per_page.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</div>";
                                                        echo "</p>";
                                        ...
                                        echo "<tr>
												...
												<th></th>												
														...
														echo '<td><a href="patent_delete.php?id=' . $row[15] . '" onclick="return checkDelete()">Delete</a></td>';
                                                        echo '<td><a href="patent_edit.php?id=' . $row[15] . '">Edit</a></td>';
