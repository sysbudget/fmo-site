						...
						$unit_contributor_name_short = $_SESSION['unit_contributor_name_short'];
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<a href='presented_view_use_all.php'>View All</a> | <b>View Page:</b> ";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='presented_view_use_per_page.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</div>";
                                                        echo "</p>";
                                                        ...
                                                        echo '<td nowrap="nowrap"><a href="presented_input.php?id=' . $row[10] . '">Select</a></td>';
														// counter
                                                        ...
                                                        echo '<td><a href="presented_input.php?id=' . $row[10] . '">Select</a></td>';
