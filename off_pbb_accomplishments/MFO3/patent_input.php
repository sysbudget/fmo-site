...
//Extract fields.
	...
	$file_name_sample = "mfo3_research_patent_" . $cu . "_" . $du . "_" . $conu . "_" . $d;
...
<body>
<h2>MFO3: Patent - Input New Record</h2><hr/>

<!-- Edit form here -->
<form id="input_patent" method="post" action="patent_save.php" onsubmit="return validateForm()" enctype="multipart/form-data">
...
<table>
    ...
    <tr>
    	<td width="155"><div align="right">Patent Title</div></td>
	   	<td width="500"><textarea name="pat_title" cols="50" rows="6" onkeyup="limit(pat_title)" onblur="limit(pat_title)" required style='text-align:left'></textarea></td>
  	</tr>
	...
	<tr>
    	...
    	<td width="500"><input name="appli_date" type="text" required id="appli_date" value="" size="11"/></td>
	</tr>
	...
	<tr>
    	...
    	<td width="500"><input name="appli_num" type="text" required id="appli_num" value="" size="11"/></td>
	</tr>
    <tr>
	<tr>
    	<td width="155"><div align="right">Date Patented</div></td>
    	<td width="500"><input name="pat_date" type="text" required id="pat_date" value="" size="11"/></td>
	</tr>
	...
	<tr>
    	...
    	<td width="500"><input name="pat_num" type="text" required id="pat_num" value="" size="11"/></td>
	</tr>
    <tr>
    	<td width="155"><div align="right">Name of Inventor/s</div></td>
	   	<td width="500"><textarea name="pat_inventor" cols="50" rows="6" onkeyup="limit(pat_inventor)" onblur="limit(pat_inventor)" required style='text-align:left'></textarea></td>
  	</tr>
