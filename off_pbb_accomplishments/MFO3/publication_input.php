...
//Extract fields.
	...
	$file_name_sample = "mfo3_research_publication_" . $cu . "_" . $du . "_" . $conu . "_" . $d;
...
<body>
<h2>MFO3: Publication - Input New Record</h2><hr/>

<!-- Edit form here -->
<form id="input_publication" method="post" action="publication_save.php" onsubmit="return validateForm()" enctype="multipart/form-data">
...
<table>
	...
	<tr>
    	...
    	<td width="500"><input name="pub_date" type="text" required id="pub_date" value="" size="11"/></td>
	</tr>
    ...
    <tr>
    	<td width="155"><div align="right">Submitting Author/s</div></td>
	   	<td width="500"><textarea name="pub_author" cols="50" rows="6" onkeyup="limit(pub_author)" onblur="limit(pub_author)" required style='text-align:left'></textarea></td>
  	</tr>
	...
	<tr>
    	...
    	<option value="">Please Select :</option>
    	  ...
    	  <option value="<?php echo $option1->journal_publication_type_id . ',' . $option1->journal_publication_type_name; ?>"><?php echo $option1->journal_publication_type_name; ?></option>
    	  <?php endforeach; ?>
    	 </select></td>
	</tr>
    <tr>
    	<td width="155"><div align="right">Name</div></td>
	   	<td width="500"><textarea name="pub_name" cols="50" rows="6" onkeyup="limit(pub_name)" onblur="limit(pub_name)" required style='text-align:left'></textarea></td>
  	</tr>
	...
	<tr>
    	...
    	<td width="500"><input name="pub_vol" type="text" required id="pub_vol" value="" size="11"/></td>
	</tr>
...
<!--   <input type="hidden" name="mfo3_form_program_id" value="<?php print $mfo3_form_program_id; ?>" id="button" ><button type="submit">Submit</button> -->
