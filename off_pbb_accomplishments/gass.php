    ...
    <table width="990" height="480" border="0" cellpadding="5" cellspacing="0">
	  <tr>
		...
		<ul id="MenuBar1" class="MenuBarVertical">
  			<li><a class="MenuBarItemSubmenu" href="#">GASS</a>
      			<ul>
                  <a href="under_construction.php" target="myFrame"><li>View Records</li></a>
                  <a href="under_construction.php" target="myFrame"><li>Input Records</li></a>
                </ul>
  			</li>
		</ul>
        </td>
