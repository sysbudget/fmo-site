...
function validateForm()
{
  ...
  //Check number of trainees and request acted upon
	...
	var b = 0;
	var c = 0;
	var a = 1*(document.getElementById("trainees_count").value);
	var b = 1*(document.getElementById("rating_survey_size").value);
	var c = 1*(document.getElementById("timeliness_survey_size").value);
	if (a < b)	{
        alert("The rating survey size can not be more than the number of trainees");
        return false;
	}

	if (a < c)	{
        alert("The timeliness survey size can not be more than the number of trainees");
        return false;
	}
...
<tr>
    <td width="155"><div align="right">Duration of the Training As Stated In The Certificate</div><div align="right"></div></td> 
...
<tr>
        ...
        <td></td>
    	<td colspan="2" scope="row"><div align="left">
        <i>(as officially stated in the Certificate; Training Period must be within the calendar year 2016)</i><br/></div>
	   	</td>
</tr>
...
<tr>
   	<td><div align="right">
	<strong>Training Request</strong></div>
	</td>
</tr>

<tr>
    <td width="155"><div align="right">Mode of Training Requested</div></td>
 	<td width="500">
...
<tr>
    <td width="155"><div align="right">Number of Request</div></td>
    <td width="500"><input name="request_count" type="number" min="0" required id="request_count" placeholder="0" size="11" onkeyup="checkban(request_count)" onblur="checkban(request_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Number of Request<br/>acted within 3 Days</div></td>
    <td width="500"><input name="request_acted" type="number" min="0" required id="request_acted" placeholder="0" size="11" onkeyup="checkban(request_acted)" onblur="checkban(request_acted)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Number of Trainees</div></td>
    <td width="500"><input name="trainees_count" type="number" min="0" required id="trainees_count" placeholder="0" size="11" onkeyup="checkban(trainees_count)" onblur="checkban(trainees_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Number of Training Hours</div></td>
    <td width="500"><input name="training_hours" type="number" min="0" required id="training_hours" placeholder="0" size="11" onkeyup="checkban(training_hours)" onblur="checkban(training_hours)" /></td>
</tr>
...
<tr>
        ...
        <td></td>
    	<td colspan="2" scope="row"><div align="left">
        <i>(Copy the above prescribed filename to upload the PDF copy of the Extension Service Request)</i><br/></div>
	   	</td>
</tr>
...
<tr>
    <td width="155"><div align="right">Is this training included in the Budget Proposal Form B for the year?</div></td>
 	<td width="500">
...
<tr>
    <td width="155"><div align="right">Survey Conducted</div></td>
 	<td width="500">
    <input type="radio" onchange="disable_survey(survey_conducted)" id="c1" name="survey_conducted" checked <?php if (isset($survey_conducted) && $survey_conducted=="Yes") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="disable_survey(survey_conducted)" id="c2" name="survey_conducted" <?php if (isset($survey_conducted) && $survey_conducted=="No") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    <td width="155"><div align="right">Survey Mode</div></td>
 	<td width="500">
    <input type="radio" id="rm1" name="rating_mode" required checked <?php if (isset($rating_mode) && $rating_mode=="Conventional") echo "checked";?>  value="Conventional">Conventional
...
<tr>
    <td width="155"><div align="right">Was the Training rated?</div></td>
 	<td width="500">
    <input type="radio" onchange="disable_rating(rating_conducted)" id="rc1" name="rating_conducted" checked <?php if (isset($rating_conducted) && $rating_conducted=="Y") echo "checked";?>  value="Y">Yes
...
<tr>
    ...
    <td width="500"><input name="rating_survey_size" type="number" min="0" required id="rating_survey_size" placeholder="0" size="11" onkeyup="checkban(rating_survey_size)" onblur="checkban(rating_survey_size)" /></td>
</tr>
...
<tr>
    ...
    <td width="500"><input name="no_rating_count" type="number" min="0" required id="no_rating_count" placeholder="0" size="11" onkeyup="checkban(no_rating_count)" onblur="checkban(no_rating_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Poor Count on Rating</div></td>
    <td width="500"><input name="poor_rating_count" type="number" min="0" required id="poor_rating_count" placeholder="0" size="11" onkeyup="checkban(poor_rating_count)" onblur="checkban(poor_rating_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Fair Count on Rating</div></td>
    <td width="500"><input name="fair_rating_count" type="number" min="0" required id="fair_rating_count" placeholder="0" size="11" onkeyup="checkban(fair_rating_count)" onblur="checkban(fair_rating_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Good Count on Rating</div></td>
    <td width="500"><input name="good_rating_count" type="number" min="0" required id="good_rating_count" placeholder="0" size="11" onkeyup="checkban(good_rating_count)" onblur="checkban(good_rating_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Better Count on Rating</div></td>
    <td width="500"><input name="better_rating_count" type="number" min="0" required id="better_rating_count" placeholder="0" size="11" onkeyup="checkban(better_rating_count)" onblur="checkban(better_rating_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Best Count on Rating</div></td>
    <td width="500"><input name="best_rating_count" type="number" min="0" required id="best_rating_count" placeholder="0" size="11" onkeyup="checkban(best_rating_count)" onblur="checkban(best_rating_count)" /></td>
</tr>
...
<tr>
        ...
        <td></td>
    	<td colspan="2" scope="row"><div align="left">
        <i>(Copy the above prescribed filename to upload the PDF copy of the Accomplished Extension Service Rating Survey Form Sample)</i><br/></div>
	   	</td>
</tr>
...
<tr>
    <td width="155"><div align="right">Was the Timeliness on training rated?</div></td>
 	<td width="500">
    <input type="radio" onchange="disable_timeliness(timeliness_conducted)" id="tc1" name="timeliness_conducted" checked <?php if (isset($timeliness_conducted) && $timeliness_conducted=="Y") echo "checked";?>  value="Y">Yes
...
<tr>
    <td width="155"><div align="right">Size</div></td>
    <td width="500"><input name="timeliness_survey_size" type="number" min="0" required id="timeliness_survey_size" placeholder="0" size="11" onkeyup="checkban(timeliness_survey_size)" onblur="checkban(timeliness_survey_size)" /></td>
</tr>
...
<tr>
    ...
    <td width="500"><input name="no_timeliness_count" type="number" min="0" required id="no_timeliness_count" placeholder="0" size="11" onkeyup="checkban(no_timeliness_count)" onblur="checkban(no_timeliness_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Poor Count on Timeliness</div></td>
    <td width="500"><input name="poor_timeliness_count" type="number" min="0" required id="poor_timeliness_count" placeholder="0" size="11" onkeyup="checkban(poor_timeliness_count)" onblur="checkban(poor_timeliness_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Fair Count on Timeliness</div></td>
    <td width="500"><input name="fair_timeliness_count" type="number" min="0" required id="fair_timeliness_count" placeholder="0" size="11" onkeyup="checkban(fair_timeliness_count)" onblur="checkban(fair_timeliness_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Good Count on Timeliness</div></td>
    <td width="500"><input name="good_timeliness_count" type="number" min="0" required id="good_timeliness_count" placeholder="0" size="11" onkeyup="checkban(good_timeliness_count)" onblur="checkban(good_timeliness_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Better Count on Timeliness</div></td>
    <td width="500"><input name="better_timeliness_count" type="number" min="0" required id="better_timeliness_count" placeholder="0" size="11" onkeyup="checkban(better_timeliness_count)" onblur="checkban(better_timeliness_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Best Count on Timeliness</div></td>
    <td width="500"><input name="best_timeliness_count" type="number" min="0" required id="best_timeliness_count" placeholder="0" size="11" onkeyup="checkban(best_timeliness_count)" onblur="checkban(best_timeliness_count)" /></td>
</tr>
...
<tr>
        ...
        <td></td>
    	<td colspan="2" scope="row"><div align="left">
        <i>(Copy the above prescribed filename to upload the PDF copy of the Accomplished Extension Service Timeliness Survey Form Sample)</i><br/></div>
	   	</td>
</tr>
...
<tr>
        ...
        <td></td>
    	<td colspan="2" scope="row"><div align="left">
        <i>(Copy the above prescribed filename to upload the PDF copy of the Extension Service Survey Tally Sheets Endorsed by the Unit Head)</i><br/></div>
	   	</td>
</tr>
