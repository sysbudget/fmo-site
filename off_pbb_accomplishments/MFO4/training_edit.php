...
// get the id from the url
	$mfo4_forma_trainings_id = $_GET['id'];
...
$ext_title = $row['mfo4_forma_trainings_title_of_training'];
$ext_venue = $row['mfo4_forma_trainings_place_venue'];
$ext_duration = $row['mfo4_forma_trainings_date_description'];
$start_date = strtotime($row['mfo4_forma_trainings_date']);
$request_mode = $row['mfo4_forma_trainings_request_mode'];
$requester = $row['mfo4_forma_trainings_requested_by'];
$request_count = $row['mfo4_forma_trainings_no_of_clients_who_requested'];
$request_acted = $row['mfo4_forma_trainings_no_of_requests_responded_witin_3_days'];
$trainees_count = $row['mfo4_forma_trainings_no_of_persons_trained'];
$training_hours = $row['mfo4_forma_trainings_training_hours'];
$considered_gaa_bp = $row['mfo4_forma_trainings_considered_in_gaa'];
$survey_conducted = $row['mfo4_forma_trainings_survey_conducted'];
$rating_mode = $row['mfo4_forma_trainings_surveyed_to_rate_training_survey_mode'];
$rating_conducted = $row['mfo4_forma_trainings_was_a_survey_conducted_to_rate_training'];
$rating_survey_size = $row['mfo4_forma_trainings_no_of_persons_surveyed_to_rate_training'];
$no_rating_count = $row['mfo4_forma_trainings_surveyed_to_rate_training_no_answer'];
$poor_rating_count = $row['mfo4_forma_trainings_surveyed_to_rate_training_bad'];
$fair_rating_count = $row['mfo4_forma_trainings_surveyed_to_rate_training_fair'];
$good_rating_count = $row['mfo4_forma_trainings_surveyed_to_rate_training_good'];
$better_rating_count = $row['mfo4_forma_trainings_surveyed_to_rate_training_better'];
$best_rating_count = $row['mfo4_forma_trainings_surveyed_to_rate_training_best'];
$timeliness_conducted = $row['mfo4_forma_trainings_was_a_survey_conducted_to_ask_if_timely'];
$timeliness_survey_size = $row['mfo4_forma_trainings_no_of_persons_surveyed_to_ask_if_timely'];
$no_timeliness_count = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_no_answer'];
$poor_timeliness_count = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_bad'];
$fair_timeliness_count = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_fair'];
$good_timeliness_count = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_good'];
$better_timeliness_count = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_better'];
$best_timeliness_count = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_best'];
$mfo4_forma_trainings_id = $row['mfo4_forma_trainings_id'];

	if ($request_count == 0){$request_count = "";}
	if ($request_acted == 0){$request_acted = "";}
	if ($trainees_count == 0){$trainees_count = "";}
	if ($training_hours == 0){$training_hours = "";}
	...
	$a = $row['mfo4_forma_trainings_request_attachment'];
	$attach_ext_service_req = rtrim($a,".pdf");
	$b = $row['mfo4_forma_trainings_survey_form_to_rate_training_attachment'];
	$attach_rating_sample = rtrim($b,".pdf");
	$c = $row['mfo4_forma_trainings_surveyed_to_ask_if_timely_attachment'];
	$attach_timeliness_sample = rtrim($c,".pdf");
	$d = $row['mfo4_forma_trainings_survey_tally_sheet_attachment'];
...
//Get session values
	...
	if (empty($attach_ext_service_req)){
...
function disable_survey()
{
	if (document.getElementById("c1").checked) {
		...
		return disable_rating();
		return disable_timeliness();
	}
	else
	{
...
function validateForm()
{
  ...
  //Check timeliness survey size equal total rating answers
...
<div class="viewbody">
<h2>MFO4: Training/Extension Services - Edit Record</h2>
<a href="training_view_all.php">View All Records</a>
<hr/>

<!-- Edit form here -->
<form name="edit_training_form" id="edit_training_form" method="post" action="training_save_edited.php" onsubmit="return validateForm()" enctype="multipart/form-data">
<table>
<tr>
...
<tr>
    ...
    <td width="500"><textarea name="ext_title" cols="50" rows="6" onkeyup="limit(ext_title)" onblur="limit(ext_title)" required><?php print $ext_title; ?></textarea></td>
</tr>
...
<tr>
    ...
    <td width="500"><textarea name="ext_venue" cols="50" rows="6" onkeyup="limit(ext_venue)" onblur="limit(ext_venue)" required><?php print $ext_venue; ?></textarea></td>
</tr>
...
<tr>
    ...
    <td width="500"><textarea name="ext_duration" cols="50" rows="6" onkeyup="limit(ext_duration)" onblur="limit(ext_duration)" required><?php print $ext_duration; ?></textarea></td>
</tr>
...
<tr>
    <td width="155"><div align="right">Requester</div></td>
 	<td width="500">
    <input type="radio" name="requester" <?php if (isset($requester) && $requester=="Head of Agency") echo "checked";?>  value="Head of Agency">Head of Agency
...
<tr>
    ...
    <td width="500"><input name="trainees_count" type="number" min="0" required id="trainees_count" placeholder="0" value="<?php print $trainees_count; ?>"  size="11" onkeyup="checkban(trainees_count)" onblur="checkban(trainees_count)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Number of Training Hours</div></td>
    <td width="500"><input name="training_hours" type="number" min="0" required id="training_hours" placeholder="0" value="<?php print $training_hours; ?>"  size="11" onkeyup="checkban(training_hours)" onblur="checkban(training_hours)" /></td>
</tr>

<tr>
    <td width="155"><div align="right">Prescribed Attachment 1 Filename</div></td>
    <td width="500"><textarea name="file_name_display1" id="file_name_display1" readonly cols="50" rows="6" required><?php print $attach_ext_service_req; ?></textarea></td>
	<input name="file_name_sample1" hidden id="file_name_sample1" value="<?php print $attach_ext_service_req; ?>" />
</tr>
...
<tr>
       ...
       <input type="hidden" name="mfo4_forma_trainings_id" value="<?php print $mfo4_forma_trainings_id; ?>"><button type="submit">Submit</button></div>
	</th>
    </tr>
