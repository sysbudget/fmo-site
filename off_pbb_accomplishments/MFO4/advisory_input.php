...
function disable_timeliness()
{
	...
	else
	{
   		...
   		document.getElementById("best_timeliness_count").disabled = true;
   		document.getElementById("uploadFile3").disabled = true;
   		document.getElementById("timeliness_survey_size").value = 0;
   		document.getElementById("no_timeliness_count").value = 0;
   		document.getElementById("poor_timeliness_count").value = 0;
   		document.getElementById("fair_timeliness_count").value = 0;
   		document.getElementById("good_timeliness_count").value = 0;
   		document.getElementById("better_timeliness_count").value = 0;
   		document.getElementById("best_timeliness_count").value = 0;
	}
...
<div class="viewbody">
<h2>MFO4: Advisory Services - Input Form</h2>
<a href="advisory_view_all.php">View All Records</a>
<hr/>
...
<!-- Edit form here -->
<form name="inputForm" action="advisory_insert.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
<table>
...
<tr>
    <td width="155"><div align="right">Title/Type of Consultancy</div><div align="right"></div></td> 
    <td width="500"><textarea name="advisory_title" cols="50" rows="6" onkeyup="limit(advisory_title)" onblur="limit(advisory_title)" required></textarea></td>
</tr>
...
<tr>
    ...
    <td width="500"><textarea name="advisory_venue" cols="50" rows="6" onkeyup="limit(advisory_venue)" onblur="limit(advisory_venue)" required></textarea></td>
</tr>
...
<tr>
    <td width="155"><div align="right">Mode of Advisory Requested</div></td>
 	<td width="500">
...
<tr>
    ...
    <td width="500"><input name="client_count" type="number" min="0" required id="client_count" placeholder="0" size="11" onkeyup="checkban(client_count)" onblur="checkban(client_count)" /></td>
</tr>
...
<tr>
    <td width="155"><div align="right">Survey Conducted</div></td>
 	<td width="500">
    <input type="radio" onchange="disable_survey(survey_conducted)" id="c1" name="survey_conducted" checked <?php if (isset($survery_conducted) && $survery_conducted=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="disable_survey(survey_conducted)" id="c2" name="survey_conducted" <?php if (isset($survery_conducted) && $survery_conducted=="N") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    ...
    <td width="500"><input name="assisted_count" type="number" min="0" required id="assisted_count" placeholder="0" size="11" onkeyup="checkban(assisted_count)" onblur="checkban(assisted_count)" /></td>
</tr>
