...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>Graduate Degree Program - View Per Page</title>
                ...
                <?php
						if ($result)
						{
							if ($result->num_rows != 0)
							{
								...
								echo "<p><a href='gradprog_input.php'>Add New Record</a> | ";
								echo "<a href='gradprog_view_all.php'>View All</a> | <b>View Page:</b> ";
								...
								for ($i = 1; $i <= $total_pages; $i++)
								{
									...
									{
										echo "<a href='gradprog_view_per_page.php?page=$i'>$i</a> ";
									}
                                 }
                                 echo "</p>";
                                 echo "</div>";
