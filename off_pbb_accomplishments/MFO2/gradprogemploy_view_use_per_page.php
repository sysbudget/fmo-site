...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>Employment Status Improvement</title>
        ...
        <body>
                <div class="viewbody">
				<h2>MFO 2: Employment Status Improvement - Select Graduate Degree Program</h2>
                ...
                <?php
						if ($result)
						{
							if ($result->num_rows != 0)
							{
								...
								echo "<a href='gradprogemploy_view_use_all.php'>View All</a> | <b>View Page:</b> ";
								...
								for ($i = 1; $i <= $total_pages; $i++)
								{
									...
									{
										echo "<a href='gradprogemploy_view_use_all.php?page=$i'>$i</a> ";
									}
                                 }
                                 echo "</p>";
                                 echo "</div>";
								...
								for ($i = $start; $i < $end; $i++)
								{
									...
									echo '<td><a href="gradprogemploy_input.php?id=' . $row[0] . '">Select</a></td>';
