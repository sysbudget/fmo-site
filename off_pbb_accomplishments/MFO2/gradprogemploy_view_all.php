...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>Employment Status Improvement - View All</title>
                ...
                <?php
						if ($result)
						{
							if ($result->num_rows != 0)
							{
								...
								echo '<p><a href="gradprogemploy_view_use_per_page.php?page=1">Add New Record</a> | <b>View All</b> | <a href="gradprogemploy_view_per_page.php?page=1">View Page</a></p>';
								echo '</div>';
