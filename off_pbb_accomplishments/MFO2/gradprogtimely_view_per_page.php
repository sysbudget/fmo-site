...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>Timeliness of Education Service Delivery - View Per Page</title>
                ...
                <?php
						if ($result)
						{
							if ($result->num_rows != 0)
							{
								...
								echo "<p><a href='gradprogtimely_view_use_per_page.php?page=1'>Add New Record</a> | ";
								echo "<a href='gradprogtimely_view_all.php'>View All</a> | <b>View Page:</b> ";
								...
								for ($i = 1; $i <= $total_pages; $i++)
								{
									...
									{
										echo "<a href='gradprogtimely_view_per_page.php?page=$i'>$i</a> ";
									}
                                 }
                                 echo "</p>";
                                 echo "</div>";
