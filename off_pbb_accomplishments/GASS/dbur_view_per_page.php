...
ORDER BY gass_forma_dbur_id ASC" ;
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<a href='dbur_view_all.php'>View All</a> | <b>View Page:</b> ";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='dbur_view_per_page.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</div>";
                                                        echo "</p>";
...
/*
														...
														echo '<td><a href="dbur_delete.php?id=' . $row[38] . '" onclick="return checkDelete()">Delete</a></td>';
                                                        echo '<td><a href="dbur_edit.php?id=' . $row[38] . '">Edit</a></td>';
...
*/
														...
														// echo out the contents of each row into a table
														echo '<td><a href="dbur_delete.php?id=' . $row[22] . '" onclick="return checkDelete()">Delete</a></td>';
                                                        echo '<td><a href="dbur_edit.php?id=' . $row[22] . '">Edit</a></td>';
														...
														echo "<td nowrap='nowrap'><a href = " . "uploads/" . $cu_short_name . "/" . $row[19] . ">" . $row[19] . "</a></td>";
														echo "<td nowrap='nowrap'><a href = " . "uploads/" . $cu_short_name . "/" . $row[20] . ">" . $row[20] . "</a></td>";
