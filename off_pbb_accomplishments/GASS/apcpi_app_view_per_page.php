...
ORDER BY gass_formcd_apcpi_app_id ASC" ;
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<a href='apcpi_app_view_all.php'>View All</a> | <b>View Page:</b> ";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='apcpi_app_per_page.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</div>";
                                                        echo "</p>";
												...
												echo "<tr>
														...
														echo '<td><a href="apcpi_app_delete.php?id=' . $row[6] . '" onclick="return checkDelete()">Delete</a></td>';
                                                        echo '<td><a href="apcpi_app_edit.php?id=' . $row[6] . '">Edit</a></td>';
