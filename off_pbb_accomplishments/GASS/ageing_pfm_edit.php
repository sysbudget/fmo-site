...
//Extract fields.
	...
	$qtr = $row['gass_formb23_cash_advance_coa_fr_quarter'];
	$cash_advance = $row['gass_formb2_cash_advance_submitted'];
	$fin_position = $row['gass_formb3_coa_fr_financial_position'];
	$fin_performance = $row['gass_formb3_coa_fr_financial_performance'];
	$net_asset = $row['gass_formb3_coa_fr_changes_in_net_asset'];
	$cash_flows = $row['gass_formb3_coa_fr_cash_flows'];
	$actual_amounts = $row['gass_formb3_coa_fr_budget_and_actual_amounts'];
	$notes_to_financial = $row['gass_formb3_coa_fr_notes_to_financial_statements'];

	$a = $row['gass_formb2_cash_advance_attachment'];
	$gass_formb2_cash_advance = rtrim($a,".pdf");
	$b = $row['gass_formb3_coa_fr_attachment'];
	$gass_formb3_coa = rtrim($b,".pdf");
...
//Get session values
	...
	if (empty($gass_formb2_cash_advance)){
	...
	$gass_formb2_cash_advance = $file_name_sample1;
	}
	
	if (empty($gass_formb3_coa)){
	...
	$gass_formb3_coa = $file_name_sample2;
	}
...
<body>
<div class="viewbody">
<h2>GASS B2: Report on Ageing of Cash Advance and GASS B3: COA Financial Reports - Edit Record</h2>
<hr/>

<!-- Edit form here -->
<form name="edit_ageing_pfm_form" id="edit_ageing_pfm_form" method="post" action="ageing_pfm_save_edited.php" enctype="multipart/form-data">
<table>
...
<tr>
    ...
    <input type="radio" onchange="choice1(cash_advance)" name="cash_advance" id="cash_advance_y" <?php if (isset($cash_advance) && $cash_advance=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice1(cash_advance)" name="cash_advance" id="cash_advance_n" <?php if (isset($cash_advance) && $cash_advance=="N") echo "checked";?>  value="N">No
	</td>
</tr>

<tr>
    <td width="155"><div align="right">Prescribed Attachment 1 Filename</div></td>
    <td width="500"><textarea name="file_name_display1" id="file_name_display1" readonly cols="50" rows="6" required><?php print $gass_formb2_cash_advance; ?></textarea></td>
	<input name="file_name_sample1" hidden id="file_name_sample1" value="<?php print $gass_formb2_cash_advance; ?>" />
</tr>
...
<tr>
    ...
    <input type="radio" onchange="choice2(fin_position)" name="fin_position" id="fin_position_y" <?php if (isset($fin_position) && $fin_position=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice2(fin_position)" name="fin_position" id="fin_position_n" <?php if (isset($fin_position) && $fin_position=="N") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    ...
    <input type="radio" onchange="choice2(fin_performance)" name="fin_performance" id="fin_performance_y" <?php if (isset($fin_performance) && $fin_performance=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice2(fin_performance)" name="fin_performance" id="fin_performance_n" <?php if (isset($fin_performance) && $fin_performance=="N") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    ...
    <input type="radio" onchange="choice2(net_asset)" name="net_asset" id="net_asset_y" <?php if (isset($net_asset) && $net_asset=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice2(net_asset)" name="net_asset" id="net_asset_n" <?php if (isset($net_asset) && $net_asset=="N") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    ...
    <input type="radio" onchange="choice2(cash_flows)" name="cash_flows" id="cash_flows_y" <?php if (isset($cash_flows) && $cash_flows=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice2(cash_flows)" name="cash_flows" id="cash_flows_n" <?php if (isset($cash_flows) && $cash_flows=="N") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    ...
    <input type="radio" onchange="choice2(actual_amounts)" name="actual_amounts" id="actual_amounts_y" <?php if (isset($actual_amounts) && $actual_amounts=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice2(actual_amounts)" name="actual_amounts" id="actual_amounts_n" <?php if (isset($actual_amounts) && $actual_amounts=="N") echo "checked";?>  value="N">No
	</td>
</tr>
...
<tr>
    ...
    <input type="radio" onchange="choice2(notes_to_financial)" name="notes_to_financial" id="notes_to_financial_y" <?php if (isset($notes_to_financial) && $notes_to_financial=="Y") echo "checked";?>  value="Y">Yes
   	<input type="radio" onchange="choice2(notes_to_financial)" name="notes_to_financial" id="notes_to_financial_n" <?php if (isset($notes_to_financial) && $notes_to_financial=="N") echo "checked";?>  value="N">No
	</td>
</tr>

    <td width="155"><div align="right">Prescribed Attachment 2 Filename</div></td>
    <td width="500"><textarea name="file_name_display2" id="file_name_display2" readonly cols="50" rows="6" required><?php print $gass_formb3_coa; ?></textarea></td>
	<input name="file_name_sample2" hidden id="file_name_sample2" value="<?php print $gass_formb3_coa; ?>" />
</tr>
...
<tr>
       ...
       <input type="hidden" name="gass_formb23_cash_advance_coa_fr_id" value="<?php print $gass_formb23_cash_advance_coa_fr_id; ?>"><button type="submit">Submit</button></div>
	</th>
    </tr>
