...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
                <div class="viewbody">
                <h2>GASS: C&D APCPI and APP Report - View Records</h2>
                <?php
...
ORDER BY gass_formcd_apcpi_app_id ASC" ;
}
else {
$query = "SELECT 
unit_delivery_name_cu,
...
ORDER BY gass_formcd_apcpi_app_id ASC" ;
						...
						{									
                                ...
                                if ($result->num_rows > 0)
                                {
										...
										echo "<b>View All</b> | <a href='apcpi_app_view_per_page.php'>View Page:</a> ";
                                        echo "</div>";
												...
												echo "<tr>
														...
														<th width='50' nowrap='nowrap'>APCPI</th>
														<th width='150' nowrap='nowrap'>Attachment 1</th>
														<th width='50' nowrap='nowrap'>APP</th>
                                        ...
                                        while ($row = $result->fetch_object())
                                        {
                                                ...
                                                echo "<td><a href='apcpi_app_delete.php?id=" . $row->gass_formcd_apcpi_app_id . "' onclick='return checkDelete()'>Delete</a></td>";
                                                echo "<td><a href='apcpi_app_edit.php?id=" . $row->gass_formcd_apcpi_app_id . "'>Edit</a></td>";
												// counter
												...
												echo "<td nowrap='nowrap'>" . $row->unit_contributor_name . "</td>";
														...
														$temp0 = $row->gass_formc_apcpi_submitted;
														if ( $temp0 == 'Y'){
															$temp0 = 'Yes';
															}
															else
												...
												echo "<td nowrap='nowrap'><a href = " . "uploads/" . $cu_short_name . "/" . $row->gass_formc_apcpi_attachment . ">" . $row->gass_formc_apcpi_attachment . "</a></td>";

														$temp1 = $row->gass_formd_app_submitted;
														if ( $temp1 == 'Y'){
															$temp1 = 'Yes';
															}
															else
												...
												echo "<td nowrap='nowrap'><a href = " . "uploads/" . $cu_short_name . "/" . $row->gass_formd_app_attachment . ">" . $row->gass_formd_app_attachment . "</a></td>";
                                ...
                                {
										echo "<p><a href='apcpi_app_input.php'>Add New Record</a> | ";
