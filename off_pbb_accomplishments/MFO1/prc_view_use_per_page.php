...
$query = "SELECT mfo1_forma_program_id, unit_delivery_name_cu, unit_contributor_name, ref_program_level_name, mfo1_forma_program_name, mfo1_forma_program_with_board, mfo1_forma_program_enrollment_in_terminal_year, mfo1_forma_program_graduates_total, mfo1_forma_program_graduates_total_within_timeframe, unit_contributor_id FROM tbl_sd_1_mfo1_forma_program WHERE (mfo1_forma_program_with_board = 'Y') AND (('$sd_users_username' = 'admin') OR (unit_contributor_id = '$unit_contributor_id')) ORDER BY ref_program_level_id, mfo1_forma_program_name;" ;
...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>PRC Licensure Examination</title>
        ...
        <body>
                <div class="viewbody">
				<h2>MFO 1: PRC Licensure Examination - Select Professional/Board Degree Program</h2>
                ...
                <?php
						if ($result)
						{
							if ($result->num_rows != 0)
							{
								...
								echo "<p><a href='prc_view_use_all.php'>View All</a> | <b>View Page:</b> ";
								...
								for ($i = 1; $i <= $total_pages; $i++)
								{
									...
									{
										echo "<a href='prc_view_use_per_page.php?page=$i'>$i</a> ";
									}
                                 }
                                 echo "</p>";
                                 echo "</div>";
								...
								for ($i = $start; $i < $end; $i++)
								{
									...
									echo '<td><a href="prc_input.php?id=' . $row[0] . '">Select</a></td>';
