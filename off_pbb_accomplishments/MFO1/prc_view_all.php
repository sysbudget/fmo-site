...
<html xmlns="http://www.w3.org/1999/xhtml">
		<head>  
                <title>PRC Licensure Exam - View All</title>
                ...
                <?php
						...
						{									
                                ...
                                if ($result->num_rows > 0)
                                {
										...
										echo '<p><a href="prc_view_use_per_page.php?page=1">Add New Record</a> | <b>View All</b> | <a href="prc_view_per_page.php?page=1">View Page</a></p>';
										echo '</div>';
                                ...
                                {
									echo '<div class="viewlinks">';
									echo '<p><a href="prc_view_use_per_page.php?page=1">Add New Record</a> | No record to display!</p>';
									echo '</div>';
                                }
