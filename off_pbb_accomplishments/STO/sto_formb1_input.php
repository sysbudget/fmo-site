...
//provision for the var orig_date = document.getElementById("orig_cert_date");
 ...
 //provision for the orig date validation
...
//check the format of date if  MM/DD/YYYY
...
<div class="viewbody">
<h2>STO B.1: International QMS Certificate - Input Form</h2>
...
<?php
    ...
    $query = $mysqli->query("SELECT sto_formb1_quality_assessment_id, ref_quality_assessment_standard_name FROM `tbl_sd_6_sto_formb1_quality_assessment` ORDER BY ref_quality_assessment_standard_name ASC");
...
<!-- Edit form here -->
<form name="inputForm" action="sto_formb1_insert.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
<table>

<tr>
    <td width="155"><div align="right">QMS Standard</div></td> 
    <td width="500"><textarea name="qms_std" cols="50" rows="6" onkeyup="limit(qms_std)" onblur="limit(qms_std)" required></textarea></td>
</tr>
...
<tr>
    <td width="155"><div align="right">Certificate Holder</div></td> 
    <td width="500"><textarea name="cert_holder" cols="50" rows="6" onkeyup="limit(cert_holder)" onblur="limit(cert_holder)" required></textarea></td>
</tr>
...
<tr>
    <td width="155"><div align="right">Scope</div></td> 
    <td width="500"><textarea name="cert_scope" cols="50" rows="6" onkeyup="limit(cert_scope)" onblur="limit(cert_scope)" required></textarea></td>
</tr>
...
<tr>
    <td width="155"><div align="right">Certificate/Appendix Number</div></td> 
    <td width="500"><textarea name="cert_number" cols="50" rows="6" onkeyup="limit(cert_number)" onblur="limit(cert_number)" required></textarea></td>
</tr>
...
<tr>
    ...
    <td><input name="re_reg_cert_date" type="text" required id="re_reg_cert_date" value="" size="11"/></td>
</tr>
...
<tr>
    ...
    <td><input name="expiry_date" type="text" required id="expiry_date" value="" size="11"/></td>
</tr>
...
<?php
	//free the query set and close the connection 
	$query->close();
	$mysqli->close();
?>
</body>
