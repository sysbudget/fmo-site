...
<!-- ============ Begin Content ============== -->
		<form name="form1" method="post" action="uploadFiles2.php">
			<p>To submit the accomplished forms, enter the number of files you wish to upload to the UP System Budget Office server and click "Submit". </p>
			<p>
			<input name="uploadNeed" type="text" id="uploadNeed" maxlength="3">
			</p>
			<p>
