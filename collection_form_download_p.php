...
<!-- ============ Page Heading ============== -->
		<h1 class="HeadingStyle">UP Manila-Philippine General Hospital Data Collection Forms</h1>
		<p>Click the links below to download the forms:</p>
<!-- ============ Begin Content ============== -->
		<?php
			$result=mysql_query("select * from wpc_downloads where recampcd='P' order by active desc, form_id asc, unit asc, department asc");
