						...
						if ($usercu == !'') {
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
                                                        ...
                                                        echo "<p><a href='input-chapter.php'>Add New Book Chapter</a> | <a href='view-chapter.php'>View All</a> | <b>View Page:</b>";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='view-paginated-chapter.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</p>";
                                                        echo "</div>";
