        ...
        <body>
                ...
                <?php
                        ...
                        // number of results to show per page
										...
										if ($usercu == !'') {
										$query = "SELECT year_cover, tbl_cu.short_name, unit, chapter_category, chapter_title, chapter_book_title, chapter_sub_author, chapter_author, chapter_book_publisher, chapter_book_editor, chapter_cit_dbase, chapter_book_year_published, chapter_book_edition, chapter_num_pages ,chapter_book_isbn,  chapter_book_circ_level, chapter_keyword, user_name, bcid FROM tbl_chapter_main_raw INNER JOIN tbl_cu ON tbl_chapter_main_raw.cu = tbl_cu.id WHERE user_name =  '$username' ORDER BY bcid DESC" ;
}
else {
										$query = "SELECT year_cover, tbl_cu.short_name, unit, chapter_category, chapter_title, chapter_book_title, chapter_sub_author, chapter_author, chapter_book_publisher, chapter_book_editor, chapter_cit_dbase, chapter_book_year_published, chapter_book_edition, chapter_num_pages ,chapter_book_isbn,  chapter_book_circ_level, chapter_keyword, user_name, bcid FROM tbl_chapter_main_raw INNER JOIN tbl_cu ON tbl_chapter_main_raw.cu = tbl_cu.id ORDER BY bcid DESC" ;
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
														...
														echo "<p><a href='input-chapter.php'>Add New Record</a>";
                                                        echo "</div>";
                                        ...
                                        echo "<tr>
												...
												<th></th>
                                                        ...
                                                        echo '<td><a href="edit-chapter.php?id=' . $row[18] . '">Edit</a></td>';                                                        /*echo '<td nowrap="nowrap"><a href="award-input-chapter.php?id=' . $row[12] . '">Add Award</a></td>';*/
