    ...
    <table width="990" height="480" border="0" cellpadding="5" cellspacing="0">
	  <tr>
		...
		<ul id="MenuBar1" class="MenuBarVertical">
  			<li><a class="MenuBarItemSubmenu" href="#">Invention</a>
      			<ul>
              	  <a href="invention/input-inv.php" target="myFrame"><li>Input Data</li></a>              
                  <a href="invention/view-inv.php" target="myFrame"><li>View Invention</li></a>             
