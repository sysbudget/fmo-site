...
$query = "INSERT INTO tbl_invention_main_raw(created, user_name, year_cover, cu, unit, inv_sub_inventor, inv_inventor, inv_invention, inv_applied, inv_patented, inv_commercial, inv_adopted, inv_patent_num, inv_date_issue, inv_development, inv_service, inv_end_product, inv_product_name, inv_award, inv_keyword) VALUES (NOW(), '$user_name', '$year_cover', '$cu', '$unit', '$inv_sub_inventor', '$inv_inventor', '$inv_invention', '$inv_applied', '$inv_patented', '$inv_commercial', '$inv_adopted', '$inv_patent_num', STR_TO_DATE('$_POST[start_date]','%m/%d/%Y'), '$inv_development', '$inv_service', '$inv_end_product', '$inv_product_name', '$inv_award','$inv_keyword')";
...
echo "1 record added";
header("Location: ../invention/view-input-inv.php");
