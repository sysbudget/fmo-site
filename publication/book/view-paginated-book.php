						...
						if ($usercu == !'') {
										...
										if ($result = $mysqli->query($query))
                                        {
                                                if ($result->num_rows != 0)
                                                {
                                                        ...
                                                        echo "<p><a href='input-book.php'>Add New Record</a> | <a href='view-book.php'>View All</a> | <b>View Page:</b>";
                                                        for ($i = 1; $i <= $total_pages; $i++)
                                                        {
                                                                ...
                                                                {
                                                                        echo "<a href='view-paginated-book.php?page=$i'>$i</a> ";
                                                                }
                                                        }
                                                        echo "</p>";
                                                        echo "</div>";
                                        ...
                                        echo "<tr>
												...
												<th></th>
                                                        ...
                                                        echo '<td><a href="edit-book.php?id=' . $row[17] . '">Edit</a></td>';                                                        					
                                                        /*echo '<td nowrap="nowrap"><a href="award-input-book.php?id=' . $row[11] . '">Add Award</a></td>';*/
