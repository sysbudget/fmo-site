...
if ( $creative_review == '' ) {
print '<p>Error! Peer review  is missing.</p>';
exit();
}
...
$query = "UPDATE tbl_creative_main_raw
SET
edited = NOW(), 
user_name = '$user_name',
...
cu = '$cu',
unit = '$unit',
creative_discipline = '$creative_discipline',
creative_type = '$creative_type',
creative_review = '$creative_review',
creative_title = '$creative_title',
creative_sub_artist = '$creative_sub_artist',
creative_artist = '$creative_artist',
creative_publisher = '$creative_publisher',
creative_editor = '$creative_editor',
creative_cit_dbase = '$creative_cit_dbase',
creative_year_published = '$creative_year_published',
creative_circ_level = '$creative_circ_level',
creative_award = '$creative_award',
...
header("Location: view-edited-creative.php?id=" . $cwid);
