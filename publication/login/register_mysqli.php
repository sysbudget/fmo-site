...
if (!empty($_POST) && empty($errors))
{
    ...
    $query = "INSERT INTO tbl_users_publication (emp_number, first_name, last_name, designation, telephone, office, cu, username, password, pwconfirm, email, created)
    ...
    <body>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <table>
              ...
              <tr>
                <td><label for="username">Telephone Number</label></td>
              ...
              <tr>
                <td><label for="username">Office</label></td>
