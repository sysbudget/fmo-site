...
<!-- ============ Page Heading ============== -->
		<h1 class="HeadingStyle">Memoranda</h1>
		<p>The following links are PDF files of the memoranda from the Vice-President for Planning and Finance regarding the submission of the Data Collection Forms:</p> 

<!-- ============ Begin Content ============== -->
		<?php
			$result=mysql_query("select * from wpc_downloads where recampcd='U' order by active desc, form_id asc");
			$count=mysql_num_rows($result);				
		?>    
		<form id="form1" name="form1" method="post" action="">
		<table border="0" cellpadding="3" cellspacing="1" > 
            <tr>
			    <th width="287" height="30" scope="col" ><div align="left">For:</div></th>
			</tr>
			<?php
