...
// Create page object
$frm_1_t_conu_pbb_detail_contributor_list = new cfrm_1_t_conu_pbb_detail_contributor_list();
$Page =& $frm_1_t_conu_pbb_detail_contributor_list;

// Page init
$frm_1_t_conu_pbb_detail_contributor_list->Page_Init();

// Page main
$frm_1_t_conu_pbb_detail_contributor_list->Page_Main();
?>
...
// Create page object
var frm_1_t_conu_pbb_detail_contributor_list = new up_Page("frm_1_t_conu_pbb_detail_contributor_list");

// page properties
frm_1_t_conu_pbb_detail_contributor_list.PageID = "list"; // page ID
frm_1_t_conu_pbb_detail_contributor_list.FormID = "ffrm_1_t_conu_pbb_detail_contributorlist"; // form ID
var UP_PAGE_ID = frm_1_t_conu_pbb_detail_contributor_list.PageID; // for backward compatibility

// extend page with Form_CustomValidate function
frm_1_t_conu_pbb_detail_contributor_list.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_1_t_conu_pbb_detail_contributor_list.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_1_t_conu_pbb_detail_contributor_list.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_1_t_conu_pbb_detail_contributor_list.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<?php } ?>
<?php if (($frm_1_t_conu_pbb_detail_contributor->Export == "") || (UP_EXPORT_MASTER_RECORD && $frm_1_t_conu_pbb_detail_contributor->Export == "print")) { ?>
<?php
$gsMasterReturnUrl = "frm_1_t_conu_contributor_pi_statuslist.php";
if ($frm_1_t_conu_pbb_detail_contributor_list->DbMasterFilter <> "" && $frm_1_t_conu_pbb_detail_contributor->getCurrentMasterTable() == "frm_1_t_conu_contributor_pi_status") {
	if ($frm_1_t_conu_pbb_detail_contributor_list->MasterRecordExists) {
		if ($frm_1_t_conu_pbb_detail_contributor->getCurrentMasterTable() == $frm_1_t_conu_pbb_detail_contributor->TableVar) $gsMasterReturnUrl .= "?" . UP_TABLE_SHOW_MASTER . "=";
?>
...
&nbsp;&nbsp;<?php $frm_1_t_conu_pbb_detail_contributor_list->ExportOptions->Render("body"); ?>
</p>
<?php if ($frm_1_t_conu_pbb_detail_contributor->Export == "") { ?>
...
<?php
	...
	if ($bSelectLimit) {
		$frm_1_t_conu_pbb_detail_contributor_list->TotalRecs = $frm_1_t_conu_pbb_detail_contributor->SelectRecordCount();
	} else {
		if ($frm_1_t_conu_pbb_detail_contributor_list->Recordset = $frm_1_t_conu_pbb_detail_contributor_list->LoadRecordset())
			$frm_1_t_conu_pbb_detail_contributor_list->TotalRecs = $frm_1_t_conu_pbb_detail_contributor_list->Recordset->RecordCount();
	}
	$frm_1_t_conu_pbb_detail_contributor_list->StartRec = 1;
	if ($frm_1_t_conu_pbb_detail_contributor_list->DisplayRecs <= 0 || ($frm_1_t_conu_pbb_detail_contributor->Export <> "" && $frm_1_t_conu_pbb_detail_contributor->ExportAll)) // Display all records
		$frm_1_t_conu_pbb_detail_contributor_list->DisplayRecs = $frm_1_t_conu_pbb_detail_contributor_list->TotalRecs;
	if (!($frm_1_t_conu_pbb_detail_contributor->Export <> "" && $frm_1_t_conu_pbb_detail_contributor->ExportAll))
		$frm_1_t_conu_pbb_detail_contributor_list->SetUpStartRec(); // Set up start record position
	if ($bSelectLimit)
		$frm_1_t_conu_pbb_detail_contributor_list->Recordset = $frm_1_t_conu_pbb_detail_contributor_list->LoadRecordset($frm_1_t_conu_pbb_detail_contributor_list->StartRec-1, $frm_1_t_conu_pbb_detail_contributor_list->DisplayRecs);
?>
<p class="upbudgetofficeclass upTitle" style="white-space: nowrap;"><?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_1_t_conu_pbb_detail_contributor->TableCaption() ?>
<?php if ($frm_1_t_conu_pbb_detail_contributor->getCurrentMasterTable() == "") { ?>
&nbsp;&nbsp;<?php $frm_1_t_conu_pbb_detail_contributor_list->ExportOptions->Render("body"); ?>
<?php } ?>
</p>
<?php if ($Security->CanSearch()) { ?>
<?php if ($frm_1_t_conu_pbb_detail_contributor->Export == "" && $frm_1_t_conu_pbb_detail_contributor->CurrentAction == "") { ?>
<a href="javascript:up_ToggleSearchPanel(frm_1_t_conu_pbb_detail_contributor_list);" style="text-decoration: none;"><img id="frm_1_t_conu_pbb_detail_contributor_list_SearchImage" src="phpimages/collapse.gif" alt="" width="9" height="9" border="0"></a><span class="upbudgetofficeclass">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
<div id="frm_1_t_conu_pbb_detail_contributor_list_SearchPanel">
<form name="ffrm_1_t_conu_pbb_detail_contributorlistsrch" id="ffrm_1_t_conu_pbb_detail_contributorlistsrch" class="upForm" action="<?php echo up_CurrentPage() ?>">
<input type="hidden" id="t" name="t" value="frm_1_t_conu_pbb_detail_contributor">
<div class="upBasicSearch">
<div id="xsr_1" class="upCssTableRow">
	<input type="text" name="<?php echo UP_TABLE_BASIC_SEARCH ?>" id="<?php echo UP_TABLE_BASIC_SEARCH ?>" size="20" value="<?php echo up_HtmlEncode($frm_1_t_conu_pbb_detail_contributor->getSessionBasicSearchKeyword()) ?>">
	<input type="Submit" name="Submit" id="Submit" value="<?php echo up_BtnCaption($Language->Phrase("QuickSearchBtn")) ?>">&nbsp;
	<a href="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>&nbsp;
</div>
<div id="xsr_2" class="upCssTableRow">
	<label><input type="radio" name="<?php echo UP_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo UP_TABLE_BASIC_SEARCH_TYPE ?>" value=""<?php if ($frm_1_t_conu_pbb_detail_contributor->getSessionBasicSearchType() == "") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>&nbsp;&nbsp;<label><input type="radio" name="<?php echo UP_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo UP_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($frm_1_t_conu_pbb_detail_contributor->getSessionBasicSearchType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>&nbsp;&nbsp;<label><input type="radio" name="<?php echo UP_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo UP_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($frm_1_t_conu_pbb_detail_contributor->getSessionBasicSearchType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</form>
</div>
<?php } ?>
<?php } ?>
<?php $frm_1_t_conu_pbb_detail_contributor_list->ShowPageHeader(); ?>
<?php
$frm_1_t_conu_pbb_detail_contributor_list->ShowMessage();
?>
<br>
<table cellspacing="0" class="upGrid"><tr><td class="upGridContent">
<?php if ($frm_1_t_conu_pbb_detail_contributor->Export == "") { ?>
<div class="upGridUpperPanel">
<?php if ($frm_1_t_conu_pbb_detail_contributor->CurrentAction <> "gridadd" && $frm_1_t_conu_pbb_detail_contributor->CurrentAction <> "gridedit") { ?>
<form name="uppagerform" id="uppagerform" class="upForm" action="<?php echo up_CurrentPage() ?>">
<table border="0" cellspacing="0" cellpadding="0" class="upPager">
	<tr>
		<td nowrap>
<?php if (!isset($frm_1_t_conu_pbb_detail_contributor_list->Pager)) $frm_1_t_conu_pbb_detail_contributor_list->Pager = new cPrevNextPager($frm_1_t_conu_pbb_detail_contributor_list->StartRec, $frm_1_t_conu_pbb_detail_contributor_list->DisplayRecs, $frm_1_t_conu_pbb_detail_contributor_list->TotalRecs) ?>
<?php if ($frm_1_t_conu_pbb_detail_contributor_list->Pager->RecordCount > 0) { ?>
	<table border="0" cellspacing="0" cellpadding="0"><tr><td><span class="upbudgetofficeclass"><?php echo $Language->Phrase("Page") ?>&nbsp;</span></td>
<!--first page button-->
	<?php if ($frm_1_t_conu_pbb_detail_contributor_list->Pager->FirstButton->Enabled) { ?>
	<td><a href="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageUrl() ?>start=<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->FirstButton->Start ?>"><img src="phpimages/first.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phpimages/firstdisab.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($frm_1_t_conu_pbb_detail_contributor_list->Pager->PrevButton->Enabled) { ?>
	<td><a href="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageUrl() ?>start=<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->PrevButton->Start ?>"><img src="phpimages/prev.gif" alt="<?php echo $Language->Phrase("PagerPrevious") ?>" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phpimages/prevdisab.gif" alt="<?php echo $Language->Phrase("PagerPrevious") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
<!--current page number-->
	<td><input type="text" name="<?php echo UP_TABLE_PAGE_NO ?>" id="<?php echo UP_TABLE_PAGE_NO ?>" value="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->CurrentPage ?>" size="4"></td>
<!--next page button-->
	<?php if ($frm_1_t_conu_pbb_detail_contributor_list->Pager->NextButton->Enabled) { ?>
	<td><a href="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageUrl() ?>start=<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->NextButton->Start ?>"><img src="phpimages/next.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phpimages/nextdisab.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($frm_1_t_conu_pbb_detail_contributor_list->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageUrl() ?>start=<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->LastButton->Start ?>"><img src="phpimages/last.gif" alt="<?php echo $Language->Phrase("PagerLast") ?>" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phpimages/lastdisab.gif" alt="<?php echo $Language->Phrase("PagerLast") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
	<td><span class="upbudgetofficeclass">&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->PageCount ?></span></td>
	</tr></table>
	</td>	
	<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td>
	<span class="upbudgetofficeclass"><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $frm_1_t_conu_pbb_detail_contributor_list->Pager->RecordCount ?></span>
<?php } else { ?>
	<?php if ($Security->CanList()) { ?>
	<?php if ($frm_1_t_conu_pbb_detail_contributor_list->SearchWhere == "0=101") { ?>
...
<?php } ?>
<form name="ffrm_1_t_conu_pbb_detail_contributorlist" id="ffrm_1_t_conu_pbb_detail_contributorlist" class="upForm" action="" method="post">
<input type="hidden" name="t" id="t" value="frm_1_t_conu_pbb_detail_contributor">
<div id="gmp_frm_1_t_conu_pbb_detail_contributor" class="upGridMiddlePanel">
<?php if ($frm_1_t_conu_pbb_detail_contributor_list->TotalRecs > 0) { ?>
...
// Render list options
$frm_1_t_conu_pbb_detail_contributor_list->RenderListOptions();

// Render list options (header, left)
$frm_1_t_conu_pbb_detail_contributor_list->ListOptions->Render("header", "left");
?>
<?php if ($frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->Visible) { // Delivery Unit ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Delivery_Unit) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn" style="white-space: nowrap;"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->Visible) { // Contributing Unit ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Contributing_Unit) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn" style="white-space: nowrap;"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_1_t_conu_pbb_detail_contributor->MFO->Visible) { // MFO ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->MFO) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn" style="white-space: nowrap;"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->MFO->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->MFO->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->MFO->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_1_t_conu_pbb_detail_contributor->Question->Visible) { // Question ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Question) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->Question->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->Question->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->Question->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_1_t_conu_pbb_detail_contributor->Applicable->Visible) { // Applicable ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Applicable) ?>',1);">
...
<?php if ($frm_1_t_conu_pbb_detail_contributor->Target->Visible) { // Target ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Target) ?>',1);">
...
<?php if ($frm_1_t_conu_pbb_detail_contributor->Target_Remarks->Visible) { // Target Remarks ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Target_Remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->Target_Remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->Target_Remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->Target_Remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date->Visible) { // Target Cut-Off Date ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn" style="white-space: nowrap;"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_1_t_conu_pbb_detail_contributor->Target_Message->Visible) { // Target Message ?>
	...
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_1_t_conu_pbb_detail_contributor->SortUrl($frm_1_t_conu_pbb_detail_contributor->Target_Message) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn" style="white-space: nowrap;"><thead><tr><td><?php echo $frm_1_t_conu_pbb_detail_contributor->Target_Message->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_1_t_conu_pbb_detail_contributor->Target_Message->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_1_t_conu_pbb_detail_contributor->Target_Message->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
$frm_1_t_conu_pbb_detail_contributor_list->ListOptions->Render("header", "right");
?>
	</tr>
</thead>
<?php
if ($frm_1_t_conu_pbb_detail_contributor->ExportAll && $frm_1_t_conu_pbb_detail_contributor->Export <> "") {
	$frm_1_t_conu_pbb_detail_contributor_list->StopRec = $frm_1_t_conu_pbb_detail_contributor_list->TotalRecs;
} else {

	// Set the last record to display
	if ($frm_1_t_conu_pbb_detail_contributor_list->TotalRecs > $frm_1_t_conu_pbb_detail_contributor_list->StartRec + $frm_1_t_conu_pbb_detail_contributor_list->DisplayRecs - 1)
		$frm_1_t_conu_pbb_detail_contributor_list->StopRec = $frm_1_t_conu_pbb_detail_contributor_list->StartRec + $frm_1_t_conu_pbb_detail_contributor_list->DisplayRecs - 1;
	else
		$frm_1_t_conu_pbb_detail_contributor_list->StopRec = $frm_1_t_conu_pbb_detail_contributor_list->TotalRecs;
}
$frm_1_t_conu_pbb_detail_contributor_list->RecCnt = $frm_1_t_conu_pbb_detail_contributor_list->StartRec - 1;
if ($frm_1_t_conu_pbb_detail_contributor_list->Recordset && !$frm_1_t_conu_pbb_detail_contributor_list->Recordset->EOF) {
	$frm_1_t_conu_pbb_detail_contributor_list->Recordset->MoveFirst();
	if (!$bSelectLimit && $frm_1_t_conu_pbb_detail_contributor_list->StartRec > 1)
		$frm_1_t_conu_pbb_detail_contributor_list->Recordset->Move($frm_1_t_conu_pbb_detail_contributor_list->StartRec - 1);
} elseif (!$frm_1_t_conu_pbb_detail_contributor->AllowAddDeleteRow && $frm_1_t_conu_pbb_detail_contributor_list->StopRec == 0) {
	$frm_1_t_conu_pbb_detail_contributor_list->StopRec = $frm_1_t_conu_pbb_detail_contributor->GridAddRowCount;
}

// Initialize aggregate
$frm_1_t_conu_pbb_detail_contributor->RowType = UP_ROWTYPE_AGGREGATEINIT;
$frm_1_t_conu_pbb_detail_contributor->ResetAttrs();
$frm_1_t_conu_pbb_detail_contributor_list->RenderRow();
$frm_1_t_conu_pbb_detail_contributor_list->RowCnt = 0;
while ($frm_1_t_conu_pbb_detail_contributor_list->RecCnt < $frm_1_t_conu_pbb_detail_contributor_list->StopRec) {
	$frm_1_t_conu_pbb_detail_contributor_list->RecCnt++;
	if (intval($frm_1_t_conu_pbb_detail_contributor_list->RecCnt) >= intval($frm_1_t_conu_pbb_detail_contributor_list->StartRec)) {
		$frm_1_t_conu_pbb_detail_contributor_list->RowCnt++;

		// Set up key count
		$frm_1_t_conu_pbb_detail_contributor_list->KeyCount = $frm_1_t_conu_pbb_detail_contributor_list->RowIndex;
		...
		if ($frm_1_t_conu_pbb_detail_contributor->CurrentAction == "gridadd") {
			...
			$frm_1_t_conu_pbb_detail_contributor_list->LoadRowValues($frm_1_t_conu_pbb_detail_contributor_list->Recordset); // Load row values
		}
		$frm_1_t_conu_pbb_detail_contributor->RowType = UP_ROWTYPE_VIEW; // Render view
		$frm_1_t_conu_pbb_detail_contributor->RowAttrs = array('onmouseover'=>'up_MouseOver(event, this);', 'onmouseout'=>'up_MouseOut(event, this);', 'onclick'=>'up_Click(event, this);');
...
$frm_1_t_conu_pbb_detail_contributor_list->ListOptions->Render("body", "left");
?>
	<?php if ($frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->Visible) { // Delivery Unit ?>
...
<a name="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageObjName . "_row_" . $frm_1_t_conu_pbb_detail_contributor_list->RowCnt ?>" id="<?php echo $frm_1_t_conu_pbb_detail_contributor_list->PageObjName . "_row_" . $frm_1_t_conu_pbb_detail_contributor_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->Visible) { // Contributing Unit ?>
...
$frm_1_t_conu_pbb_detail_contributor_list->ListOptions->Render("body", "right");
?>
	</tr>
<?php
	}
	if ($frm_1_t_conu_pbb_detail_contributor->CurrentAction <> "gridadd")
		$frm_1_t_conu_pbb_detail_contributor_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
...
// Close recordset
if ($frm_1_t_conu_pbb_detail_contributor_list->Recordset)
	$frm_1_t_conu_pbb_detail_contributor_list->Recordset->Close();
?>
</td></tr></table>
<?php if ($frm_1_t_conu_pbb_detail_contributor->Export == "" && $frm_1_t_conu_pbb_detail_contributor->CurrentAction == "") { ?>
<?php } ?>
<?php
$frm_1_t_conu_pbb_detail_contributor_list->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<?php if ($frm_1_t_conu_pbb_detail_contributor->Export == "") { ?>
...
<?php
$frm_1_t_conu_pbb_detail_contributor_list->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_1_t_conu_pbb_detail_contributor_list {
	...
	// Page object name
	var $PageObjName = 'frm_1_t_conu_pbb_detail_contributor_list';
	...
	//
	function cfrm_1_t_conu_pbb_detail_contributor_list() {
		...
		$this->AddUrl = "frm_1_t_conu_pbb_detail_contributoradd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "frm_1_t_conu_pbb_detail_contributordelete.php";
		$this->MultiUpdateUrl = "frm_1_t_conu_pbb_detail_contributorupdate.php";
	...
	function Page_Init() {
		...
		if (is_numeric($gridaddcnt) && $gridaddcnt > 0)
			$frm_1_t_conu_pbb_detail_contributor->GridAddRowCount = $gridaddcnt;
	...
	//
	function Page_Main() {
		global $objForm, $Language, $gsFormError, $gsSearchError, $Security, $frm_1_t_conu_pbb_detail_contributor;
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			// Hide all options
			if ($frm_1_t_conu_pbb_detail_contributor->Export <> "" ||
				$frm_1_t_conu_pbb_detail_contributor->CurrentAction == "gridadd" ||
				$frm_1_t_conu_pbb_detail_contributor->CurrentAction == "gridedit") {
			...
			$frm_1_t_conu_pbb_detail_contributor->Recordset_SearchValidated();
		...
		if ($frm_1_t_conu_pbb_detail_contributor->getRecordsPerPage() <> "") {
			$this->DisplayRecs = $frm_1_t_conu_pbb_detail_contributor->getRecordsPerPage(); // Restore from Session
		} else {
		...
		$frm_1_t_conu_pbb_detail_contributor->Recordset_Searching($this->SearchWhere);

		// Save search criteria
		if ($this->SearchWhere <> "") {
			if ($sSrchBasic == "")
				$this->ResetBasicSearchParms();
			$frm_1_t_conu_pbb_detail_contributor->setSearchWhere($this->SearchWhere); // Save to Session
			if (!$this->RestoreSearch) {
				$this->StartRec = 1; // Reset start record counter
				$frm_1_t_conu_pbb_detail_contributor->setStartRecordNumber($this->StartRec);
			}
		} else {
			$this->SearchWhere = $frm_1_t_conu_pbb_detail_contributor->getSearchWhere();
		}
		...
		$this->DbMasterFilter = $frm_1_t_conu_pbb_detail_contributor->getMasterFilter(); // Restore master filter
		$this->DbDetailFilter = $frm_1_t_conu_pbb_detail_contributor->getDetailFilter(); // Restore detail filter

		// Add master User ID filter
		if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
			if ($frm_1_t_conu_pbb_detail_contributor->getCurrentMasterTable() == "frm_1_t_conu_contributor_pi_status")
				$this->DbMasterFilter = $frm_1_t_conu_pbb_detail_contributor->AddMasterUserIDFilter($this->DbMasterFilter, "frm_1_t_conu_contributor_pi_status"); // Add master User ID filter
		}
		up_AddFilter($sFilter, $this->DbDetailFilter);
		up_AddFilter($sFilter, $this->SearchWhere);

		// Load master record
		if ($frm_1_t_conu_pbb_detail_contributor->getMasterFilter() <> "" && $frm_1_t_conu_pbb_detail_contributor->getCurrentMasterTable() == "frm_1_t_conu_contributor_pi_status") {
			...
			if (!$this->MasterRecordExists) {
				...
				$this->Page_Terminate($frm_1_t_conu_pbb_detail_contributor->getReturnUrl()); // Return to caller
			} else {
		...
		$frm_1_t_conu_pbb_detail_contributor->setSessionWhere($sFilter);
		$frm_1_t_conu_pbb_detail_contributor->CurrentFilter = "";
	}
	...
	function BasicSearchSQL($Keyword) {
		...
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->CU, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Delivery_Unit, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Contributing_Unit, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->MFO, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Question, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->mfo_question_online_insert_question_mfo_name_rep, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Applicable, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Target_Remarks, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Target_Message, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->pbb_contributor_derived_from_supporting_documents, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->Accomplishment_Remarks, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->a_cutOffDate_remarks, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_1_t_conu_pbb_detail_contributor->mfo_question_report_mfo_name, $Keyword);
		return $sWhere;
	}
	...
	function BasicSearchWhere() {
		global $Security, $frm_1_t_conu_pbb_detail_contributor;
		$sSearchStr = "";
		if (!$Security->CanSearch()) return "";
		$sSearchKeyword = $frm_1_t_conu_pbb_detail_contributor->BasicSearchKeyword;
		$sSearchType = $frm_1_t_conu_pbb_detail_contributor->BasicSearchType;
		if ($sSearchKeyword <> "") {
		...
		if ($sSearchKeyword <> "") {
			$frm_1_t_conu_pbb_detail_contributor->setSessionBasicSearchKeyword($sSearchKeyword);
			$frm_1_t_conu_pbb_detail_contributor->setSessionBasicSearchType($sSearchType);
		}
		return $sSearchStr;
	}
	...
	function ResetSearchParms() {
		...
		$this->SearchWhere = "";
		$frm_1_t_conu_pbb_detail_contributor->setSearchWhere($this->SearchWhere);
	...
	function ResetBasicSearchParms() {
		global $frm_1_t_conu_pbb_detail_contributor;
		$frm_1_t_conu_pbb_detail_contributor->setSessionBasicSearchKeyword("");
		$frm_1_t_conu_pbb_detail_contributor->setSessionBasicSearchType("");
	}
	...
	function RestoreSearchParms() {
		...
		if ($bRestore) {
			...
			$frm_1_t_conu_pbb_detail_contributor->BasicSearchKeyword = $frm_1_t_conu_pbb_detail_contributor->getSessionBasicSearchKeyword();
			$frm_1_t_conu_pbb_detail_contributor->BasicSearchType = $frm_1_t_conu_pbb_detail_contributor->getSessionBasicSearchType();
		}
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			$frm_1_t_conu_pbb_detail_contributor->CurrentOrder = up_StripSlashes(@$_GET["order"]);
			$frm_1_t_conu_pbb_detail_contributor->CurrentOrderType = @$_GET["ordertype"];
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Delivery_Unit); // Delivery Unit
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Contributing_Unit); // Contributing Unit
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->MFO); // MFO
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Question); // Question
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Applicable); // Applicable
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Target); // Target
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Target_Remarks); // Target Remarks
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date); // Target Cut-Off Date
			$frm_1_t_conu_pbb_detail_contributor->UpdateSort($frm_1_t_conu_pbb_detail_contributor->Target_Message); // Target Message
			$frm_1_t_conu_pbb_detail_contributor->setStartRecordNumber(1); // Reset start position
		}
	}
	...
	function LoadSortOrder() {
		global $frm_1_t_conu_pbb_detail_contributor;
		$sOrderBy = $frm_1_t_conu_pbb_detail_contributor->getSessionOrderBy(); // Get ORDER BY from Session
		if ($sOrderBy == "") {
			if ($frm_1_t_conu_pbb_detail_contributor->SqlOrderBy() <> "") {
				$sOrderBy = $frm_1_t_conu_pbb_detail_contributor->SqlOrderBy();
				$frm_1_t_conu_pbb_detail_contributor->setSessionOrderBy($sOrderBy);
			}
		}
	}
	...
	function ResetCmd() {
		...
		if (@$_GET["cmd"] <> "") {
			...
			if (strtolower($sCmd) == "resetall") {
				$frm_1_t_conu_pbb_detail_contributor->setCurrentMasterTable(""); // Clear master table
				$this->DbMasterFilter = "";
				$this->DbDetailFilter = "";
				$frm_1_t_conu_pbb_detail_contributor->unit_contributor_id->setSessionValue("");
				$frm_1_t_conu_pbb_detail_contributor->mfo_question_online_insert_question_mfo->setSessionValue("");
			}
			...
			if (strtolower($sCmd) == "resetsort") {
				$sOrderBy = "";
				$frm_1_t_conu_pbb_detail_contributor->setSessionOrderBy($sOrderBy);
				$frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->MFO->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Question->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Applicable->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Target->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Target_Remarks->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date->setSort("");
				$frm_1_t_conu_pbb_detail_contributor->Target_Message->setSort("");
			}
	...
	function SetupListOptions() {
		global $Security, $Language, $frm_1_t_conu_pbb_detail_contributor;
	...
	function RenderListOptions() {
		global $Security, $Language, $frm_1_t_conu_pbb_detail_contributor, $objForm;
	...
	function SetUpStartRec() {
		...
		$this->StartRec = $frm_1_t_conu_pbb_detail_contributor->getStartRecordNumber();
	...
	function LoadBasicSearchValues() {
		global $frm_1_t_conu_pbb_detail_contributor;
		$frm_1_t_conu_pbb_detail_contributor->BasicSearchKeyword = @$_GET[UP_TABLE_BASIC_SEARCH];
		$frm_1_t_conu_pbb_detail_contributor->BasicSearchType = @$_GET[UP_TABLE_BASIC_SEARCH_TYPE];
	}
	...
	function LoadRecordset($offset = -1, $rowcnt = -1) {
		...
		$frm_1_t_conu_pbb_detail_contributor->Recordset_Selecting($frm_1_t_conu_pbb_detail_contributor->CurrentFilter);

		// Load List page SQL
		$sSql = $frm_1_t_conu_pbb_detail_contributor->SelectSQL();
		...
		$frm_1_t_conu_pbb_detail_contributor->Recordset_Selected($rs);
		return $rs;
	}
	...
	function LoadOldRecord() {
		...
		$bValidKey = TRUE;
		if (strval($frm_1_t_conu_pbb_detail_contributor->getKey("pbb_contributor_id")) <> "")
			$frm_1_t_conu_pbb_detail_contributor->pbb_contributor_id->CurrentValue = $frm_1_t_conu_pbb_detail_contributor->getKey("pbb_contributor_id"); // pbb_contributor_id
		else
			$bValidKey = FALSE;

		// Load old recordset
		if ($bValidKey) {
			$frm_1_t_conu_pbb_detail_contributor->CurrentFilter = $frm_1_t_conu_pbb_detail_contributor->KeyFilter();
			$sSql = $frm_1_t_conu_pbb_detail_contributor->SQL();
	...
	function RenderRow() {
		...
		// Initialize URLs
		$this->ViewUrl = $frm_1_t_conu_pbb_detail_contributor->ViewUrl();
		$this->EditUrl = $frm_1_t_conu_pbb_detail_contributor->EditUrl();
		$this->InlineEditUrl = $frm_1_t_conu_pbb_detail_contributor->InlineEditUrl();
		$this->CopyUrl = $frm_1_t_conu_pbb_detail_contributor->CopyUrl();
		$this->InlineCopyUrl = $frm_1_t_conu_pbb_detail_contributor->InlineCopyUrl();
		$this->DeleteUrl = $frm_1_t_conu_pbb_detail_contributor->DeleteUrl();
		...
		$frm_1_t_conu_pbb_detail_contributor->CU->CellCssStyle = "white-space: nowrap;";

		// Delivery Unit
		$frm_1_t_conu_pbb_detail_contributor->Delivery_Unit->CellCssStyle = "white-space: nowrap;";

		// Contributing Unit
		$frm_1_t_conu_pbb_detail_contributor->Contributing_Unit->CellCssStyle = "white-space: nowrap;";

		// mfo_question_id
		// mfo_question_online_pi_seq
		// MFO

		$frm_1_t_conu_pbb_detail_contributor->MFO->CellCssStyle = "white-space: nowrap;";
		...
		$frm_1_t_conu_pbb_detail_contributor->Target_Cut2DOff_Date->CellCssStyle = "white-space: nowrap;";

		// Target Message
		$frm_1_t_conu_pbb_detail_contributor->Target_Message->CellCssStyle = "white-space: nowrap;";
	...
	function ShowOptionLink() {
		...
		if ($Security->IsLoggedIn()) {
			if (!$Security->IsAdmin()) {
				return $Security->IsValidUserID($frm_1_t_conu_pbb_detail_contributor->unit_contributor_id->CurrentValue);
			}
		}
		return TRUE;
	}
