...
<?php echo $frm_9_m_sa_mfo_questions->TableCustomInnerHtml ?>
	...
	<tr class="upTableHeader">
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->FldCaption() ?></td>
		...
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_answer->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->FldCaption() ?></td>
		...
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_computation_denominator->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_trend->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->pi_no->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->pi_sub->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->iatf_2013->FldCaption() ?></td>
		<td valign="top"><?php echo $frm_9_m_sa_mfo_questions->iatf_2014->FldCaption() ?></td>
	</tr>
	</thead>
	<tbody>
<?php
...
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->ListViewValue() ?></div></td>
...
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_answer->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_answer->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->ListViewValue() ?></div></td>
...
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_computation_denominator->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_computation_denominator->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_trend->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_trend->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_trend->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->pi_no->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->pi_no->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->pi_no->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->pi_sub->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->pi_sub->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->pi_sub->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->iatf_2013->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->iatf_2013->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->iatf_2013->ListViewValue() ?></div></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->iatf_2014->CellAttributes() ?>>
<div<?php echo $frm_9_m_sa_mfo_questions->iatf_2014->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->iatf_2014->ListViewValue() ?></div></td>
	</tr>
<?php
