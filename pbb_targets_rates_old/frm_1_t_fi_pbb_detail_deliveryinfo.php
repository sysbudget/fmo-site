...
$frm_1_t_fi_pbb_detail_delivery = NULL;

//
// Table class for frm_1_t_fi_pbb_detail_delivery
//
class cfrm_1_t_fi_pbb_detail_delivery {
	var $TableVar = 'frm_1_t_fi_pbb_detail_delivery';
	...
	//
	function cfrm_1_t_fi_pbb_detail_delivery() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// pbb_delivery_id
		$this->pbb_delivery_id = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_pbb_delivery_id', 'pbb_delivery_id', '`pbb_delivery_id`', 3, -1, FALSE, '`pbb_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pbb_delivery_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pbb_delivery_id'] =& $this->pbb_delivery_id;

		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// focal_person_id
		$this->focal_person_id = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_id
		$this->cu_id = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// mfo_question_id
		$this->mfo_question_id = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_mfo_question_id', 'mfo_question_id', '`mfo_question_id`', 3, -1, FALSE, '`mfo_question_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_pi_seq = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_mfo_question_online_pi_seq', 'mfo_question_online_pi_seq', '`mfo_question_online_pi_seq`', 3, -1, FALSE, '`mfo_question_online_pi_seq`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_insert_question_mfo = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_mfo_question_online_insert_question_mfo', 'mfo_question_online_insert_question_mfo', '`mfo_question_online_insert_question_mfo`', 3, -1, FALSE, '`mfo_question_online_insert_question_mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_report_mfo_name = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_mfo_question_report_mfo_name', 'mfo_question_report_mfo_name', '`mfo_question_report_mfo_name`', 200, -1, FALSE, '`mfo_question_report_mfo_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_question_report_mfo_name'] =& $this->mfo_question_report_mfo_name;

		// mfo_question_report_form_a_1_mfo
		$this->mfo_question_report_form_a_1_mfo = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_mfo_question_report_form_a_1_mfo', 'mfo_question_report_form_a_1_mfo', '`mfo_question_report_form_a_1_mfo`', 3, -1, FALSE, '`mfo_question_report_form_a_1_mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// pi_no
		$this->pi_no = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_pi_no', 'pi_no', '`pi_no`', 3, -1, FALSE, '`pi_no`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi_no->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi_no'] =& $this->pi_no;

		// pi_sub
		$this->pi_sub = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_pi_sub', 'pi_sub', '`pi_sub`', 200, -1, FALSE, '`pi_sub`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_sub'] =& $this->pi_sub;

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// t_startDate
		$this->t_startDate = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_t_startDate', 't_startDate', '`t_startDate`', 135, 6, FALSE, '`t_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_contributor = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_t_cutOffDate_contributor', 't_cutOffDate_contributor', '`t_cutOffDate_contributor`', 135, 6, FALSE, '`t_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_delivery = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_t_cutOffDate_delivery', 't_cutOffDate_delivery', '`t_cutOffDate_delivery`', 135, 6, FALSE, '`t_cutOffDate_delivery`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->pbb_delivery_derived_from_supporting_documents = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_pbb_delivery_derived_from_supporting_documents', 'pbb_delivery_derived_from_supporting_documents', '`pbb_delivery_derived_from_supporting_documents`', 200, -1, FALSE, '`pbb_delivery_derived_from_supporting_documents`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pbb_delivery_derived_from_supporting_documents'] =& $this->pbb_delivery_derived_from_supporting_documents;

		// a_startDate
		$this->a_startDate = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_a_startDate', 'a_startDate', '`a_startDate`', 135, 6, FALSE, '`a_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_contributor = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_a_cutOffDate_contributor', 'a_cutOffDate_contributor', '`a_cutOffDate_contributor`', 135, 6, FALSE, '`a_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_delivery = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_a_cutOffDate_delivery', 'a_cutOffDate_delivery', '`a_cutOffDate_delivery`', 135, 6, FALSE, '`a_cutOffDate_delivery`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_cutOffDate_fp
		$this->a_cutOffDate_fp = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_a_cutOffDate_fp', 'a_cutOffDate_fp', '`a_cutOffDate_fp`', 135, 6, FALSE, '`a_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_remarks = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_a_cutOffDate_remarks', 'a_cutOffDate_remarks', '`a_cutOffDate_remarks`', 200, -1, FALSE, '`a_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['a_cutOffDate_remarks'] =& $this->a_cutOffDate_remarks;

		// pbb_delivery_a_rating
		$this->pbb_delivery_a_rating = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_pbb_delivery_a_rating', 'pbb_delivery_a_rating', '`pbb_delivery_a_rating`', 5, -1, FALSE, '`pbb_delivery_a_rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// CU
		$this->CU = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// MFO
		$this->MFO = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// Applicable
		$this->Applicable = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Applicable', 'Applicable', '`Applicable`', 200, -1, FALSE, '`Applicable`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Applicable'] =& $this->Applicable;

		// Target
		$this->Target = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Target', 'Target', '`Target`', 5, -1, FALSE, '`Target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target'] =& $this->Target;

		// Target Remarks
		$this->Target_Remarks = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Target_Remarks', 'Target Remarks', '`Target Remarks`', 200, -1, FALSE, '`Target Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Remarks'] =& $this->Target_Remarks;

		// Target Cut-Off Date
		$this->Target_Cut2DOff_Date = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Target_Cut2DOff_Date', 'Target Cut-Off Date', '`Target Cut-Off Date`', 200, -1, FALSE, '`Target Cut-Off Date`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Cut-Off Date'] =& $this->Target_Cut2DOff_Date;

		// Accomplishment
		$this->Accomplishment = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Accomplishment', 'Accomplishment', '`Accomplishment`', 5, -1, FALSE, '`Accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Accomplishment'] =& $this->Accomplishment;

		// Numerator
		$this->Numerator = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Numerator', 'Numerator', '`Numerator`', 5, -1, FALSE, '`Numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator'] =& $this->Numerator;

		// Jan-Mar (N)
		$this->Jan2DMar_28N29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Jan2DMar_28N29', 'Jan-Mar (N)', '`Jan-Mar (N)`', 5, -1, FALSE, '`Jan-Mar (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jan2DMar_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jan-Mar (N)'] =& $this->Jan2DMar_28N29;

		// Apr-Jun (N)
		$this->Apr2DJun_28N29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Apr2DJun_28N29', 'Apr-Jun (N)', '`Apr-Jun (N)`', 5, -1, FALSE, '`Apr-Jun (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Apr2DJun_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Apr-Jun (N)'] =& $this->Apr2DJun_28N29;

		// Jul-Sep (N)
		$this->Jul2DSep_28N29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Jul2DSep_28N29', 'Jul-Sep (N)', '`Jul-Sep (N)`', 5, -1, FALSE, '`Jul-Sep (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jul2DSep_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jul-Sep (N)'] =& $this->Jul2DSep_28N29;

		// Oct-Dec (N)
		$this->Oct2DDec_28N29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Oct2DDec_28N29', 'Oct-Dec (N)', '`Oct-Dec (N)`', 5, -1, FALSE, '`Oct-Dec (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Oct2DDec_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Oct-Dec (N)'] =& $this->Oct2DDec_28N29;

		// Denominator
		$this->Denominator = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Denominator', 'Denominator', '`Denominator`', 5, -1, FALSE, '`Denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Denominator'] =& $this->Denominator;

		// Jan-Mar (D)
		$this->Jan2DMar_28D29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Jan2DMar_28D29', 'Jan-Mar (D)', '`Jan-Mar (D)`', 5, -1, FALSE, '`Jan-Mar (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jan2DMar_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jan-Mar (D)'] =& $this->Jan2DMar_28D29;

		// Apr-Jun (D)
		$this->Apr2DJun_28D29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Apr2DJun_28D29', 'Apr-Jun (D)', '`Apr-Jun (D)`', 5, -1, FALSE, '`Apr-Jun (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Apr2DJun_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Apr-Jun (D)'] =& $this->Apr2DJun_28D29;

		// Jul-Sep (D)
		$this->Jul2DSep_28D29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Jul2DSep_28D29', 'Jul-Sep (D)', '`Jul-Sep (D)`', 5, -1, FALSE, '`Jul-Sep (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jul2DSep_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jul-Sep (D)'] =& $this->Jul2DSep_28D29;

		// Oct-Dec (D)
		$this->Oct2DDec_28D29 = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Oct2DDec_28D29', 'Oct-Dec (D)', '`Oct-Dec (D)`', 5, -1, FALSE, '`Oct-Dec (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Accomplishment_Remarks = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Accomplishment_Remarks', 'Accomplishment Remarks', '`Accomplishment Remarks`', 200, -1, FALSE, '`Accomplishment Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Accomplishment Remarks'] =& $this->Accomplishment_Remarks;

		// Below 100% Performance Rating
		$this->Below_10025_Performance_Rating = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Below_10025_Performance_Rating', 'Below 100% Performance Rating', '`Below 100% Performance Rating`', 5, -1, FALSE, '`Below 100% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->z10025_to_12025_Performance_Rating = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_z10025_to_12025_Performance_Rating', '100% to 120% Performance Rating', '`100% to 120% Performance Rating`', 5, -1, FALSE, '`100% to 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Above_12025_Performance_Rating = new cField('frm_1_t_fi_pbb_detail_delivery', 'frm_1_t_fi_pbb_detail_delivery', 'x_Above_12025_Performance_Rating', 'Above 120% Performance Rating', '`Above 120% Performance Rating`', 5, -1, FALSE, '`Above 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_1_t_fi_pbb_detail_delivery_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_1_t_fi_pbb_detail_delivery`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_1_t_fi_pbb_detail_delivery` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_1_t_fi_pbb_detail_delivery` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_1_t_fi_pbb_detail_delivery` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_1_t_fi_pbb_detail_deliverylist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_1_t_fi_pbb_detail_deliveryview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_1_t_fi_pbb_detail_deliveryadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_1_t_fi_pbb_detail_deliveryedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_1_t_fi_pbb_detail_deliveryedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_1_t_fi_pbb_detail_deliveryadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_1_t_fi_pbb_detail_deliveryadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_1_t_fi_pbb_detail_deliverydelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_1_t_fi_pbb_detail_delivery" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_1_t_fi_pbb_detail_delivery` WHERE " . $this->AddUserIDFilter("");
