...
// Create page object
$frm_9_m_sa_units_delivery_add = new cfrm_9_m_sa_units_delivery_add();
$Page =& $frm_9_m_sa_units_delivery_add;

// Page init
$frm_9_m_sa_units_delivery_add->Page_Init();

// Page main
$frm_9_m_sa_units_delivery_add->Page_Main();
?>
...
// Create page object
var frm_9_m_sa_units_delivery_add = new up_Page("frm_9_m_sa_units_delivery_add");

// page properties
frm_9_m_sa_units_delivery_add.PageID = "add"; // page ID
frm_9_m_sa_units_delivery_add.FormID = "ffrm_9_m_sa_units_deliveryadd"; // form ID
var UP_PAGE_ID = frm_9_m_sa_units_delivery_add.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_9_m_sa_units_delivery_add.ValidateForm = function(fobj) {
...
frm_9_m_sa_units_delivery_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_9_m_sa_units_delivery_add.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_9_m_sa_units_delivery_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_9_m_sa_units_delivery_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_9_m_sa_units_delivery->TableCaption() ?></p>
<p class="upbudgetofficeclass"><a href="<?php echo $frm_9_m_sa_units_delivery->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $frm_9_m_sa_units_delivery_add->ShowPageHeader(); ?>
<?php
$frm_9_m_sa_units_delivery_add->ShowMessage();
?>
<form name="ffrm_9_m_sa_units_deliveryadd" id="ffrm_9_m_sa_units_deliveryadd" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_9_m_sa_units_delivery_add.ValidateForm(this);">
<p>
...
<p>
<?php if ($frm_9_m_sa_units_delivery->getCurrentDetailTable() == "frm_9_m_sa_units_contributor" && $frm_9_m_sa_units_contributor->DetailAdd) { ?>
<br>
...
<?php
$frm_9_m_sa_units_delivery_add->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_9_m_sa_units_delivery_add->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_9_m_sa_units_delivery_add {
	...
	// Page object name
	var $PageObjName = 'frm_9_m_sa_units_delivery_add';
	...
	//
	function cfrm_9_m_sa_units_delivery_add() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$frm_9_m_sa_units_delivery->CurrentAction = $_POST["a_add"]; // Get form action
			...
			if (!$this->ValidateForm()) {
				$frm_9_m_sa_units_delivery->CurrentAction = "I"; // Form error, reset action
			...
			if (@$_GET["unit_delivery_id"] != "") {
				...
				$frm_9_m_sa_units_delivery->setKey("unit_delivery_id", $frm_9_m_sa_units_delivery->unit_delivery_id->CurrentValue); // Set up key
			} else {
				$frm_9_m_sa_units_delivery->setKey("unit_delivery_id", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
				$frm_9_m_sa_units_delivery->CurrentAction = "C"; // Copy record
			} else {
				$frm_9_m_sa_units_delivery->CurrentAction = "I"; // Display blank record
		...
		switch ($frm_9_m_sa_units_delivery->CurrentAction) {
			...
			case "A": // ' Add new record
				$frm_9_m_sa_units_delivery->SendEmail = TRUE; // Send email on add success
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					if ($frm_9_m_sa_units_delivery->getCurrentDetailTable() <> "") // Master/detail add
						$sReturnUrl = $frm_9_m_sa_units_delivery->getDetailUrl();
					else
						$sReturnUrl = $frm_9_m_sa_units_delivery->getReturnUrl();
					if (up_GetPageName($sReturnUrl) == "frm_9_m_sa_units_deliveryview.php")
						$sReturnUrl = $frm_9_m_sa_units_delivery->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$frm_9_m_sa_units_delivery->RowType = UP_ROWTYPE_ADD;  // Render add type
	...
	function LoadDefaultValues() {
		global $frm_9_m_sa_units_delivery;
		$frm_9_m_sa_units_delivery->focal_person_id->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->focal_person_id->OldValue = $frm_9_m_sa_units_delivery->focal_person_id->CurrentValue;
		$frm_9_m_sa_units_delivery->cu_id->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->cu_id->OldValue = $frm_9_m_sa_units_delivery->cu_id->CurrentValue;
		...
		$frm_9_m_sa_units_delivery->cu_short_name->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->cu_short_name->OldValue = $frm_9_m_sa_units_delivery->cu_short_name->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_name_cu->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->unit_delivery_name_cu->OldValue = $frm_9_m_sa_units_delivery->unit_delivery_name_cu->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_name->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->unit_delivery_name->OldValue = $frm_9_m_sa_units_delivery->unit_delivery_name->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_name_short->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->unit_delivery_name_short->OldValue = $frm_9_m_sa_units_delivery->unit_delivery_name_short->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_personnel_count->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->unit_delivery_personnel_count->OldValue = $frm_9_m_sa_units_delivery->unit_delivery_personnel_count->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_1->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_2->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_3->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_4->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_5->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->unit_delivery_sto->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->unit_delivery_gass_ab->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->unit_delivery_gass_ab->OldValue = $frm_9_m_sa_units_delivery->unit_delivery_gass_ab->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_gass_cd->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->unit_delivery_gass_cd->OldValue = $frm_9_m_sa_units_delivery->unit_delivery_gass_cd->CurrentValue;
		$frm_9_m_sa_units_delivery->unit_delivery_gass->CurrentValue = "Y";
		$frm_9_m_sa_units_delivery->cutOffDate_id->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->cutOffDate_id->OldValue = $frm_9_m_sa_units_delivery->cutOffDate_id->CurrentValue;
		$frm_9_m_sa_units_delivery->t_startDate->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->t_startDate->OldValue = $frm_9_m_sa_units_delivery->t_startDate->CurrentValue;
		$frm_9_m_sa_units_delivery->t_cutOffDate_fp->CurrentValue = NULL;
		$frm_9_m_sa_units_delivery->t_cutOffDate_fp->OldValue = $frm_9_m_sa_units_delivery->t_cutOffDate_fp->CurrentValue;
	...
	function LoadOldRecord() {
		...
		$bValidKey = TRUE;
		if (strval($frm_9_m_sa_units_delivery->getKey("unit_delivery_id")) <> "")
			$frm_9_m_sa_units_delivery->unit_delivery_id->CurrentValue = $frm_9_m_sa_units_delivery->getKey("unit_delivery_id"); // unit_delivery_id
		else
			$bValidKey = FALSE;
	...
	function ValidateForm() {
		...
		if ($frm_9_m_sa_units_delivery->getCurrentDetailTable() == "frm_9_m_sa_units_contributor" && $GLOBALS["frm_9_m_sa_units_contributor"]->DetailAdd) {
	...
	function AddRow($rsold = NULL) {
		...
		// focal_person_id
		$frm_9_m_sa_units_delivery->focal_person_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->focal_person_id->CurrentValue, NULL, FALSE);

		// cu_id
		$frm_9_m_sa_units_delivery->cu_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->cu_id->CurrentValue, NULL, FALSE);

		// cu_sequence
		$frm_9_m_sa_units_delivery->cu_sequence->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->cu_sequence->CurrentValue, NULL, FALSE);

		// cu_short_name
		$frm_9_m_sa_units_delivery->cu_short_name->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->cu_short_name->CurrentValue, NULL, FALSE);

		// unit_delivery_name_cu
		$frm_9_m_sa_units_delivery->unit_delivery_name_cu->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_name_cu->CurrentValue, NULL, FALSE);

		// unit_delivery_name
		$frm_9_m_sa_units_delivery->unit_delivery_name->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_name->CurrentValue, NULL, FALSE);

		// unit_delivery_name_short
		$frm_9_m_sa_units_delivery->unit_delivery_name_short->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_name_short->CurrentValue, NULL, FALSE);

		// unit_delivery_personnel_count
		$frm_9_m_sa_units_delivery->unit_delivery_personnel_count->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_personnel_count->CurrentValue, NULL, FALSE);

		// unit_delivery_mfo_1
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_1->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_mfo_1->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_mfo_1->CurrentValue) == "");

		// unit_delivery_mfo_2
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_2->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_mfo_2->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_mfo_2->CurrentValue) == "");

		// unit_delivery_mfo_3
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_3->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_mfo_3->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_mfo_3->CurrentValue) == "");

		// unit_delivery_mfo_4
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_4->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_mfo_4->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_mfo_4->CurrentValue) == "");

		// unit_delivery_mfo_5
		$frm_9_m_sa_units_delivery->unit_delivery_mfo_5->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_mfo_5->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_mfo_5->CurrentValue) == "");

		// unit_delivery_sto
		$frm_9_m_sa_units_delivery->unit_delivery_sto->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_sto->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_sto->CurrentValue) == "");

		// unit_delivery_gass_ab
		$frm_9_m_sa_units_delivery->unit_delivery_gass_ab->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_gass_ab->CurrentValue, NULL, FALSE);

		// unit_delivery_gass_cd
		$frm_9_m_sa_units_delivery->unit_delivery_gass_cd->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_gass_cd->CurrentValue, NULL, FALSE);

		// unit_delivery_gass
		$frm_9_m_sa_units_delivery->unit_delivery_gass->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->unit_delivery_gass->CurrentValue, NULL, strval($frm_9_m_sa_units_delivery->unit_delivery_gass->CurrentValue) == "");

		// cutOffDate_id
		$frm_9_m_sa_units_delivery->cutOffDate_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_delivery->cutOffDate_id->CurrentValue, NULL, FALSE);

		// t_startDate
		$frm_9_m_sa_units_delivery->t_startDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_units_delivery->t_startDate->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_fp
		$frm_9_m_sa_units_delivery->t_cutOffDate_fp->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_units_delivery->t_cutOffDate_fp->CurrentValue, 6), NULL, FALSE);
		...
		if ($AddRow) {
			$frm_9_m_sa_units_delivery->unit_delivery_id->setDbValue($conn->Insert_ID());
			$rsnew['unit_delivery_id'] = $frm_9_m_sa_units_delivery->unit_delivery_id->DbValue;
		}

		// Add detail records
		if ($AddRow) {
			if ($frm_9_m_sa_units_delivery->getCurrentDetailTable() == "frm_9_m_sa_units_contributor" && $GLOBALS["frm_9_m_sa_units_contributor"]->DetailAdd) {
				$GLOBALS["frm_9_m_sa_units_contributor"]->unit_delivery_id->setSessionValue($frm_9_m_sa_units_delivery->unit_delivery_id->CurrentValue); // Set master key
				$frm_9_m_sa_units_contributor_grid = new cfrm_9_m_sa_units_contributor_grid(); // get detail page object
				$AddRow = $frm_9_m_sa_units_contributor_grid->GridInsert();
				$frm_9_m_sa_units_contributor_grid = NULL;
			}
		}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			if ($sDetailTblVar == "frm_9_m_sa_units_contributor") {
				...
				if ($GLOBALS["frm_9_m_sa_units_contributor"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["frm_9_m_sa_units_contributor"]->CurrentMode = "copy";
					else
						$GLOBALS["frm_9_m_sa_units_contributor"]->CurrentMode = "add";
					$GLOBALS["frm_9_m_sa_units_contributor"]->CurrentAction = "gridadd";
