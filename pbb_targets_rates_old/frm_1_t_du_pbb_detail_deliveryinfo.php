...
$frm_1_t_du_pbb_detail_delivery = NULL;

//
// Table class for frm_1_t_du_pbb_detail_delivery
//
class cfrm_1_t_du_pbb_detail_delivery {
	var $TableVar = 'frm_1_t_du_pbb_detail_delivery';
	...
	var $t_cutOffDate_fp;
	var $pbb_delivery_derived_from_supporting_documents;
	var $a_startDate;
	var $a_cutOffDate_contributor;
	var $a_cutOffDate_delivery;
	var $a_cutOffDate_fp;
	var $pbb_delivery_a_rating;
	var $cu_sequence;
	var $CU;
	var $Delivery_Unit;
	var $MFO;
	...
	//
	function cfrm_1_t_du_pbb_detail_delivery() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// pbb_delivery_id
		$this->pbb_delivery_id = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_pbb_delivery_id', 'pbb_delivery_id', '`pbb_delivery_id`', 3, -1, FALSE, '`pbb_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pbb_delivery_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pbb_delivery_id'] =& $this->pbb_delivery_id;

		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// focal_person_id
		$this->focal_person_id = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_id
		$this->cu_id = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// mfo_question_id
		$this->mfo_question_id = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_mfo_question_id', 'mfo_question_id', '`mfo_question_id`', 3, -1, FALSE, '`mfo_question_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_pi_seq = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_mfo_question_online_pi_seq', 'mfo_question_online_pi_seq', '`mfo_question_online_pi_seq`', 3, -1, FALSE, '`mfo_question_online_pi_seq`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_insert_question_mfo = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_mfo_question_online_insert_question_mfo', 'mfo_question_online_insert_question_mfo', '`mfo_question_online_insert_question_mfo`', 3, -1, FALSE, '`mfo_question_online_insert_question_mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_report_mfo_name = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_mfo_question_report_mfo_name', 'mfo_question_report_mfo_name', '`mfo_question_report_mfo_name`', 200, -1, FALSE, '`mfo_question_report_mfo_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_question_report_mfo_name'] =& $this->mfo_question_report_mfo_name;

		// mfo_question_report_form_a_1_mfo
		$this->mfo_question_report_form_a_1_mfo = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_mfo_question_report_form_a_1_mfo', 'mfo_question_report_form_a_1_mfo', '`mfo_question_report_form_a_1_mfo`', 3, -1, FALSE, '`mfo_question_report_form_a_1_mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// pi_no
		$this->pi_no = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_pi_no', 'pi_no', '`pi_no`', 3, -1, FALSE, '`pi_no`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi_no->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi_no'] =& $this->pi_no;

		// pi_sub
		$this->pi_sub = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_pi_sub', 'pi_sub', '`pi_sub`', 200, -1, FALSE, '`pi_sub`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_sub'] =& $this->pi_sub;

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// t_startDate
		$this->t_startDate = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_t_startDate', 't_startDate', '`t_startDate`', 135, 6, FALSE, '`t_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_contributor = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_t_cutOffDate_contributor', 't_cutOffDate_contributor', '`t_cutOffDate_contributor`', 135, 6, FALSE, '`t_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_delivery = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_t_cutOffDate_delivery', 't_cutOffDate_delivery', '`t_cutOffDate_delivery`', 135, 6, FALSE, '`t_cutOffDate_delivery`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->pbb_delivery_derived_from_supporting_documents = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_pbb_delivery_derived_from_supporting_documents', 'pbb_delivery_derived_from_supporting_documents', '`pbb_delivery_derived_from_supporting_documents`', 200, -1, FALSE, '`pbb_delivery_derived_from_supporting_documents`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pbb_delivery_derived_from_supporting_documents'] =& $this->pbb_delivery_derived_from_supporting_documents;

		// a_startDate
		$this->a_startDate = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_a_startDate', 'a_startDate', '`a_startDate`', 135, 6, FALSE, '`a_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_contributor = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_a_cutOffDate_contributor', 'a_cutOffDate_contributor', '`a_cutOffDate_contributor`', 135, 6, FALSE, '`a_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_delivery = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_a_cutOffDate_delivery', 'a_cutOffDate_delivery', '`a_cutOffDate_delivery`', 135, 6, FALSE, '`a_cutOffDate_delivery`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_cutOffDate_fp
		$this->a_cutOffDate_fp = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_a_cutOffDate_fp', 'a_cutOffDate_fp', '`a_cutOffDate_fp`', 135, 6, FALSE, '`a_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->pbb_delivery_a_rating = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_pbb_delivery_a_rating', 'pbb_delivery_a_rating', '`pbb_delivery_a_rating`', 5, -1, FALSE, '`pbb_delivery_a_rating`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pbb_delivery_a_rating->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['pbb_delivery_a_rating'] =& $this->pbb_delivery_a_rating;

		// cu_sequence
		$this->cu_sequence = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// CU
		$this->CU = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// MFO
		$this->MFO = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// Applicable
		$this->Applicable = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Applicable', 'Applicable', '`Applicable`', 200, -1, FALSE, '`Applicable`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Applicable'] =& $this->Applicable;

		// Target
		$this->Target = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Target', 'Target', '`Target`', 5, -1, FALSE, '`Target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target'] =& $this->Target;

		// Target Remarks
		$this->Target_Remarks = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Target_Remarks', 'Target Remarks', '`Target Remarks`', 200, -1, FALSE, '`Target Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Remarks'] =& $this->Target_Remarks;

		// Target Cut-Off Date
		$this->Target_Cut2DOff_Date = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Target_Cut2DOff_Date', 'Target Cut-Off Date', '`Target Cut-Off Date`', 200, -1, FALSE, '`Target Cut-Off Date`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Cut-Off Date'] =& $this->Target_Cut2DOff_Date;

		// Accomplishment
		$this->Accomplishment = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Accomplishment', 'Accomplishment', '`Accomplishment`', 5, -1, FALSE, '`Accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Accomplishment'] =& $this->Accomplishment;

		// Numerator
		$this->Numerator = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Numerator', 'Numerator', '`Numerator`', 5, -1, FALSE, '`Numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator'] =& $this->Numerator;

		// Jan-Mar (N)
		$this->Jan2DMar_28N29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Jan2DMar_28N29', 'Jan-Mar (N)', '`Jan-Mar (N)`', 5, -1, FALSE, '`Jan-Mar (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jan2DMar_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jan-Mar (N)'] =& $this->Jan2DMar_28N29;

		// Apr-Jun (N)
		$this->Apr2DJun_28N29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Apr2DJun_28N29', 'Apr-Jun (N)', '`Apr-Jun (N)`', 5, -1, FALSE, '`Apr-Jun (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Apr2DJun_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Apr-Jun (N)'] =& $this->Apr2DJun_28N29;

		// Jul-Sep (N)
		$this->Jul2DSep_28N29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Jul2DSep_28N29', 'Jul-Sep (N)', '`Jul-Sep (N)`', 5, -1, FALSE, '`Jul-Sep (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jul2DSep_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jul-Sep (N)'] =& $this->Jul2DSep_28N29;

		// Oct-Dec (N)
		$this->Oct2DDec_28N29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Oct2DDec_28N29', 'Oct-Dec (N)', '`Oct-Dec (N)`', 5, -1, FALSE, '`Oct-Dec (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Oct2DDec_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Oct-Dec (N)'] =& $this->Oct2DDec_28N29;

		// Denominator
		$this->Denominator = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Denominator', 'Denominator', '`Denominator`', 5, -1, FALSE, '`Denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Denominator'] =& $this->Denominator;

		// Jan-Mar (D)
		$this->Jan2DMar_28D29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Jan2DMar_28D29', 'Jan-Mar (D)', '`Jan-Mar (D)`', 5, -1, FALSE, '`Jan-Mar (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jan2DMar_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jan-Mar (D)'] =& $this->Jan2DMar_28D29;

		// Apr-Jun (D)
		$this->Apr2DJun_28D29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Apr2DJun_28D29', 'Apr-Jun (D)', '`Apr-Jun (D)`', 5, -1, FALSE, '`Apr-Jun (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Apr2DJun_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Apr-Jun (D)'] =& $this->Apr2DJun_28D29;

		// Jul-Sep (D)
		$this->Jul2DSep_28D29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Jul2DSep_28D29', 'Jul-Sep (D)', '`Jul-Sep (D)`', 5, -1, FALSE, '`Jul-Sep (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jul2DSep_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jul-Sep (D)'] =& $this->Jul2DSep_28D29;

		// Oct-Dec (D)
		$this->Oct2DDec_28D29 = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Oct2DDec_28D29', 'Oct-Dec (D)', '`Oct-Dec (D)`', 5, -1, FALSE, '`Oct-Dec (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Oct2DDec_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Oct-Dec (D)'] =& $this->Oct2DDec_28D29;

		// Accomplishment Remarks
		$this->Accomplishment_Remarks = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Accomplishment_Remarks', 'Accomplishment Remarks', '`Accomplishment Remarks`', 200, -1, FALSE, '`Accomplishment Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Accomplishment Remarks'] =& $this->Accomplishment_Remarks;

		// a_cutOffDate_remarks
		$this->a_cutOffDate_remarks = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_a_cutOffDate_remarks', 'a_cutOffDate_remarks', '`a_cutOffDate_remarks`', 200, -1, FALSE, '`a_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['a_cutOffDate_remarks'] =& $this->a_cutOffDate_remarks;

		// Below 100% Performance Rating
		$this->Below_10025_Performance_Rating = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Below_10025_Performance_Rating', 'Below 100% Performance Rating', '`Below 100% Performance Rating`', 5, -1, FALSE, '`Below 100% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->z10025_to_12025_Performance_Rating = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_z10025_to_12025_Performance_Rating', '100% to 120% Performance Rating', '`100% to 120% Performance Rating`', 5, -1, FALSE, '`100% to 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Above_12025_Performance_Rating = new cField('frm_1_t_du_pbb_detail_delivery', 'frm_1_t_du_pbb_detail_delivery', 'x_Above_12025_Performance_Rating', 'Above 120% Performance Rating', '`Above 120% Performance Rating`', 5, -1, FALSE, '`Above 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_1_t_du_pbb_detail_delivery_Highlight";
	}
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "frm_1_t_du_delivery_pi_status") {
			if ($this->unit_delivery_id->getSessionValue() <> "")
				$sMasterFilter .= "`unit_delivery_id`=" . up_QuotedValue($this->unit_delivery_id->getSessionValue(), UP_DATATYPE_NUMBER);
			else
				return "";
			if ($this->mfo_question_online_insert_question_mfo_name_rep->getSessionValue() <> "")
				$sMasterFilter .= " AND `MFO`=" . up_QuotedValue($this->mfo_question_online_insert_question_mfo_name_rep->getSessionValue(), UP_DATATYPE_STRING);
			else
				return "";
		}
	...
	function getDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "frm_1_t_du_delivery_pi_status") {
			if ($this->unit_delivery_id->getSessionValue() <> "")
				$sDetailFilter .= "`unit_delivery_id`=" . up_QuotedValue($this->unit_delivery_id->getSessionValue(), UP_DATATYPE_NUMBER);
			else
				return "";
			if ($this->mfo_question_online_insert_question_mfo_name_rep->getSessionValue() <> "")
				$sDetailFilter .= " AND `mfo_question_online_insert_question_mfo_name_rep`=" . up_QuotedValue($this->mfo_question_online_insert_question_mfo_name_rep->getSessionValue(), UP_DATATYPE_STRING);
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_frm_1_t_du_delivery_pi_status() {
		return "`unit_delivery_id`=@unit_delivery_id@ AND `MFO`='@MFO@'";
	}

	// Detail filter
	function SqlDetailFilter_frm_1_t_du_delivery_pi_status() {
		return "`unit_delivery_id`=@unit_delivery_id@ AND `mfo_question_online_insert_question_mfo_name_rep`='@mfo_question_online_insert_question_mfo_name_rep@'";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_1_t_du_pbb_detail_contributor") {
			$sDetailUrl = $GLOBALS["frm_1_t_du_pbb_detail_contributor"]->ListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&pbb_delivery_id=" . $this->pbb_delivery_id->CurrentValue;
		}
		return $sDetailUrl;
	}
	...
	function SqlFrom() { // From
		return "`frm_1_t_du_pbb_detail_delivery`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_1_t_du_pbb_detail_delivery` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_1_t_du_pbb_detail_delivery` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_1_t_du_pbb_detail_delivery` WHERE ";
		$SQL .= up_QuotedName('pbb_delivery_id') . '=' . up_QuotedValue($rs['pbb_delivery_id'], $this->pbb_delivery_id->FldDataType) . ' AND ';
	...
	function SqlKeyFilter() {
		return "`pbb_delivery_id` = @pbb_delivery_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->pbb_delivery_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@pbb_delivery_id@", up_AdjustSql($this->pbb_delivery_id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_1_t_du_pbb_detail_deliverylist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_1_t_du_pbb_detail_deliveryview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_1_t_du_pbb_detail_deliveryadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_1_t_du_pbb_detail_deliveryedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_1_t_du_pbb_detail_deliveryedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_1_t_du_pbb_detail_deliveryadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_1_t_du_pbb_detail_deliveryadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_1_t_du_pbb_detail_deliverydelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->pbb_delivery_id->CurrentValue)) {
			$sUrl .= "pbb_delivery_id=" . urlencode($this->pbb_delivery_id->CurrentValue);
		} else {
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_1_t_du_pbb_detail_delivery" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["pbb_delivery_id"]; // pbb_delivery_id
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->pbb_delivery_id->CurrentValue = $key;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->pbb_delivery_derived_from_supporting_documents->setDbValue($rs->fields('pbb_delivery_derived_from_supporting_documents'));
		...
		$this->pbb_delivery_a_rating->setDbValue($rs->fields('pbb_delivery_a_rating'));
		...
		$this->Oct2DDec_28N29->setDbValue($rs->fields('Oct-Dec (N)'));
		...
		$this->Oct2DDec_28D29->setDbValue($rs->fields('Oct-Dec (D)'));
   ...
   // Common render codes
		...
		// pbb_delivery_derived_from_supporting_documents
		$this->pbb_delivery_derived_from_supporting_documents->ViewValue = $this->pbb_delivery_derived_from_supporting_documents->CurrentValue;
		$this->pbb_delivery_derived_from_supporting_documents->ViewCustomAttributes = "";
		...
		// pbb_delivery_a_rating
		$this->pbb_delivery_a_rating->ViewValue = $this->pbb_delivery_a_rating->CurrentValue;
		$this->pbb_delivery_a_rating->ViewCustomAttributes = "";
		...
		// Oct-Dec (N)
		$this->Oct2DDec_28N29->ViewValue = $this->Oct2DDec_28N29->CurrentValue;
		$this->Oct2DDec_28N29->ViewCustomAttributes = "";
		...
		// Oct-Dec (D)
		$this->Oct2DDec_28D29->ViewValue = $this->Oct2DDec_28D29->CurrentValue;
		$this->Oct2DDec_28D29->ViewCustomAttributes = "";
		...
		// pbb_delivery_derived_from_supporting_documents
		$this->pbb_delivery_derived_from_supporting_documents->LinkCustomAttributes = "";
		$this->pbb_delivery_derived_from_supporting_documents->HrefValue = "";
		$this->pbb_delivery_derived_from_supporting_documents->TooltipValue = "";
		...
		// pbb_delivery_a_rating
		$this->pbb_delivery_a_rating->LinkCustomAttributes = "";
		$this->pbb_delivery_a_rating->HrefValue = "";
		$this->pbb_delivery_a_rating->TooltipValue = "";
		...
		// Oct-Dec (N)
		$this->Oct2DDec_28N29->LinkCustomAttributes = "";
		$this->Oct2DDec_28N29->HrefValue = "";
		$this->Oct2DDec_28N29->TooltipValue = "";
		...
		// Oct-Dec (D)
		$this->Oct2DDec_28D29->LinkCustomAttributes = "";
		$this->Oct2DDec_28D29->HrefValue = "";
		$this->Oct2DDec_28D29->TooltipValue = "";
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$XmlDoc->AddField('pbb_delivery_derived_from_supporting_documents', $this->pbb_delivery_derived_from_supporting_documents->ExportValue($this->Export, $this->ExportOriginalValue));
					...
					$XmlDoc->AddField('pbb_delivery_a_rating', $this->pbb_delivery_a_rating->ExportValue($this->Export, $this->ExportOriginalValue));
					...
					$XmlDoc->AddField('Oct2DDec_28N29', $this->Oct2DDec_28N29->ExportValue($this->Export, $this->ExportOriginalValue));
					...
					$XmlDoc->AddField('Oct2DDec_28D29', $this->Oct2DDec_28D29->ExportValue($this->Export, $this->ExportOriginalValue));
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->pbb_delivery_derived_from_supporting_documents);
				...
				$Doc->ExportCaption($this->pbb_delivery_a_rating);
				...
				$Doc->ExportCaption($this->Oct2DDec_28N29);
				...
				$Doc->ExportCaption($this->Oct2DDec_28D29);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$Doc->ExportField($this->pbb_delivery_derived_from_supporting_documents);
					...
					$Doc->ExportField($this->pbb_delivery_a_rating);
					...
					$Doc->ExportField($this->Oct2DDec_28N29);
					...
					$Doc->ExportField($this->Oct2DDec_28D29);
	...
	function AddUserIDFilter($sFilter) {
		...
		if (!$Security->IsAdmin()) {
			...
			if ($sFilterWrk <> "")
				$sFilterWrk = '`unit_delivery_id` IN (' . $sFilterWrk . ')';
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_1_t_du_pbb_detail_delivery` WHERE " . $this->AddUserIDFilter("");
	...
	function AddMasterUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "frm_1_t_du_delivery_pi_status") {
			$sFilterWrk = $GLOBALS["frm_1_t_du_delivery_pi_status"]->AddUserIDFilter($sFilterWrk);
		}
		return $sFilterWrk;
	}
	...
	function AddDetailUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "frm_1_t_du_delivery_pi_status") {
			$sSubqueryWrk = $GLOBALS["frm_1_t_du_delivery_pi_status"]->GetUserIDSubquery($this->unit_delivery_id, $GLOBALS["frm_1_t_du_delivery_pi_status"]->unit_delivery_id);
			if ($sSubqueryWrk <> "") {
				if ($sFilterWrk <> "") {
			...
			$sSubqueryWrk = $GLOBALS["frm_1_t_du_delivery_pi_status"]->GetUserIDSubquery($this->mfo_question_online_insert_question_mfo_name_rep, $GLOBALS["frm_1_t_du_delivery_pi_status"]->MFO);
			if ($sSubqueryWrk <> "") {
				if ($sFilterWrk <> "") {
					$sFilterWrk = "($sFilterWrk) AND ($sSubqueryWrk)";
				} else {
