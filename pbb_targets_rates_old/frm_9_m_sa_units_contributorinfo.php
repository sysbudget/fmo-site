...
$frm_9_m_sa_units_contributor = NULL;

//
// Table class for frm_9_m_sa_units_contributor
//
class cfrm_9_m_sa_units_contributor {
	var $TableVar = 'frm_9_m_sa_units_contributor';
	...
	//
	function cfrm_9_m_sa_units_contributor() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// unit_contributor_id
		$this->unit_contributor_id = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_unit_contributor_id', 'unit_contributor_id', '`unit_contributor_id`', 3, -1, FALSE, '`unit_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// focal_person_id
		$this->focal_person_id = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_id
		$this->cu_id = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// t_startDate
		$this->t_startDate = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_t_startDate', 't_startDate', '`t_startDate`', 135, 6, FALSE, '`t_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_startDate->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateMDY"));
		$this->fields['t_startDate'] =& $this->t_startDate;

		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_remarks = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_t_cutOffDate_remarks', 't_cutOffDate_remarks', '`t_cutOffDate_remarks`', 200, -1, FALSE, '`t_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_cutOffDate_remarks'] =& $this->t_cutOffDate_remarks;

		// a_startDate
		$this->a_startDate = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_a_startDate', 'a_startDate', '`a_startDate`', 135, 6, FALSE, '`a_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_contributor = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_a_cutOffDate_contributor', 'a_cutOffDate_contributor', '`a_cutOffDate_contributor`', 135, 6, FALSE, '`a_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// CU
		$this->CU = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// DU Office Name
		$this->DU_Office_Name = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_DU_Office_Name', 'DU Office Name', '`DU Office Name`', 200, -1, FALSE, '`DU Office Name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['DU Office Name'] =& $this->DU_Office_Name;

		// ConU Office Name
		$this->ConU_Office_Name = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_ConU_Office_Name', 'ConU Office Name', '`ConU Office Name`', 200, -1, FALSE, '`ConU Office Name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ConU Office Name'] =& $this->ConU_Office_Name;

		// ConU Short Name
		$this->ConU_Short_Name = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_ConU_Short_Name', 'ConU Short Name', '`ConU Short Name`', 200, -1, FALSE, '`ConU Short Name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ConU Short Name'] =& $this->ConU_Short_Name;

		// Personnel Count
		$this->Personnel_Count = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_Personnel_Count', 'Personnel Count', '`Personnel Count`', 3, -1, FALSE, '`Personnel Count`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Personnel_Count->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Personnel Count'] =& $this->Personnel_Count;

		// MFO 1
		$this->MFO_1 = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_MFO_1', 'MFO 1', '`MFO 1`', 200, -1, FALSE, '`MFO 1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO 1'] =& $this->MFO_1;

		// MFO 2
		$this->MFO_2 = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_MFO_2', 'MFO 2', '`MFO 2`', 200, -1, FALSE, '`MFO 2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO 2'] =& $this->MFO_2;

		// MFO 3
		$this->MFO_3 = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_MFO_3', 'MFO 3', '`MFO 3`', 200, -1, FALSE, '`MFO 3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO 3'] =& $this->MFO_3;

		// MFO 4
		$this->MFO_4 = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_MFO_4', 'MFO 4', '`MFO 4`', 200, -1, FALSE, '`MFO 4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO 4'] =& $this->MFO_4;

		// MFO 5
		$this->MFO_5 = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_MFO_5', 'MFO 5', '`MFO 5`', 200, -1, FALSE, '`MFO 5`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO 5'] =& $this->MFO_5;

		// STO
		$this->STO = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_STO', 'STO', '`STO`', 200, -1, FALSE, '`STO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['STO'] =& $this->STO;

		// GASS AB
		$this->GASS_AB = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_GASS_AB', 'GASS AB', '`GASS AB`', 200, -1, FALSE, '`GASS AB`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['GASS AB'] =& $this->GASS_AB;

		// GASS CD
		$this->GASS_CD = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_GASS_CD', 'GASS CD', '`GASS CD`', 200, -1, FALSE, '`GASS CD`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['GASS CD'] =& $this->GASS_CD;

		// GASS
		$this->GASS = new cField('frm_9_m_sa_units_contributor', 'frm_9_m_sa_units_contributor', 'x_GASS', 'GASS', '`GASS`', 200, -1, FALSE, '`GASS`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_9_m_sa_units_contributor_Highlight";
	}
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "frm_9_m_sa_units_delivery") {
	...
	// Master filter
	function SqlMasterFilter_frm_9_m_sa_units_delivery() {
		return "`unit_delivery_id`=@unit_delivery_id@";
	}

	// Detail filter
	function SqlDetailFilter_frm_9_m_sa_units_delivery() {
		return "`unit_delivery_id`=@unit_delivery_id@";
	}

	// Table level SQL
	function SqlFrom() { // From
		return "`frm_9_m_sa_units_contributor`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_9_m_sa_units_contributor` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_9_m_sa_units_contributor` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_9_m_sa_units_contributor` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_9_m_sa_units_contributorlist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_9_m_sa_units_contributorview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_9_m_sa_units_contributoradd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_9_m_sa_units_contributoredit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_9_m_sa_units_contributoradd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_9_m_sa_units_contributordelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_9_m_sa_units_contributor" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
