...
$frm_2_a_fi_rep_form_a_raw_data_cu = NULL;

//
// Table class for frm_2_a_fi_rep_form_a_raw_data_cu
//
class cfrm_2_a_fi_rep_form_a_raw_data_cu {
	var $TableVar = 'frm_2_a_fi_rep_form_a_raw_data_cu';
	...
	//
	function cfrm_2_a_fi_rep_form_a_raw_data_cu() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// focal_person_id
		$this->focal_person_id = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// CU
		$this->CU = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// CU Name
		$this->CU_Name = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_CU_Name', 'CU Name', '`CU Name`', 200, -1, FALSE, '`CU Name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU Name'] =& $this->CU_Name;

		// mfo_question_id
		$this->mfo_question_id = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_mfo_question_id', 'mfo_question_id', '`mfo_question_id`', 3, -1, FALSE, '`mfo_question_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_pi_seq = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_mfo_question_online_pi_seq', 'mfo_question_online_pi_seq', '`mfo_question_online_pi_seq`', 3, -1, FALSE, '`mfo_question_online_pi_seq`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// MFO
		$this->MFO = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// Applicable
		$this->Applicable = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Applicable', 'Applicable', '`Applicable`', 200, -1, FALSE, '`Applicable`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Applicable'] =& $this->Applicable;

		// Target
		$this->Target = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Target', 'Target', '`Target`', 5, -1, FALSE, '`Target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target'] =& $this->Target;

		// Target Remarks
		$this->Target_Remarks = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Target_Remarks', 'Target Remarks', '`Target Remarks`', 200, -1, FALSE, '`Target Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Remarks'] =& $this->Target_Remarks;

		// Accomplishment
		$this->Accomplishment = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Accomplishment', 'Accomplishment', '`Accomplishment`', 5, -1, FALSE, '`Accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Accomplishment'] =& $this->Accomplishment;

		// Numerator (A)
		$this->Numerator_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Numerator_28A29', 'Numerator (A)', '`Numerator (A)`', 5, -1, FALSE, '`Numerator (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator_28A29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator (A)'] =& $this->Numerator_28A29;

		// Numerator Qtr1 (A)
		$this->Numerator_Qtr1_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Numerator_Qtr1_28A29', 'Numerator Qtr1 (A)', '`Numerator Qtr1 (A)`', 200, -1, FALSE, '`Numerator Qtr1 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Numerator Qtr1 (A)'] =& $this->Numerator_Qtr1_28A29;

		// Numerator Qtr2 (A)
		$this->Numerator_Qtr2_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Numerator_Qtr2_28A29', 'Numerator Qtr2 (A)', '`Numerator Qtr2 (A)`', 200, -1, FALSE, '`Numerator Qtr2 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Numerator Qtr2 (A)'] =& $this->Numerator_Qtr2_28A29;

		// Numerator Qtr3 (A)
		$this->Numerator_Qtr3_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Numerator_Qtr3_28A29', 'Numerator Qtr3 (A)', '`Numerator Qtr3 (A)`', 200, -1, FALSE, '`Numerator Qtr3 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Numerator Qtr3 (A)'] =& $this->Numerator_Qtr3_28A29;

		// Numerator Qtr4 (A)
		$this->Numerator_Qtr4_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Numerator_Qtr4_28A29', 'Numerator Qtr4 (A)', '`Numerator Qtr4 (A)`', 200, -1, FALSE, '`Numerator Qtr4 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Numerator Qtr4 (A)'] =& $this->Numerator_Qtr4_28A29;

		// Denominator (A)
		$this->Denominator_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Denominator_28A29', 'Denominator (A)', '`Denominator (A)`', 5, -1, FALSE, '`Denominator (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Denominator_28A29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Denominator (A)'] =& $this->Denominator_28A29;

		// Denominator Qtr1 (A)
		$this->Denominator_Qtr1_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Denominator_Qtr1_28A29', 'Denominator Qtr1 (A)', '`Denominator Qtr1 (A)`', 200, -1, FALSE, '`Denominator Qtr1 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Denominator Qtr1 (A)'] =& $this->Denominator_Qtr1_28A29;

		// Denominator Qtr2 (A)
		$this->Denominator_Qtr2_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Denominator_Qtr2_28A29', 'Denominator Qtr2 (A)', '`Denominator Qtr2 (A)`', 200, -1, FALSE, '`Denominator Qtr2 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Denominator Qtr2 (A)'] =& $this->Denominator_Qtr2_28A29;

		// Denominator Qtr3 (A)
		$this->Denominator_Qtr3_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Denominator_Qtr3_28A29', 'Denominator Qtr3 (A)', '`Denominator Qtr3 (A)`', 200, -1, FALSE, '`Denominator Qtr3 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Denominator Qtr3 (A)'] =& $this->Denominator_Qtr3_28A29;

		// Denominator Qtr4 (A)
		$this->Denominator_Qtr4_28A29 = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Denominator_Qtr4_28A29', 'Denominator Qtr4 (A)', '`Denominator Qtr4 (A)`', 200, -1, FALSE, '`Denominator Qtr4 (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Denominator Qtr4 (A)'] =& $this->Denominator_Qtr4_28A29;

		// Accomplishment Remarks
		$this->Accomplishment_Remarks = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Accomplishment_Remarks', 'Accomplishment Remarks', '`Accomplishment Remarks`', 200, -1, FALSE, '`Accomplishment Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Accomplishment Remarks'] =& $this->Accomplishment_Remarks;

		// Performance Rating
		$this->Performance_Rating = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Performance_Rating', 'Performance Rating', '`Performance Rating`', 5, -1, FALSE, '`Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Below_10025_Performance_Rating = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Below_10025_Performance_Rating', 'Below 100% Performance Rating', '`Below 100% Performance Rating`', 200, -1, FALSE, '`Below 100% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Below 100% Performance Rating'] =& $this->Below_10025_Performance_Rating;

		// 100% to 120% Performance Rating
		$this->z10025_to_12025_Performance_Rating = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_z10025_to_12025_Performance_Rating', '100% to 120% Performance Rating', '`100% to 120% Performance Rating`', 200, -1, FALSE, '`100% to 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['100% to 120% Performance Rating'] =& $this->z10025_to_12025_Performance_Rating;

		// Above 120% Performance Rating
		$this->Above_12025_Performance_Rating = new cField('frm_2_a_fi_rep_form_a_raw_data_cu', 'frm_2_a_fi_rep_form_a_raw_data_cu', 'x_Above_12025_Performance_Rating', 'Above 120% Performance Rating', '`Above 120% Performance Rating`', 200, -1, FALSE, '`Above 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_2_a_fi_rep_form_a_raw_data_cu_Highlight";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_2_a_fi_pbb_detail_delivery") {
			$sDetailUrl = $GLOBALS["frm_2_a_fi_pbb_detail_delivery"]->ListUrl() . "?showmaster=" . $this->TableVar;
			$sDetailUrl .= "&focal_person_id=" . $this->focal_person_id->CurrentValue;
			$sDetailUrl .= "&mfo_question_online_pi_seq=" . $this->mfo_question_online_pi_seq->CurrentValue;
		}
		return $sDetailUrl;
	}
	...
	function SqlFrom() { // From
		return "`frm_2_a_fi_rep_form_a_raw_data_cu`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_2_a_fi_rep_form_a_raw_data_cu` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_2_a_fi_rep_form_a_raw_data_cu` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_2_a_fi_rep_form_a_raw_data_cu` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_2_a_fi_rep_form_a_raw_data_culist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_2_a_fi_rep_form_a_raw_data_cuview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_2_a_fi_rep_form_a_raw_data_cuadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_2_a_fi_rep_form_a_raw_data_cuedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_2_a_fi_rep_form_a_raw_data_cuadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_2_a_fi_rep_form_a_raw_data_cudelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_2_a_fi_rep_form_a_raw_data_cu" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_2_a_fi_rep_form_a_raw_data_cu` WHERE " . $this->AddUserIDFilter("");
