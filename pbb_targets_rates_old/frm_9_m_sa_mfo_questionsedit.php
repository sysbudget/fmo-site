...
<?php if ($frm_9_m_sa_mfo_questions->mfo_question_id->Visible) { // mfo_question_id ?>
	<tr id="r_mfo_question_id"<?php echo $frm_9_m_sa_mfo_questions->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->FldCaption() ?></td>
		<td<?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->CellAttributes() ?>><span id="el_mfo_question_id">
<div<?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->ViewAttributes() ?>><?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->EditValue ?></div>
...
</span><?php echo $frm_9_m_sa_mfo_questions->mfo_question_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
class cfrm_9_m_sa_mfo_questions_edit {
	...
	function RenderRow() {
		...
		if ($frm_9_m_sa_mfo_questions->RowType == UP_ROWTYPE_VIEW) { // View row
			...
			// mfo_question_id
			$frm_9_m_sa_mfo_questions->mfo_question_id->EditCustomAttributes = "";
			$frm_9_m_sa_mfo_questions->mfo_question_id->EditValue = $frm_9_m_sa_mfo_questions->mfo_question_id->CurrentValue;
			$frm_9_m_sa_mfo_questions->mfo_question_id->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// mfo_question_expected_answer
			$frm_9_m_sa_mfo_questions->mfo_question_expected_answer->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_expected_answer->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_expected_answer->ReadOnly);

			// mfo_question_online_insert_question_mfo
			$frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo->ReadOnly);

			// mfo_question_online_insert_question_mfo_name_rep
			$frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_online_insert_question_mfo_name_rep->ReadOnly);
			...
			// mfo_question_online_computation_denominator
			$frm_9_m_sa_mfo_questions->mfo_question_online_computation_denominator->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_online_computation_denominator->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_online_computation_denominator->ReadOnly);

			// mfo_question_supporting_document_requirement
			$frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_supporting_document_requirement->ReadOnly);

			// mfo_question_expected_trend
			$frm_9_m_sa_mfo_questions->mfo_question_expected_trend->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_expected_trend->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_expected_trend->ReadOnly);

			// mfo_question_online_ask_y_n
			$frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_online_ask_y_n->ReadOnly);

			// mfo_question_online_pi_question_numerator
			$frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_numerator->ReadOnly);

			// mfo_question_online_pi_question_denominator
			$frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_online_pi_question_denominator->ReadOnly);

			// mfo_question_expected_numerator
			$frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_expected_numerator->ReadOnly);

			// mfo_question_expected_denominator
			$frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_expected_denominator->ReadOnly);

			// mfo_question_report_mfo_name
			$frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_report_mfo_name->ReadOnly);

			// mfo_question_report_form_a_pi_question
			$frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_pi_question->ReadOnly);

			// mfo_question_report_form_a_1_mfo
			$frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_mfo->ReadOnly);

			// mfo_question_report_form_a_1_sequence
			$frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_1_sequence->ReadOnly);

			// mfo_question_report_form_a_gaa_value
			$frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->mfo_question_report_form_a_gaa_value->ReadOnly);

			// pi_no
			$frm_9_m_sa_mfo_questions->pi_no->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->pi_no->CurrentValue, 0, $frm_9_m_sa_mfo_questions->pi_no->ReadOnly);

			// pi_sub
			$frm_9_m_sa_mfo_questions->pi_sub->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->pi_sub->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->pi_sub->ReadOnly);

			// iatf_2013
			$frm_9_m_sa_mfo_questions->iatf_2013->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->iatf_2013->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->iatf_2013->ReadOnly);

			// iatf_2014
			$frm_9_m_sa_mfo_questions->iatf_2014->SetDbValueDef($rsnew, $frm_9_m_sa_mfo_questions->iatf_2014->CurrentValue, NULL, $frm_9_m_sa_mfo_questions->iatf_2014->ReadOnly);
