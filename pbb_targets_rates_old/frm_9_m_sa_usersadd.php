...
<input type="text" name="x_Password" id="x_Password" size="30" maxlength="15" value="<?php echo $frm_9_m_sa_users->Password->EditValue ?>"<?php echo $frm_9_m_sa_users->Password->EditAttributes() ?>>
