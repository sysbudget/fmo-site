...
class cfrm_1_t_fi_delivery_pi_status {
	...
	function cfrm_1_t_fi_delivery_pi_status() {
		...
		// unit_contributor_id
		$this->unit_contributor_id = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_unit_contributor_id', 'unit_contributor_id', '`unit_contributor_id`', 200, -1, FALSE, '`unit_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Contributor Unit
		$this->Contributor_Unit = new cField('frm_1_t_fi_delivery_pi_status', 'frm_1_t_fi_delivery_pi_status', 'x_Contributor_Unit', 'Contributor Unit', '`Contributor Unit`', 200, -1, FALSE, '`Contributor Unit`', FALSE, FALSE, 'FORMATTED TEXT');
