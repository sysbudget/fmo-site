...
// Create page object
$frm_9_m_sa_cutoffdate_add = new cfrm_9_m_sa_cutoffdate_add();
$Page =& $frm_9_m_sa_cutoffdate_add;

// Page init
$frm_9_m_sa_cutoffdate_add->Page_Init();

// Page main
$frm_9_m_sa_cutoffdate_add->Page_Main();
?>
...
// Create page object
var frm_9_m_sa_cutoffdate_add = new up_Page("frm_9_m_sa_cutoffdate_add");

// page properties
frm_9_m_sa_cutoffdate_add.PageID = "add"; // page ID
frm_9_m_sa_cutoffdate_add.FormID = "ffrm_9_m_sa_cutoffdateadd"; // form ID
var UP_PAGE_ID = frm_9_m_sa_cutoffdate_add.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_9_m_sa_cutoffdate_add.ValidateForm = function(fobj) {
...
frm_9_m_sa_cutoffdate_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_9_m_sa_cutoffdate_add.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_9_m_sa_cutoffdate_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_9_m_sa_cutoffdate_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_9_m_sa_cutoffdate->TableCaption() ?></p>
<p class="upbudgetofficeclass"><a href="<?php echo $frm_9_m_sa_cutoffdate->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $frm_9_m_sa_cutoffdate_add->ShowPageHeader(); ?>
<?php
$frm_9_m_sa_cutoffdate_add->ShowMessage();
?>
<form name="ffrm_9_m_sa_cutoffdateadd" id="ffrm_9_m_sa_cutoffdateadd" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_9_m_sa_cutoffdate_add.ValidateForm(this);">
<p>
...
<?php
$frm_9_m_sa_cutoffdate_add->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_9_m_sa_cutoffdate_add->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_9_m_sa_cutoffdate_add {
	...
	// Page object name
	var $PageObjName = 'frm_9_m_sa_cutoffdate_add';
	...
	//
	function cfrm_9_m_sa_cutoffdate_add() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$frm_9_m_sa_cutoffdate->CurrentAction = $_POST["a_add"]; // Get form action
			$this->CopyRecord = $this->LoadOldRecord(); // Load old recordset
			$this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$frm_9_m_sa_cutoffdate->CurrentAction = "I"; // Form error, reset action
			...
			if (@$_GET["cutOffDate_id"] != "") {
				...
				$frm_9_m_sa_cutoffdate->setKey("cutOffDate_id", $frm_9_m_sa_cutoffdate->cutOffDate_id->CurrentValue); // Set up key
			} else {
				$frm_9_m_sa_cutoffdate->setKey("cutOffDate_id", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
				$frm_9_m_sa_cutoffdate->CurrentAction = "C"; // Copy record
			} else {
				$frm_9_m_sa_cutoffdate->CurrentAction = "I"; // Display blank record
		...
		switch ($frm_9_m_sa_cutoffdate->CurrentAction) {
			...
			case "A": // ' Add new record
				$frm_9_m_sa_cutoffdate->SendEmail = TRUE; // Send email on add success
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					$sReturnUrl = $frm_9_m_sa_cutoffdate->getReturnUrl();
					if (up_GetPageName($sReturnUrl) == "frm_9_m_sa_cutoffdateview.php")
						$sReturnUrl = $frm_9_m_sa_cutoffdate->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$frm_9_m_sa_cutoffdate->RowType = UP_ROWTYPE_ADD;  // Render add type
	...
	function LoadDefaultValues() {
		global $frm_9_m_sa_cutoffdate;
		$frm_9_m_sa_cutoffdate->focal_person_office->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->focal_person_office->OldValue = $frm_9_m_sa_cutoffdate->focal_person_office->CurrentValue;
		$frm_9_m_sa_cutoffdate->t_startDate->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->t_startDate->OldValue = $frm_9_m_sa_cutoffdate->t_startDate->CurrentValue;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_contributor->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_contributor->OldValue = $frm_9_m_sa_cutoffdate->t_cutOffDate_contributor->CurrentValue;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_delivery->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_delivery->OldValue = $frm_9_m_sa_cutoffdate->t_cutOffDate_delivery->CurrentValue;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_fp->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_fp->OldValue = $frm_9_m_sa_cutoffdate->t_cutOffDate_fp->CurrentValue;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_remarks->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->t_cutOffDate_remarks->OldValue = $frm_9_m_sa_cutoffdate->t_cutOffDate_remarks->CurrentValue;
		$frm_9_m_sa_cutoffdate->a_startDate->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->a_startDate->OldValue = $frm_9_m_sa_cutoffdate->a_startDate->CurrentValue;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_contributor->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_contributor->OldValue = $frm_9_m_sa_cutoffdate->a_cutOffDate_contributor->CurrentValue;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_delivery->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_delivery->OldValue = $frm_9_m_sa_cutoffdate->a_cutOffDate_delivery->CurrentValue;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_fp->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_fp->OldValue = $frm_9_m_sa_cutoffdate->a_cutOffDate_fp->CurrentValue;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_remarks->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->a_cutOffDate_remarks->OldValue = $frm_9_m_sa_cutoffdate->a_cutOffDate_remarks->CurrentValue;
		$frm_9_m_sa_cutoffdate->remarks->CurrentValue = NULL;
		$frm_9_m_sa_cutoffdate->remarks->OldValue = $frm_9_m_sa_cutoffdate->remarks->CurrentValue;
	}
	...
	function RenderRow() {
		...
		} elseif ($frm_9_m_sa_cutoffdate->RowType == UP_ROWTYPE_ADD) { // Add row
	...
	function AddRow($rsold = NULL) {
		...
		// focal_person_office
		$frm_9_m_sa_cutoffdate->focal_person_office->SetDbValueDef($rsnew, $frm_9_m_sa_cutoffdate->focal_person_office->CurrentValue, NULL, FALSE);

		// t_startDate
		$frm_9_m_sa_cutoffdate->t_startDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->t_startDate->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_contributor
		$frm_9_m_sa_cutoffdate->t_cutOffDate_contributor->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->t_cutOffDate_contributor->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_delivery
		$frm_9_m_sa_cutoffdate->t_cutOffDate_delivery->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->t_cutOffDate_delivery->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_fp
		$frm_9_m_sa_cutoffdate->t_cutOffDate_fp->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->t_cutOffDate_fp->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_remarks
		$frm_9_m_sa_cutoffdate->t_cutOffDate_remarks->SetDbValueDef($rsnew, $frm_9_m_sa_cutoffdate->t_cutOffDate_remarks->CurrentValue, NULL, FALSE);

		// a_startDate
		$frm_9_m_sa_cutoffdate->a_startDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->a_startDate->CurrentValue, 6), NULL, FALSE);

		// a_cutOffDate_contributor
		$frm_9_m_sa_cutoffdate->a_cutOffDate_contributor->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->a_cutOffDate_contributor->CurrentValue, 6), NULL, FALSE);

		// a_cutOffDate_delivery
		$frm_9_m_sa_cutoffdate->a_cutOffDate_delivery->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->a_cutOffDate_delivery->CurrentValue, 6), NULL, FALSE);

		// a_cutOffDate_fp
		$frm_9_m_sa_cutoffdate->a_cutOffDate_fp->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_cutoffdate->a_cutOffDate_fp->CurrentValue, 6), NULL, FALSE);

		// a_cutOffDate_remarks
		$frm_9_m_sa_cutoffdate->a_cutOffDate_remarks->SetDbValueDef($rsnew, $frm_9_m_sa_cutoffdate->a_cutOffDate_remarks->CurrentValue, NULL, FALSE);

		// remarks
		$frm_9_m_sa_cutoffdate->remarks->SetDbValueDef($rsnew, $frm_9_m_sa_cutoffdate->remarks->CurrentValue, NULL, FALSE);

		// Call Row Inserting event
		$rs = ($rsold == NULL) ? NULL : $rsold->fields;
		$bInsertRow = $frm_9_m_sa_cutoffdate->Row_Inserting($rs, $rsnew);
		if ($bInsertRow) {
			$conn->raiseErrorFn = 'up_ErrorFn';
			$AddRow = $conn->Execute($frm_9_m_sa_cutoffdate->InsertSQL($rsnew));
			$conn->raiseErrorFn = '';
		} else {
		...
		if ($AddRow) {
			$frm_9_m_sa_cutoffdate->cutOffDate_id->setDbValue($conn->Insert_ID());
			$rsnew['cutOffDate_id'] = $frm_9_m_sa_cutoffdate->cutOffDate_id->DbValue;
		}
		if ($AddRow) {

			// Call Row Inserted event
			$rs = ($rsold == NULL) ? NULL : $rsold->fields;
			$frm_9_m_sa_cutoffdate->Row_Inserted($rs, $rsnew);
		}
		return $AddRow;
	}
