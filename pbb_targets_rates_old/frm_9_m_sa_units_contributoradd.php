...
// Create page object
$frm_9_m_sa_units_contributor_add = new cfrm_9_m_sa_units_contributor_add();
$Page =& $frm_9_m_sa_units_contributor_add;

// Page init
$frm_9_m_sa_units_contributor_add->Page_Init();

// Page main
$frm_9_m_sa_units_contributor_add->Page_Main();
?>
...
// Create page object
var frm_9_m_sa_units_contributor_add = new up_Page("frm_9_m_sa_units_contributor_add");

// page properties
frm_9_m_sa_units_contributor_add.PageID = "add"; // page ID
frm_9_m_sa_units_contributor_add.FormID = "ffrm_9_m_sa_units_contributoradd"; // form ID
var UP_PAGE_ID = frm_9_m_sa_units_contributor_add.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_9_m_sa_units_contributor_add.ValidateForm = function(fobj) {
...
frm_9_m_sa_units_contributor_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_9_m_sa_units_contributor_add.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_9_m_sa_units_contributor_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_9_m_sa_units_contributor_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_9_m_sa_units_contributor->TableCaption() ?></p>
...
<?php $frm_9_m_sa_units_contributor_add->ShowPageHeader(); ?>
<?php
$frm_9_m_sa_units_contributor_add->ShowMessage();
?>
<form name="ffrm_9_m_sa_units_contributoradd" id="ffrm_9_m_sa_units_contributoradd" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_9_m_sa_units_contributor_add.ValidateForm(this);">
<p>
...
<?php
$frm_9_m_sa_units_contributor_add->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_9_m_sa_units_contributor_add->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_9_m_sa_units_contributor_add {
	...
	// Page object name
	var $PageObjName = 'frm_9_m_sa_units_contributor_add';
	...
	//
	function cfrm_9_m_sa_units_contributor_add() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$frm_9_m_sa_units_contributor->CurrentAction = $_POST["a_add"]; // Get form action
			$this->CopyRecord = $this->LoadOldRecord(); // Load old recordset
			$this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$frm_9_m_sa_units_contributor->CurrentAction = "I"; // Form error, reset action
			...
			if (@$_GET["unit_contributor_id"] != "") {
				...
				$frm_9_m_sa_units_contributor->setKey("unit_contributor_id", $frm_9_m_sa_units_contributor->unit_contributor_id->CurrentValue); // Set up key
			} else {
				$frm_9_m_sa_units_contributor->setKey("unit_contributor_id", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
				$frm_9_m_sa_units_contributor->CurrentAction = "C"; // Copy record
			} else {
				$frm_9_m_sa_units_contributor->CurrentAction = "I"; // Display blank record
		...
		switch ($frm_9_m_sa_units_contributor->CurrentAction) {
			...
			case "A": // ' Add new record
				$frm_9_m_sa_units_contributor->SendEmail = TRUE; // Send email on add success
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					$sReturnUrl = $frm_9_m_sa_units_contributor->getReturnUrl();
					if (up_GetPageName($sReturnUrl) == "frm_9_m_sa_units_contributorview.php")
						$sReturnUrl = $frm_9_m_sa_units_contributor->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$frm_9_m_sa_units_contributor->RowType = UP_ROWTYPE_ADD;  // Render add type
	...
	function LoadDefaultValues() {
		global $frm_9_m_sa_units_contributor;
		$frm_9_m_sa_units_contributor->unit_delivery_id->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_delivery_id->OldValue = $frm_9_m_sa_units_contributor->unit_delivery_id->CurrentValue;
		$frm_9_m_sa_units_contributor->focal_person_id->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->focal_person_id->OldValue = $frm_9_m_sa_units_contributor->focal_person_id->CurrentValue;
		$frm_9_m_sa_units_contributor->cu_id->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->cu_id->OldValue = $frm_9_m_sa_units_contributor->cu_id->CurrentValue;
		$frm_9_m_sa_units_contributor->cu_short_name->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->cu_short_name->OldValue = $frm_9_m_sa_units_contributor->cu_short_name->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_delivery_name_cu->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_delivery_name_cu->OldValue = $frm_9_m_sa_units_contributor->unit_delivery_name_cu->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_contributor_name->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_contributor_name->OldValue = $frm_9_m_sa_units_contributor->unit_contributor_name->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_contributor_name_short->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_contributor_name_short->OldValue = $frm_9_m_sa_units_contributor->unit_contributor_name_short->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_contributor_personnel_count->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_contributor_personnel_count->OldValue = $frm_9_m_sa_units_contributor->unit_contributor_personnel_count->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_1->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_2->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_3->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_4->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_5->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->unit_contributor_sto->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->unit_contributor_gass_ab->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_contributor_gass_ab->OldValue = $frm_9_m_sa_units_contributor->unit_contributor_gass_ab->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_contributor_gass_cd->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->unit_contributor_gass_cd->OldValue = $frm_9_m_sa_units_contributor->unit_contributor_gass_cd->CurrentValue;
		$frm_9_m_sa_units_contributor->unit_contributor_gass->CurrentValue = "Y";
		$frm_9_m_sa_units_contributor->cutOffDate_id->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->cutOffDate_id->OldValue = $frm_9_m_sa_units_contributor->cutOffDate_id->CurrentValue;
		$frm_9_m_sa_units_contributor->t_startDate->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->t_startDate->OldValue = $frm_9_m_sa_units_contributor->t_startDate->CurrentValue;
		$frm_9_m_sa_units_contributor->t_cutOffDate_fp->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->t_cutOffDate_fp->OldValue = $frm_9_m_sa_units_contributor->t_cutOffDate_fp->CurrentValue;
		$frm_9_m_sa_units_contributor->t_cutOffDate_remarks->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->t_cutOffDate_remarks->OldValue = $frm_9_m_sa_units_contributor->t_cutOffDate_remarks->CurrentValue;
		$frm_9_m_sa_units_contributor->a_startDate->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->a_startDate->OldValue = $frm_9_m_sa_units_contributor->a_startDate->CurrentValue;
		$frm_9_m_sa_units_contributor->a_cutOffDate_contributor->CurrentValue = NULL;
		$frm_9_m_sa_units_contributor->a_cutOffDate_contributor->OldValue = $frm_9_m_sa_units_contributor->a_cutOffDate_contributor->CurrentValue;
	}
	...
	function LoadOldRecord() {
		...
		$bValidKey = TRUE;
		if (strval($frm_9_m_sa_units_contributor->getKey("unit_contributor_id")) <> "")
			$frm_9_m_sa_units_contributor->unit_contributor_id->CurrentValue = $frm_9_m_sa_units_contributor->getKey("unit_contributor_id"); // unit_contributor_id
		else
			$bValidKey = FALSE;
	...
	function AddRow($rsold = NULL) {
		...
		// unit_delivery_id
		$frm_9_m_sa_units_contributor->unit_delivery_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_delivery_id->CurrentValue, NULL, FALSE);

		// focal_person_id
		$frm_9_m_sa_units_contributor->focal_person_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->focal_person_id->CurrentValue, NULL, FALSE);

		// cu_id
		$frm_9_m_sa_units_contributor->cu_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->cu_id->CurrentValue, NULL, FALSE);

		// cu_short_name
		$frm_9_m_sa_units_contributor->cu_short_name->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->cu_short_name->CurrentValue, NULL, FALSE);

		// unit_delivery_name_cu
		$frm_9_m_sa_units_contributor->unit_delivery_name_cu->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_delivery_name_cu->CurrentValue, NULL, FALSE);

		// unit_contributor_name
		$frm_9_m_sa_units_contributor->unit_contributor_name->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_name->CurrentValue, NULL, FALSE);

		// unit_contributor_name_short
		$frm_9_m_sa_units_contributor->unit_contributor_name_short->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_name_short->CurrentValue, NULL, FALSE);

		// unit_contributor_personnel_count
		$frm_9_m_sa_units_contributor->unit_contributor_personnel_count->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_personnel_count->CurrentValue, NULL, FALSE);

		// unit_contributor_mfo_1
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_1->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_mfo_1->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_mfo_1->CurrentValue) == "");

		// unit_contributor_mfo_2
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_2->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_mfo_2->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_mfo_2->CurrentValue) == "");

		// unit_contributor_mfo_3
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_3->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_mfo_3->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_mfo_3->CurrentValue) == "");

		// unit_contributor_mfo_4
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_4->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_mfo_4->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_mfo_4->CurrentValue) == "");

		// unit_contributor_mfo_5
		$frm_9_m_sa_units_contributor->unit_contributor_mfo_5->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_mfo_5->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_mfo_5->CurrentValue) == "");

		// unit_contributor_sto
		$frm_9_m_sa_units_contributor->unit_contributor_sto->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_sto->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_sto->CurrentValue) == "");

		// unit_contributor_gass_ab
		$frm_9_m_sa_units_contributor->unit_contributor_gass_ab->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_gass_ab->CurrentValue, NULL, FALSE);

		// unit_contributor_gass_cd
		$frm_9_m_sa_units_contributor->unit_contributor_gass_cd->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_gass_cd->CurrentValue, NULL, FALSE);

		// unit_contributor_gass
		$frm_9_m_sa_units_contributor->unit_contributor_gass->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->unit_contributor_gass->CurrentValue, NULL, strval($frm_9_m_sa_units_contributor->unit_contributor_gass->CurrentValue) == "");

		// cutOffDate_id
		$frm_9_m_sa_units_contributor->cutOffDate_id->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->cutOffDate_id->CurrentValue, NULL, FALSE);

		// t_startDate
		$frm_9_m_sa_units_contributor->t_startDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_units_contributor->t_startDate->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_fp
		$frm_9_m_sa_units_contributor->t_cutOffDate_fp->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_units_contributor->t_cutOffDate_fp->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_remarks
		$frm_9_m_sa_units_contributor->t_cutOffDate_remarks->SetDbValueDef($rsnew, $frm_9_m_sa_units_contributor->t_cutOffDate_remarks->CurrentValue, NULL, FALSE);

		// a_startDate
		$frm_9_m_sa_units_contributor->a_startDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_units_contributor->a_startDate->CurrentValue, 6), NULL, FALSE);

		// a_cutOffDate_contributor
		$frm_9_m_sa_units_contributor->a_cutOffDate_contributor->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_9_m_sa_units_contributor->a_cutOffDate_contributor->CurrentValue, 6), NULL, FALSE);
		...
		if ($AddRow) {
			$frm_9_m_sa_units_contributor->unit_contributor_id->setDbValue($conn->Insert_ID());
			$rsnew['unit_contributor_id'] = $frm_9_m_sa_units_contributor->unit_contributor_id->DbValue;
		}
		if ($AddRow) {
