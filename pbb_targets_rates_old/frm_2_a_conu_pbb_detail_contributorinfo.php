...
$frm_2_a_conu_pbb_detail_contributor = NULL;

//
// Table class for frm_2_a_conu_pbb_detail_contributor
//
class cfrm_2_a_conu_pbb_detail_contributor {
	var $TableVar = 'frm_2_a_conu_pbb_detail_contributor';
	...
	//
	function cfrm_2_a_conu_pbb_detail_contributor() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// pbb_contributor_id
		$this->pbb_contributor_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_pbb_contributor_id', 'pbb_contributor_id', '`pbb_contributor_id`', 3, -1, FALSE, '`pbb_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// pbb_delivery_id
		$this->pbb_delivery_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_pbb_delivery_id', 'pbb_delivery_id', '`pbb_delivery_id`', 3, -1, FALSE, '`pbb_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pbb_delivery_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pbb_delivery_id'] =& $this->pbb_delivery_id;

		// unit_contributor_id
		$this->unit_contributor_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_unit_contributor_id', 'unit_contributor_id', '`unit_contributor_id`', 3, -1, FALSE, '`unit_contributor_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// unit_delivery_id
		$this->unit_delivery_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_unit_delivery_id', 'unit_delivery_id', '`unit_delivery_id`', 3, -1, FALSE, '`unit_delivery_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// focal_person_id
		$this->focal_person_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// Contributing Unit
		$this->Contributing_Unit = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Contributing_Unit', 'Contributing Unit', '`Contributing Unit`', 200, -1, FALSE, '`Contributing Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Contributing Unit'] =& $this->Contributing_Unit;

		// mfo_question_id
		$this->mfo_question_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_mfo_question_id', 'mfo_question_id', '`mfo_question_id`', 3, -1, FALSE, '`mfo_question_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_pi_seq = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_mfo_question_online_pi_seq', 'mfo_question_online_pi_seq', '`mfo_question_online_pi_seq`', 3, -1, FALSE, '`mfo_question_online_pi_seq`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// MFO
		$this->MFO = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// mfo_question_online_insert_question_mfo
		$this->mfo_question_online_insert_question_mfo = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_mfo_question_online_insert_question_mfo', 'mfo_question_online_insert_question_mfo', '`mfo_question_online_insert_question_mfo`', 3, -1, FALSE, '`mfo_question_online_insert_question_mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->mfo_question_online_insert_question_mfo_name_rep = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_mfo_question_online_insert_question_mfo_name_rep', 'mfo_question_online_insert_question_mfo_name_rep', '`mfo_question_online_insert_question_mfo_name_rep`', 200, -1, FALSE, '`mfo_question_online_insert_question_mfo_name_rep`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_question_online_insert_question_mfo_name_rep'] =& $this->mfo_question_online_insert_question_mfo_name_rep;

		// Applicable
		$this->Applicable = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Applicable', 'Applicable', '`Applicable`', 200, -1, FALSE, '`Applicable`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Applicable'] =& $this->Applicable;

		// Target
		$this->Target = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Target', 'Target', '`Target`', 5, -1, FALSE, '`Target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target'] =& $this->Target;

		// Target Remarks
		$this->Target_Remarks = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Target_Remarks', 'Target Remarks', '`Target Remarks`', 200, -1, FALSE, '`Target Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Remarks'] =& $this->Target_Remarks;

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// t_startDate
		$this->t_startDate = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_t_startDate', 't_startDate', '`t_startDate`', 135, 6, FALSE, '`t_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_contributor = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_t_cutOffDate_contributor', 't_cutOffDate_contributor', '`t_cutOffDate_contributor`', 135, 6, FALSE, '`t_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_delivery = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_t_cutOffDate_delivery', 't_cutOffDate_delivery', '`t_cutOffDate_delivery`', 135, 6, FALSE, '`t_cutOffDate_delivery`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Target Cut-Off Date
		$this->Target_Cut2DOff_Date = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Target_Cut2DOff_Date', 'Target Cut-Off Date', '`Target Cut-Off Date`', 200, -1, FALSE, '`Target Cut-Off Date`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Cut-Off Date'] =& $this->Target_Cut2DOff_Date;

		// Target Message
		$this->Target_Message = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Target_Message', 'Target Message', '`Target Message`', 200, -1, FALSE, '`Target Message`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Target Message'] =& $this->Target_Message;

		// pbb_contributor_derived_from_supporting_documents
		$this->pbb_contributor_derived_from_supporting_documents = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_pbb_contributor_derived_from_supporting_documents', 'pbb_contributor_derived_from_supporting_documents', '`pbb_contributor_derived_from_supporting_documents`', 200, -1, FALSE, '`pbb_contributor_derived_from_supporting_documents`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pbb_contributor_derived_from_supporting_documents'] =& $this->pbb_contributor_derived_from_supporting_documents;

		// Accomplishment
		$this->Accomplishment = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Accomplishment', 'Accomplishment', '`Accomplishment`', 5, -1, FALSE, '`Accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Accomplishment'] =& $this->Accomplishment;

		// Numerator
		$this->Numerator = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Numerator', 'Numerator', '`Numerator`', 5, -1, FALSE, '`Numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator'] =& $this->Numerator;

		// Jan-Mar (N)
		$this->Jan2DMar_28N29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Jan2DMar_28N29', 'Jan-Mar (N)', '`Jan-Mar (N)`', 5, -1, FALSE, '`Jan-Mar (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jan2DMar_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jan-Mar (N)'] =& $this->Jan2DMar_28N29;

		// Apr-Jun (N)
		$this->Apr2DJun_28N29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Apr2DJun_28N29', 'Apr-Jun (N)', '`Apr-Jun (N)`', 5, -1, FALSE, '`Apr-Jun (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Apr2DJun_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Apr-Jun (N)'] =& $this->Apr2DJun_28N29;

		// Jul-Sep (N)
		$this->Jul2DSep_28N29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Jul2DSep_28N29', 'Jul-Sep (N)', '`Jul-Sep (N)`', 5, -1, FALSE, '`Jul-Sep (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jul2DSep_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jul-Sep (N)'] =& $this->Jul2DSep_28N29;

		// Oct-Nov (N)
		$this->Oct2DNov_28N29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Oct2DNov_28N29', 'Oct-Nov (N)', '`Oct-Nov (N)`', 5, -1, FALSE, '`Oct-Nov (N)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Oct2DNov_28N29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Oct-Nov (N)'] =& $this->Oct2DNov_28N29;

		// Denominator
		$this->Denominator = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Denominator', 'Denominator', '`Denominator`', 5, -1, FALSE, '`Denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Denominator'] =& $this->Denominator;

		// Jan-Mar (D)
		$this->Jan2DMar_28D29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Jan2DMar_28D29', 'Jan-Mar (D)', '`Jan-Mar (D)`', 5, -1, FALSE, '`Jan-Mar (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jan2DMar_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jan-Mar (D)'] =& $this->Jan2DMar_28D29;

		// Apr-Jun (D)
		$this->Apr2DJun_28D29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Apr2DJun_28D29', 'Apr-Jun (D)', '`Apr-Jun (D)`', 5, -1, FALSE, '`Apr-Jun (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Apr2DJun_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Apr-Jun (D)'] =& $this->Apr2DJun_28D29;

		// Jul-Sep (D)
		$this->Jul2DSep_28D29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Jul2DSep_28D29', 'Jul-Sep (D)', '`Jul-Sep (D)`', 5, -1, FALSE, '`Jul-Sep (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Jul2DSep_28D29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Jul-Sep (D)'] =& $this->Jul2DSep_28D29;

		// Oct-Nov (D)
		$this->Oct2DNov_28D29 = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Oct2DNov_28D29', 'Oct-Nov (D)', '`Oct-Nov (D)`', 5, -1, FALSE, '`Oct-Nov (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Accomplishment_Remarks = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Accomplishment_Remarks', 'Accomplishment Remarks', '`Accomplishment Remarks`', 200, -1, FALSE, '`Accomplishment Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Accomplishment Remarks'] =& $this->Accomplishment_Remarks;

		// a_startDate
		$this->a_startDate = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_a_startDate', 'a_startDate', '`a_startDate`', 135, 6, FALSE, '`a_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_contributor = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_a_cutOffDate_contributor', 'a_cutOffDate_contributor', '`a_cutOffDate_contributor`', 135, 6, FALSE, '`a_cutOffDate_contributor`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_delivery = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_a_cutOffDate_delivery', 'a_cutOffDate_delivery', '`a_cutOffDate_delivery`', 135, 6, FALSE, '`a_cutOffDate_delivery`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_cutOffDate_fp
		$this->a_cutOffDate_fp = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_a_cutOffDate_fp', 'a_cutOffDate_fp', '`a_cutOffDate_fp`', 135, 6, FALSE, '`a_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_remarks = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_a_cutOffDate_remarks', 'a_cutOffDate_remarks', '`a_cutOffDate_remarks`', 200, -1, FALSE, '`a_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['a_cutOffDate_remarks'] =& $this->a_cutOffDate_remarks;

		// pbb_contributor_a_rating
		$this->pbb_contributor_a_rating = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_pbb_contributor_a_rating', 'pbb_contributor_a_rating', '`pbb_contributor_a_rating`', 5, -1, FALSE, '`pbb_contributor_a_rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Below_10025_Performance_Rating = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Below_10025_Performance_Rating', 'Below 100% Performance Rating', '`Below 100% Performance Rating`', 5, -1, FALSE, '`Below 100% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// CU
		$this->CU = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// mfo_question_report_mfo_name
		$this->mfo_question_report_mfo_name = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_mfo_question_report_mfo_name', 'mfo_question_report_mfo_name', '`mfo_question_report_mfo_name`', 200, -1, FALSE, '`mfo_question_report_mfo_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_question_report_mfo_name'] =& $this->mfo_question_report_mfo_name;

		// mfo_question_report_form_a_1_mfo
		$this->mfo_question_report_form_a_1_mfo = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_mfo_question_report_form_a_1_mfo', 'mfo_question_report_form_a_1_mfo', '`mfo_question_report_form_a_1_mfo`', 3, -1, FALSE, '`mfo_question_report_form_a_1_mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->z10025_to_12025_Performance_Rating = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_z10025_to_12025_Performance_Rating', '100% to 120% Performance Rating', '`100% to 120% Performance Rating`', 5, -1, FALSE, '`100% to 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Above_12025_Performance_Rating = new cField('frm_2_a_conu_pbb_detail_contributor', 'frm_2_a_conu_pbb_detail_contributor', 'x_Above_12025_Performance_Rating', 'Above 120% Performance Rating', '`Above 120% Performance Rating`', 5, -1, FALSE, '`Above 120% Performance Rating`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_2_a_conu_pbb_detail_contributor_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_2_a_conu_pbb_detail_contributor`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_2_a_conu_pbb_detail_contributor` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_2_a_conu_pbb_detail_contributor` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_2_a_conu_pbb_detail_contributor` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_2_a_conu_pbb_detail_contributorlist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_2_a_conu_pbb_detail_contributorview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_2_a_conu_pbb_detail_contributoradd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_2_a_conu_pbb_detail_contributoredit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_2_a_conu_pbb_detail_contributoradd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_2_a_conu_pbb_detail_contributordelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_2_a_conu_pbb_detail_contributor" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_2_a_conu_pbb_detail_contributor` WHERE " . $this->AddUserIDFilter("");
