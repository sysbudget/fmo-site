...
<!-- ============ Page Heading ============== -->
		<h1 class="HeadingStyle">UP Los Baños Data Collection Forms</h1>
		<p>Click the links below to download the forms:</p>
<!-- ============ Begin Content ============== -->
		<?php
			$result=mysql_query("select * from wpc_downloads where recampcd='L' order by active desc, form_id asc, unit asc, department asc");
