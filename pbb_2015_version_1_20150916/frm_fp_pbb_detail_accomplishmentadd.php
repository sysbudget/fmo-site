...
// Create page object
$frm_fp_pbb_detail_accomplishment_add = new cfrm_fp_pbb_detail_accomplishment_add();
$Page =& $frm_fp_pbb_detail_accomplishment_add;

// Page init
$frm_fp_pbb_detail_accomplishment_add->Page_Init();

// Page main
$frm_fp_pbb_detail_accomplishment_add->Page_Main();
?>
...
// Create page object
var frm_fp_pbb_detail_accomplishment_add = new up_Page("frm_fp_pbb_detail_accomplishment_add");

// page properties
frm_fp_pbb_detail_accomplishment_add.PageID = "add"; // page ID
frm_fp_pbb_detail_accomplishment_add.FormID = "ffrm_fp_pbb_detail_accomplishmentadd"; // form ID
var UP_PAGE_ID = frm_fp_pbb_detail_accomplishment_add.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_fp_pbb_detail_accomplishment_add.ValidateForm = function(fobj) {
...
frm_fp_pbb_detail_accomplishment_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_fp_pbb_detail_accomplishment_add.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_fp_pbb_detail_accomplishment_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_fp_pbb_detail_accomplishment_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_fp_pbb_detail_accomplishment->TableCaption() ?></p>
...
<?php $frm_fp_pbb_detail_accomplishment_add->ShowPageHeader(); ?>
<?php
$frm_fp_pbb_detail_accomplishment_add->ShowMessage();
?>
<form name="ffrm_fp_pbb_detail_accomplishmentadd" id="ffrm_fp_pbb_detail_accomplishmentadd" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_fp_pbb_detail_accomplishment_add.ValidateForm(this);">
<p>
...
<?php
$frm_fp_pbb_detail_accomplishment_add->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_fp_pbb_detail_accomplishment_add->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_fp_pbb_detail_accomplishment_add {
	...
	// Page object name
	var $PageObjName = 'frm_fp_pbb_detail_accomplishment_add';
	...
	//
	function cfrm_fp_pbb_detail_accomplishment_add() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$frm_fp_pbb_detail_accomplishment->CurrentAction = $_POST["a_add"]; // Get form action
			$this->CopyRecord = $this->LoadOldRecord(); // Load old recordset
			$this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$frm_fp_pbb_detail_accomplishment->CurrentAction = "I"; // Form error, reset action
			...
			if (@$_GET["pbb_id"] != "") {
				...
				$frm_fp_pbb_detail_accomplishment->setKey("pbb_id", $frm_fp_pbb_detail_accomplishment->pbb_id->CurrentValue); // Set up key
			} else {
				$frm_fp_pbb_detail_accomplishment->setKey("pbb_id", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
				$frm_fp_pbb_detail_accomplishment->CurrentAction = "C"; // Copy record
			} else {
				$frm_fp_pbb_detail_accomplishment->CurrentAction = "I"; // Display blank record
		...
		switch ($frm_fp_pbb_detail_accomplishment->CurrentAction) {
			...
			case "A": // ' Add new record
				$frm_fp_pbb_detail_accomplishment->SendEmail = TRUE; // Send email on add success
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					$sReturnUrl = $frm_fp_pbb_detail_accomplishment->getReturnUrl();
					if (up_GetPageName($sReturnUrl) == "frm_fp_pbb_detail_accomplishmentview.php")
						$sReturnUrl = $frm_fp_pbb_detail_accomplishment->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$frm_fp_pbb_detail_accomplishment->RowType = UP_ROWTYPE_ADD;  // Render add type
	...
	function LoadDefaultValues() {
		global $frm_fp_pbb_detail_accomplishment;
		$frm_fp_pbb_detail_accomplishment->cu_sequence->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->cu_sequence->OldValue = $frm_fp_pbb_detail_accomplishment->cu_sequence->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->cu_short_name->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->cu_short_name->OldValue = $frm_fp_pbb_detail_accomplishment->cu_short_name->CurrentValue;
		...
		$frm_fp_pbb_detail_accomplishment->mfo_sequence->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->mfo_sequence->OldValue = $frm_fp_pbb_detail_accomplishment->mfo_sequence->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->mfo->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->mfo->OldValue = $frm_fp_pbb_detail_accomplishment->mfo->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->pi_no->CurrentValue = 0;
		$frm_fp_pbb_detail_accomplishment->pi_sub->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->pi_sub->OldValue = $frm_fp_pbb_detail_accomplishment->pi_sub->CurrentValue;
		...
		$frm_fp_pbb_detail_accomplishment->pi_question->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->pi_question->OldValue = $frm_fp_pbb_detail_accomplishment->pi_question->CurrentValue;
		...
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr1->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr2->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr3->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr4->CurrentValue = 0.00;
		...
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr1->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr2->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr3->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr4->CurrentValue = 0.00;
		...
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate->OldValue = $frm_fp_pbb_detail_accomplishment->t_cutOffDate->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate_remarks->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate_remarks->OldValue = $frm_fp_pbb_detail_accomplishment->t_cutOffDate_remarks->CurrentValue;
		...
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr1->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr2->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr3->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr4->CurrentValue = 0.00;
		...
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr1->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr2->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr3->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr4->CurrentValue = 0.00;
		...
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr1->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr2->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr3->CurrentValue = 0.00;
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr4->CurrentValue = 0.00;
		...
		$frm_fp_pbb_detail_accomplishment->a_cutOffDate->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->a_cutOffDate->OldValue = $frm_fp_pbb_detail_accomplishment->a_cutOffDate->CurrentValue;
		...
		$frm_fp_pbb_detail_accomplishment->units_id->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->units_id->OldValue = $frm_fp_pbb_detail_accomplishment->units_id->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->a_rating->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->a_rating->OldValue = $frm_fp_pbb_detail_accomplishment->a_rating->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->mfo_id->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->mfo_id->OldValue = $frm_fp_pbb_detail_accomplishment->mfo_id->CurrentValue;
		...
		$frm_fp_pbb_detail_accomplishment->cutOffDate_id->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->cutOffDate_id->OldValue = $frm_fp_pbb_detail_accomplishment->cutOffDate_id->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->mfo_name_rep->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->mfo_name_rep->OldValue = $frm_fp_pbb_detail_accomplishment->mfo_name_rep->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate_fp->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate_fp->OldValue = $frm_fp_pbb_detail_accomplishment->t_cutOffDate_fp->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->a_cutOffDate_fp->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->a_cutOffDate_fp->OldValue = $frm_fp_pbb_detail_accomplishment->a_cutOffDate_fp->CurrentValue;
		$frm_fp_pbb_detail_accomplishment->applicable->CurrentValue = NULL;
		$frm_fp_pbb_detail_accomplishment->applicable->OldValue = $frm_fp_pbb_detail_accomplishment->applicable->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
			$bValidUser = $Security->IsValidUserID($frm_fp_pbb_detail_accomplishment->focal_person_id->CurrentValue);
			if (!$bValidUser) {
				$sUserIdMsg = str_replace("%c", CurrentUserID(), $Language->Phrase("UnAuthorizedUserID"));
				$sUserIdMsg = str_replace("%u", $frm_fp_pbb_detail_accomplishment->focal_person_id->CurrentValue, $sUserIdMsg);
		...
		// cu_sequence
		$frm_fp_pbb_detail_accomplishment->cu_sequence->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->cu_sequence->CurrentValue, NULL, FALSE);

		// cu_short_name
		$frm_fp_pbb_detail_accomplishment->cu_short_name->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->cu_short_name->CurrentValue, NULL, FALSE);
		...
		// focal_person_id
		$frm_fp_pbb_detail_accomplishment->focal_person_id->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->focal_person_id->CurrentValue, NULL, FALSE);

		// mfo_sequence
		$frm_fp_pbb_detail_accomplishment->mfo_sequence->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->mfo_sequence->CurrentValue, NULL, FALSE);

		// mfo
		$frm_fp_pbb_detail_accomplishment->mfo->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->mfo->CurrentValue, NULL, FALSE);

		// pi_no
		$frm_fp_pbb_detail_accomplishment->pi_no->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->pi_no->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->pi_no->CurrentValue) == "");

		// pi_sub
		$frm_fp_pbb_detail_accomplishment->pi_sub->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->pi_sub->CurrentValue, NULL, FALSE);
		...
		// pi_question
		$frm_fp_pbb_detail_accomplishment->pi_question->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->pi_question->CurrentValue, NULL, FALSE);
		...
		// t_numerator_qtr1
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr1->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_numerator_qtr1->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_numerator_qtr1->CurrentValue) == "");

		// t_numerator_qtr2
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr2->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_numerator_qtr2->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_numerator_qtr2->CurrentValue) == "");

		// t_numerator_qtr3
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr3->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_numerator_qtr3->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_numerator_qtr3->CurrentValue) == "");

		// t_numerator_qtr4
		$frm_fp_pbb_detail_accomplishment->t_numerator_qtr4->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_numerator_qtr4->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_numerator_qtr4->CurrentValue) == "");
		...
		// t_denominator_qtr1
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr1->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_denominator_qtr1->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_denominator_qtr1->CurrentValue) == "");

		// t_denominator_qtr2
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr2->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_denominator_qtr2->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_denominator_qtr2->CurrentValue) == "");

		// t_denominator_qtr3
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr3->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_denominator_qtr3->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_denominator_qtr3->CurrentValue) == "");

		// t_denominator_qtr4
		$frm_fp_pbb_detail_accomplishment->t_denominator_qtr4->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_denominator_qtr4->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->t_denominator_qtr4->CurrentValue) == "");
		...
		// t_cutOffDate
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_fp_pbb_detail_accomplishment->t_cutOffDate->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_remarks
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate_remarks->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->t_cutOffDate_remarks->CurrentValue, NULL, FALSE);
		...
		// a_numerator_qtr1
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr1->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_numerator_qtr1->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_numerator_qtr1->CurrentValue) == "");

		// a_numerator_qtr2
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr2->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_numerator_qtr2->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_numerator_qtr2->CurrentValue) == "");

		// a_numerator_qtr3
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr3->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_numerator_qtr3->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_numerator_qtr3->CurrentValue) == "");

		// a_numerator_qtr4
		$frm_fp_pbb_detail_accomplishment->a_numerator_qtr4->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_numerator_qtr4->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_numerator_qtr4->CurrentValue) == "");
		...
		// a_denominator_qtr1
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr1->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_denominator_qtr1->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_denominator_qtr1->CurrentValue) == "");

		// a_denominator_qtr2
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr2->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_denominator_qtr2->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_denominator_qtr2->CurrentValue) == "");

		// a_denominator_qtr3
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr3->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_denominator_qtr3->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_denominator_qtr3->CurrentValue) == "");

		// a_denominator_qtr4
		$frm_fp_pbb_detail_accomplishment->a_denominator_qtr4->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_denominator_qtr4->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_denominator_qtr4->CurrentValue) == "");
		...
		// a_supporting_docs_qtr1
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr1->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr1->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr1->CurrentValue) == "");

		// a_supporting_docs_qtr2
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr2->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr2->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr2->CurrentValue) == "");

		// a_supporting_docs_qtr3
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr3->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr3->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr3->CurrentValue) == "");

		// a_supporting_docs_qtr4
		$frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr4->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr4->CurrentValue, NULL, strval($frm_fp_pbb_detail_accomplishment->a_supporting_docs_qtr4->CurrentValue) == "");
		...
		// a_cutOffDate
		$frm_fp_pbb_detail_accomplishment->a_cutOffDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_fp_pbb_detail_accomplishment->a_cutOffDate->CurrentValue, 6), NULL, FALSE);
		...
		// units_id
		$frm_fp_pbb_detail_accomplishment->units_id->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->units_id->CurrentValue, NULL, FALSE);

		// a_rating
		$frm_fp_pbb_detail_accomplishment->a_rating->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->a_rating->CurrentValue, NULL, FALSE);

		// mfo_id
		$frm_fp_pbb_detail_accomplishment->mfo_id->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->mfo_id->CurrentValue, NULL, FALSE);
		...
		// cutOffDate_id
		$frm_fp_pbb_detail_accomplishment->cutOffDate_id->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->cutOffDate_id->CurrentValue, NULL, FALSE);

		// mfo_name_rep
		$frm_fp_pbb_detail_accomplishment->mfo_name_rep->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->mfo_name_rep->CurrentValue, NULL, FALSE);

		// t_cutOffDate_fp
		$frm_fp_pbb_detail_accomplishment->t_cutOffDate_fp->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_fp_pbb_detail_accomplishment->t_cutOffDate_fp->CurrentValue, 6), NULL, FALSE);

		// a_cutOffDate_fp
		$frm_fp_pbb_detail_accomplishment->a_cutOffDate_fp->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_fp_pbb_detail_accomplishment->a_cutOffDate_fp->CurrentValue, 6), NULL, FALSE);

		// applicable
		$frm_fp_pbb_detail_accomplishment->applicable->SetDbValueDef($rsnew, $frm_fp_pbb_detail_accomplishment->applicable->CurrentValue, NULL, FALSE);
