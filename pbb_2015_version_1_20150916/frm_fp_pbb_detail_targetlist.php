...
<?php
$gsMasterReturnUrl = "frm_fp_completion_statuslist.php";
if ($frm_fp_pbb_detail_target_list->DbMasterFilter <> "" && $frm_fp_pbb_detail_target->getCurrentMasterTable() == "frm_fp_completion_status") {
...
?>
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("MasterRecord") ?><?php echo $frm_fp_completion_status->TableCaption() ?>
...
<?php } ?>
<?php include_once "frm_fp_completion_statusmaster.php" ?>
<?php
	}
}
?>
<?php
$gsMasterReturnUrl = "frm_fp_formalist.php";
if ($frm_fp_pbb_detail_target_list->DbMasterFilter <> "" && $frm_fp_pbb_detail_target->getCurrentMasterTable() == "frm_fp_forma") {
	if ($frm_fp_pbb_detail_target_list->MasterRecordExists) {
		if ($frm_fp_pbb_detail_target->getCurrentMasterTable() == $frm_fp_pbb_detail_target->TableVar) $gsMasterReturnUrl .= "?" . UP_TABLE_SHOW_MASTER . "=";
?>
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("MasterRecord") ?><?php echo $frm_fp_forma->TableCaption() ?>
&nbsp;&nbsp;<?php $frm_fp_pbb_detail_target_list->ExportOptions->Render("body"); ?>
</p>
<?php if ($frm_fp_pbb_detail_target->Export == "") { ?>
<p class="upbudgetofficeclass"><a href="<?php echo $gsMasterReturnUrl ?>"><?php echo $Language->Phrase("BackToMasterPage") ?></a></p>
<?php } ?>
<?php include_once "frm_fp_formamaster.php" ?>
<?php
	}
}
?>
...
<?php if ($frm_fp_pbb_detail_target->applicable->Visible) { // applicable ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->applicable) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->applicable->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->applicable) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->applicable->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->applicable->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->applicable->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_pbb_detail_target->target->Visible) { // target ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->target) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->target->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->target) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->target->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->target->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->target->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->t_numerator->Visible) { // t_numerator ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_numerator) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->t_numerator->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_numerator) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->t_numerator->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->t_numerator->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->t_numerator->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->t_denominator->Visible) { // t_denominator ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_denominator) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->t_denominator->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_denominator) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->t_denominator->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->t_denominator->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->t_denominator->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->t_remarks->Visible) { // t_remarks ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_remarks) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->t_remarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->t_remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->t_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->t_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->t_cutOffDate_remarks->Visible) { // t_cutOffDate_remarks ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->t_cutOffDate_remarks) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->t_cutOffDate_remarks->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_fp_pbb_detail_target->accomplishment->Visible) { // accomplishment ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->accomplishment) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->accomplishment->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->accomplishment) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->accomplishment->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->accomplishment->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->accomplishment->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->a_numerator->Visible) { // a_numerator ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_numerator) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_numerator->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_fp_pbb_detail_target->a_denominator->Visible) { // a_denominator ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_denominator) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_denominator->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_denominator) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->a_denominator->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->a_denominator->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->a_denominator->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->a_supporting_docs->Visible) { // a_supporting_docs ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_supporting_docs) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_supporting_docs->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_supporting_docs) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->a_supporting_docs->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->a_supporting_docs->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->a_supporting_docs->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->a_remarks->Visible) { // a_remarks ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_remarks) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_remarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->a_remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->a_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->a_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->a_cutOffDate_remarks->Visible) { // a_cutOffDate_remarks ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_cutOffDate_remarks) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_cutOffDate_remarks->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_fp_pbb_detail_target->a_rating_above_90->Visible) { // a_rating_above_90 ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_rating_above_90) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_rating_above_90->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_fp_pbb_detail_target->a_rating_below_90->Visible) { // a_rating_below_90 ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_rating_below_90) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_rating_below_90->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_rating_below_90) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->a_rating_below_90->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->a_rating_below_90->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->a_rating_below_90->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_pbb_detail_target->a_supporting_docs_comparison->Visible) { // a_supporting_docs_comparison ?>
	<?php if ($frm_fp_pbb_detail_target->SortUrl($frm_fp_pbb_detail_target->a_supporting_docs_comparison) == "") { ?>
		<td><?php echo $frm_fp_pbb_detail_target->a_supporting_docs_comparison->FldCaption() ?></td>
	<?php } else { ?>
...
class cfrm_fp_pbb_detail_target_list {
	...
	function cfrm_fp_pbb_detail_target_list() {
		...
		if (!isset($GLOBALS['frm_fp_completion_status'])) $GLOBALS['frm_fp_completion_status'] = new cfrm_fp_completion_status();

		// Table object (frm_fp_forma)
		if (!isset($GLOBALS['frm_fp_forma'])) $GLOBALS['frm_fp_forma'] = new cfrm_fp_forma();
	...
	function Page_Main() {
		...
		if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
			if ($frm_fp_pbb_detail_target->getCurrentMasterTable() == "frm_fp_completion_status")
				$this->DbMasterFilter = $frm_fp_pbb_detail_target->AddMasterUserIDFilter($this->DbMasterFilter, "frm_fp_completion_status"); // Add master User ID filter
			if ($frm_fp_pbb_detail_target->getCurrentMasterTable() == "frm_fp_forma")
				$this->DbMasterFilter = $frm_fp_pbb_detail_target->AddMasterUserIDFilter($this->DbMasterFilter, "frm_fp_forma"); // Add master User ID filter
		}
		up_AddFilter($sFilter, $this->DbDetailFilter);
		up_AddFilter($sFilter, $this->SearchWhere);

		// Load master record
		if ($frm_fp_pbb_detail_target->getMasterFilter() <> "" && $frm_fp_pbb_detail_target->getCurrentMasterTable() == "frm_fp_completion_status") {
			global $frm_fp_completion_status;
			$rsmaster = $frm_fp_completion_status->LoadRs($this->DbMasterFilter);
			$this->MasterRecordExists = ($rsmaster && !$rsmaster->EOF);
			if (!$this->MasterRecordExists) {
				$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record found
				$this->Page_Terminate($frm_fp_pbb_detail_target->getReturnUrl()); // Return to caller
			} else {
				$frm_fp_completion_status->LoadListRowValues($rsmaster);
				$frm_fp_completion_status->RowType = UP_ROWTYPE_MASTER; // Master row
				$frm_fp_completion_status->RenderListRow();
				$rsmaster->Close();
			}
		}

		// Load master record
		if ($frm_fp_pbb_detail_target->getMasterFilter() <> "" && $frm_fp_pbb_detail_target->getCurrentMasterTable() == "frm_fp_forma") {
			global $frm_fp_forma;
			$rsmaster = $frm_fp_forma->LoadRs($this->DbMasterFilter);
			$this->MasterRecordExists = ($rsmaster && !$rsmaster->EOF);
			if (!$this->MasterRecordExists) {
				$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record found
				$this->Page_Terminate($frm_fp_pbb_detail_target->getReturnUrl()); // Return to caller
			} else {
				$frm_fp_forma->LoadListRowValues($rsmaster);
				$frm_fp_forma->RowType = UP_ROWTYPE_MASTER; // Master row
				$frm_fp_forma->RenderListRow();
				$rsmaster->Close();
			}
		}
	...
	function RenderRow() {
		...
		// pi_question
		$frm_fp_pbb_detail_target->pi_question->CellCssStyle = "width: 400px;";
	...
	function SetUpMasterParms() {
		...
		if (@$_GET[UP_TABLE_SHOW_MASTER] <> "") {
			...
			if ($sMasterTblVar == "frm_fp_completion_status") {
				$bValidMaster = TRUE;
				if (@$_GET["units_id"] <> "") {
					$GLOBALS["frm_fp_completion_status"]->units_id->setQueryStringValue($_GET["units_id"]);
					$frm_fp_pbb_detail_target->units_id->setQueryStringValue($GLOBALS["frm_fp_completion_status"]->units_id->QueryStringValue);
					$frm_fp_pbb_detail_target->units_id->setSessionValue($frm_fp_pbb_detail_target->units_id->QueryStringValue);
					if (!is_numeric($GLOBALS["frm_fp_completion_status"]->units_id->QueryStringValue)) $bValidMaster = FALSE;
				} else {
					$bValidMaster = FALSE;
				}
			}
			if ($sMasterTblVar == "frm_fp_forma") {
				$bValidMaster = TRUE;
				if (@$_GET["Sequence"] <> "") {
					$GLOBALS["frm_fp_forma"]->Sequence->setQueryStringValue($_GET["Sequence"]);
					$frm_fp_pbb_detail_target->mfo_sequence->setQueryStringValue($GLOBALS["frm_fp_forma"]->Sequence->QueryStringValue);
					$frm_fp_pbb_detail_target->mfo_sequence->setSessionValue($frm_fp_pbb_detail_target->mfo_sequence->QueryStringValue);
					if (!is_numeric($GLOBALS["frm_fp_forma"]->Sequence->QueryStringValue)) $bValidMaster = FALSE;
				} else {
					$bValidMaster = FALSE;
				}
			}
