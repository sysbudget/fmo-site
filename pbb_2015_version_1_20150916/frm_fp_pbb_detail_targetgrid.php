...
<?php if ($frm_fp_pbb_detail_target->t_remarks->Visible) { // t_remarks ?>
	...
	<?php } else { ?>
		<td><div>
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->t_remarks->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->t_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->t_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_pbb_detail_target->a_remarks->Visible) { // a_remarks ?>
	...
	<?php } else { ?>
		<td><div>
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_pbb_detail_target->a_remarks->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_fp_pbb_detail_target->a_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_pbb_detail_target->a_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
