...
// Create page object
$frm_fp_units_accomplishment_add = new cfrm_fp_units_accomplishment_add();
$Page =& $frm_fp_units_accomplishment_add;

// Page init
$frm_fp_units_accomplishment_add->Page_Init();

// Page main
$frm_fp_units_accomplishment_add->Page_Main();
?>
...
// Create page object
var frm_fp_units_accomplishment_add = new up_Page("frm_fp_units_accomplishment_add");

// page properties
frm_fp_units_accomplishment_add.PageID = "add"; // page ID
frm_fp_units_accomplishment_add.FormID = "ffrm_fp_units_accomplishmentadd"; // form ID
var UP_PAGE_ID = frm_fp_units_accomplishment_add.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_fp_units_accomplishment_add.ValidateForm = function(fobj) {
...
frm_fp_units_accomplishment_add.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_fp_units_accomplishment_add.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_fp_units_accomplishment_add.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_fp_units_accomplishment_add.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_fp_units_accomplishment->TableCaption() ?></p>
<p class="upbudgetofficeclass"><a href="<?php echo $frm_fp_units_accomplishment->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $frm_fp_units_accomplishment_add->ShowPageHeader(); ?>
<?php
$frm_fp_units_accomplishment_add->ShowMessage();
?>
<form name="ffrm_fp_units_accomplishmentadd" id="ffrm_fp_units_accomplishmentadd" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_fp_units_accomplishment_add.ValidateForm(this);">
<p>
...
<?php
$frm_fp_units_accomplishment_add->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_fp_units_accomplishment_add->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_fp_units_accomplishment_add {
	...
	// Page object name
	var $PageObjName = 'frm_fp_units_accomplishment_add';
	...
	//
	function cfrm_fp_units_accomplishment_add() {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			$frm_fp_units_accomplishment->CurrentAction = $_POST["a_add"]; // Get form action
			$this->CopyRecord = $this->LoadOldRecord(); // Load old recordset
			$this->LoadFormValues(); // Load form values

			// Validate form
			if (!$this->ValidateForm()) {
				$frm_fp_units_accomplishment->CurrentAction = "I"; // Form error, reset action
			...
			if (@$_GET["units_id"] != "") {
				...
				$frm_fp_units_accomplishment->setKey("units_id", $frm_fp_units_accomplishment->units_id->CurrentValue); // Set up key
			} else {
				$frm_fp_units_accomplishment->setKey("units_id", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
				$frm_fp_units_accomplishment->CurrentAction = "C"; // Copy record
			} else {
				$frm_fp_units_accomplishment->CurrentAction = "I"; // Display blank record
		...
		switch ($frm_fp_units_accomplishment->CurrentAction) {
			...
			case "A": // ' Add new record
				$frm_fp_units_accomplishment->SendEmail = TRUE; // Send email on add success
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					$this->setSuccessMessage($Language->Phrase("AddSuccess")); // Set up success message
					$sReturnUrl = $frm_fp_units_accomplishment->getReturnUrl();
					if (up_GetPageName($sReturnUrl) == "frm_fp_units_accomplishmentview.php")
						$sReturnUrl = $frm_fp_units_accomplishment->ViewUrl(); // View paging, return to view page with keyurl directly
		...
		$frm_fp_units_accomplishment->RowType = UP_ROWTYPE_ADD;  // Render add type
	...
	function LoadDefaultValues() {
		...
		$frm_fp_units_accomplishment->unit_id->CurrentValue = NULL;
		$frm_fp_units_accomplishment->unit_id->OldValue = $frm_fp_units_accomplishment->unit_id->CurrentValue;
		$frm_fp_units_accomplishment->cu_sequence->CurrentValue = NULL;
		$frm_fp_units_accomplishment->cu_sequence->OldValue = $frm_fp_units_accomplishment->cu_sequence->CurrentValue;
		$frm_fp_units_accomplishment->cu_short_name->CurrentValue = NULL;
		$frm_fp_units_accomplishment->cu_short_name->OldValue = $frm_fp_units_accomplishment->cu_short_name->CurrentValue;
		$frm_fp_units_accomplishment->cu_unit_name->CurrentValue = NULL;
		$frm_fp_units_accomplishment->cu_unit_name->OldValue = $frm_fp_units_accomplishment->cu_unit_name->CurrentValue;
		$frm_fp_units_accomplishment->unit_name->CurrentValue = NULL;
		$frm_fp_units_accomplishment->unit_name->OldValue = $frm_fp_units_accomplishment->unit_name->CurrentValue;
		$frm_fp_units_accomplishment->unit_name_short->CurrentValue = NULL;
		$frm_fp_units_accomplishment->unit_name_short->OldValue = $frm_fp_units_accomplishment->unit_name_short->CurrentValue;
		$frm_fp_units_accomplishment->personnel_count->CurrentValue = NULL;
		$frm_fp_units_accomplishment->personnel_count->OldValue = $frm_fp_units_accomplishment->personnel_count->CurrentValue;
		$frm_fp_units_accomplishment->mfo_1->CurrentValue = "Y";
		$frm_fp_units_accomplishment->mfo_2->CurrentValue = "Y";
		$frm_fp_units_accomplishment->mfo_3->CurrentValue = "Y";
		$frm_fp_units_accomplishment->mfo_4->CurrentValue = "Y";
		$frm_fp_units_accomplishment->mfo_5->CurrentValue = "Y";
		$frm_fp_units_accomplishment->sto->CurrentValue = "Y";
		$frm_fp_units_accomplishment->gass->CurrentValue = "Y";
		$frm_fp_units_accomplishment->users_name->CurrentValue = NULL;
		$frm_fp_units_accomplishment->users_name->OldValue = $frm_fp_units_accomplishment->users_name->CurrentValue;
		$frm_fp_units_accomplishment->users_nameLast->CurrentValue = NULL;
		$frm_fp_units_accomplishment->users_nameLast->OldValue = $frm_fp_units_accomplishment->users_nameLast->CurrentValue;
		$frm_fp_units_accomplishment->users_nameFirst->CurrentValue = NULL;
		$frm_fp_units_accomplishment->users_nameFirst->OldValue = $frm_fp_units_accomplishment->users_nameFirst->CurrentValue;
		$frm_fp_units_accomplishment->users_nameMiddle->CurrentValue = NULL;
		$frm_fp_units_accomplishment->users_nameMiddle->OldValue = $frm_fp_units_accomplishment->users_nameMiddle->CurrentValue;
		$frm_fp_units_accomplishment->users_userLoginName->CurrentValue = "null";
		$frm_fp_units_accomplishment->users_password->CurrentValue = "null";
		$frm_fp_units_accomplishment->users_email->CurrentValue = NULL;
		$frm_fp_units_accomplishment->users_email->OldValue = $frm_fp_units_accomplishment->users_email->CurrentValue;
		$frm_fp_units_accomplishment->users_contactNo->CurrentValue = NULL;
		$frm_fp_units_accomplishment->users_contactNo->OldValue = $frm_fp_units_accomplishment->users_contactNo->CurrentValue;
		$frm_fp_units_accomplishment->tbl_cutOffDate_id->CurrentValue = NULL;
		$frm_fp_units_accomplishment->tbl_cutOffDate_id->OldValue = $frm_fp_units_accomplishment->tbl_cutOffDate_id->CurrentValue;
		$frm_fp_units_accomplishment->t_cutOffDate->CurrentValue = NULL;
		$frm_fp_units_accomplishment->t_cutOffDate->OldValue = $frm_fp_units_accomplishment->t_cutOffDate->CurrentValue;
		$frm_fp_units_accomplishment->t_cutOffDate_remarks->CurrentValue = NULL;
		$frm_fp_units_accomplishment->t_cutOffDate_remarks->OldValue = $frm_fp_units_accomplishment->t_cutOffDate_remarks->CurrentValue;
	}
	...
	function RenderRow() {
		...
		} elseif ($frm_fp_units_accomplishment->RowType == UP_ROWTYPE_ADD) { // Add row
	...
	function AddRow($rsold = NULL) {
		...
		if ($Security->CurrentUserID() <> "" && !$Security->IsAdmin()) { // Non system admin
			$bValidUser = $Security->IsValidUserID($frm_fp_units_accomplishment->focal_person_id->CurrentValue);
			if (!$bValidUser) {
				$sUserIdMsg = str_replace("%c", CurrentUserID(), $Language->Phrase("UnAuthorizedUserID"));
				$sUserIdMsg = str_replace("%u", $frm_fp_units_accomplishment->focal_person_id->CurrentValue, $sUserIdMsg);
		...
		// focal_person_id
		$frm_fp_units_accomplishment->focal_person_id->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->focal_person_id->CurrentValue, NULL, FALSE);

		// unit_id
		$frm_fp_units_accomplishment->unit_id->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->unit_id->CurrentValue, NULL, FALSE);

		// cu_sequence
		$frm_fp_units_accomplishment->cu_sequence->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->cu_sequence->CurrentValue, NULL, FALSE);

		// cu_short_name
		$frm_fp_units_accomplishment->cu_short_name->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->cu_short_name->CurrentValue, NULL, FALSE);

		// cu_unit_name
		$frm_fp_units_accomplishment->cu_unit_name->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->cu_unit_name->CurrentValue, NULL, FALSE);

		// unit_name
		$frm_fp_units_accomplishment->unit_name->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->unit_name->CurrentValue, NULL, FALSE);

		// unit_name_short
		$frm_fp_units_accomplishment->unit_name_short->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->unit_name_short->CurrentValue, NULL, FALSE);

		// personnel_count
		$frm_fp_units_accomplishment->personnel_count->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->personnel_count->CurrentValue, NULL, FALSE);

		// mfo_1
		$frm_fp_units_accomplishment->mfo_1->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->mfo_1->CurrentValue, NULL, strval($frm_fp_units_accomplishment->mfo_1->CurrentValue) == "");

		// mfo_2
		$frm_fp_units_accomplishment->mfo_2->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->mfo_2->CurrentValue, NULL, strval($frm_fp_units_accomplishment->mfo_2->CurrentValue) == "");

		// mfo_3
		$frm_fp_units_accomplishment->mfo_3->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->mfo_3->CurrentValue, NULL, strval($frm_fp_units_accomplishment->mfo_3->CurrentValue) == "");

		// mfo_4
		$frm_fp_units_accomplishment->mfo_4->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->mfo_4->CurrentValue, NULL, strval($frm_fp_units_accomplishment->mfo_4->CurrentValue) == "");

		// mfo_5
		$frm_fp_units_accomplishment->mfo_5->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->mfo_5->CurrentValue, NULL, strval($frm_fp_units_accomplishment->mfo_5->CurrentValue) == "");

		// sto
		$frm_fp_units_accomplishment->sto->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->sto->CurrentValue, NULL, strval($frm_fp_units_accomplishment->sto->CurrentValue) == "");

		// gass
		$frm_fp_units_accomplishment->gass->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->gass->CurrentValue, NULL, strval($frm_fp_units_accomplishment->gass->CurrentValue) == "");

		// users_name
		$frm_fp_units_accomplishment->users_name->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_name->CurrentValue, NULL, FALSE);

		// users_nameLast
		$frm_fp_units_accomplishment->users_nameLast->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_nameLast->CurrentValue, NULL, FALSE);

		// users_nameFirst
		$frm_fp_units_accomplishment->users_nameFirst->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_nameFirst->CurrentValue, NULL, FALSE);

		// users_nameMiddle
		$frm_fp_units_accomplishment->users_nameMiddle->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_nameMiddle->CurrentValue, NULL, FALSE);

		// users_userLoginName
		$frm_fp_units_accomplishment->users_userLoginName->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_userLoginName->CurrentValue, NULL, strval($frm_fp_units_accomplishment->users_userLoginName->CurrentValue) == "");

		// users_password
		$frm_fp_units_accomplishment->users_password->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_password->CurrentValue, NULL, strval($frm_fp_units_accomplishment->users_password->CurrentValue) == "");

		// users_email
		$frm_fp_units_accomplishment->users_email->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_email->CurrentValue, NULL, FALSE);

		// users_contactNo
		$frm_fp_units_accomplishment->users_contactNo->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->users_contactNo->CurrentValue, NULL, FALSE);

		// tbl_cutOffDate_id
		$frm_fp_units_accomplishment->tbl_cutOffDate_id->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->tbl_cutOffDate_id->CurrentValue, NULL, FALSE);

		// t_cutOffDate
		$frm_fp_units_accomplishment->t_cutOffDate->SetDbValueDef($rsnew, up_UnFormatDateTime($frm_fp_units_accomplishment->t_cutOffDate->CurrentValue, 6), NULL, FALSE);

		// t_cutOffDate_remarks
		$frm_fp_units_accomplishment->t_cutOffDate_remarks->SetDbValueDef($rsnew, $frm_fp_units_accomplishment->t_cutOffDate_remarks->CurrentValue, NULL, FALSE);

		// Call Row Inserting event
		$rs = ($rsold == NULL) ? NULL : $rsold->fields;
		$bInsertRow = $frm_fp_units_accomplishment->Row_Inserting($rs, $rsnew);
		if ($bInsertRow) {
			$conn->raiseErrorFn = 'up_ErrorFn';
			$AddRow = $conn->Execute($frm_fp_units_accomplishment->InsertSQL($rsnew));
			$conn->raiseErrorFn = '';
		} else {
		...
		if ($AddRow) {
			$frm_fp_units_accomplishment->units_id->setDbValue($conn->Insert_ID());
			$rsnew['units_id'] = $frm_fp_units_accomplishment->units_id->DbValue;
		}
		if ($AddRow) {

			// Call Row Inserted event
			$rs = ($rsold == NULL) ? NULL : $rsold->fields;
			$frm_fp_units_accomplishment->Row_Inserted($rs, $rsnew);
		}
		return $AddRow;
	}
