...
//
// Table class for rep_3_1_forma
//
class crep_3_1_forma {
	var $TableVar = 'rep_3_1_forma';
	...
	//
	function crep_3_1_forma() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// Sequence
		$this->Sequence = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_Sequence', 'Sequence', '`Sequence`', 3, -1, FALSE, '`Sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sequence'] =& $this->Sequence;

		// MFO
		$this->MFO = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// Sum / Avg
		$this->Sum_2F_Avg = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_Sum_2F_Avg', 'Sum / Avg', '`Sum / Avg`', 5, -1, FALSE, '`Sum / Avg`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sum_2F_Avg->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Sum / Avg'] =& $this->Sum_2F_Avg;

		// GAA
		$this->GAA = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_GAA', 'GAA', '`GAA`', 5, -1, FALSE, '`GAA`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->GAA->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['GAA'] =& $this->GAA;

		// Remarks
		$this->Remarks = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks'] =& $this->Remarks;

		// Participating Units Count
		$this->Participating_Units_Count = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_Participating_Units_Count', 'Participating Units Count', '`Participating Units Count`', 20, -1, FALSE, '`Participating Units Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Participating Units
		$this->Participating_Units = new cField('rep_3_1_forma', 'rep_3_1_forma', 'x_Participating_Units', 'Participating Units', '`Participating Units`', 201, -1, FALSE, '`Participating Units`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "rep_3_1_forma_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `rep_3_1_forma` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `rep_3_1_forma` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `rep_3_1_forma` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("rep_3_1_formaview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "rep_3_1_formaadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("rep_3_1_formaedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("rep_3_1_formaadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("rep_3_1_formadelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=rep_3_1_forma" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
