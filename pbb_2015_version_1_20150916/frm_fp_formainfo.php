...
//
// Table class for frm_fp_forma
//
class cfrm_fp_forma {
	var $TableVar = 'frm_fp_forma';
	...
	//
	function cfrm_fp_forma() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// id
		$this->id = new cField('frm_fp_forma', 'frm_fp_forma', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_fp_forma', 'frm_fp_forma', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// CU Office
		$this->CU_Office = new cField('frm_fp_forma', 'frm_fp_forma', 'x_CU_Office', 'CU Office', '`CU Office`', 200, -1, FALSE, '`CU Office`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU Office'] =& $this->CU_Office;

		// Sequence
		$this->Sequence = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Sequence', 'Sequence', '`Sequence`', 3, -1, FALSE, '`Sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sequence'] =& $this->Sequence;

		// MFO
		$this->MFO = new cField('frm_fp_forma', 'frm_fp_forma', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// Participating Units Count
		$this->Participating_Units_Count = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Participating_Units_Count', 'Participating Units Count', '`Participating Units Count`', 3, -1, FALSE, '`Participating Units Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Target
		$this->Target = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Target', 'Target', '`Target`', 5, -1, FALSE, '`Target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target'] =& $this->Target;

		// Numerator (T)
		$this->Numerator_28T29 = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Numerator_28T29', 'Numerator (T)', '`Numerator (T)`', 5, -1, FALSE, '`Numerator (T)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator_28T29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator (T)'] =& $this->Numerator_28T29;

		// Denominator (T)
		$this->Denominator_28T29 = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Denominator_28T29', 'Denominator (T)', '`Denominator (T)`', 5, -1, FALSE, '`Denominator (T)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Denominator_28T29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Denominator (T)'] =& $this->Denominator_28T29;

		// Accomplishment
		$this->Accomplishment = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Accomplishment', 'Accomplishment', '`Accomplishment`', 5, -1, FALSE, '`Accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Accomplishment'] =& $this->Accomplishment;

		// Numerator (A)
		$this->Numerator_28A29 = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Numerator_28A29', 'Numerator (A)', '`Numerator (A)`', 5, -1, FALSE, '`Numerator (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator_28A29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator (A)'] =& $this->Numerator_28A29;

		// Denominator (A)
		$this->Denominator_28A29 = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Denominator_28A29', 'Denominator (A)', '`Denominator (A)`', 5, -1, FALSE, '`Denominator (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Supporting_Documents_Count = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Supporting_Documents_Count', 'Supporting Documents Count', '`Supporting Documents Count`', 3, -1, FALSE, '`Supporting Documents Count`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Supporting_Documents_Count->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Supporting Documents Count'] =& $this->Supporting_Documents_Count;

		// Rating
		$this->Rating = new cField('frm_fp_forma', 'frm_fp_forma', 'x_Rating', 'Rating', '`Rating`', 5, -1, FALSE, '`Rating`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlOrderBy() { // Order By
		return "`CU Office` ASC,`Sequence` ASC";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_fp_forma` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_fp_forma` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_fp_forma` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_fp_formaview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_fp_formaadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_fp_formaedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_fp_formaedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_fp_formaadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_fp_formaadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_fp_formadelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_fp_forma" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_fp_forma` WHERE " . $this->AddUserIDFilter("");
