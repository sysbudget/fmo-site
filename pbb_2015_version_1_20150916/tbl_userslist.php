...
<?php if ($tbl_users->users_ID->Visible) { // users_ID ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_ID) == "") { ?>
		<td><?php echo $tbl_users->users_ID->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_ID) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_ID->FldCaption() ?></td><td style="width: 10px;"><?php if ($tbl_users->users_ID->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_ID->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->cu->Visible) { // cu ?>
	<?php if ($tbl_users->SortUrl($tbl_users->cu) == "") { ?>
		<td><?php echo $tbl_users->cu->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->cu) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->cu->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->cu->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->cu->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->units_id->Visible) { // units_id ?>
	<?php if ($tbl_users->SortUrl($tbl_users->units_id) == "") { ?>
		<td><?php echo $tbl_users->units_id->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->units_id) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->units_id->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->units_id->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->units_id->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->cu_unit_name->Visible) { // cu_unit_name ?>
	<?php if ($tbl_users->SortUrl($tbl_users->cu_unit_name) == "") { ?>
		<td><?php echo $tbl_users->cu_unit_name->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->cu_unit_name) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->cu_unit_name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->cu_unit_name->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->cu_unit_name->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_name->Visible) { // users_name ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_name) == "") { ?>
		<td><?php echo $tbl_users->users_name->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_name) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_name->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_name->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_name->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_nameLast->Visible) { // users_nameLast ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_nameLast) == "") { ?>
		<td><?php echo $tbl_users->users_nameLast->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_nameLast) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_nameLast->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_nameLast->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_nameLast->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_nameFirst->Visible) { // users_nameFirst ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_nameFirst) == "") { ?>
		<td><?php echo $tbl_users->users_nameFirst->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_nameFirst) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_nameFirst->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_nameFirst->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_nameFirst->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_nameMiddle->Visible) { // users_nameMiddle ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_nameMiddle) == "") { ?>
		<td><?php echo $tbl_users->users_nameMiddle->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_nameMiddle) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_nameMiddle->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_nameMiddle->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_nameMiddle->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_userLoginName->Visible) { // users_userLoginName ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_userLoginName) == "") { ?>
		<td><?php echo $tbl_users->users_userLoginName->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_userLoginName) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_userLoginName->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_userLoginName->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_userLoginName->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_password->Visible) { // users_password ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_password) == "") { ?>
		<td><?php echo $tbl_users->users_password->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_password) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_password->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_password->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_password->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_userLevel->Visible) { // users_userLevel ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_userLevel) == "") { ?>
		<td><?php echo $tbl_users->users_userLevel->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_userLevel) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_userLevel->FldCaption() ?></td><td style="width: 10px;"><?php if ($tbl_users->users_userLevel->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_userLevel->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_email->Visible) { // users_email ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_email) == "") { ?>
		<td><?php echo $tbl_users->users_email->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_email) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_email->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_email->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_email->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($tbl_users->users_contactNo->Visible) { // users_contactNo ?>
	<?php if ($tbl_users->SortUrl($tbl_users->users_contactNo) == "") { ?>
		<td><?php echo $tbl_users->users_contactNo->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $tbl_users->SortUrl($tbl_users->users_contactNo) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $tbl_users->users_contactNo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($tbl_users->users_contactNo->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($tbl_users->users_contactNo->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<div<?php echo $tbl_users->cu->ViewAttributes() ?>><?php echo $tbl_users->cu->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($tbl_users->units_id->Visible) { // units_id ?>
		<td<?php echo $tbl_users->units_id->CellAttributes() ?>>
<div<?php echo $tbl_users->units_id->ViewAttributes() ?>><?php echo $tbl_users->units_id->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($tbl_users->cu_unit_name->Visible) { // cu_unit_name ?>
		<td<?php echo $tbl_users->cu_unit_name->CellAttributes() ?>>
<div<?php echo $tbl_users->cu_unit_name->ViewAttributes() ?>><?php echo $tbl_users->cu_unit_name->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($tbl_users->users_name->Visible) { // users_name ?>
...
<div<?php echo $tbl_users->users_nameLast->ViewAttributes() ?>><?php echo $tbl_users->users_nameLast->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($tbl_users->users_nameFirst->Visible) { // users_nameFirst ?>
		<td<?php echo $tbl_users->users_nameFirst->CellAttributes() ?>>
<div<?php echo $tbl_users->users_nameFirst->ViewAttributes() ?>><?php echo $tbl_users->users_nameFirst->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($tbl_users->users_nameMiddle->Visible) { // users_nameMiddle ?>
		<td<?php echo $tbl_users->users_nameMiddle->CellAttributes() ?>>
<div<?php echo $tbl_users->users_nameMiddle->ViewAttributes() ?>><?php echo $tbl_users->users_nameMiddle->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($tbl_users->users_userLoginName->Visible) { // users_userLoginName ?>
...
class ctbl_users_list {
	...
	function BasicSearchSQL($Keyword) {
		...
		$sWhere = "";
		$this->BuildBasicSearchSQL($sWhere, $tbl_users->cu, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $tbl_users->units_id, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $tbl_users->cu_unit_name, $Keyword);
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$tbl_users->UpdateSort($tbl_users->cu); // cu
			$tbl_users->UpdateSort($tbl_users->units_id); // units_id
			$tbl_users->UpdateSort($tbl_users->cu_unit_name); // cu_unit_name
			$tbl_users->UpdateSort($tbl_users->users_name); // users_name
			$tbl_users->UpdateSort($tbl_users->users_nameLast); // users_nameLast
			$tbl_users->UpdateSort($tbl_users->users_nameFirst); // users_nameFirst
			$tbl_users->UpdateSort($tbl_users->users_nameMiddle); // users_nameMiddle
	...
	function ResetCmd() {
		...
		if (@$_GET["cmd"] <> "") {
			...
			if (strtolower($sCmd) == "resetsort") {
				...
				$tbl_users->cu->setSort("");
				$tbl_users->units_id->setSort("");
				$tbl_users->cu_unit_name->setSort("");
				$tbl_users->users_name->setSort("");
				$tbl_users->users_nameLast->setSort("");
				$tbl_users->users_nameFirst->setSort("");
				$tbl_users->users_nameMiddle->setSort("");
	...
	function ShowOptionLink() {
		...
		if ($Security->IsLoggedIn()) {
			if (!$Security->IsAdmin()) {
				return $Security->IsValidUserID($tbl_users->units_id->CurrentValue);
			}
		}
		return TRUE;
	}
