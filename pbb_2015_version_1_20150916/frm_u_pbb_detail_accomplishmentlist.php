...
<a class="upGridLink" href="" onclick="up_SubmitSelected(document.ffrm_u_pbb_detail_accomplishmentlist, '<?php echo $frm_u_pbb_detail_accomplishment_list->MultiDeleteUrl ?>');return false;"><?php echo $Language->Phrase("DeleteSelectedLink") ?></a>&nbsp;&nbsp;
<?php } ?>
<?php } ?>
</span>
</div>
...
<?php if ($frm_u_pbb_detail_accomplishment->target->Visible) { // target ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->target) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->target->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->target) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->target->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->target->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->target->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->t_numerator->Visible) { // t_numerator ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_numerator) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->t_numerator->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_u_pbb_detail_accomplishment->t_denominator->Visible) { // t_denominator ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_denominator) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->t_denominator->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_denominator) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->t_denominator->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->t_denominator->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->t_denominator->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->t_remarks->Visible) { // t_remarks ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_remarks) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->t_remarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->t_remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->t_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->t_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->Visible) { // t_cutOffDate_remarks ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->accomplishment->Visible) { // accomplishment ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->accomplishment) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->accomplishment->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->accomplishment) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->accomplishment->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->accomplishment->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->accomplishment->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_numerator->Visible) { // a_numerator ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_numerator) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_numerator->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_u_pbb_detail_accomplishment->a_denominator->Visible) { // a_denominator ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_denominator) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_denominator->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_denominator) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_denominator->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_denominator->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_denominator->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_supporting_docs->Visible) { // a_supporting_docs ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_supporting_docs) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_supporting_docs) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_supporting_docs->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_supporting_docs->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_remarks->Visible) { // a_remarks ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_remarks) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_remarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_rating_above_90->Visible) { // a_rating_above_90 ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_rating_above_90) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_rating_above_90->FldCaption() ?></td>
	<?php } else { ?>
...
<?php if ($frm_u_pbb_detail_accomplishment->a_rating_below_90->Visible) { // a_rating_below_90 ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_rating_below_90) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_rating_below_90->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_rating_below_90) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_rating_below_90->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_rating_below_90->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_rating_below_90->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks->Visible) { // a_cutOffDate_remarks ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_cutOffDate_remarks->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison->Visible) { // a_supporting_docs_comparison ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_supporting_docs_comparison->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->cutOffDate_id->Visible) { // cutOffDate_id ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->cutOffDate_id) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->cutOffDate_id->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->cutOffDate_id) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->cutOffDate_id->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->cutOffDate_id->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->cutOffDate_id->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->mfo_name_rep->Visible) { // mfo_name_rep ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->mfo_name_rep) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->mfo_name_rep->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->mfo_name_rep) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->mfo_name_rep->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->mfo_name_rep->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->mfo_name_rep->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->Visible) { // t_cutOffDate_fp ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->Visible) { // a_cutOffDate_fp ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->FldCaption() ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($frm_u_pbb_detail_accomplishment->applicable->Visible) { // applicable ?>
	<?php if ($frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->applicable) == "") { ?>
		<td><?php echo $frm_u_pbb_detail_accomplishment->applicable->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_u_pbb_detail_accomplishment->SortUrl($frm_u_pbb_detail_accomplishment->applicable) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_u_pbb_detail_accomplishment->applicable->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_u_pbb_detail_accomplishment->applicable->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_u_pbb_detail_accomplishment->applicable->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_u_pbb_detail_accomplishment->accomplishment->Visible) { // accomplishment ?>
...
<div<?php echo $frm_u_pbb_detail_accomplishment->cutOffDate_id->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->cutOffDate_id->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_u_pbb_detail_accomplishment->mfo_name_rep->Visible) { // mfo_name_rep ?>
		<td<?php echo $frm_u_pbb_detail_accomplishment->mfo_name_rep->CellAttributes() ?>>
<div<?php echo $frm_u_pbb_detail_accomplishment->mfo_name_rep->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->mfo_name_rep->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->Visible) { // t_cutOffDate_fp ?>
		<td<?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->CellAttributes() ?>>
<div<?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->Visible) { // a_cutOffDate_fp ?>
		<td<?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->CellAttributes() ?>>
<div<?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_u_pbb_detail_accomplishment->applicable->Visible) { // applicable ?>
		<td<?php echo $frm_u_pbb_detail_accomplishment->applicable->CellAttributes() ?>>
<div<?php echo $frm_u_pbb_detail_accomplishment->applicable->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->applicable->ListViewValue() ?></div>
</td>
	<?php } ?>
<?php
...
class cfrm_u_pbb_detail_accomplishment_list {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_u_pbb_detail_accomplishment->mfo_name_rep, $Keyword);
		$this->BuildBasicSearchSQL($sWhere, $frm_u_pbb_detail_accomplishment->applicable, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$frm_u_pbb_detail_accomplishment->UpdateSort($frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks); // t_cutOffDate_remarks
			...
			$frm_u_pbb_detail_accomplishment->UpdateSort($frm_u_pbb_detail_accomplishment->cutOffDate_id); // cutOffDate_id
			$frm_u_pbb_detail_accomplishment->UpdateSort($frm_u_pbb_detail_accomplishment->mfo_name_rep); // mfo_name_rep
			$frm_u_pbb_detail_accomplishment->UpdateSort($frm_u_pbb_detail_accomplishment->t_cutOffDate_fp); // t_cutOffDate_fp
			$frm_u_pbb_detail_accomplishment->UpdateSort($frm_u_pbb_detail_accomplishment->a_cutOffDate_fp); // a_cutOffDate_fp
			$frm_u_pbb_detail_accomplishment->UpdateSort($frm_u_pbb_detail_accomplishment->applicable); // applicable
	...
	function ResetCmd() {
		...
		if (@$_GET["cmd"] <> "") {
			...
			if (strtolower($sCmd) == "resetsort") {
				...
				$frm_u_pbb_detail_accomplishment->t_cutOffDate_remarks->setSort("");
				...
				$frm_u_pbb_detail_accomplishment->cutOffDate_id->setSort("");
				$frm_u_pbb_detail_accomplishment->mfo_name_rep->setSort("");
				$frm_u_pbb_detail_accomplishment->t_cutOffDate_fp->setSort("");
				$frm_u_pbb_detail_accomplishment->a_cutOffDate_fp->setSort("");
				$frm_u_pbb_detail_accomplishment->applicable->setSort("");
			}
	...
	function SetupListOptions() {
		...
		$item->OnLeft = TRUE;
		$item->Header = "<input type=\"checkbox\" name=\"key\" id=\"key\" class=\"upbudgetofficeclass\" onclick=\"frm_u_pbb_detail_accomplishment_list.SelectAllKey(this);\">";
		$item->MoveTo(0);
	...
	function RenderListOptions() {
		...
		if ($Security->CanDelete() && $this->ShowOptionLink() && $oListOpt->Visible)
			$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" id=\"key_m[]\" value=\"" . up_HtmlEncode($frm_u_pbb_detail_accomplishment->pbb_id->CurrentValue) . "\" class=\"upbudgetofficeclass\" onclick='up_ClickMultiCheckbox(this);'>";
