...
class ctbl_collectionperiod {
	...
	function ctbl_collectionperiod() {
		...
		// cu
		$this->cu = new cField('tbl_collectionperiod', 'tbl_collectionperiod', 'x_cu', 'cu', '`cu`', 3, -1, FALSE, '`cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu'] =& $this->cu;

		// unitID
		$this->unitID = new cField('tbl_collectionperiod', 'tbl_collectionperiod', 'x_unitID', 'unitID', '`unitID`', 3, -1, FALSE, '`unitID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->unitID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unitID'] =& $this->unitID;

		// collectionPeriod_ay
		$this->collectionPeriod_ay = new cField('tbl_collectionperiod', 'tbl_collectionperiod', 'x_collectionPeriod_ay', 'collectionPeriod_ay', '`collectionPeriod_ay`', 3, -1, FALSE, '`collectionPeriod_ay`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->collectionPeriod_sem = new cField('tbl_collectionperiod', 'tbl_collectionperiod', 'x_collectionPeriod_sem', 'collectionPeriod_sem', '`collectionPeriod_sem`', 3, -1, FALSE, '`collectionPeriod_sem`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// academicYear_ID
		$this->academicYear_ID = new cField('tbl_collectionperiod', 'tbl_collectionperiod', 'x_academicYear_ID', 'academicYear_ID', '`academicYear_ID`', 3, -1, FALSE, '`academicYear_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->collectionPeriod_status = new cField('tbl_collectionperiod', 'tbl_collectionperiod', 'x_collectionPeriod_status', 'collectionPeriod_status', '`collectionPeriod_status`', 3, -1, FALSE, '`collectionPeriod_status`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "tbl_profile") {
			$sDetailUrl = $GLOBALS["tbl_profile"]->ListUrl() . "?showmaster=" . $this->TableVar;
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			...
			return $this->KeyUrl("tbl_collectionperiodedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			...
			return $this->KeyUrl("tbl_collectionperiodadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `tbl_collectionperiod` WHERE " . $this->AddUserIDFilter("");
