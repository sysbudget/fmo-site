...
/**
 * FacultyProfile V1 configuration file
 */
...
define("UP_DEFAULT_DATE_FORMAT", "mm/dd/yyyy", TRUE); // Default date format
define("UP_DEFAULT_DATE_FORMAT_ID", "6", TRUE); // Default date format
define("UP_DATE_SEPARATOR", "/", TRUE); // Date separator
define("UP_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("UP_PROJECT_NAME", "db_facultyprofile_web_2D_20130515", TRUE); // Project name
define("UP_RANDOM_KEY", 'ysnUUYpr5ToetZTt', TRUE); // Random key for encryption
define("UP_PROJECT_STYLESHEET_FILENAME", "phpcss/db_facultyprofile_web_2D_20130515.css", TRUE); // Project stylesheet file name
define("UP_CHARSET", "utf8", TRUE); // Project charset changed from none to utf8 by Tracy Nov 12, 2015
...
define("UP_CONN_USER", 'prod_fpweb', TRUE);
define("UP_CONN_PASS", 'isk0n6bayan', TRUE);
define("UP_CONN_DB", 'db_facultyprofile_web', TRUE);
 ...
 */
define("UP_MYSQL_CHARSET", "utf8", TRUE); // Project charset changed from none to utf8 by Tracy Nov 12, 2015
...
// Table parameters
define("UP_TABLE_PREFIX", "||UPFacultyProfileReport||", TRUE);
...
// Audit Trail
define("UP_AUDIT_TRAIL_TO_DATABASE", TRUE, TRUE); // Write audit trail to DB
define("UP_AUDIT_TRAIL_TABLE_NAME", "tbl_audittrail", TRUE); // Audit trail table name
define("UP_AUDIT_TRAIL_FIELD_NAME_DATETIME", "datetime", TRUE); // Audit trail DateTime field name
define("UP_AUDIT_TRAIL_FIELD_NAME_SCRIPT", "script", TRUE); // Audit trail Script field name
define("UP_AUDIT_TRAIL_FIELD_NAME_USER", "user", TRUE); // Audit trail User field name
define("UP_AUDIT_TRAIL_FIELD_NAME_ACTION", "action", TRUE); // Audit trail Action field name
define("UP_AUDIT_TRAIL_FIELD_NAME_TABLE", "table", TRUE); // Audit trail Table field name
define("UP_AUDIT_TRAIL_FIELD_NAME_FIELD", "field", TRUE); // Audit trail Field field name
define("UP_AUDIT_TRAIL_FIELD_NAME_KEYVALUE", "keyvalue", TRUE); // Audit trail Key Value field name
define("UP_AUDIT_TRAIL_FIELD_NAME_OLDVALUE", "oldvalue", TRUE); // Audit trail Old Value field name
define("UP_AUDIT_TRAIL_FIELD_NAME_NEWVALUE", "newvalue", TRUE); // Audit trail New Value field name

// Security
define("UP_ADMIN_USER_NAME", "administrator", TRUE); // Administrator user name
define("UP_ADMIN_PASSWORD", "fyt4urrytm@n", TRUE); // Administrator password
define("UP_USE_CUSTOM_LOGIN", TRUE, TRUE); // Use custom login

// Compatibility with UPFacultyProfile Report 3 only
...
define("UP_AUTO_SUGGEST_MAX_ENTRIES", 15, TRUE);
...
?>
<?php
define("UP_ROWTYPE_PREVIEW", 11, TRUE); // Preview record
?>
<?php
define("UP_CAPTCHA_FONT", "aftershock.ttf", TRUE);
?>
<?php
define("UP_PDF_STYLESHEET_FILENAME", "phpcss/uppdf.css", TRUE); // export PDF CSS styles
define("UP_PDF_MEMORY_LIMIT", "128M", TRUE); // Memory limit
define("UP_PDF_TIME_LIMIT", 120, TRUE); // Time limit
?>
