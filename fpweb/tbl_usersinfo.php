...
class ctbl_users {
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "view_tbl_uporgchart_cu_users") {
	...
	// Master filter
	function SqlMasterFilter_view_tbl_uporgchart_cu_users() {
		return "`code`='@code@'";
	}

	// Detail filter
	function SqlDetailFilter_view_tbl_uporgchart_cu_users() {
		return "`cu`='@cu@'";
	}
...
//			$AddUrl .= "?" . $sUrlParm;
   ...
   // Common render codes
		...
		$this->users_ID->CellCssStyle = "white-space: nowrap;";
		...
		// users_name
		$this->users_name->CellCssStyle = "white-space: nowrap;";

		// users_nameLast
		$this->users_nameLast->CellCssStyle = "white-space: nowrap;";

		// users_nameFirst
		$this->users_nameFirst->CellCssStyle = "white-space: nowrap;";

		// users_nameMiddle
		$this->users_nameMiddle->CellCssStyle = "white-space: nowrap;";

		// users_userLoginName
		$this->users_userLoginName->CellCssStyle = "white-space: nowrap;";

		// users_password
		$this->users_password->CellCssStyle = "white-space: nowrap;";

		// users_userLevel
		$this->users_userLevel->CellCssStyle = "white-space: nowrap;";

		// users_email
		$this->users_email->CellCssStyle = "white-space: nowrap;";

		// users_contactNo
		$this->users_contactNo->CellCssStyle = "white-space: nowrap;";
		...
		$sSqlWrk .= " ORDER BY `cuUnitName` Asc";
			$rswrk = $conn->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->unitID->ViewValue = $rswrk->fields('cuUnitName');
				$rswrk->Close();
			} else {
