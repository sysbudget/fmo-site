...
<input type="password" name="x_users_password" id="x_users_password" size="30" maxlength="15"<?php echo $tbl_users->users_password->EditAttributes() ?>>
...
<?php if (strval($tbl_users->cu->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_cu" id="x_cu" value="<?php echo up_HtmlEncode(strval($tbl_users->cu->getSessionValue())) ?>">
<?php } ?>
<p>
