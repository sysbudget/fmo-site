...
/**
 * MySQL API for FacultyProfile V1
 ...
 */
$UPFacultyProfile_vers = 'University of the Philippines (C) 2013 UP Budget Office Technology Limited';
...
class ADOConnection
{
	...
	/**
	 * Returns floating point version number of UPFacultyProfile
	 * Usage: $db->Version();
	 * 
	 * @access public 
	 */
	...
	function Version()
	{
		global $UPFacultyProfile_vers;
		return (float) substr($UPFacultyProfile_vers,1);
	}
