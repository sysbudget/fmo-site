...
$tbl_uporgchart_cu = NULL;

//
// Table class for tbl_uporgchart_cu
//
class ctbl_uporgchart_cu {
	var $TableVar = 'tbl_uporgchart_cu';
	...
	//
	function ctbl_uporgchart_cu() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// ID
		$this->ID = new cField('tbl_uporgchart_cu', 'tbl_uporgchart_cu', 'x_ID', 'ID', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] =& $this->ID;

		// code
		$this->code = new cField('tbl_uporgchart_cu', 'tbl_uporgchart_cu', 'x_code', 'code', '`code`', 200, -1, FALSE, '`code`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['code'] =& $this->code;

		// shortName
		$this->shortName = new cField('tbl_uporgchart_cu', 'tbl_uporgchart_cu', 'x_shortName', 'shortName', '`shortName`', 200, -1, FALSE, '`shortName`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['shortName'] =& $this->shortName;

		// name
		$this->name = new cField('tbl_uporgchart_cu', 'tbl_uporgchart_cu', 'x_name', 'name', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['name'] =& $this->name;

		// acronym
		$this->acronym = new cField('tbl_uporgchart_cu', 'tbl_uporgchart_cu', 'x_acronym', 'acronym', '`acronym`', 200, -1, FALSE, '`acronym`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['acronym'] =& $this->acronym;

		// address
		$this->address = new cField('tbl_uporgchart_cu', 'tbl_uporgchart_cu', 'x_address', 'address', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "tbl_uporgchart_cu_Highlight";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "tbl_uporgchart_unit") {
			$sDetailUrl = $GLOBALS["tbl_uporgchart_unit"]->ListUrl() . "?showmaster=" . $this->TableVar;
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tbl_uporgchart_cu` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `tbl_uporgchart_cu` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `tbl_uporgchart_cu` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_uporgchart_culist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tbl_uporgchart_cuview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tbl_uporgchart_cuadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbl_uporgchart_cuedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbl_uporgchart_cuedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("tbl_uporgchart_cuadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("tbl_uporgchart_cuadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tbl_uporgchart_cudelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tbl_uporgchart_cu" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
