...
class ctbl_profile {
	...
	function ctbl_profile() {
		...
		// facultyprofile_ID
		$this->facultyprofile_ID = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_ID', 'facultyprofile_ID', '`facultyprofile_ID`', 3, -1, FALSE, '`facultyprofile_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// faculty_ID
		$this->faculty_ID = new cField('tbl_profile', 'tbl_profile', 'x_faculty_ID', 'faculty_ID', '`faculty_ID`', 3, -1, FALSE, '`faculty_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->faculty_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['faculty_ID'] =& $this->faculty_ID;

		// faculty_name
		$this->faculty_name = new cField('tbl_profile', 'tbl_profile', 'x_faculty_name', 'faculty_name', '`faculty_name`', 200, -1, FALSE, '`faculty_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['faculty_name'] =& $this->faculty_name;

		// collectionPeriod_ID
		$this->collectionPeriod_ID = new cField('tbl_profile', 'tbl_profile', 'x_collectionPeriod_ID', 'collectionPeriod_ID', '`collectionPeriod_ID`', 3, -1, FALSE, '`collectionPeriod_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// cu
		$this->cu = new cField('tbl_profile', 'tbl_profile', 'x_cu', 'cu', '`cu`', 5, -1, FALSE, '`cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['cu'] =& $this->cu;

		// collectionPeriod_ay
		$this->collectionPeriod_ay = new cField('tbl_profile', 'tbl_profile', 'x_collectionPeriod_ay', 'collectionPeriod_ay', '`collectionPeriod_ay`', 3, -1, FALSE, '`collectionPeriod_ay`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->collectionPeriod_sem = new cField('tbl_profile', 'tbl_profile', 'x_collectionPeriod_sem', 'collectionPeriod_sem', '`collectionPeriod_sem`', 3, -1, FALSE, '`collectionPeriod_sem`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->collectionPeriod_cutOffDate = new cField('tbl_profile', 'tbl_profile', 'x_collectionPeriod_cutOffDate', 'collectionPeriod_cutOffDate', '`collectionPeriod_cutOffDate`', 135, 6, FALSE, '`collectionPeriod_cutOffDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// unitID
		$this->unitID = new cField('tbl_profile', 'tbl_profile', 'x_unitID', 'unitID', '`unitID`', 3, -1, FALSE, '`unitID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->unitID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unitID'] =& $this->unitID;

		// facultyprofile_homeUnit_ID
		$this->facultyprofile_homeUnit_ID = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_homeUnit_ID', 'facultyprofile_homeUnit_ID', '`facultyprofile_homeUnit_ID`', 3, -1, FALSE, '`facultyprofile_homeUnit_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_isHomeUnit = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_isHomeUnit', 'facultyprofile_isHomeUnit', '`facultyprofile_isHomeUnit`', 200, -1, FALSE, '`facultyprofile_isHomeUnit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['facultyprofile_isHomeUnit'] =& $this->facultyprofile_isHomeUnit;

		// facultyGroup_CHEDCode
		$this->facultyGroup_CHEDCode = new cField('tbl_profile', 'tbl_profile', 'x_facultyGroup_CHEDCode', 'facultyGroup_CHEDCode', '`facultyGroup_CHEDCode`', 200, -1, FALSE, '`facultyGroup_CHEDCode`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['facultyGroup_CHEDCode'] =& $this->facultyGroup_CHEDCode;

		// facultyRank_ID
		$this->facultyRank_ID = new cField('tbl_profile', 'tbl_profile', 'x_facultyRank_ID', 'facultyRank_ID', '`facultyRank_ID`', 3, -1, FALSE, '`facultyRank_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->facultyRank_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['facultyRank_ID'] =& $this->facultyRank_ID;

		// facultyprofile_sg
		$this->facultyprofile_sg = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_sg', 'facultyprofile_sg', '`facultyprofile_sg`', 3, -1, FALSE, '`facultyprofile_sg`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_annualSalary = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_annualSalary', 'facultyprofile_annualSalary', '`facultyprofile_annualSalary`', 5, -1, FALSE, '`facultyprofile_annualSalary`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// facultyprofile_fte
		$this->facultyprofile_fte = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_fte', 'facultyprofile_fte', '`facultyprofile_fte`', 5, -1, FALSE, '`facultyprofile_fte`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_tenureCode = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_tenureCode', 'facultyprofile_tenureCode', '`facultyprofile_tenureCode`', 3, -1, FALSE, '`facultyprofile_tenureCode`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_leaveCode = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_leaveCode', 'facultyprofile_leaveCode', '`facultyprofile_leaveCode`', 3, -1, FALSE, '`facultyprofile_leaveCode`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_disCHED_disciplineMajorCode_gen = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_disCHED_disciplineMajorCode_gen', 'facultyprofile_disCHED_disciplineMajorCode_gen', '`facultyprofile_disCHED_disciplineMajorCode_gen`', 3, -1, FALSE, '`facultyprofile_disCHED_disciplineMajorCode_gen`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->disCHED_disciplineCode_gen = new cField('tbl_profile', 'tbl_profile', 'x_disCHED_disciplineCode_gen', 'disCHED_disciplineCode_gen', '`disCHED_disciplineCode_gen`', 3, -1, FALSE, '`disCHED_disciplineCode_gen`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_specificDiscipline_1_primaryTeachingLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_specificDiscipline_1_primaryTeachingLoad', 'facultyprofile_specificDiscipline_1_primaryTeachingLoad', '`facultyprofile_specificDiscipline_1_primaryTeachingLoad`', 3, -1, FALSE, '`facultyprofile_specificDiscipline_1_primaryTeachingLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_specificDiscipline_2_primaryTeachingLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_specificDiscipline_2_primaryTeachingLoad', 'facultyprofile_specificDiscipline_2_primaryTeachingLoad', '`facultyprofile_specificDiscipline_2_primaryTeachingLoad`', 3, -1, FALSE, '`facultyprofile_specificDiscipline_2_primaryTeachingLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labHrs_basic = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labHrs_basic', 'facultyprofile_labHrs_basic', '`facultyprofile_labHrs_basic`', 5, -1, FALSE, '`facultyprofile_labHrs_basic`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecHrs_basic = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecHrs_basic', 'facultyprofile_lecHrs_basic', '`facultyprofile_lecHrs_basic`', 5, -1, FALSE, '`facultyprofile_lecHrs_basic`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalHrs_basic = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalHrs_basic', 'facultyprofile_totalHrs_basic', '`facultyprofile_totalHrs_basic`', 5, -1, FALSE, '`facultyprofile_totalHrs_basic`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labSCH_basic = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labSCH_basic', 'facultyprofile_labSCH_basic', '`facultyprofile_labSCH_basic`', 5, -1, FALSE, '`facultyprofile_labSCH_basic`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecSCH_basic = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecSCH_basic', 'facultyprofile_lecSCH_basic', '`facultyprofile_lecSCH_basic`', 5, -1, FALSE, '`facultyprofile_lecSCH_basic`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalSCH_basic = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalSCH_basic', 'facultyprofile_totalSCH_basic', '`facultyprofile_totalSCH_basic`', 5, -1, FALSE, '`facultyprofile_totalSCH_basic`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labCr_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labCr_ugrad', 'facultyprofile_labCr_ugrad', '`facultyprofile_labCr_ugrad`', 5, -1, FALSE, '`facultyprofile_labCr_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecCr_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecCr_ugrad', 'facultyprofile_lecCr_ugrad', '`facultyprofile_lecCr_ugrad`', 5, -1, FALSE, '`facultyprofile_lecCr_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_mixedLabLecCr_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_mixedLabLecCr_ugrad', 'facultyprofile_mixedLabLecCr_ugrad', '`facultyprofile_mixedLabLecCr_ugrad`', 5, -1, FALSE, '`facultyprofile_mixedLabLecCr_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalCr_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalCr_ugrad', 'facultyprofile_totalCr_ugrad', '`facultyprofile_totalCr_ugrad`', 5, -1, FALSE, '`facultyprofile_totalCr_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labHrs_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labHrs_ugrad', 'facultyprofile_labHrs_ugrad', '`facultyprofile_labHrs_ugrad`', 5, -1, FALSE, '`facultyprofile_labHrs_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecHrs_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecHrs_ugrad', 'facultyprofile_lecHrs_ugrad', '`facultyprofile_lecHrs_ugrad`', 5, -1, FALSE, '`facultyprofile_lecHrs_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_mixedLabLecHrs_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_mixedLabLecHrs_ugrad', 'facultyprofile_mixedLabLecHrs_ugrad', '`facultyprofile_mixedLabLecHrs_ugrad`', 5, -1, FALSE, '`facultyprofile_mixedLabLecHrs_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalHrs_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalHrs_ugrad', 'facultyprofile_totalHrs_ugrad', '`facultyprofile_totalHrs_ugrad`', 5, -1, FALSE, '`facultyprofile_totalHrs_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labSCH_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labSCH_ugrad', 'facultyprofile_labSCH_ugrad', '`facultyprofile_labSCH_ugrad`', 5, -1, FALSE, '`facultyprofile_labSCH_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecSCH_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecSCH_ugrad', 'facultyprofile_lecSCH_ugrad', '`facultyprofile_lecSCH_ugrad`', 5, -1, FALSE, '`facultyprofile_lecSCH_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_mixedLabLecSCH_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_mixedLabLecSCH_ugrad', 'facultyprofile_mixedLabLecSCH_ugrad', '`facultyprofile_mixedLabLecSCH_ugrad`', 5, -1, FALSE, '`facultyprofile_mixedLabLecSCH_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalSCH_ugrad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalSCH_ugrad', 'facultyprofile_totalSCH_ugrad', '`facultyprofile_totalSCH_ugrad`', 5, -1, FALSE, '`facultyprofile_totalSCH_ugrad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labCr_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labCr_graduate', 'facultyprofile_labCr_graduate', '`facultyprofile_labCr_graduate`', 5, -1, FALSE, '`facultyprofile_labCr_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecCr_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecCr_graduate', 'facultyprofile_lecCr_graduate', '`facultyprofile_lecCr_graduate`', 5, -1, FALSE, '`facultyprofile_lecCr_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_mixedLabLecCr_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_mixedLabLecCr_graduate', 'facultyprofile_mixedLabLecCr_graduate', '`facultyprofile_mixedLabLecCr_graduate`', 5, -1, FALSE, '`facultyprofile_mixedLabLecCr_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalCr_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalCr_graduate', 'facultyprofile_totalCr_graduate', '`facultyprofile_totalCr_graduate`', 5, -1, FALSE, '`facultyprofile_totalCr_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labHrs_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labHrs_graduate', 'facultyprofile_labHrs_graduate', '`facultyprofile_labHrs_graduate`', 5, -1, FALSE, '`facultyprofile_labHrs_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecHrs_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecHrs_graduate', 'facultyprofile_lecHrs_graduate', '`facultyprofile_lecHrs_graduate`', 5, -1, FALSE, '`facultyprofile_lecHrs_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_mixedLabLecHrs_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_mixedLabLecHrs_graduate', 'facultyprofile_mixedLabLecHrs_graduate', '`facultyprofile_mixedLabLecHrs_graduate`', 5, -1, FALSE, '`facultyprofile_mixedLabLecHrs_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalHrs_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalHrs_graduate', 'facultyprofile_totalHrs_graduate', '`facultyprofile_totalHrs_graduate`', 5, -1, FALSE, '`facultyprofile_totalHrs_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_labSCH_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_labSCH_graduate', 'facultyprofile_labSCH_graduate', '`facultyprofile_labSCH_graduate`', 5, -1, FALSE, '`facultyprofile_labSCH_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_lecSCH_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_lecSCH_graduate', 'facultyprofile_lecSCH_graduate', '`facultyprofile_lecSCH_graduate`', 5, -1, FALSE, '`facultyprofile_lecSCH_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_mixedLabLecSCH_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_mixedLabLecSCH_graduate', 'facultyprofile_mixedLabLecSCH_graduate', '`facultyprofile_mixedLabLecSCH_graduate`', 5, -1, FALSE, '`facultyprofile_mixedLabLecSCH_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalSCH_graduate = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalSCH_graduate', 'facultyprofile_totalSCH_graduate', '`facultyprofile_totalSCH_graduate`', 5, -1, FALSE, '`facultyprofile_totalSCH_graduate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_researchLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_researchLoad', 'facultyprofile_researchLoad', '`facultyprofile_researchLoad`', 5, -1, FALSE, '`facultyprofile_researchLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_extensionServicesLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_extensionServicesLoad', 'facultyprofile_extensionServicesLoad', '`facultyprofile_extensionServicesLoad`', 5, -1, FALSE, '`facultyprofile_extensionServicesLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_studyLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_studyLoad', 'facultyprofile_studyLoad', '`facultyprofile_studyLoad`', 5, -1, FALSE, '`facultyprofile_studyLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_forProductionLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_forProductionLoad', 'facultyprofile_forProductionLoad', '`facultyprofile_forProductionLoad`', 5, -1, FALSE, '`facultyprofile_forProductionLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_administrativeLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_administrativeLoad', 'facultyprofile_administrativeLoad', '`facultyprofile_administrativeLoad`', 5, -1, FALSE, '`facultyprofile_administrativeLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_otherLoadCredits = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_otherLoadCredits', 'facultyprofile_otherLoadCredits', '`facultyprofile_otherLoadCredits`', 5, -1, FALSE, '`facultyprofile_otherLoadCredits`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_total_nonTeachingLoad = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_total_nonTeachingLoad', 'facultyprofile_total_nonTeachingLoad', '`facultyprofile_total_nonTeachingLoad`', 5, -1, FALSE, '`facultyprofile_total_nonTeachingLoad`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_totalWorkloadInCreditUnits_gen = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_totalWorkloadInCreditUnits_gen', 'facultyprofile_totalWorkloadInCreditUnits_gen', '`facultyprofile_totalWorkloadInCreditUnits_gen`', 5, -1, FALSE, '`facultyprofile_totalWorkloadInCreditUnits_gen`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->facultyprofile_remarks = new cField('tbl_profile', 'tbl_profile', 'x_facultyprofile_remarks', 'facultyprofile_remarks', '`facultyprofile_remarks`', 200, -1, FALSE, '`facultyprofile_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['facultyprofile_remarks'] =& $this->facultyprofile_remarks;

		// collectionPeriod_status
		$this->collectionPeriod_status = new cField('tbl_profile', 'tbl_profile', 'x_collectionPeriod_status', 'collectionPeriod_status', '`collectionPeriod_status`', 3, -1, FALSE, '`collectionPeriod_status`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "tbl_collectionperiod") {
	...
	// Master filter
	function SqlMasterFilter_tbl_collectionperiod() {
		return "`collectionPeriod_ID`=@collectionPeriod_ID@";
	}

	// Detail filter
	function SqlDetailFilter_tbl_collectionperiod() {
		return "`collectionPeriod_ID`=@collectionPeriod_ID@";
	}
	...
	function SqlWhere() { // Where
		$sWhere = "";
		$this->TableFilter = "`collectionPeriod_status` = 1";
	...
	function DeleteSQL(&$rs) {
		...
		$SQL .= up_QuotedName('facultyprofile_ID') . '=' . up_QuotedValue($rs['facultyprofile_ID'], $this->facultyprofile_ID->FldDataType) . ' AND ';
	...
	function SqlKeyFilter() {
		return "`facultyprofile_ID` = @facultyprofile_ID@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->facultyprofile_ID->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@facultyprofile_ID@", up_AdjustSql($this->facultyprofile_ID->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("tbl_profileedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("tbl_profileadd.php", $this->UrlParm($parm));
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->facultyprofile_ID->CurrentValue)) {
			$sUrl .= "facultyprofile_ID=" . urlencode($this->facultyprofile_ID->CurrentValue);
		} else {
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["facultyprofile_ID"]; // facultyprofile_ID
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->facultyprofile_ID->CurrentValue = $key;
   ...
   // Common render codes
		...
		// facultyprofile_specificDiscipline_1_primaryTeachingLoad
		if (strval($this->facultyprofile_specificDiscipline_1_primaryTeachingLoad->CurrentValue) <> "") {
			$sFilterWrk = "`disCHED_disciplineSpecific_code` = " . up_AdjustSql($this->facultyprofile_specificDiscipline_1_primaryTeachingLoad->CurrentValue) . "";
		...
		$sSqlWrk .= " ORDER BY `disCHED_disciplineSpecific_nameList` Asc";
			$rswrk = $conn->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->facultyprofile_specificDiscipline_1_primaryTeachingLoad->ViewValue = $rswrk->fields('disCHED_disciplineSpecific_nameList');
				$rswrk->Close();
			} else {
			...
			$this->facultyprofile_specificDiscipline_1_primaryTeachingLoad->ViewValue = NULL;
		}
		$this->facultyprofile_specificDiscipline_1_primaryTeachingLoad->ViewCustomAttributes = "";

		// facultyprofile_specificDiscipline_2_primaryTeachingLoad
		if (strval($this->facultyprofile_specificDiscipline_2_primaryTeachingLoad->CurrentValue) <> "") {
			$sFilterWrk = "`disCHED_disciplineSpecific_code` = " . up_AdjustSql($this->facultyprofile_specificDiscipline_2_primaryTeachingLoad->CurrentValue) . "";
		$sSqlWrk = "SELECT `disCHED_disciplineSpecific_nameList` FROM `ref_disciplinechedcodes_minor`";
		$sWhereWrk = "";
		if ($sFilterWrk <> "") {
			if ($sWhereWrk <> "") $sWhereWrk .= " AND ";
		...
		$sSqlWrk .= " ORDER BY `disCHED_disciplineSpecific_nameList` Asc";
			$rswrk = $conn->Execute($sSqlWrk);
			if ($rswrk && !$rswrk->EOF) { // Lookup values found
				$this->facultyprofile_specificDiscipline_2_primaryTeachingLoad->ViewValue = $rswrk->fields('disCHED_disciplineSpecific_nameList');
				$rswrk->Close();
			} else {
			...
			$this->facultyprofile_specificDiscipline_2_primaryTeachingLoad->ViewValue = NULL;
		}
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `tbl_profile` WHERE " . $this->AddUserIDFilter("");
	...
	function AddMasterUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "tbl_collectionperiod") {
			$sFilterWrk = $GLOBALS["tbl_collectionperiod"]->AddUserIDFilter($sFilterWrk);
		}
		return $sFilterWrk;
	}
	...
	function AddDetailUserIDFilter($sFilter, $sCurrentMasterTable) {
		$sFilterWrk = $sFilter;
		if ($sCurrentMasterTable == "tbl_collectionperiod") {
			$sSubqueryWrk = $GLOBALS["tbl_collectionperiod"]->GetUserIDSubquery($this->collectionPeriod_ID, $GLOBALS["tbl_collectionperiod"]->collectionPeriod_ID);
			if ($sSubqueryWrk <> "") {
				if ($sFilterWrk <> "") {
