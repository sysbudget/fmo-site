...
$frm_sam_mfo_questions_cu = NULL;

//
// Table class for frm_sam_mfo_questions_cu
//
class cfrm_sam_mfo_questions_cu {
	var $TableVar = 'frm_sam_mfo_questions_cu';
	...
	//
	function cfrm_sam_mfo_questions_cu() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// target_quota_id
		$this->target_quota_id = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_target_quota_id', 'target_quota_id', '`target_quota_id`', 3, -1, FALSE, '`target_quota_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->target_quota_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['target_quota_id'] =& $this->target_quota_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// cu_short_name
		$this->cu_short_name = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// focal_person_office
		$this->focal_person_office = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_focal_person_office', 'focal_person_office', '`focal_person_office`', 200, -1, FALSE, '`focal_person_office`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['focal_person_office'] =& $this->focal_person_office;

		// mfo_id
		$this->mfo_id = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_mfo_id', 'mfo_id', '`mfo_id`', 3, -1, FALSE, '`mfo_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo_id'] =& $this->mfo_id;

		// mfo_sequence
		$this->mfo_sequence = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_mfo_sequence', 'mfo_sequence', '`mfo_sequence`', 3, -1, FALSE, '`mfo_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo_sequence'] =& $this->mfo_sequence;

		// mfo_name
		$this->mfo_name = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_mfo_name', 'mfo_name', '`mfo_name`', 200, -1, FALSE, '`mfo_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name'] =& $this->mfo_name;

		// pi_question
		$this->pi_question = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_pi_question', 'pi_question', '`pi_question`', 200, -1, FALSE, '`pi_question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_question'] =& $this->pi_question;

		// target_quota
		$this->target_quota = new cField('frm_sam_mfo_questions_cu', 'frm_sam_mfo_questions_cu', 'x_target_quota', 'target_quota', '`target_quota`', 5, -1, FALSE, '`target_quota`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->target_quota->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['target_quota'] =& $this->target_quota;
	}
	...
	function HighlightName() {
		return "frm_sam_mfo_questions_cu_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_sam_mfo_questions_cu`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_mfo_questions_cu` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_mfo_questions_cu` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_mfo_questions_cu` WHERE ";
		$SQL .= up_QuotedName('target_quota_id') . '=' . up_QuotedValue($rs['target_quota_id'], $this->target_quota_id->FldDataType) . ' AND ';
	...
	function SqlKeyFilter() {
		return "`target_quota_id` = @target_quota_id@";
	}

	// Key filter
	function KeyFilter() {
		$sKeyFilter = $this->SqlKeyFilter();
		if (!is_numeric($this->target_quota_id->CurrentValue))
			$sKeyFilter = "0=1"; // Invalid key
		$sKeyFilter = str_replace("@target_quota_id@", up_AdjustSql($this->target_quota_id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_mfo_questions_culist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_mfo_questions_cuview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_mfo_questions_cuadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_mfo_questions_cuedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_mfo_questions_cuadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_mfo_questions_cudelete.php", $this->UrlParm());
	}
	...
	function KeyUrl($url, $parm = "") {
		$sUrl = $url . "?";
		if ($parm <> "") $sUrl .= $parm . "&";
		if (!is_null($this->target_quota_id->CurrentValue)) {
			$sUrl .= "target_quota_id=" . urlencode($this->target_quota_id->CurrentValue);
		} else {
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_mfo_questions_cu" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			$arKeys[] = @$_GET["target_quota_id"]; // target_quota_id
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->target_quota_id->CurrentValue = $key;
	...
	function LoadListRowValues(&$rs) {
		$this->target_quota_id->setDbValue($rs->fields('target_quota_id'));
		...
		$this->target_quota->setDbValue($rs->fields('target_quota'));
	}
   ...
   // Common render codes
		...
		$this->target_quota_id->ViewValue = $this->target_quota_id->CurrentValue;
		$this->target_quota_id->ViewCustomAttributes = "";
		...
		// target_quota
		$this->target_quota->ViewValue = $this->target_quota->CurrentValue;
		$this->target_quota->ViewCustomAttributes = "";

		// target_quota_id
		$this->target_quota_id->LinkCustomAttributes = "";
		$this->target_quota_id->HrefValue = "";
		$this->target_quota_id->TooltipValue = "";
		...
		// target_quota
		$this->target_quota->LinkCustomAttributes = "";
		$this->target_quota->HrefValue = "";
		$this->target_quota->TooltipValue = "";
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					$XmlDoc->AddField('target_quota_id', $this->target_quota_id->ExportValue($this->Export, $this->ExportOriginalValue));
					...
					$XmlDoc->AddField('target_quota', $this->target_quota->ExportValue($this->Export, $this->ExportOriginalValue));
				} else {
				}
			}
			$Recordset->MoveNext();
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			$Doc->BeginExportRow();
			if ($ExportPageType == "view") {
				$Doc->ExportCaption($this->target_quota_id);
				...
				$Doc->ExportCaption($this->target_quota);
			} else {
			}
			if ($this->Export == "pdf") {
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					$Doc->ExportField($this->target_quota_id);
					...
					$Doc->ExportField($this->target_quota);
				} else {
				}
				$Doc->EndExportRow();
			}
