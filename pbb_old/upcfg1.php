...
define("UP_RANDOM_KEY", 'vnvjKEtrv19vsFYg', TRUE); // Random key for encryption
...
// Security
define("UP_ADMIN_USER_NAME", "sysad", TRUE); // Administrator user name
define("UP_ADMIN_PASSWORD", "fyt4urryt", TRUE); // Administrator password
