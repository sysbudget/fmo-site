...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList('frm_sam_rep_a_eligible_status'))
			$this->Page_Terminate("frm_sam_rep_a_eligible_statuslist.php");
		if ($Security->AllowList('frm_sam_rep_a_eligible_status_unit'))
			$this->Page_Terminate("frm_sam_rep_a_eligible_status_unitlist.php");
		if ($Security->AllowList('frm_sam_rep_a_eligible_status_unit_mfo'))
			$this->Page_Terminate("frm_sam_rep_a_eligible_status_unit_mfolist.php");
		...
		if ($Security->AllowList('frm_sam_rep_ta_form_a_0'))
			$this->Page_Terminate("frm_sam_rep_ta_form_a_0list.php");
