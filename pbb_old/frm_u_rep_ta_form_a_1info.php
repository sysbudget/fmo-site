...
$frm_u_rep_ta_form_a_1 = NULL;

//
// Table class for frm_u_rep_ta_form_a_1
//
class cfrm_u_rep_ta_form_a_1 {
	var $TableVar = 'frm_u_rep_ta_form_a_1';
	...
	//
	function cfrm_u_rep_ta_form_a_1() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// units_id
		$this->units_id = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Constituent_University = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Constituent_University', 'Constituent University', '`Constituent University`', 200, -1, FALSE, '`Constituent University`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Constituent University'] =& $this->Constituent_University;

		// Delivery Unit
		$this->Delivery_Unit = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Delivery_Unit', 'Delivery Unit', '`Delivery Unit`', 200, -1, FALSE, '`Delivery Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Delivery Unit'] =& $this->Delivery_Unit;

		// PI 1
		$this->PI_1 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_1', 'PI 1', '`PI 1`', 200, -1, FALSE, '`PI 1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 1'] =& $this->PI_1;

		// PI Question (1)
		$this->PI_Question_28129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28129', 'PI Question (1)', '`PI Question (1)`', 200, -1, FALSE, '`PI Question (1)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (1)'] =& $this->PI_Question_28129;

		// Target (1)
		$this->Target_28129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28129', 'Target (1)', '`Target (1)`', 5, -1, FALSE, '`Target (1)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28129->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (1)'] =& $this->Target_28129;

		// Target N (1)
		$this->Target_N_28129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28129', 'Target N (1)', '`Target N (1)`', 5, -1, FALSE, '`Target N (1)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28129->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (1)'] =& $this->Target_N_28129;

		// Target D (1)
		$this->Target_D_28129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28129', 'Target D (1)', '`Target D (1)`', 5, -1, FALSE, '`Target D (1)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28129->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (1)'] =& $this->Target_D_28129;

		// Remarks (1)
		$this->Remarks_28129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28129', 'Remarks (1)', '`Remarks (1)`', 200, -1, FALSE, '`Remarks (1)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (1)'] =& $this->Remarks_28129;

		// PI 2
		$this->PI_2 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_2', 'PI 2', '`PI 2`', 200, -1, FALSE, '`PI 2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 2'] =& $this->PI_2;

		// PI Question (2)
		$this->PI_Question_28229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28229', 'PI Question (2)', '`PI Question (2)`', 200, -1, FALSE, '`PI Question (2)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (2)'] =& $this->PI_Question_28229;

		// Target (2)
		$this->Target_28229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28229', 'Target (2)', '`Target (2)`', 5, -1, FALSE, '`Target (2)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28229->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (2)'] =& $this->Target_28229;

		// Target N (2)
		$this->Target_N_28229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28229', 'Target N (2)', '`Target N (2)`', 5, -1, FALSE, '`Target N (2)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28229->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (2)'] =& $this->Target_N_28229;

		// Target D (2)
		$this->Target_D_28229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28229', 'Target D (2)', '`Target D (2)`', 5, -1, FALSE, '`Target D (2)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28229->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (2)'] =& $this->Target_D_28229;

		// Remarks (2)
		$this->Remarks_28229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28229', 'Remarks (2)', '`Remarks (2)`', 200, -1, FALSE, '`Remarks (2)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (2)'] =& $this->Remarks_28229;

		// PI 3
		$this->PI_3 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_3', 'PI 3', '`PI 3`', 200, -1, FALSE, '`PI 3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 3'] =& $this->PI_3;

		// PI Question (3)
		$this->PI_Question_28329 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28329', 'PI Question (3)', '`PI Question (3)`', 200, -1, FALSE, '`PI Question (3)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (3)'] =& $this->PI_Question_28329;

		// Target (3)
		$this->Target_28329 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28329', 'Target (3)', '`Target (3)`', 5, -1, FALSE, '`Target (3)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28329->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (3)'] =& $this->Target_28329;

		// Target N (3)
		$this->Target_N_28329 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28329', 'Target N (3)', '`Target N (3)`', 5, -1, FALSE, '`Target N (3)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28329->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (3)'] =& $this->Target_N_28329;

		// Target D (3)
		$this->Target_D_28329 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28329', 'Target D (3)', '`Target D (3)`', 5, -1, FALSE, '`Target D (3)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28329->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (3)'] =& $this->Target_D_28329;

		// Remarks (3)
		$this->Remarks_28329 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28329', 'Remarks (3)', '`Remarks (3)`', 200, -1, FALSE, '`Remarks (3)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (3)'] =& $this->Remarks_28329;

		// PI 4
		$this->PI_4 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_4', 'PI 4', '`PI 4`', 200, -1, FALSE, '`PI 4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 4'] =& $this->PI_4;

		// PI Question (4)
		$this->PI_Question_28429 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28429', 'PI Question (4)', '`PI Question (4)`', 200, -1, FALSE, '`PI Question (4)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (4)'] =& $this->PI_Question_28429;

		// Target (4)
		$this->Target_28429 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28429', 'Target (4)', '`Target (4)`', 5, -1, FALSE, '`Target (4)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28429->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (4)'] =& $this->Target_28429;

		// Target N (4)
		$this->Target_N_28429 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28429', 'Target N (4)', '`Target N (4)`', 5, -1, FALSE, '`Target N (4)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28429->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (4)'] =& $this->Target_N_28429;

		// Target D (4)
		$this->Target_D_28429 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28429', 'Target D (4)', '`Target D (4)`', 5, -1, FALSE, '`Target D (4)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28429->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (4)'] =& $this->Target_D_28429;

		// Remarks (4)
		$this->Remarks_28429 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28429', 'Remarks (4)', '`Remarks (4)`', 200, -1, FALSE, '`Remarks (4)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (4)'] =& $this->Remarks_28429;

		// PI 5
		$this->PI_5 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_5', 'PI 5', '`PI 5`', 200, -1, FALSE, '`PI 5`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 5'] =& $this->PI_5;

		// PI Question (5)
		$this->PI_Question_28529 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28529', 'PI Question (5)', '`PI Question (5)`', 200, -1, FALSE, '`PI Question (5)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (5)'] =& $this->PI_Question_28529;

		// Target (5)
		$this->Target_28529 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28529', 'Target (5)', '`Target (5)`', 5, -1, FALSE, '`Target (5)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28529->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (5)'] =& $this->Target_28529;

		// Target N (5)
		$this->Target_N_28529 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28529', 'Target N (5)', '`Target N (5)`', 5, -1, FALSE, '`Target N (5)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28529->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (5)'] =& $this->Target_N_28529;

		// Target D (5)
		$this->Target_D_28529 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28529', 'Target D (5)', '`Target D (5)`', 5, -1, FALSE, '`Target D (5)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28529->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (5)'] =& $this->Target_D_28529;

		// Remarks (5)
		$this->Remarks_28529 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28529', 'Remarks (5)', '`Remarks (5)`', 200, -1, FALSE, '`Remarks (5)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (5)'] =& $this->Remarks_28529;

		// PI 6
		$this->PI_6 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_6', 'PI 6', '`PI 6`', 200, -1, FALSE, '`PI 6`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 6'] =& $this->PI_6;

		// PI Question (6)
		$this->PI_Question_28629 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28629', 'PI Question (6)', '`PI Question (6)`', 200, -1, FALSE, '`PI Question (6)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (6)'] =& $this->PI_Question_28629;

		// Target (6)
		$this->Target_28629 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28629', 'Target (6)', '`Target (6)`', 5, -1, FALSE, '`Target (6)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28629->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (6)'] =& $this->Target_28629;

		// Target N (6)
		$this->Target_N_28629 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28629', 'Target N (6)', '`Target N (6)`', 5, -1, FALSE, '`Target N (6)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28629->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (6)'] =& $this->Target_N_28629;

		// Target D (6)
		$this->Target_D_28629 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28629', 'Target D (6)', '`Target D (6)`', 5, -1, FALSE, '`Target D (6)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28629->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (6)'] =& $this->Target_D_28629;

		// Remarks (6)
		$this->Remarks_28629 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28629', 'Remarks (6)', '`Remarks (6)`', 200, -1, FALSE, '`Remarks (6)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (6)'] =& $this->Remarks_28629;

		// PI 7
		$this->PI_7 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_7', 'PI 7', '`PI 7`', 200, -1, FALSE, '`PI 7`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 7'] =& $this->PI_7;

		// PI Question (7)
		$this->PI_Question_28729 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28729', 'PI Question (7)', '`PI Question (7)`', 200, -1, FALSE, '`PI Question (7)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (7)'] =& $this->PI_Question_28729;

		// Target (7)
		$this->Target_28729 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28729', 'Target (7)', '`Target (7)`', 5, -1, FALSE, '`Target (7)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28729->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (7)'] =& $this->Target_28729;

		// Target N (7)
		$this->Target_N_28729 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28729', 'Target N (7)', '`Target N (7)`', 5, -1, FALSE, '`Target N (7)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28729->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (7)'] =& $this->Target_N_28729;

		// Target D (7)
		$this->Target_D_28729 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28729', 'Target D (7)', '`Target D (7)`', 5, -1, FALSE, '`Target D (7)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28729->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (7)'] =& $this->Target_D_28729;

		// Remarks (7)
		$this->Remarks_28729 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28729', 'Remarks (7)', '`Remarks (7)`', 200, -1, FALSE, '`Remarks (7)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (7)'] =& $this->Remarks_28729;

		// PI 8
		$this->PI_8 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_8', 'PI 8', '`PI 8`', 200, -1, FALSE, '`PI 8`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 8'] =& $this->PI_8;

		// PI Question (8)
		$this->PI_Question_28829 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28829', 'PI Question (8)', '`PI Question (8)`', 200, -1, FALSE, '`PI Question (8)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (8)'] =& $this->PI_Question_28829;

		// Target (8)
		$this->Target_28829 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28829', 'Target (8)', '`Target (8)`', 5, -1, FALSE, '`Target (8)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28829->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (8)'] =& $this->Target_28829;

		// Target N (8)
		$this->Target_N_28829 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28829', 'Target N (8)', '`Target N (8)`', 5, -1, FALSE, '`Target N (8)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28829->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (8)'] =& $this->Target_N_28829;

		// Target D (8)
		$this->Target_D_28829 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28829', 'Target D (8)', '`Target D (8)`', 5, -1, FALSE, '`Target D (8)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28829->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (8)'] =& $this->Target_D_28829;

		// Remarks (8)
		$this->Remarks_28829 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28829', 'Remarks (8)', '`Remarks (8)`', 200, -1, FALSE, '`Remarks (8)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (8)'] =& $this->Remarks_28829;

		// PI 9
		$this->PI_9 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_9', 'PI 9', '`PI 9`', 200, -1, FALSE, '`PI 9`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 9'] =& $this->PI_9;

		// PI Question (9)
		$this->PI_Question_28929 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_28929', 'PI Question (9)', '`PI Question (9)`', 200, -1, FALSE, '`PI Question (9)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (9)'] =& $this->PI_Question_28929;

		// Target (9)
		$this->Target_28929 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_28929', 'Target (9)', '`Target (9)`', 5, -1, FALSE, '`Target (9)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_28929->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (9)'] =& $this->Target_28929;

		// Target N (9)
		$this->Target_N_28929 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_28929', 'Target N (9)', '`Target N (9)`', 5, -1, FALSE, '`Target N (9)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_28929->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (9)'] =& $this->Target_N_28929;

		// Target D (9)
		$this->Target_D_28929 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_28929', 'Target D (9)', '`Target D (9)`', 5, -1, FALSE, '`Target D (9)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_28929->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (9)'] =& $this->Target_D_28929;

		// Remarks (9)
		$this->Remarks_28929 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_28929', 'Remarks (9)', '`Remarks (9)`', 200, -1, FALSE, '`Remarks (9)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (9)'] =& $this->Remarks_28929;

		// PI 10
		$this->PI_10 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_10', 'PI 10', '`PI 10`', 200, -1, FALSE, '`PI 10`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 10'] =& $this->PI_10;

		// PI Question (10)
		$this->PI_Question_281029 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_281029', 'PI Question (10)', '`PI Question (10)`', 200, -1, FALSE, '`PI Question (10)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (10)'] =& $this->PI_Question_281029;

		// Target (10)
		$this->Target_281029 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_281029', 'Target (10)', '`Target (10)`', 5, -1, FALSE, '`Target (10)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_281029->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (10)'] =& $this->Target_281029;

		// Target N (10)
		$this->Target_N_281029 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_281029', 'Target N (10)', '`Target N (10)`', 5, -1, FALSE, '`Target N (10)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_281029->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (10)'] =& $this->Target_N_281029;

		// Target D (10)
		$this->Target_D_281029 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_281029', 'Target D (10)', '`Target D (10)`', 5, -1, FALSE, '`Target D (10)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_281029->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (10)'] =& $this->Target_D_281029;

		// Remarks (10)
		$this->Remarks_281029 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_281029', 'Remarks (10)', '`Remarks (10)`', 200, -1, FALSE, '`Remarks (10)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (10)'] =& $this->Remarks_281029;

		// PI 11
		$this->PI_11 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_11', 'PI 11', '`PI 11`', 200, -1, FALSE, '`PI 11`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 11'] =& $this->PI_11;

		// PI Question (11)
		$this->PI_Question_281129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_281129', 'PI Question (11)', '`PI Question (11)`', 200, -1, FALSE, '`PI Question (11)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (11)'] =& $this->PI_Question_281129;

		// Target (11)
		$this->Target_281129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_281129', 'Target (11)', '`Target (11)`', 5, -1, FALSE, '`Target (11)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_281129->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (11)'] =& $this->Target_281129;

		// Target N (11)
		$this->Target_N_281129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_281129', 'Target N (11)', '`Target N (11)`', 5, -1, FALSE, '`Target N (11)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_281129->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (11)'] =& $this->Target_N_281129;

		// Target D (11)
		$this->Target_D_281129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_281129', 'Target D (11)', '`Target D (11)`', 5, -1, FALSE, '`Target D (11)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_281129->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (11)'] =& $this->Target_D_281129;

		// Remarks (11)
		$this->Remarks_281129 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_281129', 'Remarks (11)', '`Remarks (11)`', 200, -1, FALSE, '`Remarks (11)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (11)'] =& $this->Remarks_281129;

		// PI 12
		$this->PI_12 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_12', 'PI 12', '`PI 12`', 200, -1, FALSE, '`PI 12`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI 12'] =& $this->PI_12;

		// PI Question (12)
		$this->PI_Question_281229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_PI_Question_281229', 'PI Question (12)', '`PI Question (12)`', 200, -1, FALSE, '`PI Question (12)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['PI Question (12)'] =& $this->PI_Question_281229;

		// Target (12)
		$this->Target_281229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_281229', 'Target (12)', '`Target (12)`', 5, -1, FALSE, '`Target (12)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_281229->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target (12)'] =& $this->Target_281229;

		// Target N (12)
		$this->Target_N_281229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_N_281229', 'Target N (12)', '`Target N (12)`', 5, -1, FALSE, '`Target N (12)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_N_281229->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target N (12)'] =& $this->Target_N_281229;

		// Target D (12)
		$this->Target_D_281229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Target_D_281229', 'Target D (12)', '`Target D (12)`', 5, -1, FALSE, '`Target D (12)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target_D_281229->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target D (12)'] =& $this->Target_D_281229;

		// Remarks (12)
		$this->Remarks_281229 = new cField('frm_u_rep_ta_form_a_1', 'frm_u_rep_ta_form_a_1', 'x_Remarks_281229', 'Remarks (12)', '`Remarks (12)`', 200, -1, FALSE, '`Remarks (12)`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_u_rep_ta_form_a_1_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_u_rep_ta_form_a_1` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_u_rep_ta_form_a_1` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_u_rep_ta_form_a_1` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_u_rep_ta_form_a_1list.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_u_rep_ta_form_a_1view.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_u_rep_ta_form_a_1add.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_u_rep_ta_form_a_1edit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_u_rep_ta_form_a_1add.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_u_rep_ta_form_a_1delete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_u_rep_ta_form_a_1" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_u_rep_ta_form_a_1` WHERE " . $this->AddUserIDFilter("");
