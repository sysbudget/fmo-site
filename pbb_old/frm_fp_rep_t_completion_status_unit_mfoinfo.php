...
$frm_fp_rep_t_completion_status_unit_mfo = NULL;

//
// Table class for frm_fp_rep_t_completion_status_unit_mfo
//
class cfrm_fp_rep_t_completion_status_unit_mfo {
	var $TableVar = 'frm_fp_rep_t_completion_status_unit_mfo';
	...
	//
	function cfrm_fp_rep_t_completion_status_unit_mfo() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// focal_person_id
		$this->focal_person_id = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_short_name
		$this->cu_short_name = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// units_id
		$this->units_id = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// cu_unit_name
		$this->cu_unit_name = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_unit_name'] =& $this->cu_unit_name;

		// mfo
		$this->mfo = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_mfo', 'mfo', '`mfo`', 3, -1, FALSE, '`mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo'] =& $this->mfo;

		// mfo_name_rep
		$this->mfo_name_rep = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_mfo_name_rep', 'mfo_name_rep', '`mfo_name_rep`', 200, -1, FALSE, '`mfo_name_rep`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name_rep'] =& $this->mfo_name_rep;

		// budget
		$this->budget = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_budget', 'budget', '`budget`', 131, -1, FALSE, '`budget`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->budget->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['budget'] =& $this->budget;

		// No. of PIs (A)
		$this->No2E_of_PIs_28A29 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_No2E_of_PIs_28A29', 'No. of PIs (A)', '`No. of PIs (A)`', 20, -1, FALSE, '`No. of PIs (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->No2E_of_PIs_28A29->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['No. of PIs (A)'] =& $this->No2E_of_PIs_28A29;

		// Applicable PIs (B)
		$this->Applicable_PIs_28B29 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_Applicable_PIs_28B29', 'Applicable PIs (B)', '`Applicable PIs (B)`', 20, -1, FALSE, '`Applicable PIs (B)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Not_Applicable_PIs_28C29 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_Not_Applicable_PIs_28C29', 'Not Applicable PIs (C)', '`Not Applicable PIs (C)`', 20, -1, FALSE, '`Not Applicable PIs (C)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// PI with Target (D)
		$this->PI_with_Target_28D29 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_PI_with_Target_28D29', 'PI with Target (D)', '`PI with Target (D)`', 20, -1, FALSE, '`PI with Target (D)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Remarks (A = C)
		$this->Remarks_28A_3D_C29 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_Remarks_28A_3D_C29', 'Remarks (A = C)', '`Remarks (A = C)`', 200, -1, FALSE, '`Remarks (A = C)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (A = C)'] =& $this->Remarks_28A_3D_C29;

		// Remarks (B > D)
		$this->Remarks_28B_3E_D29 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_Remarks_28B_3E_D29', 'Remarks (B > D)', '`Remarks (B > D)`', 200, -1, FALSE, '`Remarks (B > D)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks (B > D)'] =& $this->Remarks_28B_3E_D29;

		// Remarks (D = 0)
		$this->Remarks_28D_3D_029 = new cField('frm_fp_rep_t_completion_status_unit_mfo', 'frm_fp_rep_t_completion_status_unit_mfo', 'x_Remarks_28D_3D_029', 'Remarks (D = 0)', '`Remarks (D = 0)`', 200, -1, FALSE, '`Remarks (D = 0)`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_fp_rep_t_completion_status_unit_mfo_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_fp_rep_t_completion_status_unit_mfo`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_fp_rep_t_completion_status_unit_mfo` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_fp_rep_t_completion_status_unit_mfo` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_fp_rep_t_completion_status_unit_mfo` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_fp_rep_t_completion_status_unit_mfolist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_fp_rep_t_completion_status_unit_mfoview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_fp_rep_t_completion_status_unit_mfoadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_fp_rep_t_completion_status_unit_mfoedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_fp_rep_t_completion_status_unit_mfoadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_fp_rep_t_completion_status_unit_mfodelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_fp_rep_t_completion_status_unit_mfo" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		// No. of PIs (A)
		$this->No2E_of_PIs_28A29->CellCssStyle = "white-space: nowrap;";

		// Applicable PIs (B)
		$this->Applicable_PIs_28B29->CellCssStyle = "white-space: nowrap;";

		// Not Applicable PIs (C)
		$this->Not_Applicable_PIs_28C29->CellCssStyle = "white-space: nowrap;";

		// PI with Target (D)
		$this->PI_with_Target_28D29->CellCssStyle = "white-space: nowrap;";

		// Remarks (A = C)
		$this->Remarks_28A_3D_C29->CellCssStyle = "white-space: nowrap;";

		// Remarks (B > D)
		$this->Remarks_28B_3E_D29->CellCssStyle = "white-space: nowrap;";

		// Remarks (D = 0)
		$this->Remarks_28D_3D_029->CellCssStyle = "white-space: nowrap;";
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_fp_rep_t_completion_status_unit_mfo` WHERE " . $this->AddUserIDFilter("");
