...
//
// Table class for frm_fp_units
//
class cfrm_fp_units {
	var $TableVar = 'frm_fp_units';
	...
	//
	function cfrm_fp_units() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// units_id
		$this->units_id = new cField('frm_fp_units', 'frm_fp_units', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_fp_units', 'frm_fp_units', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// unit_id
		$this->unit_id = new cField('frm_fp_units', 'frm_fp_units', 'x_unit_id', 'unit_id', '`unit_id`', 3, -1, FALSE, '`unit_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->unit_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unit_id'] =& $this->unit_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_fp_units', 'frm_fp_units', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// cu_short_name
		$this->cu_short_name = new cField('frm_fp_units', 'frm_fp_units', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// cu_unit_name
		$this->cu_unit_name = new cField('frm_fp_units', 'frm_fp_units', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_unit_name'] =& $this->cu_unit_name;

		// unit_name
		$this->unit_name = new cField('frm_fp_units', 'frm_fp_units', 'x_unit_name', 'unit_name', '`unit_name`', 200, -1, FALSE, '`unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_name'] =& $this->unit_name;

		// unit_name_short
		$this->unit_name_short = new cField('frm_fp_units', 'frm_fp_units', 'x_unit_name_short', 'unit_name_short', '`unit_name_short`', 200, -1, FALSE, '`unit_name_short`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_name_short'] =& $this->unit_name_short;

		// personnel_count
		$this->personnel_count = new cField('frm_fp_units', 'frm_fp_units', 'x_personnel_count', 'personnel_count', '`personnel_count`', 3, -1, FALSE, '`personnel_count`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->personnel_count->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['personnel_count'] =& $this->personnel_count;

		// mfo_1
		$this->mfo_1 = new cField('frm_fp_units', 'frm_fp_units', 'x_mfo_1', 'mfo_1', '`mfo_1`', 200, -1, FALSE, '`mfo_1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_1'] =& $this->mfo_1;

		// mfo_2
		$this->mfo_2 = new cField('frm_fp_units', 'frm_fp_units', 'x_mfo_2', 'mfo_2', '`mfo_2`', 200, -1, FALSE, '`mfo_2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_2'] =& $this->mfo_2;

		// mfo_3
		$this->mfo_3 = new cField('frm_fp_units', 'frm_fp_units', 'x_mfo_3', 'mfo_3', '`mfo_3`', 200, -1, FALSE, '`mfo_3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_3'] =& $this->mfo_3;

		// mfo_4
		$this->mfo_4 = new cField('frm_fp_units', 'frm_fp_units', 'x_mfo_4', 'mfo_4', '`mfo_4`', 200, -1, FALSE, '`mfo_4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_4'] =& $this->mfo_4;

		// mfo_5
		$this->mfo_5 = new cField('frm_fp_units', 'frm_fp_units', 'x_mfo_5', 'mfo_5', '`mfo_5`', 200, -1, FALSE, '`mfo_5`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_5'] =& $this->mfo_5;

		// sto
		$this->sto = new cField('frm_fp_units', 'frm_fp_units', 'x_sto', 'sto', '`sto`', 200, -1, FALSE, '`sto`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['sto'] =& $this->sto;

		// gass
		$this->gass = new cField('frm_fp_units', 'frm_fp_units', 'x_gass', 'gass', '`gass`', 200, -1, FALSE, '`gass`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['gass'] =& $this->gass;

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_fp_units', 'frm_fp_units', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_fp_units', 'frm_fp_units', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_remarks = new cField('frm_fp_units', 'frm_fp_units', 'x_t_cutOffDate_remarks', 't_cutOffDate_remarks', '`t_cutOffDate_remarks`', 200, -1, FALSE, '`t_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_cutOffDate_remarks'] =& $this->t_cutOffDate_remarks;

		// cu_id
		$this->cu_id = new cField('frm_fp_units', 'frm_fp_units', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// t_startDate
		$this->t_startDate = new cField('frm_fp_units', 'frm_fp_units', 'x_t_startDate', 't_startDate', '`t_startDate`', 135, 6, FALSE, '`t_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_fp_units` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_fp_units` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_fp_units` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_fp_unitsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_fp_unitsadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_fp_unitsedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_fp_unitsadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_fp_unitsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_fp_units" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_fp_units` WHERE " . $this->AddUserIDFilter("");
