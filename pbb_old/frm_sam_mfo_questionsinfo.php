...
$frm_sam_mfo_questions = NULL;

//
// Table class for frm_sam_mfo_questions
//
class cfrm_sam_mfo_questions {
	var $TableVar = 'frm_sam_mfo_questions';
	...
	//
	function cfrm_sam_mfo_questions() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// mfo_id
		$this->mfo_id = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_mfo_id', 'mfo_id', '`mfo_id`', 3, -1, FALSE, '`mfo_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo_id'] =& $this->mfo_id;

		// mfo_sequence
		$this->mfo_sequence = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_mfo_sequence', 'mfo_sequence', '`mfo_sequence`', 3, -1, FALSE, '`mfo_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo_sequence'] =& $this->mfo_sequence;

		// mfo
		$this->mfo = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_mfo', 'mfo', '`mfo`', 3, -1, FALSE, '`mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo'] =& $this->mfo;

		// pi_no
		$this->pi_no = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_pi_no', 'pi_no', '`pi_no`', 20, -1, FALSE, '`pi_no`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi_no->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi_no'] =& $this->pi_no;

		// pi_sub
		$this->pi_sub = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_pi_sub', 'pi_sub', '`pi_sub`', 200, -1, FALSE, '`pi_sub`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_sub'] =& $this->pi_sub;

		// mfo_name_rep
		$this->mfo_name_rep = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_mfo_name_rep', 'mfo_name_rep', '`mfo_name_rep`', 200, -1, FALSE, '`mfo_name_rep`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name_rep'] =& $this->mfo_name_rep;

		// mfo_name
		$this->mfo_name = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_mfo_name', 'mfo_name', '`mfo_name`', 200, -1, FALSE, '`mfo_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name'] =& $this->mfo_name;

		// pi_question
		$this->pi_question = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_pi_question', 'pi_question', '`pi_question`', 200, -1, FALSE, '`pi_question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_question'] =& $this->pi_question;

		// gaa_value
		$this->gaa_value = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_gaa_value', 'gaa_value', '`gaa_value`', 5, -1, FALSE, '`gaa_value`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->gaa_value->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['gaa_value'] =& $this->gaa_value;

		// denominator
		$this->denominator = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_denominator', 'denominator', '`denominator`', 200, -1, FALSE, '`denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['denominator'] =& $this->denominator;

		// pi_type
		$this->pi_type = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_pi_type', 'pi_type', '`pi_type`', 200, -1, FALSE, '`pi_type`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_type'] =& $this->pi_type;

		// expectations
		$this->expectations = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_expectations', 'expectations', '`expectations`', 200, -1, FALSE, '`expectations`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['expectations'] =& $this->expectations;

		// form_a_1_sequence
		$this->form_a_1_sequence = new cField('frm_sam_mfo_questions', 'frm_sam_mfo_questions', 'x_form_a_1_sequence', 'form_a_1_sequence', '`form_a_1_sequence`', 3, -1, FALSE, '`form_a_1_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_mfo_questions_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_mfo_questions` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_mfo_questions` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_mfo_questions` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_mfo_questionslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_mfo_questionsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_mfo_questionsadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_mfo_questionsedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_mfo_questionsadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_mfo_questionsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_mfo_questions" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$XmlDoc->AddField('form_a_1_sequence', $this->form_a_1_sequence->ExportValue($this->Export, $this->ExportOriginalValue));
				} else {
				}
			}
			$Recordset->MoveNext();
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->form_a_1_sequence);
			} else {
			}
			if ($this->Export == "pdf") {
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$Doc->ExportField($this->form_a_1_sequence);
				} else {
				}
				$Doc->EndExportRow();
			}
