...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28129->Visible) { // Target D (1) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28129->Visible) { // Remarks (1) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28129) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28129->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28129) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28129->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28129->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28129->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28229->Visible) { // Target D (2) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28229->Visible) { // Remarks (2) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28229) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28229->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28229) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28229->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28229->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28229->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28329->Visible) { // Target D (3) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28329->Visible) { // Remarks (3) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28329) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28329->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28329) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28329->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28329->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28329->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28429->Visible) { // Target D (4) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28429->Visible) { // Remarks (4) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28429) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28429->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28429) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28429->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28429->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28429->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28529->Visible) { // Target D (5) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28529->Visible) { // Remarks (5) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28529) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28529->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28529) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28529->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28529->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28529->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28629->Visible) { // Target D (6) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28629->Visible) { // Remarks (6) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28629) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28629->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28629) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28629->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28629->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28629->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28729->Visible) { // Target D (7) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28729->Visible) { // Remarks (7) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28729) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28729->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28729) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28729->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28729->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28729->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28829->Visible) { // Target D (8) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28829->Visible) { // Remarks (8) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28829) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28829->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28829) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28829->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28829->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28829->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_28929->Visible) { // Target D (9) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28929->Visible) { // Remarks (9) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28929) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28929->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_28929) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28929->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_28929->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_28929->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_281029->Visible) { // Target D (10) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_281029->Visible) { // Remarks (10) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_281029) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281029->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_281029) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281029->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_281029->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_281029->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_281129->Visible) { // Target D (11) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_281129->Visible) { // Remarks (11) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_281129) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281129->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_281129) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281129->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_281129->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_281129->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($frm_fp_rep_ta_form_a_1->Target_D_281229->Visible) { // Target D (12) ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($frm_fp_rep_ta_form_a_1->Remarks_281229->Visible) { // Remarks (12) ?>
	<?php if ($frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_281229) == "") { ?>
		<td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281229->FldCaption() ?></td>
	<?php } else { ?>
		<td><div class="upPointer" onmousedown="up_Sort(event,'<?php echo $frm_fp_rep_ta_form_a_1->SortUrl($frm_fp_rep_ta_form_a_1->Remarks_281229) ?>',1);">
			<table cellspacing="0" class="upTableHeaderBtn"><thead><tr><td><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281229->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td style="width: 10px;"><?php if ($frm_fp_rep_ta_form_a_1->Remarks_281229->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($frm_fp_rep_ta_form_a_1->Remarks_281229->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></thead></table>
		</div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28129->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28129->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28129->Visible) { // Remarks (1) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28129->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28129->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28129->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_2->Visible) { // PI 2 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28229->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28229->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28229->Visible) { // Remarks (2) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28229->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28229->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28229->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_3->Visible) { // PI 3 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28329->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28329->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28329->Visible) { // Remarks (3) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28329->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28329->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28329->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_4->Visible) { // PI 4 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28429->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28429->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28429->Visible) { // Remarks (4) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28429->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28429->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28429->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_5->Visible) { // PI 5 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28529->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28529->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28529->Visible) { // Remarks (5) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28529->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28529->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28529->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_6->Visible) { // PI 6 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28629->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28629->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28629->Visible) { // Remarks (6) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28629->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28629->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28629->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_7->Visible) { // PI 7 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28729->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28729->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28729->Visible) { // Remarks (7) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28729->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28729->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28729->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_8->Visible) { // PI 8 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28829->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28829->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28829->Visible) { // Remarks (8) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28829->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28829->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28829->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_9->Visible) { // PI 9 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_28929->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_28929->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_28929->Visible) { // Remarks (9) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28929->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_28929->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_28929->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_10->Visible) { // PI 10 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_281029->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_281029->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_281029->Visible) { // Remarks (10) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_281029->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_281029->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281029->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_11->Visible) { // PI 11 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_281129->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_281129->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_281129->Visible) { // Remarks (11) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_281129->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_281129->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281129->ListViewValue() ?></div>
</td>
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->PI_12->Visible) { // PI 12 ?>
...
<div<?php echo $frm_fp_rep_ta_form_a_1->Target_D_281229->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Target_D_281229->ListViewValue() ?></div>
	...
	<?php } ?>
	<?php if ($frm_fp_rep_ta_form_a_1->Remarks_281229->Visible) { // Remarks (12) ?>
		<td<?php echo $frm_fp_rep_ta_form_a_1->Remarks_281229->CellAttributes() ?>>
<div<?php echo $frm_fp_rep_ta_form_a_1->Remarks_281229->ViewAttributes() ?>><?php echo $frm_fp_rep_ta_form_a_1->Remarks_281229->ListViewValue() ?></div>
</td>
	<?php } ?>
<?php
...
class cfrm_fp_rep_ta_form_a_1_list {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28129, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28229, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28329, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28429, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28529, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28629, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28729, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28829, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_28929, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_281029, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_281129, $Keyword);
		...
		$this->BuildBasicSearchSQL($sWhere, $frm_fp_rep_ta_form_a_1->Remarks_281229, $Keyword);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28129); // Remarks (1)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28229); // Remarks (2)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28329); // Remarks (3)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28429); // Remarks (4)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28529); // Remarks (5)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28629); // Remarks (6)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28729); // Remarks (7)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28829); // Remarks (8)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_28929); // Remarks (9)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_281029); // Remarks (10)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_281129); // Remarks (11)
			...
			$frm_fp_rep_ta_form_a_1->UpdateSort($frm_fp_rep_ta_form_a_1->Remarks_281229); // Remarks (12)
	...
	function ResetCmd() {
		...
		if (@$_GET["cmd"] <> "") {
			...
			if (strtolower($sCmd) == "resetsort") {
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28129->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28229->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28329->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28429->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28529->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28629->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28729->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28829->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_28929->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_281029->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_281129->setSort("");
				...
				$frm_fp_rep_ta_form_a_1->Remarks_281229->setSort("");
			}
	...
	function LoadRowValues(&$rs) {
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28129->setDbValue($rs->fields('Remarks (1)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28229->setDbValue($rs->fields('Remarks (2)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28329->setDbValue($rs->fields('Remarks (3)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28429->setDbValue($rs->fields('Remarks (4)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28529->setDbValue($rs->fields('Remarks (5)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28629->setDbValue($rs->fields('Remarks (6)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28729->setDbValue($rs->fields('Remarks (7)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28829->setDbValue($rs->fields('Remarks (8)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_28929->setDbValue($rs->fields('Remarks (9)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_281029->setDbValue($rs->fields('Remarks (10)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_281129->setDbValue($rs->fields('Remarks (11)'));
		...
		$frm_fp_rep_ta_form_a_1->Remarks_281229->setDbValue($rs->fields('Remarks (12)'));
	}
	...
	function RenderRow() {
		...
		$frm_fp_rep_ta_form_a_1->units_id->CellCssStyle = "white-space: nowrap;";

		// focal_person_id
		$frm_fp_rep_ta_form_a_1->focal_person_id->CellCssStyle = "white-space: nowrap;";

		// Constituent University
		$frm_fp_rep_ta_form_a_1->Constituent_University->CellCssStyle = "white-space: nowrap;";
		...
		if ($frm_fp_rep_ta_form_a_1->RowType == UP_ROWTYPE_VIEW) { // View row
			...
			// Remarks (1)
			$frm_fp_rep_ta_form_a_1->Remarks_28129->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28129->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28129->ViewCustomAttributes = "";
			...
			// Remarks (2)
			$frm_fp_rep_ta_form_a_1->Remarks_28229->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28229->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28229->ViewCustomAttributes = "";
			...
			// Remarks (3)
			$frm_fp_rep_ta_form_a_1->Remarks_28329->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28329->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28329->ViewCustomAttributes = "";
			...
			// Remarks (4)
			$frm_fp_rep_ta_form_a_1->Remarks_28429->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28429->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28429->ViewCustomAttributes = "";
			...
			// Remarks (5)
			$frm_fp_rep_ta_form_a_1->Remarks_28529->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28529->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28529->ViewCustomAttributes = "";
			...
			// Remarks (6)
			$frm_fp_rep_ta_form_a_1->Remarks_28629->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28629->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28629->ViewCustomAttributes = "";
			...
			// Remarks (7)
			$frm_fp_rep_ta_form_a_1->Remarks_28729->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28729->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28729->ViewCustomAttributes = "";
			...
			// Remarks (8)
			$frm_fp_rep_ta_form_a_1->Remarks_28829->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28829->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28829->ViewCustomAttributes = "";
			...
			// Remarks (9)
			$frm_fp_rep_ta_form_a_1->Remarks_28929->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_28929->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_28929->ViewCustomAttributes = "";
			...
			// Remarks (10)
			$frm_fp_rep_ta_form_a_1->Remarks_281029->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_281029->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_281029->ViewCustomAttributes = "";
			...
			// Remarks (11)
			$frm_fp_rep_ta_form_a_1->Remarks_281129->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_281129->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_281129->ViewCustomAttributes = "";
			...
			// Remarks (12)
			$frm_fp_rep_ta_form_a_1->Remarks_281229->ViewValue = $frm_fp_rep_ta_form_a_1->Remarks_281229->CurrentValue;
			$frm_fp_rep_ta_form_a_1->Remarks_281229->ViewCustomAttributes = "";
			...
			// Remarks (1)
			$frm_fp_rep_ta_form_a_1->Remarks_28129->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28129->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28129->TooltipValue = "";
			...
			// Remarks (2)
			$frm_fp_rep_ta_form_a_1->Remarks_28229->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28229->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28229->TooltipValue = "";
			...
			// Remarks (3)
			$frm_fp_rep_ta_form_a_1->Remarks_28329->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28329->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28329->TooltipValue = "";
			...
			// Remarks (4)
			$frm_fp_rep_ta_form_a_1->Remarks_28429->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28429->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28429->TooltipValue = "";
			...
			// Remarks (5)
			$frm_fp_rep_ta_form_a_1->Remarks_28529->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28529->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28529->TooltipValue = "";
			...
			// Remarks (6)
			$frm_fp_rep_ta_form_a_1->Remarks_28629->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28629->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28629->TooltipValue = "";
			...
			// Remarks (7)
			$frm_fp_rep_ta_form_a_1->Remarks_28729->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28729->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28729->TooltipValue = "";
			...
			// Remarks (8)
			$frm_fp_rep_ta_form_a_1->Remarks_28829->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28829->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28829->TooltipValue = "";
			...
			// Remarks (9)
			$frm_fp_rep_ta_form_a_1->Remarks_28929->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28929->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_28929->TooltipValue = "";
			...
			// Remarks (10)
			$frm_fp_rep_ta_form_a_1->Remarks_281029->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_281029->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_281029->TooltipValue = "";
			...
			// Remarks (11)
			$frm_fp_rep_ta_form_a_1->Remarks_281129->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_281129->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_281129->TooltipValue = "";
			...
			// Remarks (12)
			$frm_fp_rep_ta_form_a_1->Remarks_281229->LinkCustomAttributes = "";
			$frm_fp_rep_ta_form_a_1->Remarks_281229->HrefValue = "";
			$frm_fp_rep_ta_form_a_1->Remarks_281229->TooltipValue = "";
		}
