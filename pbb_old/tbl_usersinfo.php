...
class ctbl_users {
	...
	function ctbl_users() {
		...
		// units_id
		$this->units_id = new cField('tbl_users', 'tbl_users', 'x_units_id', 'units_id', '`units_id`', 200, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['units_id'] =& $this->units_id;

		// cu_unit_name
		$this->cu_unit_name = new cField('tbl_users', 'tbl_users', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
...
//			$AddUrl .= "?" . $sUrlParm;
   ...
   // Common render codes
	...
	function UserIDFilter($userid) {
		$sUserIDFilter = '`units_id` = ' . up_QuotedValue($userid, UP_DATATYPE_STRING);
