...
$frm_sam_rep_t_completion_status_unit_pi = NULL;

//
// Table class for frm_sam_rep_t_completion_status_unit_pi
//
class cfrm_sam_rep_t_completion_status_unit_pi {
	var $TableVar = 'frm_sam_rep_t_completion_status_unit_pi';
	...
	//
	function cfrm_sam_rep_t_completion_status_unit_pi() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// units_id
		$this->units_id = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// CU
		$this->CU = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Unit
		$this->Unit = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_Unit', 'Unit', '`Unit`', 200, -1, FALSE, '`Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Unit'] =& $this->Unit;

		// Personnel Count
		$this->Personnel_Count = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_Personnel_Count', 'Personnel Count', '`Personnel Count`', 3, -1, FALSE, '`Personnel Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Total_No2E_of_PIs_Participated = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_Total_No2E_of_PIs_Participated', 'Total No. of PIs Participated', '`Total No. of PIs Participated`', 20, -1, FALSE, '`Total No. of PIs Participated`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// PIs Not Yet Started
		$this->PIs_Not_Yet_Started = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_PIs_Not_Yet_Started', 'PIs Not Yet Started', '`PIs Not Yet Started`', 20, -1, FALSE, '`PIs Not Yet Started`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// PIs Started
		$this->PIs_Started = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_PIs_Started', 'PIs Started', '`PIs Started`', 20, -1, FALSE, '`PIs Started`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->PIs_Started->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PIs Started'] =& $this->PIs_Started;

		// % Completed
		$this->z25_Completed = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_z25_Completed', '% Completed', '`% Completed`', 200, -1, FALSE, '`% Completed`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['% Completed'] =& $this->z25_Completed;

		// Completion Status
		$this->Completion_Status = new cField('frm_sam_rep_t_completion_status_unit_pi', 'frm_sam_rep_t_completion_status_unit_pi', 'x_Completion_Status', 'Completion Status', '`Completion Status`', 200, -1, FALSE, '`Completion Status`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_rep_t_completion_status_unit_pi_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_sam_rep_t_completion_status_unit_pi`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_rep_t_completion_status_unit_pi` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_rep_t_completion_status_unit_pi` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_rep_t_completion_status_unit_pi` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_rep_t_completion_status_unit_pilist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_rep_t_completion_status_unit_piview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_rep_t_completion_status_unit_piadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_t_completion_status_unit_piedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_t_completion_status_unit_piadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_rep_t_completion_status_unit_pidelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_rep_t_completion_status_unit_pi" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
