...
$frm_sam_rep_a_eligible_status_unit_mfo = NULL;

//
// Table class for frm_sam_rep_a_eligible_status_unit_mfo
//
class cfrm_sam_rep_a_eligible_status_unit_mfo {
	var $TableVar = 'frm_sam_rep_a_eligible_status_unit_mfo';
	...
	//
	function cfrm_sam_rep_a_eligible_status_unit_mfo() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_short_name
		$this->cu_short_name = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// cu_sequence
		$this->cu_sequence = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// units_id
		$this->units_id = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// cu_unit_name
		$this->cu_unit_name = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_unit_name'] =& $this->cu_unit_name;

		// mfo
		$this->mfo = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_mfo', 'mfo', '`mfo`', 3, -1, FALSE, '`mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo'] =& $this->mfo;

		// mfo_name_rep
		$this->mfo_name_rep = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_mfo_name_rep', 'mfo_name_rep', '`mfo_name_rep`', 200, -1, FALSE, '`mfo_name_rep`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name_rep'] =& $this->mfo_name_rep;

		// Participated PI
		$this->Participated_PI = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_Participated_PI', 'Participated PI', '`Participated PI`', 20, -1, FALSE, '`Participated PI`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Participated_PI->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Participated PI'] =& $this->Participated_PI;

		// Not Started PI
		$this->Not_Started_PI = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_Not_Started_PI', 'Not Started PI', '`Not Started PI`', 20, -1, FALSE, '`Not Started PI`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Not_Started_PI->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Not Started PI'] =& $this->Not_Started_PI;

		// % Not Started PI
		$this->z25_Not_Started_PI = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_z25_Not_Started_PI', '% Not Started PI', '`% Not Started PI`', 131, -1, FALSE, '`% Not Started PI`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Status
		$this->Status = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_Status', 'Status', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Status'] =& $this->Status;

		// Not Eligible PI Count
		$this->Not_Eligible_PI_Count = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_Not_Eligible_PI_Count', 'Not Eligible PI Count', '`Not Eligible PI Count`', 20, -1, FALSE, '`Not Eligible PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// % Not Eligible PI Count
		$this->z25_Not_Eligible_PI_Count = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_z25_Not_Eligible_PI_Count', '% Not Eligible PI Count', '`% Not Eligible PI Count`', 131, -1, FALSE, '`% Not Eligible PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Eligible PI Count
		$this->Eligible_PI_Count = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_Eligible_PI_Count', 'Eligible PI Count', '`Eligible PI Count`', 20, -1, FALSE, '`Eligible PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// % Eligible PI Count
		$this->z25_Eligible_PI_Count = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_z25_Eligible_PI_Count', '% Eligible PI Count', '`% Eligible PI Count`', 131, -1, FALSE, '`% Eligible PI Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Remarks
		$this->Remarks = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Remarks'] =& $this->Remarks;

		// budget
		$this->budget = new cField('frm_sam_rep_a_eligible_status_unit_mfo', 'frm_sam_rep_a_eligible_status_unit_mfo', 'x_budget', 'budget', '`budget`', 131, -1, FALSE, '`budget`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_rep_a_eligible_status_unit_mfo_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_sam_rep_a_eligible_status_unit_mfo`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_rep_a_eligible_status_unit_mfo` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_rep_a_eligible_status_unit_mfo` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_rep_a_eligible_status_unit_mfo` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_rep_a_eligible_status_unit_mfolist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unit_mfoview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_rep_a_eligible_status_unit_mfoadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unit_mfoedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unit_mfoadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unit_mfodelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_rep_a_eligible_status_unit_mfo" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
