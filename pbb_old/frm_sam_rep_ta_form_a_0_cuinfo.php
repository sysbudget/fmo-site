...
$frm_sam_rep_ta_form_a_0_cu = NULL;

//
// Table class for frm_sam_rep_ta_form_a_0_cu
//
class cfrm_sam_rep_ta_form_a_0_cu {
	var $TableVar = 'frm_sam_rep_ta_form_a_0_cu';
	...
	//
	function cfrm_sam_rep_ta_form_a_0_cu() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// id
		$this->id = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_id', 'id', '`id`', 20, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// CU Office
		$this->CU_Office = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_CU_Office', 'CU Office', '`CU Office`', 200, -1, FALSE, '`CU Office`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU Office'] =& $this->CU_Office;

		// Sequence
		$this->Sequence = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Sequence', 'Sequence', '`Sequence`', 3, -1, FALSE, '`Sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sequence'] =& $this->Sequence;

		// MFO
		$this->MFO = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_MFO', 'MFO', '`MFO`', 200, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['MFO'] =& $this->MFO;

		// Question
		$this->Question = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Question', 'Question', '`Question`', 200, -1, FALSE, '`Question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Question'] =& $this->Question;

		// Participating Units Count
		$this->Participating_Units_Count = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Participating_Units_Count', 'Participating Units Count', '`Participating Units Count`', 20, -1, FALSE, '`Participating Units Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Target
		$this->Target = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Target', 'Target', '`Target`', 5, -1, FALSE, '`Target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Target'] =& $this->Target;

		// Numerator (T)
		$this->Numerator_28T29 = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Numerator_28T29', 'Numerator (T)', '`Numerator (T)`', 5, -1, FALSE, '`Numerator (T)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator_28T29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator (T)'] =& $this->Numerator_28T29;

		// Denominator (T)
		$this->Denominator_28T29 = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Denominator_28T29', 'Denominator (T)', '`Denominator (T)`', 5, -1, FALSE, '`Denominator (T)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Denominator_28T29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Denominator (T)'] =& $this->Denominator_28T29;

		// Accomplishment
		$this->Accomplishment = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Accomplishment', 'Accomplishment', '`Accomplishment`', 5, -1, FALSE, '`Accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Accomplishment'] =& $this->Accomplishment;

		// Numerator (A)
		$this->Numerator_28A29 = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Numerator_28A29', 'Numerator (A)', '`Numerator (A)`', 5, -1, FALSE, '`Numerator (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Numerator_28A29->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Numerator (A)'] =& $this->Numerator_28A29;

		// Denominator (A)
		$this->Denominator_28A29 = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Denominator_28A29', 'Denominator (A)', '`Denominator (A)`', 5, -1, FALSE, '`Denominator (A)`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Supporting_Documents_Count = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Supporting_Documents_Count', 'Supporting Documents Count', '`Supporting Documents Count`', 5, -1, FALSE, '`Supporting Documents Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Rating
		$this->Rating = new cField('frm_sam_rep_ta_form_a_0_cu', 'frm_sam_rep_ta_form_a_0_cu', 'x_Rating', 'Rating', '`Rating`', 5, -1, FALSE, '`Rating`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_rep_ta_form_a_0_cu_Highlight";
	}
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "frm_sam_rep_ta_form_a_0") {
			if ($this->Sequence->getSessionValue() <> "")
				$sMasterFilter .= "`Sequence`=" . up_QuotedValue($this->Sequence->getSessionValue(), UP_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	function getDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "frm_sam_rep_ta_form_a_0") {
			if ($this->Sequence->getSessionValue() <> "")
				$sDetailFilter .= "`Sequence`=" . up_QuotedValue($this->Sequence->getSessionValue(), UP_DATATYPE_NUMBER);
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_frm_sam_rep_ta_form_a_0() {
		return "`Sequence`=@Sequence@";
	}

	// Detail filter
	function SqlDetailFilter_frm_sam_rep_ta_form_a_0() {
		return "`Sequence`=@Sequence@";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_sam_pbb_detail") {
			$sDetailUrl = $GLOBALS["frm_sam_pbb_detail"]->ListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlFrom() { // From
		return "`frm_sam_rep_ta_form_a_0_cu`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_rep_ta_form_a_0_cu` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_rep_ta_form_a_0_cu` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_rep_ta_form_a_0_cu` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_rep_ta_form_a_0_culist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_rep_ta_form_a_0_cuview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_rep_ta_form_a_0_cuadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_ta_form_a_0_cuedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_ta_form_a_0_cuadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_rep_ta_form_a_0_cudelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_rep_ta_form_a_0_cu" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
