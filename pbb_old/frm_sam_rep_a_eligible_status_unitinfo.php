...
$frm_sam_rep_a_eligible_status_unit = NULL;

//
// Table class for frm_sam_rep_a_eligible_status_unit
//
class cfrm_sam_rep_a_eligible_status_unit {
	var $TableVar = 'frm_sam_rep_a_eligible_status_unit';
	...
	//
	function cfrm_sam_rep_a_eligible_status_unit() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_short_name
		$this->cu_short_name = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// cu_sequence
		$this->cu_sequence = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// units_id
		$this->units_id = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// cu_unit_name
		$this->cu_unit_name = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_unit_name'] =& $this->cu_unit_name;

		// personnel_count
		$this->personnel_count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_personnel_count', 'personnel_count', '`personnel_count`', 3, -1, FALSE, '`personnel_count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Participated_MFO_Count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_Participated_MFO_Count', 'Participated MFO Count', '`Participated MFO Count`', 20, -1, FALSE, '`Participated MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Not_Started_MFO_Count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_Not_Started_MFO_Count', 'Not Started MFO Count', '`Not Started MFO Count`', 20, -1, FALSE, '`Not Started MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// % Not Started MFO
		$this->z25_Not_Started_MFO = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_z25_Not_Started_MFO', '% Not Started MFO', '`% Not Started MFO`', 131, -1, FALSE, '`% Not Started MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Status
		$this->Status = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_Status', 'Status', '`Status`', 200, -1, FALSE, '`Status`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Status'] =& $this->Status;

		// Not Eligible MFO Count
		$this->Not_Eligible_MFO_Count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_Not_Eligible_MFO_Count', 'Not Eligible MFO Count', '`Not Eligible MFO Count`', 20, -1, FALSE, '`Not Eligible MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// % Not Eligible MFO Count
		$this->z25_Not_Eligible_MFO_Count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_z25_Not_Eligible_MFO_Count', '% Not Eligible MFO Count', '`% Not Eligible MFO Count`', 131, -1, FALSE, '`% Not Eligible MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Eligible MFO Count
		$this->Eligible_MFO_Count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_Eligible_MFO_Count', 'Eligible MFO Count', '`Eligible MFO Count`', 20, -1, FALSE, '`Eligible MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// % Eligible MFO Count
		$this->z25_Eligible_MFO_Count = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_z25_Eligible_MFO_Count', '% Eligible MFO Count', '`% Eligible MFO Count`', 131, -1, FALSE, '`% Eligible MFO Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Remarks
		$this->Remarks = new cField('frm_sam_rep_a_eligible_status_unit', 'frm_sam_rep_a_eligible_status_unit', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_rep_a_eligible_status_unit_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`frm_sam_rep_a_eligible_status_unit`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_rep_a_eligible_status_unit` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_rep_a_eligible_status_unit` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_rep_a_eligible_status_unit` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_rep_a_eligible_status_unitlist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unitview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_rep_a_eligible_status_unitadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unitedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unitadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_rep_a_eligible_status_unitdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_rep_a_eligible_status_unit" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
