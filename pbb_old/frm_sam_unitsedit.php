...
// Create page object
$frm_sam_units_edit = new cfrm_sam_units_edit();
$Page =& $frm_sam_units_edit;

// Page init
$frm_sam_units_edit->Page_Init();

// Page main
$frm_sam_units_edit->Page_Main();
?>
...
// Create page object
var frm_sam_units_edit = new up_Page("frm_sam_units_edit");

// page properties
frm_sam_units_edit.PageID = "edit"; // page ID
frm_sam_units_edit.FormID = "ffrm_sam_unitsedit"; // form ID
var UP_PAGE_ID = frm_sam_units_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
frm_sam_units_edit.ValidateForm = function(fobj) {
...
frm_sam_units_edit.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
frm_sam_units_edit.SelectAllKey = function(elem) {
	up_SelectAll(elem);
	up_ClickAll(elem);
}
<?php if (UP_CLIENT_VALIDATE) { ?>
frm_sam_units_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
frm_sam_units_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<p class="upbudgetofficeclass upTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $frm_sam_units->TableCaption() ?></p>
<p class="upbudgetofficeclass"><a href="<?php echo $frm_sam_units->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $frm_sam_units_edit->ShowPageHeader(); ?>
<?php
$frm_sam_units_edit->ShowMessage();
?>
<form name="ffrm_sam_unitsedit" id="ffrm_sam_unitsedit" action="<?php echo up_CurrentPage() ?>" method="post" onsubmit="return frm_sam_units_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="frm_sam_units">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="upGrid"><tr><td class="upGridContent">
<div class="upGridMiddlePanel">
<table cellspacing="0" class="upTable">
<?php if ($frm_sam_units->cu_short_name->Visible) { // cu_short_name ?>
	<tr id="r_cu_short_name"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->cu_short_name->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->cu_short_name->CellAttributes() ?>><span id="el_cu_short_name">
<div<?php echo $frm_sam_units->cu_short_name->ViewAttributes() ?>><?php echo $frm_sam_units->cu_short_name->EditValue ?></div>
<input type="hidden" name="x_cu_short_name" id="x_cu_short_name" value="<?php echo up_HtmlEncode($frm_sam_units->cu_short_name->CurrentValue) ?>">
</span><?php echo $frm_sam_units->cu_short_name->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->unit_name->Visible) { // unit_name ?>
	<tr id="r_unit_name"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->unit_name->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->unit_name->CellAttributes() ?>><span id="el_unit_name">
<input type="text" name="x_unit_name" id="x_unit_name" size="30" maxlength="255" value="<?php echo $frm_sam_units->unit_name->EditValue ?>"<?php echo $frm_sam_units->unit_name->EditAttributes() ?>>
</span><?php echo $frm_sam_units->unit_name->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->personnel_count->Visible) { // personnel_count ?>
	<tr id="r_personnel_count"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->personnel_count->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->personnel_count->CellAttributes() ?>><span id="el_personnel_count">
<input type="text" name="x_personnel_count" id="x_personnel_count" size="30" value="<?php echo $frm_sam_units->personnel_count->EditValue ?>"<?php echo $frm_sam_units->personnel_count->EditAttributes() ?>>
</span><?php echo $frm_sam_units->personnel_count->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->mfo_1->Visible) { // mfo_1 ?>
	<tr id="r_mfo_1"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->mfo_1->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->mfo_1->CellAttributes() ?>><span id="el_mfo_1">
<div id="tp_x_mfo_1" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_mfo_1" id="x_mfo_1" value="{value}"<?php echo $frm_sam_units->mfo_1->EditAttributes() ?>></label></div>
...
<label><input type="radio" name="x_mfo_1" id="x_mfo_1" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->mfo_1->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
...
</span><?php echo $frm_sam_units->mfo_1->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->mfo_2->Visible) { // mfo_2 ?>
	<tr id="r_mfo_2"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->mfo_2->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->mfo_2->CellAttributes() ?>><span id="el_mfo_2">
<div id="tp_x_mfo_2" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_mfo_2" id="x_mfo_2" value="{value}"<?php echo $frm_sam_units->mfo_2->EditAttributes() ?>></label></div>
...
?>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label><input type="radio" name="x_mfo_2" id="x_mfo_2" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->mfo_2->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
</span><?php echo $frm_sam_units->mfo_2->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->mfo_3->Visible) { // mfo_3 ?>
	<tr id="r_mfo_3"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->mfo_3->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->mfo_3->CellAttributes() ?>><span id="el_mfo_3">
<div id="tp_x_mfo_3" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_mfo_3" id="x_mfo_3" value="{value}"<?php echo $frm_sam_units->mfo_3->EditAttributes() ?>></label></div>
...
?>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label><input type="radio" name="x_mfo_3" id="x_mfo_3" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->mfo_3->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
</span><?php echo $frm_sam_units->mfo_3->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->mfo_4->Visible) { // mfo_4 ?>
	<tr id="r_mfo_4"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->mfo_4->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->mfo_4->CellAttributes() ?>><span id="el_mfo_4">
<div id="tp_x_mfo_4" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_mfo_4" id="x_mfo_4" value="{value}"<?php echo $frm_sam_units->mfo_4->EditAttributes() ?>></label></div>
...
?>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label><input type="radio" name="x_mfo_4" id="x_mfo_4" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->mfo_4->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
</span><?php echo $frm_sam_units->mfo_4->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->mfo_5->Visible) { // mfo_5 ?>
	<tr id="r_mfo_5"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->mfo_5->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->mfo_5->CellAttributes() ?>><span id="el_mfo_5">
<div id="tp_x_mfo_5" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_mfo_5" id="x_mfo_5" value="{value}"<?php echo $frm_sam_units->mfo_5->EditAttributes() ?>></label></div>
...
?>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label><input type="radio" name="x_mfo_5" id="x_mfo_5" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->mfo_5->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
</span><?php echo $frm_sam_units->mfo_5->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->sto->Visible) { // sto ?>
	<tr id="r_sto"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->sto->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->sto->CellAttributes() ?>><span id="el_sto">
<div id="tp_x_sto" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_sto" id="x_sto" value="{value}"<?php echo $frm_sam_units->sto->EditAttributes() ?>></label></div>
...
?>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label><input type="radio" name="x_sto" id="x_sto" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->sto->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
</span><?php echo $frm_sam_units->sto->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->gass->Visible) { // gass ?>
	<tr id="r_gass"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->gass->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->gass->CellAttributes() ?>><span id="el_gass">
<div id="tp_x_gass" class="<?php echo UP_ITEM_TEMPLATE_CLASSNAME ?>"><label><input type="radio" name="x_gass" id="x_gass" value="{value}"<?php echo $frm_sam_units->gass->EditAttributes() ?>></label></div>
...
?>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 1) ?>
<label><input type="radio" name="x_gass" id="x_gass" value="<?php echo up_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?><?php echo $frm_sam_units->gass->EditAttributes() ?>><?php echo $arwrk[$rowcntwrk][1] ?></label>
<?php echo up_RepeatColumnTable($rowswrk, $rowcntwrk, 5, 2) ?>
<?php
	}
}
...
</span><?php echo $frm_sam_units->gass->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_sam_units->t_cutOffDate_remarks->Visible) { // t_cutOffDate_remarks ?>
	<tr id="r_t_cutOffDate_remarks"<?php echo $frm_sam_units->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_sam_units->t_cutOffDate_remarks->FldCaption() ?></td>
		<td<?php echo $frm_sam_units->t_cutOffDate_remarks->CellAttributes() ?>><span id="el_t_cutOffDate_remarks">
<div<?php echo $frm_sam_units->t_cutOffDate_remarks->ViewAttributes() ?>><?php echo $frm_sam_units->t_cutOffDate_remarks->EditValue ?></div>
<input type="hidden" name="x_t_cutOffDate_remarks" id="x_t_cutOffDate_remarks" value="<?php echo up_HtmlEncode($frm_sam_units->t_cutOffDate_remarks->CurrentValue) ?>">
</span><?php echo $frm_sam_units->t_cutOffDate_remarks->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</div>
</td></tr></table>
<input type="hidden" name="x_units_id" id="x_units_id" value="<?php echo up_HtmlEncode($frm_sam_units->units_id->CurrentValue) ?>">
<p>
<input type="submit" name="btnAction" id="btnAction" value="<?php echo up_BtnCaption($Language->Phrase("EditBtn")) ?>">
</form>
<?php
$frm_sam_units_edit->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<script language="JavaScript" type="text/javascript">
...
<?php
$frm_sam_units_edit->Page_Terminate();
?>
<?php
...
class cfrm_sam_units_edit {
	...
	// Page object name
	var $PageObjName = 'frm_sam_units_edit';
	...
	//
	function Page_Main() {
		global $objForm, $Language, $gsFormError, $frm_sam_units;

		// Load key from QueryString
		if (@$_GET["units_id"] <> "")
			$frm_sam_units->units_id->setQueryStringValue($_GET["units_id"]);

		// Set up master detail parameters
		$this->SetUpMasterParms();
		if (@$_POST["a_edit"] <> "") {
			$frm_sam_units->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate form
			if (!$this->ValidateForm()) {
				$frm_sam_units->CurrentAction = ""; // Form error, reset action
				$this->setFailureMessage($gsFormError);
				$frm_sam_units->EventCancelled = TRUE; // Event cancelled
				$this->RestoreFormValues();
			}
		} else {
			$frm_sam_units->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($frm_sam_units->units_id->CurrentValue == "")
			$this->Page_Terminate("frm_sam_unitslist.php"); // Invalid key, return to list
		switch ($frm_sam_units->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					$this->setFailureMessage($Language->Phrase("NoRecord")); // No record found
					$this->Page_Terminate("frm_sam_unitslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$frm_sam_units->SendEmail = TRUE; // Send email on update success
				if ($this->EditRow()) { // Update record based on key
					$this->setSuccessMessage($Language->Phrase("UpdateSuccess")); // Update success
					$sReturnUrl = $frm_sam_units->getReturnUrl();
		...
		// Render the record
		$frm_sam_units->RowType = UP_ROWTYPE_EDIT; // Render as Edit
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm, $frm_sam_units;
		if (!$frm_sam_units->cu_short_name->FldIsDetailKey) {
			$frm_sam_units->cu_short_name->setFormValue($objForm->GetValue("x_cu_short_name"));
		}
		if (!$frm_sam_units->unit_name->FldIsDetailKey) {
			$frm_sam_units->unit_name->setFormValue($objForm->GetValue("x_unit_name"));
		}
		...
		if (!$frm_sam_units->units_id->FldIsDetailKey)
	...
	function RestoreFormValues() {
		...
		$frm_sam_units->cu_short_name->CurrentValue = $frm_sam_units->cu_short_name->FormValue;
		$frm_sam_units->unit_name->CurrentValue = $frm_sam_units->unit_name->FormValue;
	...
	function RenderRow() {
		...
		if ($frm_sam_units->RowType == UP_ROWTYPE_VIEW) { // View row
			...
			// cu_short_name
			$frm_sam_units->cu_short_name->ViewValue = $frm_sam_units->cu_short_name->CurrentValue;
			$frm_sam_units->cu_short_name->ViewCustomAttributes = "";

			// unit_name
			$frm_sam_units->unit_name->ViewValue = $frm_sam_units->unit_name->CurrentValue;
			$frm_sam_units->unit_name->ViewCustomAttributes = "";
			...
			// cu_short_name
			$frm_sam_units->cu_short_name->LinkCustomAttributes = "";
			$frm_sam_units->cu_short_name->HrefValue = "";
			$frm_sam_units->cu_short_name->TooltipValue = "";

			// unit_name
			$frm_sam_units->unit_name->LinkCustomAttributes = "";
			$frm_sam_units->unit_name->HrefValue = "";
			$frm_sam_units->unit_name->TooltipValue = "";
			...
			// cu_short_name
			$frm_sam_units->cu_short_name->EditCustomAttributes = "";
			$frm_sam_units->cu_short_name->EditValue = $frm_sam_units->cu_short_name->CurrentValue;
			$frm_sam_units->cu_short_name->ViewCustomAttributes = "";

			// unit_name
			$frm_sam_units->unit_name->EditCustomAttributes = "";
			$frm_sam_units->unit_name->EditValue = up_HtmlEncode($frm_sam_units->unit_name->CurrentValue);
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// unit_name
			$frm_sam_units->unit_name->SetDbValueDef($rsnew, $frm_sam_units->unit_name->CurrentValue, NULL, $frm_sam_units->unit_name->ReadOnly);
