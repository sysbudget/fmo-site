...
//
// Table class for frm_sam_users
//
class cfrm_sam_users {
	var $TableVar = 'frm_sam_users';
	...
	//
	function cfrm_sam_users() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// users_ID
		$this->users_ID = new cField('frm_sam_users', 'frm_sam_users', 'x_users_ID', 'users_ID', '`users_ID`', 3, -1, FALSE, '`users_ID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->users_ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['users_ID'] =& $this->users_ID;

		// cu
		$this->cu = new cField('frm_sam_users', 'frm_sam_users', 'x_cu', 'cu', '`cu`', 200, -1, FALSE, '`cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu'] =& $this->cu;

		// units_id
		$this->units_id = new cField('frm_sam_users', 'frm_sam_users', 'x_units_id', 'units_id', '`units_id`', 200, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['units_id'] =& $this->units_id;

		// cu_unit_name
		$this->cu_unit_name = new cField('frm_sam_users', 'frm_sam_users', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_unit_name'] =& $this->cu_unit_name;

		// users_name
		$this->users_name = new cField('frm_sam_users', 'frm_sam_users', 'x_users_name', 'users_name', '`users_name`', 200, -1, FALSE, '`users_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_name'] =& $this->users_name;

		// users_nameLast
		$this->users_nameLast = new cField('frm_sam_users', 'frm_sam_users', 'x_users_nameLast', 'users_nameLast', '`users_nameLast`', 200, -1, FALSE, '`users_nameLast`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_nameLast'] =& $this->users_nameLast;

		// users_nameFirst
		$this->users_nameFirst = new cField('frm_sam_users', 'frm_sam_users', 'x_users_nameFirst', 'users_nameFirst', '`users_nameFirst`', 200, -1, FALSE, '`users_nameFirst`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_nameFirst'] =& $this->users_nameFirst;

		// users_nameMiddle
		$this->users_nameMiddle = new cField('frm_sam_users', 'frm_sam_users', 'x_users_nameMiddle', 'users_nameMiddle', '`users_nameMiddle`', 200, -1, FALSE, '`users_nameMiddle`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_nameMiddle'] =& $this->users_nameMiddle;

		// users_userLoginName
		$this->users_userLoginName = new cField('frm_sam_users', 'frm_sam_users', 'x_users_userLoginName', 'users_userLoginName', '`users_userLoginName`', 200, -1, FALSE, '`users_userLoginName`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_userLoginName'] =& $this->users_userLoginName;

		// users_password
		$this->users_password = new cField('frm_sam_users', 'frm_sam_users', 'x_users_password', 'users_password', '`users_password`', 200, -1, FALSE, '`users_password`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_password'] =& $this->users_password;

		// users_userLevel
		$this->users_userLevel = new cField('frm_sam_users', 'frm_sam_users', 'x_users_userLevel', 'users_userLevel', '`users_userLevel`', 3, -1, FALSE, '`users_userLevel`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->users_userLevel->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['users_userLevel'] =& $this->users_userLevel;

		// users_email
		$this->users_email = new cField('frm_sam_users', 'frm_sam_users', 'x_users_email', 'users_email', '`users_email`', 200, -1, FALSE, '`users_email`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['users_email'] =& $this->users_email;

		// users_contactNo
		$this->users_contactNo = new cField('frm_sam_users', 'frm_sam_users', 'x_users_contactNo', 'users_contactNo', '`users_contactNo`', 200, -1, FALSE, '`users_contactNo`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_users_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_users` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_users` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_users` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_usersview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_usersadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_usersedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_usersadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_usersdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_users" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_sam_users` WHERE " . $this->AddUserIDFilter("");
