...
$frm_sam_pbb_detail = NULL;

//
// Table class for frm_sam_pbb_detail
//
class cfrm_sam_pbb_detail {
	var $TableVar = 'frm_sam_pbb_detail';
	...
	//
	function cfrm_sam_pbb_detail() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// pbb_id
		$this->pbb_id = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_pbb_id', 'pbb_id', '`pbb_id`', 3, -1, FALSE, '`pbb_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pbb_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pbb_id'] =& $this->pbb_id;

		// applicable
		$this->applicable = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_applicable', 'applicable', '`applicable`', 200, -1, FALSE, '`applicable`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['applicable'] =& $this->applicable;

		// units_id
		$this->units_id = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_units_id', 'units_id', '`units_id`', 3, -1, FALSE, '`units_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->units_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['units_id'] =& $this->units_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// cu_short_name
		$this->cu_short_name = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// cu_unit_name
		$this->cu_unit_name = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_cu_unit_name', 'cu_unit_name', '`cu_unit_name`', 200, -1, FALSE, '`cu_unit_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_unit_name'] =& $this->cu_unit_name;

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// mfo_id
		$this->mfo_id = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_mfo_id', 'mfo_id', '`mfo_id`', 3, -1, FALSE, '`mfo_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo_id'] =& $this->mfo_id;

		// mfo_sequence
		$this->mfo_sequence = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_mfo_sequence', 'mfo_sequence', '`mfo_sequence`', 3, -1, FALSE, '`mfo_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo_sequence'] =& $this->mfo_sequence;

		// mfo
		$this->mfo = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_mfo', 'mfo', '`mfo`', 3, -1, FALSE, '`mfo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->mfo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['mfo'] =& $this->mfo;

		// pi_no
		$this->pi_no = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_pi_no', 'pi_no', '`pi_no`', 3, -1, FALSE, '`pi_no`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi_no->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi_no'] =& $this->pi_no;

		// pi_sub
		$this->pi_sub = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_pi_sub', 'pi_sub', '`pi_sub`', 200, -1, FALSE, '`pi_sub`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_sub'] =& $this->pi_sub;

		// mfo_name_rep
		$this->mfo_name_rep = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_mfo_name_rep', 'mfo_name_rep', '`mfo_name_rep`', 200, -1, FALSE, '`mfo_name_rep`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name_rep'] =& $this->mfo_name_rep;

		// mfo_name
		$this->mfo_name = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_mfo_name', 'mfo_name', '`mfo_name`', 200, -1, FALSE, '`mfo_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['mfo_name'] =& $this->mfo_name;

		// pi_question
		$this->pi_question = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_pi_question', 'pi_question', '`pi_question`', 200, -1, FALSE, '`pi_question`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_question'] =& $this->pi_question;

		// target
		$this->target = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_target', 'target', '`target`', 5, -1, FALSE, '`target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['target'] =& $this->target;

		// t_numerator
		$this->t_numerator = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_numerator', 't_numerator', '`t_numerator`', 5, -1, FALSE, '`t_numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator'] =& $this->t_numerator;

		// t_numerator_qtr1
		$this->t_numerator_qtr1 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_numerator_qtr1', 't_numerator_qtr1', '`t_numerator_qtr1`', 5, -1, FALSE, '`t_numerator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr1->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr1'] =& $this->t_numerator_qtr1;

		// t_numerator_qtr2
		$this->t_numerator_qtr2 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_numerator_qtr2', 't_numerator_qtr2', '`t_numerator_qtr2`', 5, -1, FALSE, '`t_numerator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr2->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr2'] =& $this->t_numerator_qtr2;

		// t_numerator_qtr3
		$this->t_numerator_qtr3 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_numerator_qtr3', 't_numerator_qtr3', '`t_numerator_qtr3`', 5, -1, FALSE, '`t_numerator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr3->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr3'] =& $this->t_numerator_qtr3;

		// t_numerator_qtr4
		$this->t_numerator_qtr4 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_numerator_qtr4', 't_numerator_qtr4', '`t_numerator_qtr4`', 5, -1, FALSE, '`t_numerator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr4->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr4'] =& $this->t_numerator_qtr4;

		// t_denominator
		$this->t_denominator = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_denominator', 't_denominator', '`t_denominator`', 5, -1, FALSE, '`t_denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_denominator'] =& $this->t_denominator;

		// t_denominator_qtr1
		$this->t_denominator_qtr1 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_denominator_qtr1', 't_denominator_qtr1', '`t_denominator_qtr1`', 5, -1, FALSE, '`t_denominator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_denominator_qtr2
		$this->t_denominator_qtr2 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_denominator_qtr2', 't_denominator_qtr2', '`t_denominator_qtr2`', 5, -1, FALSE, '`t_denominator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_denominator_qtr3
		$this->t_denominator_qtr3 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_denominator_qtr3', 't_denominator_qtr3', '`t_denominator_qtr3`', 5, -1, FALSE, '`t_denominator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_denominator_qtr4
		$this->t_denominator_qtr4 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_denominator_qtr4', 't_denominator_qtr4', '`t_denominator_qtr4`', 5, -1, FALSE, '`t_denominator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_remarks
		$this->t_remarks = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_remarks', 't_remarks', '`t_remarks`', 200, -1, FALSE, '`t_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_remarks'] =& $this->t_remarks;

		// t_cutOffDate
		$this->t_cutOffDate = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_cutOffDate', 't_cutOffDate', '`t_cutOffDate`', 135, 6, FALSE, '`t_cutOffDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_remarks = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_t_cutOffDate_remarks', 't_cutOffDate_remarks', '`t_cutOffDate_remarks`', 200, -1, FALSE, '`t_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_cutOffDate_remarks'] =& $this->t_cutOffDate_remarks;

		// accomplishment
		$this->accomplishment = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_accomplishment', 'accomplishment', '`accomplishment`', 5, -1, FALSE, '`accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['accomplishment'] =& $this->accomplishment;

		// a_numerator
		$this->a_numerator = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_numerator', 'a_numerator', '`a_numerator`', 5, -1, FALSE, '`a_numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator'] =& $this->a_numerator;

		// a_numerator_qtr1
		$this->a_numerator_qtr1 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_numerator_qtr1', 'a_numerator_qtr1', '`a_numerator_qtr1`', 5, -1, FALSE, '`a_numerator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr1->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr1'] =& $this->a_numerator_qtr1;

		// a_numerator_qtr2
		$this->a_numerator_qtr2 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_numerator_qtr2', 'a_numerator_qtr2', '`a_numerator_qtr2`', 5, -1, FALSE, '`a_numerator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr2->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr2'] =& $this->a_numerator_qtr2;

		// a_numerator_qtr3
		$this->a_numerator_qtr3 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_numerator_qtr3', 'a_numerator_qtr3', '`a_numerator_qtr3`', 5, -1, FALSE, '`a_numerator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr3->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr3'] =& $this->a_numerator_qtr3;

		// a_numerator_qtr4
		$this->a_numerator_qtr4 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_numerator_qtr4', 'a_numerator_qtr4', '`a_numerator_qtr4`', 5, -1, FALSE, '`a_numerator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr4->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr4'] =& $this->a_numerator_qtr4;

		// a_denominator
		$this->a_denominator = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_denominator', 'a_denominator', '`a_denominator`', 5, -1, FALSE, '`a_denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_denominator'] =& $this->a_denominator;

		// a_denominator_qtr1
		$this->a_denominator_qtr1 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_denominator_qtr1', 'a_denominator_qtr1', '`a_denominator_qtr1`', 5, -1, FALSE, '`a_denominator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_denominator_qtr2
		$this->a_denominator_qtr2 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_denominator_qtr2', 'a_denominator_qtr2', '`a_denominator_qtr2`', 5, -1, FALSE, '`a_denominator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_denominator_qtr3
		$this->a_denominator_qtr3 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_denominator_qtr3', 'a_denominator_qtr3', '`a_denominator_qtr3`', 5, -1, FALSE, '`a_denominator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_denominator_qtr4
		$this->a_denominator_qtr4 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_denominator_qtr4', 'a_denominator_qtr4', '`a_denominator_qtr4`', 5, -1, FALSE, '`a_denominator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_supporting_docs
		$this->a_supporting_docs = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_supporting_docs', 'a_supporting_docs', '`a_supporting_docs`', 5, -1, FALSE, '`a_supporting_docs`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_supporting_docs_qtr1 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_supporting_docs_qtr1', 'a_supporting_docs_qtr1', '`a_supporting_docs_qtr1`', 5, -1, FALSE, '`a_supporting_docs_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_supporting_docs_qtr2 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_supporting_docs_qtr2', 'a_supporting_docs_qtr2', '`a_supporting_docs_qtr2`', 5, -1, FALSE, '`a_supporting_docs_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_supporting_docs_qtr3 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_supporting_docs_qtr3', 'a_supporting_docs_qtr3', '`a_supporting_docs_qtr3`', 5, -1, FALSE, '`a_supporting_docs_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_supporting_docs_qtr4 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_supporting_docs_qtr4', 'a_supporting_docs_qtr4', '`a_supporting_docs_qtr4`', 5, -1, FALSE, '`a_supporting_docs_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_remarks
		$this->a_remarks = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_remarks', 'a_remarks', '`a_remarks`', 200, -1, FALSE, '`a_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['a_remarks'] =& $this->a_remarks;

		// a_cutOffDate
		$this->a_cutOffDate = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_cutOffDate', 'a_cutOffDate', '`a_cutOffDate`', 135, 6, FALSE, '`a_cutOffDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_cutOffDate_fp
		$this->a_cutOffDate_fp = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_cutOffDate_fp', 'a_cutOffDate_fp', '`a_cutOffDate_fp`', 135, 6, FALSE, '`a_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_remarks = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_cutOffDate_remarks', 'a_cutOffDate_remarks', '`a_cutOffDate_remarks`', 200, -1, FALSE, '`a_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['a_cutOffDate_remarks'] =& $this->a_cutOffDate_remarks;

		// a_rating
		$this->a_rating = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_rating', 'a_rating', '`a_rating`', 5, -1, FALSE, '`a_rating`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_rating->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_rating'] =& $this->a_rating;

		// a_rating_above_90
		$this->a_rating_above_90 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_rating_above_90', 'a_rating_above_90', '`a_rating_above_90`', 5, -1, FALSE, '`a_rating_above_90`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_rating_below_90
		$this->a_rating_below_90 = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_rating_below_90', 'a_rating_below_90', '`a_rating_below_90`', 5, -1, FALSE, '`a_rating_below_90`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_supporting_docs_comparison = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_a_supporting_docs_comparison', 'a_supporting_docs_comparison', '`a_supporting_docs_comparison`', 200, -1, FALSE, '`a_supporting_docs_comparison`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['a_supporting_docs_comparison'] =& $this->a_supporting_docs_comparison;

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// form_a_1_sequence
		$this->form_a_1_sequence = new cField('frm_sam_pbb_detail', 'frm_sam_pbb_detail', 'x_form_a_1_sequence', 'form_a_1_sequence', '`form_a_1_sequence`', 3, -1, FALSE, '`form_a_1_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_pbb_detail_Highlight";
	}
	...
	function getMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "frm_sam_rep_ta_form_a_0_cu") {
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_pbb_detail` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_pbb_detail` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_pbb_detail` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_pbb_detaillist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_pbb_detailview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_pbb_detailadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_pbb_detailedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_pbb_detailadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_pbb_detaildelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_pbb_detail" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_sam_pbb_detail` WHERE " . $this->AddUserIDFilter("");
