...
$frm_sam_cutoffdate = NULL;

//
// Table class for frm_sam_cutoffdate
//
class cfrm_sam_cutoffdate {
	var $TableVar = 'frm_sam_cutoffdate';
	...
	//
	function cfrm_sam_cutoffdate() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// cutOffDate_id
		$this->cutOffDate_id = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_cutOffDate_id', 'cutOffDate_id', '`cutOffDate_id`', 3, -1, FALSE, '`cutOffDate_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cutOffDate_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cutOffDate_id'] =& $this->cutOffDate_id;

		// collection_id
		$this->collection_id = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_collection_id', 'collection_id', '`collection_id`', 3, -1, FALSE, '`collection_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->collection_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['collection_id'] =& $this->collection_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// focal_person_office
		$this->focal_person_office = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_focal_person_office', 'focal_person_office', '`focal_person_office`', 200, -1, FALSE, '`focal_person_office`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['focal_person_office'] =& $this->focal_person_office;

		// t_startDate
		$this->t_startDate = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_t_startDate', 't_startDate', '`t_startDate`', 135, 6, FALSE, '`t_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_startDate->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateMDY"));
		$this->fields['t_startDate'] =& $this->t_startDate;

		// t_cutOffDate
		$this->t_cutOffDate = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_t_cutOffDate', 't_cutOffDate', '`t_cutOffDate`', 135, 6, FALSE, '`t_cutOffDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_cutOffDate_fp
		$this->t_cutOffDate_fp = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_t_cutOffDate_fp', 't_cutOffDate_fp', '`t_cutOffDate_fp`', 135, 6, FALSE, '`t_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->t_cutOffDate_remarks = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_t_cutOffDate_remarks', 't_cutOffDate_remarks', '`t_cutOffDate_remarks`', 200, -1, FALSE, '`t_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['t_cutOffDate_remarks'] =& $this->t_cutOffDate_remarks;

		// a_startDate
		$this->a_startDate = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_a_startDate', 'a_startDate', '`a_startDate`', 135, 6, FALSE, '`a_startDate`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_startDate->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateMDY"));
		$this->fields['a_startDate'] =& $this->a_startDate;

		// a_cutOffDate
		$this->a_cutOffDate = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_a_cutOffDate', 'a_cutOffDate', '`a_cutOffDate`', 135, 6, FALSE, '`a_cutOffDate`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_cutOffDate_fp
		$this->a_cutOffDate_fp = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_a_cutOffDate_fp', 'a_cutOffDate_fp', '`a_cutOffDate_fp`', 135, 6, FALSE, '`a_cutOffDate_fp`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->a_cutOffDate_remarks = new cField('frm_sam_cutoffdate', 'frm_sam_cutoffdate', 'x_a_cutOffDate_remarks', 'a_cutOffDate_remarks', '`a_cutOffDate_remarks`', 200, -1, FALSE, '`a_cutOffDate_remarks`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_cutoffdate_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_cutoffdate` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_cutoffdate` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_cutoffdate` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_cutoffdatelist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_cutoffdateview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_cutoffdateadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_sam_cutoffdateedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_sam_cutoffdateadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_cutoffdatedelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_cutoffdate" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
