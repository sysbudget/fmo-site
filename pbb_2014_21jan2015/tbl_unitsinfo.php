...
//
// Table class for tbl_units
//
class ctbl_units {
	var $TableVar = 'tbl_units';
	...
	function ctbl_units() {
		...
		// id
		$this->id = new cField('tbl_units', 'tbl_units', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// unit_bo
		$this->unit_bo = new cField('tbl_units', 'tbl_units', 'x_unit_bo', 'unit_bo', '`unit_bo`', 200, -1, FALSE, '`unit_bo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_bo'] =& $this->unit_bo;

		// unit_cu
		$this->unit_cu = new cField('tbl_units', 'tbl_units', 'x_unit_cu', 'unit_cu', '`unit_cu`', 200, -1, FALSE, '`unit_cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_cu'] =& $this->unit_cu;

		// cu
		$this->cu = new cField('tbl_units', 'tbl_units', 'x_cu', 'cu', '`cu`', 200, -1, FALSE, '`cu`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tbl_units` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `tbl_units` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `tbl_units` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tbl_unitsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tbl_unitsadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("tbl_unitsedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("tbl_unitsadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tbl_unitsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tbl_units" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
