...
$view_trans_tbl_accomplishment_a_mfo_5 = NULL;

//
// Table class for view_trans_tbl_accomplishment_a_mfo_5
//
class cview_trans_tbl_accomplishment_a_mfo_5 {
	var $TableVar = 'view_trans_tbl_accomplishment_a_mfo_5';
	...
	//
	function cview_trans_tbl_accomplishment_a_mfo_5() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// pi_id
		$this->pi_id = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_pi_id', 'pi_id', '`pi_id`', 3, -1, FALSE, '`pi_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi_id'] =& $this->pi_id;

		// id
		$this->id = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// unit_bo
		$this->unit_bo = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_unit_bo', 'unit_bo', '`unit_bo`', 200, -1, FALSE, '`unit_bo`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_bo'] =& $this->unit_bo;

		// unit_cu
		$this->unit_cu = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_unit_cu', 'unit_cu', '`unit_cu`', 200, -1, FALSE, '`unit_cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['unit_cu'] =& $this->unit_cu;

		// pi
		$this->pi = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_pi', 'pi', '`pi`', 3, -1, FALSE, '`pi`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi'] =& $this->pi;

		// pi_no
		$this->pi_no = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_pi_no', 'pi_no', '`pi_no`', 20, -1, FALSE, '`pi_no`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->pi_no->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['pi_no'] =& $this->pi_no;

		// pi_description
		$this->pi_description = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_pi_description', 'pi_description', '`pi_description`', 200, -1, FALSE, '`pi_description`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_description'] =& $this->pi_description;

		// pi_1
		$this->pi_1 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_pi_1', 'pi_1', '`pi_1`', 200, -1, FALSE, '`pi_1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['pi_1'] =& $this->pi_1;

		// target
		$this->target = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_target', 'target', '`target`', 5, -1, FALSE, '`target`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->target->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['target'] =& $this->target;

		// t_numerator
		$this->t_numerator = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_numerator', 't_numerator', '`t_numerator`', 5, -1, FALSE, '`t_numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator'] =& $this->t_numerator;

		// t_numerator_qtr1
		$this->t_numerator_qtr1 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_numerator_qtr1', 't_numerator_qtr1', '`t_numerator_qtr1`', 5, -1, FALSE, '`t_numerator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr1->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr1'] =& $this->t_numerator_qtr1;

		// t_numerator_qtr2
		$this->t_numerator_qtr2 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_numerator_qtr2', 't_numerator_qtr2', '`t_numerator_qtr2`', 5, -1, FALSE, '`t_numerator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr2->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr2'] =& $this->t_numerator_qtr2;

		// t_numerator_qtr3
		$this->t_numerator_qtr3 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_numerator_qtr3', 't_numerator_qtr3', '`t_numerator_qtr3`', 5, -1, FALSE, '`t_numerator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr3->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr3'] =& $this->t_numerator_qtr3;

		// t_numerator_qtr4
		$this->t_numerator_qtr4 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_numerator_qtr4', 't_numerator_qtr4', '`t_numerator_qtr4`', 5, -1, FALSE, '`t_numerator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_numerator_qtr4->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_numerator_qtr4'] =& $this->t_numerator_qtr4;

		// t_denominator
		$this->t_denominator = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_denominator', 't_denominator', '`t_denominator`', 5, -1, FALSE, '`t_denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->t_denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['t_denominator'] =& $this->t_denominator;

		// t_denominator_qtr1
		$this->t_denominator_qtr1 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_denominator_qtr1', 't_denominator_qtr1', '`t_denominator_qtr1`', 5, -1, FALSE, '`t_denominator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_denominator_qtr2
		$this->t_denominator_qtr2 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_denominator_qtr2', 't_denominator_qtr2', '`t_denominator_qtr2`', 5, -1, FALSE, '`t_denominator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_denominator_qtr3
		$this->t_denominator_qtr3 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_denominator_qtr3', 't_denominator_qtr3', '`t_denominator_qtr3`', 5, -1, FALSE, '`t_denominator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// t_denominator_qtr4
		$this->t_denominator_qtr4 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_t_denominator_qtr4', 't_denominator_qtr4', '`t_denominator_qtr4`', 5, -1, FALSE, '`t_denominator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// accomplishment
		$this->accomplishment = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_accomplishment', 'accomplishment', '`accomplishment`', 5, -1, FALSE, '`accomplishment`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->accomplishment->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['accomplishment'] =& $this->accomplishment;

		// a_numerator
		$this->a_numerator = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_numerator', 'a_numerator', '`a_numerator`', 5, -1, FALSE, '`a_numerator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator'] =& $this->a_numerator;

		// a_numerator_qtr1
		$this->a_numerator_qtr1 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_numerator_qtr1', 'a_numerator_qtr1', '`a_numerator_qtr1`', 5, -1, FALSE, '`a_numerator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr1->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr1'] =& $this->a_numerator_qtr1;

		// a_numerator_qtr2
		$this->a_numerator_qtr2 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_numerator_qtr2', 'a_numerator_qtr2', '`a_numerator_qtr2`', 5, -1, FALSE, '`a_numerator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr2->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr2'] =& $this->a_numerator_qtr2;

		// a_numerator_qtr3
		$this->a_numerator_qtr3 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_numerator_qtr3', 'a_numerator_qtr3', '`a_numerator_qtr3`', 5, -1, FALSE, '`a_numerator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr3->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr3'] =& $this->a_numerator_qtr3;

		// a_numerator_qtr4
		$this->a_numerator_qtr4 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_numerator_qtr4', 'a_numerator_qtr4', '`a_numerator_qtr4`', 5, -1, FALSE, '`a_numerator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_numerator_qtr4->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_numerator_qtr4'] =& $this->a_numerator_qtr4;

		// a_denominator
		$this->a_denominator = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_denominator', 'a_denominator', '`a_denominator`', 5, -1, FALSE, '`a_denominator`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->a_denominator->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['a_denominator'] =& $this->a_denominator;

		// a_denominator_qtr1
		$this->a_denominator_qtr1 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_denominator_qtr1', 'a_denominator_qtr1', '`a_denominator_qtr1`', 5, -1, FALSE, '`a_denominator_qtr1`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_denominator_qtr2
		$this->a_denominator_qtr2 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_denominator_qtr2', 'a_denominator_qtr2', '`a_denominator_qtr2`', 5, -1, FALSE, '`a_denominator_qtr2`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_denominator_qtr3
		$this->a_denominator_qtr3 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_denominator_qtr3', 'a_denominator_qtr3', '`a_denominator_qtr3`', 5, -1, FALSE, '`a_denominator_qtr3`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// a_denominator_qtr4
		$this->a_denominator_qtr4 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_a_denominator_qtr4', 'a_denominator_qtr4', '`a_denominator_qtr4`', 5, -1, FALSE, '`a_denominator_qtr4`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// remarks
		$this->remarks = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_remarks', 'remarks', '`remarks`', 200, -1, FALSE, '`remarks`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['remarks'] =& $this->remarks;

		// cu_sequence
		$this->cu_sequence = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 200, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// id_units
		$this->id_units = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_id_units', 'id_units', '`id_units`', 3, -1, FALSE, '`id_units`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_units->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_units'] =& $this->id_units;

		// id_cu
		$this->id_cu = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_id_cu', 'id_cu', '`id_cu`', 3, -1, FALSE, '`id_cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_cu->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_cu'] =& $this->id_cu;

		// above_90
		$this->above_90 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_above_90', 'above_90', '`above_90`', 5, -1, FALSE, '`above_90`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->above_90->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['above_90'] =& $this->above_90;

		// below_90
		$this->below_90 = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_below_90', 'below_90', '`below_90`', 5, -1, FALSE, '`below_90`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->below_90->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['below_90'] =& $this->below_90;

		// collectionPeriod_status
		$this->collectionPeriod_status = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_collectionPeriod_status', 'collectionPeriod_status', '`collectionPeriod_status`', 200, -1, FALSE, '`collectionPeriod_status`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['collectionPeriod_status'] =& $this->collectionPeriod_status;

		// remarks_cutOffDate
		$this->remarks_cutOffDate = new cField('view_trans_tbl_accomplishment_a_mfo_5', 'view_trans_tbl_accomplishment_a_mfo_5', 'x_remarks_cutOffDate', 'remarks_cutOffDate', '`remarks_cutOffDate`', 135, 6, FALSE, '`remarks_cutOffDate`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "view_trans_tbl_accomplishment_a_mfo_5_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`view_trans_tbl_accomplishment_a_mfo_5`";
	}
	...
	function SqlWhere() { // Where
		$sWhere = "";
		$this->TableFilter = " `target` <> 0.00 AND `pi` = '5' AND `pi_no` < 13  AND `collectionPeriod_status` = 'A' ";
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `view_trans_tbl_accomplishment_a_mfo_5` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `view_trans_tbl_accomplishment_a_mfo_5` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `view_trans_tbl_accomplishment_a_mfo_5` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_trans_tbl_accomplishment_a_mfo_5list.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("view_trans_tbl_accomplishment_a_mfo_5view.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "view_trans_tbl_accomplishment_a_mfo_5add.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("view_trans_tbl_accomplishment_a_mfo_5edit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("view_trans_tbl_accomplishment_a_mfo_5add.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("view_trans_tbl_accomplishment_a_mfo_5delete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=view_trans_tbl_accomplishment_a_mfo_5" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `view_trans_tbl_accomplishment_a_mfo_5` WHERE " . $this->AddUserIDFilter("");
