...
define("UP_PROJECT_NAME", "PBB_2014", TRUE); // Project name
define("UP_RANDOM_KEY", 'fnz0Rg7b1S4TGtPR', TRUE); // Random key for encryption
define("UP_PROJECT_STYLESHEET_FILENAME", "phpcss/PBB_2014.css", TRUE); // Project stylesheet file name
...
define("UP_AUDIT_TRAIL_TABLE_NAME", "audittrail", TRUE); // Audit trail table name
