...
$view_reps_4_3_eligible_status = NULL;

//
// Table class for view_reps_4_3_eligible_status
//
class cview_reps_4_3_eligible_status {
	var $TableVar = 'view_reps_4_3_eligible_status';
	var $TableName = 'view_reps_4_3_eligible_status';
	var $TableType = 'VIEW';
	var $ID;
	var $Unit;
	var $MFO;
	var $No_of_PI_Participated;
	var $No_of_PI_with_9025_and_Above_Rating;
	var $Remarks;
	var $fields = array();
	...
	//
	function cview_reps_4_3_eligible_status() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// ID
		$this->ID = new cField('view_reps_4_3_eligible_status', 'view_reps_4_3_eligible_status', 'x_ID', 'ID', '`ID`', 3, -1, FALSE, '`ID`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->ID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID'] =& $this->ID;

		// Unit
		$this->Unit = new cField('view_reps_4_3_eligible_status', 'view_reps_4_3_eligible_status', 'x_Unit', 'Unit', '`Unit`', 200, -1, FALSE, '`Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Unit'] =& $this->Unit;

		// MFO
		$this->MFO = new cField('view_reps_4_3_eligible_status', 'view_reps_4_3_eligible_status', 'x_MFO', 'MFO', '`MFO`', 3, -1, FALSE, '`MFO`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->MFO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MFO'] =& $this->MFO;

		// No of PI Participated
		$this->No_of_PI_Participated = new cField('view_reps_4_3_eligible_status', 'view_reps_4_3_eligible_status', 'x_No_of_PI_Participated', 'No of PI Participated', '`No of PI Participated`', 20, -1, FALSE, '`No of PI Participated`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->No_of_PI_Participated->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['No of PI Participated'] =& $this->No_of_PI_Participated;

		// No of PI with 90% and Above Rating
		$this->No_of_PI_with_9025_and_Above_Rating = new cField('view_reps_4_3_eligible_status', 'view_reps_4_3_eligible_status', 'x_No_of_PI_with_9025_and_Above_Rating', 'No of PI with 90% and Above Rating', '`No of PI with 90% and Above Rating`', 20, -1, FALSE, '`No of PI with 90% and Above Rating`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->No_of_PI_with_9025_and_Above_Rating->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['No of PI with 90% and Above Rating'] =& $this->No_of_PI_with_9025_and_Above_Rating;

		// Remarks
		$this->Remarks = new cField('view_reps_4_3_eligible_status', 'view_reps_4_3_eligible_status', 'x_Remarks', 'Remarks', '`Remarks`', 200, -1, FALSE, '`Remarks`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "view_reps_4_3_eligible_status_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`view_reps_4_3_eligible_status`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `view_reps_4_3_eligible_status` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `view_reps_4_3_eligible_status` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `view_reps_4_3_eligible_status` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_reps_4_3_eligible_statuslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("view_reps_4_3_eligible_statusview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "view_reps_4_3_eligible_statusadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("view_reps_4_3_eligible_statusedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("view_reps_4_3_eligible_statusadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("view_reps_4_3_eligible_statusdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=view_reps_4_3_eligible_status" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->No_of_PI_Participated->setDbValue($rs->fields('No of PI Participated'));
		$this->No_of_PI_with_9025_and_Above_Rating->setDbValue($rs->fields('No of PI with 90% and Above Rating'));
   ...
   // Common render codes
		...
		// No of PI Participated
		$this->No_of_PI_Participated->CellCssStyle = "white-space: nowrap;";

		// No of PI with 90% and Above Rating
		$this->No_of_PI_with_9025_and_Above_Rating->CellCssStyle = "white-space: nowrap;";
		...
		// No of PI Participated
		$this->No_of_PI_Participated->ViewValue = $this->No_of_PI_Participated->CurrentValue;
		$this->No_of_PI_Participated->ViewCustomAttributes = "";

		// No of PI with 90% and Above Rating
		$this->No_of_PI_with_9025_and_Above_Rating->ViewValue = $this->No_of_PI_with_9025_and_Above_Rating->CurrentValue;
		$this->No_of_PI_with_9025_and_Above_Rating->ViewCustomAttributes = "";
		...
		// No of PI Participated
		$this->No_of_PI_Participated->LinkCustomAttributes = "";
		$this->No_of_PI_Participated->HrefValue = "";
		$this->No_of_PI_Participated->TooltipValue = "";

		// No of PI with 90% and Above Rating
		$this->No_of_PI_with_9025_and_Above_Rating->LinkCustomAttributes = "";
		$this->No_of_PI_with_9025_and_Above_Rating->HrefValue = "";
		$this->No_of_PI_with_9025_and_Above_Rating->TooltipValue = "";
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$XmlDoc->AddField('No_of_PI_Participated', $this->No_of_PI_Participated->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('No_of_PI_with_9025_and_Above_Rating', $this->No_of_PI_with_9025_and_Above_Rating->ExportValue($this->Export, $this->ExportOriginalValue));
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->No_of_PI_Participated);
				$Doc->ExportCaption($this->No_of_PI_with_9025_and_Above_Rating);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$Doc->ExportField($this->No_of_PI_Participated);
					$Doc->ExportField($this->No_of_PI_with_9025_and_Above_Rating);
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `view_reps_4_3_eligible_status` WHERE " . $this->AddUserIDFilter("");
