...
$frm_fp_rep_a_eligible_status = NULL;

//
// Table class for frm_fp_rep_a_eligible_status
//
class cfrm_fp_rep_a_eligible_status {
	var $TableVar = 'frm_fp_rep_a_eligible_status';
	...
	//
	function cfrm_fp_rep_a_eligible_status() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// focal_person_id
		$this->focal_person_id = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_short_name
		$this->cu_short_name = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// focal_person_office
		$this->focal_person_office = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_focal_person_office', 'focal_person_office', '`focal_person_office`', 200, -1, FALSE, '`focal_person_office`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['focal_person_office'] =& $this->focal_person_office;

		// cu_sequence
		$this->cu_sequence = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Participated3A_Unit_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Participated3A_Unit_Count', 'Participated: Unit Count', '`Participated: Unit Count`', 20, -1, FALSE, '`Participated: Unit Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Participated3A_Personnel_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Participated3A_Personnel_Count', 'Participated: Personnel Count', '`Participated: Personnel Count`', 131, -1, FALSE, '`Participated: Personnel Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Not_Eligible3A_Unit_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Not_Eligible3A_Unit_Count', 'Not Eligible: Unit Count', '`Not Eligible: Unit Count`', 20, -1, FALSE, '`Not Eligible: Unit Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Not Eligible: % Unit Count
		$this->Not_Eligible3A_25_Unit_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Not_Eligible3A_25_Unit_Count', 'Not Eligible: % Unit Count', '`Not Eligible: % Unit Count`', 131, -1, FALSE, '`Not Eligible: % Unit Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Not_Eligible3A_Personnel_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Not_Eligible3A_Personnel_Count', 'Not Eligible: Personnel Count', '`Not Eligible: Personnel Count`', 131, -1, FALSE, '`Not Eligible: Personnel Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Eligible: Unit Count
		$this->Eligible3A_Unit_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Eligible3A_Unit_Count', 'Eligible: Unit Count', '`Eligible: Unit Count`', 20, -1, FALSE, '`Eligible: Unit Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		// Eligible: % Unit Count
		$this->Eligible3A_25_Unit_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Eligible3A_25_Unit_Count', 'Eligible: % Unit Count', '`Eligible: % Unit Count`', 131, -1, FALSE, '`Eligible: % Unit Count`', FALSE, FALSE, 'FORMATTED TEXT');
		...
		$this->Eligible3A_Personnel_Count = new cField('frm_fp_rep_a_eligible_status', 'frm_fp_rep_a_eligible_status', 'x_Eligible3A_Personnel_Count', 'Eligible: Personnel Count', '`Eligible: Personnel Count`', 131, -1, FALSE, '`Eligible: Personnel Count`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_fp_rep_a_eligible_status_Highlight";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_fp_rep_a_eligible_status_unit") {
			$sDetailUrl = $GLOBALS["frm_fp_rep_a_eligible_status_unit"]->ListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlFrom() { // From
		return "`frm_fp_rep_a_eligible_status`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_fp_rep_a_eligible_status` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_fp_rep_a_eligible_status` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_fp_rep_a_eligible_status` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_fp_rep_a_eligible_statuslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_fp_rep_a_eligible_statusview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_fp_rep_a_eligible_statusadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("frm_fp_rep_a_eligible_statusedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("frm_fp_rep_a_eligible_statusadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_fp_rep_a_eligible_statusdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_fp_rep_a_eligible_status" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
   ...
   // Common render codes
		...
		// Participated: Unit Count
		$this->Participated3A_Unit_Count->CellCssStyle = "white-space: nowrap;";

		// Participated: Personnel Count
		$this->Participated3A_Personnel_Count->CellCssStyle = "white-space: nowrap;";

		// Not Eligible: Unit Count
		$this->Not_Eligible3A_Unit_Count->CellCssStyle = "white-space: nowrap;";

		// Not Eligible: % Unit Count
		$this->Not_Eligible3A_25_Unit_Count->CellCssStyle = "white-space: nowrap;";

		// Not Eligible: Personnel Count
		$this->Not_Eligible3A_Personnel_Count->CellCssStyle = "white-space: nowrap;";

		// Eligible: Unit Count
		$this->Eligible3A_Unit_Count->CellCssStyle = "white-space: nowrap;";

		// Eligible: % Unit Count
		$this->Eligible3A_25_Unit_Count->CellCssStyle = "white-space: nowrap;";

		// Eligible: Personnel Count
		$this->Eligible3A_Personnel_Count->CellCssStyle = "white-space: nowrap;";
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `frm_fp_rep_a_eligible_status` WHERE " . $this->AddUserIDFilter("");
