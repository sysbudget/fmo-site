...
frm_u_pbb_detail_accomplishment_edit.MultiPage = new up_MultiPage();
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_units_id", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_cu_unit_name", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_mfo_id", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_mfo_name", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_pi_question", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_target", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_numerator", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_numerator_qtr1", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_numerator_qtr2", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_numerator_qtr3", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_numerator_qtr4", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_denominator", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_denominator_qtr1", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_denominator_qtr2", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_denominator_qtr3", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_denominator_qtr4", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_remarks", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_t_cutOffDate_remarks", 2);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_accomplishment", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_numerator", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_numerator_qtr1", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_numerator_qtr2", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_numerator_qtr3", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_numerator_qtr4", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_denominator", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_denominator_qtr1", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_denominator_qtr2", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_denominator_qtr3", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_denominator_qtr4", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_supporting_docs", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_supporting_docs_qtr1", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_supporting_docs_qtr2", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_supporting_docs_qtr3", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_supporting_docs_qtr4", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_remarks", 1);
frm_u_pbb_detail_accomplishment_edit.MultiPage.AddElement("x_a_cutOffDate_remarks", 1);
...
<div id="frm_u_pbb_detail_accomplishment_edit" class="yui-navset">
	<ul class="yui-nav">
		<li class="selected"><a href="#tab_frm_u_pbb_detail_accomplishment_1"><em><span class="upbudgetofficeclass"><?php echo $frm_u_pbb_detail_accomplishment->PageCaption(1) ?></span></em></a></li>
		<li><a href="#tab_frm_u_pbb_detail_accomplishment_2"><em><span class="upbudgetofficeclass"><?php echo $frm_u_pbb_detail_accomplishment->PageCaption(2) ?></span></em></a></li>
	</ul>            
	<div class="yui-content">
		<div id="tab_frm_u_pbb_detail_accomplishment_1">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr1->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr1->EditValue ?></div>
<input type="hidden" name="x_a_supporting_docs_qtr1" id="x_a_supporting_docs_qtr1" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr1->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->EditValue ?></div>
<input type="hidden" name="x_a_supporting_docs_qtr2" id="x_a_supporting_docs_qtr2" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->EditValue ?></div>
<input type="hidden" name="x_a_supporting_docs_qtr3" id="x_a_supporting_docs_qtr3" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->EditValue ?></div>
<input type="hidden" name="x_a_supporting_docs_qtr4" id="x_a_supporting_docs_qtr4" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->CurrentValue) ?>">
...
<?php } ?>
		...
		<div id="tab_frm_u_pbb_detail_accomplishment_2">
<table cellspacing="0" class="upGrid" style="width: 100%"><tr><td class="upGridContent">
<div class="upGridMiddlePanel">
<table cellspacing="0" class="upTable">
<?php if ($frm_u_pbb_detail_accomplishment->units_id->Visible) { // units_id ?>
	<tr id="r_units_id"<?php echo $frm_u_pbb_detail_accomplishment->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_u_pbb_detail_accomplishment->units_id->FldCaption() ?></td>
		<td<?php echo $frm_u_pbb_detail_accomplishment->units_id->CellAttributes() ?>><span id="el_units_id">
<div<?php echo $frm_u_pbb_detail_accomplishment->units_id->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->units_id->EditValue ?></div>
<input type="hidden" name="x_units_id" id="x_units_id" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->units_id->CurrentValue) ?>">
</span><?php echo $frm_u_pbb_detail_accomplishment->units_id->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php if ($frm_u_pbb_detail_accomplishment->mfo_id->Visible) { // mfo_id ?>
	<tr id="r_mfo_id"<?php echo $frm_u_pbb_detail_accomplishment->RowAttributes() ?>>
		<td class="upTableHeader"><?php echo $frm_u_pbb_detail_accomplishment->mfo_id->FldCaption() ?></td>
		<td<?php echo $frm_u_pbb_detail_accomplishment->mfo_id->CellAttributes() ?>><span id="el_mfo_id">
<div<?php echo $frm_u_pbb_detail_accomplishment->mfo_id->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->mfo_id->EditValue ?></div>
<input type="hidden" name="x_mfo_id" id="x_mfo_id" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue) ?>">
</span><?php echo $frm_u_pbb_detail_accomplishment->mfo_id->CustomMsg ?></td>
	</tr>
<?php } ?>
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr1->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr1->EditValue ?></div>
<input type="hidden" name="x_t_numerator_qtr1" id="x_t_numerator_qtr1" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_numerator_qtr1->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr2->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr2->EditValue ?></div>
<input type="hidden" name="x_t_numerator_qtr2" id="x_t_numerator_qtr2" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_numerator_qtr2->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr3->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr3->EditValue ?></div>
<input type="hidden" name="x_t_numerator_qtr3" id="x_t_numerator_qtr3" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_numerator_qtr3->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr4->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_numerator_qtr4->EditValue ?></div>
<input type="hidden" name="x_t_numerator_qtr4" id="x_t_numerator_qtr4" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_numerator_qtr4->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr1->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr1->EditValue ?></div>
<input type="hidden" name="x_t_denominator_qtr1" id="x_t_denominator_qtr1" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_denominator_qtr1->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr2->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr2->EditValue ?></div>
<input type="hidden" name="x_t_denominator_qtr2" id="x_t_denominator_qtr2" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_denominator_qtr2->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr3->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr3->EditValue ?></div>
<input type="hidden" name="x_t_denominator_qtr3" id="x_t_denominator_qtr3" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_denominator_qtr3->CurrentValue) ?>">
...
<div<?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr4->ViewAttributes() ?>><?php echo $frm_u_pbb_detail_accomplishment->t_denominator_qtr4->EditValue ?></div>
<input type="hidden" name="x_t_denominator_qtr4" id="x_t_denominator_qtr4" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_denominator_qtr4->CurrentValue) ?>">
...
<input type="hidden" name="x_t_remarks" id="x_t_remarks" value="<?php echo up_HtmlEncode($frm_u_pbb_detail_accomplishment->t_remarks->CurrentValue) ?>">
...
<script type="text/javascript">
<!--
up_TabView(frm_u_pbb_detail_accomplishment_edit);
...
class cfrm_u_pbb_detail_accomplishment_edit {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm, $frm_u_pbb_detail_accomplishment;
		if (!$frm_u_pbb_detail_accomplishment->units_id->FldIsDetailKey) {
			$frm_u_pbb_detail_accomplishment->units_id->setFormValue($objForm->GetValue("x_units_id"));
		}
		...
		if (!$frm_u_pbb_detail_accomplishment->mfo_id->FldIsDetailKey) {
			$frm_u_pbb_detail_accomplishment->mfo_id->setFormValue($objForm->GetValue("x_mfo_id"));
		}
	...
	function RestoreFormValues() {
		...
		$frm_u_pbb_detail_accomplishment->units_id->CurrentValue = $frm_u_pbb_detail_accomplishment->units_id->FormValue;
		$frm_u_pbb_detail_accomplishment->cu_unit_name->CurrentValue = $frm_u_pbb_detail_accomplishment->cu_unit_name->FormValue;
		$frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue = $frm_u_pbb_detail_accomplishment->mfo_id->FormValue;
	...
	function RenderRow() {
		...
		if ($frm_u_pbb_detail_accomplishment->RowType == UP_ROWTYPE_VIEW) { // View row
			...
			// units_id
			$frm_u_pbb_detail_accomplishment->units_id->ViewValue = $frm_u_pbb_detail_accomplishment->units_id->CurrentValue;
			if (strval($frm_u_pbb_detail_accomplishment->units_id->CurrentValue) <> "") {
				$sFilterWrk = "`units_id` = " . up_AdjustSql($frm_u_pbb_detail_accomplishment->units_id->CurrentValue) . "";
			...
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				...
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$frm_u_pbb_detail_accomplishment->units_id->ViewValue = $rswrk->fields('unit_name');
					$rswrk->Close();
				} else {
					$frm_u_pbb_detail_accomplishment->units_id->ViewValue = $frm_u_pbb_detail_accomplishment->units_id->CurrentValue;
				}
			} else {
				$frm_u_pbb_detail_accomplishment->units_id->ViewValue = NULL;
			}
			$frm_u_pbb_detail_accomplishment->units_id->ViewCustomAttributes = "";
			...
			// mfo_id
			$frm_u_pbb_detail_accomplishment->mfo_id->ViewValue = $frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue;
			if (strval($frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue) <> "") {
				$sFilterWrk = "`mfo_id` = " . up_AdjustSql($frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue) . "";
			...
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$frm_u_pbb_detail_accomplishment->mfo_id->ViewValue = $rswrk->fields('pi_question');
					$rswrk->Close();
				} else {
					$frm_u_pbb_detail_accomplishment->mfo_id->ViewValue = $frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue;
				}
			} else {
				$frm_u_pbb_detail_accomplishment->mfo_id->ViewValue = NULL;
			}
			$frm_u_pbb_detail_accomplishment->mfo_id->ViewCustomAttributes = "";
			...
			// units_id
			$frm_u_pbb_detail_accomplishment->units_id->LinkCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->units_id->HrefValue = "";
			$frm_u_pbb_detail_accomplishment->units_id->TooltipValue = "";
			...
			// mfo_id
			$frm_u_pbb_detail_accomplishment->mfo_id->LinkCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->mfo_id->HrefValue = "";
			$frm_u_pbb_detail_accomplishment->mfo_id->TooltipValue = "";
			...
			// units_id
			$frm_u_pbb_detail_accomplishment->units_id->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->units_id->EditValue = $frm_u_pbb_detail_accomplishment->units_id->CurrentValue;
			if (strval($frm_u_pbb_detail_accomplishment->units_id->CurrentValue) <> "") {
				$sFilterWrk = "`units_id` = " . up_AdjustSql($frm_u_pbb_detail_accomplishment->units_id->CurrentValue) . "";
			$sSqlWrk = "SELECT `unit_name` FROM `tbl_units`";
			$sWhereWrk = "";
			...
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$frm_u_pbb_detail_accomplishment->units_id->EditValue = $rswrk->fields('unit_name');
					$rswrk->Close();
				} else {
					$frm_u_pbb_detail_accomplishment->units_id->EditValue = $frm_u_pbb_detail_accomplishment->units_id->CurrentValue;
				}
			} else {
				$frm_u_pbb_detail_accomplishment->units_id->EditValue = NULL;
			}
			$frm_u_pbb_detail_accomplishment->units_id->ViewCustomAttributes = "";
			...
			// mfo_id
			$frm_u_pbb_detail_accomplishment->mfo_id->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->mfo_id->EditValue = $frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue;
			if (strval($frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue) <> "") {
				$sFilterWrk = "`mfo_id` = " . up_AdjustSql($frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue) . "";
			$sSqlWrk = "SELECT `pi_question` FROM `tbl_mfo_questions`";
			$sWhereWrk = "";
			...
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
				$rswrk = $conn->Execute($sSqlWrk);
				if ($rswrk && !$rswrk->EOF) { // Lookup values found
					$frm_u_pbb_detail_accomplishment->mfo_id->EditValue = $rswrk->fields('pi_question');
					$rswrk->Close();
				} else {
					$frm_u_pbb_detail_accomplishment->mfo_id->EditValue = $frm_u_pbb_detail_accomplishment->mfo_id->CurrentValue;
				}
			} else {
				$frm_u_pbb_detail_accomplishment->mfo_id->EditValue = NULL;
			}
			$frm_u_pbb_detail_accomplishment->mfo_id->ViewCustomAttributes = "";
			...
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr1->EditValue = $frm_u_pbb_detail_accomplishment->t_numerator_qtr1->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr1->ViewCustomAttributes = "";

			// t_numerator_qtr2
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr2->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr2->EditValue = $frm_u_pbb_detail_accomplishment->t_numerator_qtr2->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr2->ViewCustomAttributes = "";

			// t_numerator_qtr3
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr3->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr3->EditValue = $frm_u_pbb_detail_accomplishment->t_numerator_qtr3->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr3->ViewCustomAttributes = "";

			// t_numerator_qtr4
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr4->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr4->EditValue = $frm_u_pbb_detail_accomplishment->t_numerator_qtr4->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_numerator_qtr4->ViewCustomAttributes = "";
			...
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr1->EditValue = $frm_u_pbb_detail_accomplishment->t_denominator_qtr1->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr1->ViewCustomAttributes = "";

			// t_denominator_qtr2
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr2->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr2->EditValue = $frm_u_pbb_detail_accomplishment->t_denominator_qtr2->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr2->ViewCustomAttributes = "";

			// t_denominator_qtr3
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr3->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr3->EditValue = $frm_u_pbb_detail_accomplishment->t_denominator_qtr3->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr3->ViewCustomAttributes = "";

			// t_denominator_qtr4
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr4->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr4->EditValue = $frm_u_pbb_detail_accomplishment->t_denominator_qtr4->CurrentValue;
			$frm_u_pbb_detail_accomplishment->t_denominator_qtr4->ViewCustomAttributes = "";
			...
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr1->EditValue = $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr1->CurrentValue;
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr1->ViewCustomAttributes = "";

			// a_supporting_docs_qtr2
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->EditValue = $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->CurrentValue;
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr2->ViewCustomAttributes = "";

			// a_supporting_docs_qtr3
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->EditValue = $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->CurrentValue;
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr3->ViewCustomAttributes = "";

			// a_supporting_docs_qtr4
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->EditCustomAttributes = "";
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->EditValue = $frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->CurrentValue;
			$frm_u_pbb_detail_accomplishment->a_supporting_docs_qtr4->ViewCustomAttributes = "";
