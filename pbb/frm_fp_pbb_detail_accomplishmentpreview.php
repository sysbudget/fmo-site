...
// Create page object
$frm_fp_pbb_detail_accomplishment_preview = new cfrm_fp_pbb_detail_accomplishment_preview();
$Page =& $frm_fp_pbb_detail_accomplishment_preview;

// Page init
$frm_fp_pbb_detail_accomplishment_preview->Page_Init();

// Page main
$frm_fp_pbb_detail_accomplishment_preview->Page_Main();
?>
...
<?php if ($frm_fp_pbb_detail_accomplishment_preview->TotalRecs > 0) { ?>
(<?php echo $frm_fp_pbb_detail_accomplishment_preview->TotalRecs ?>&nbsp;<?php echo $Language->Phrase("Record") ?>)
<?php } else { ?>
(<?php echo $Language->Phrase("NoRecord") ?>)
<?php } ?>
</p>
<?php $frm_fp_pbb_detail_accomplishment_preview->ShowPageHeader(); ?>
<?php if ($frm_fp_pbb_detail_accomplishment_preview->TotalRecs > 0) { ?>
...
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // cu_unit_name ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->cu_unit_name->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // mfo_name ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->mfo_name->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // target ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->target->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // t_numerator ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->t_numerator->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // t_denominator ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->t_denominator->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // t_remarks ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->t_remarks->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // accomplishment ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->accomplishment->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_numerator ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_numerator->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_denominator ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_denominator->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_supporting_docs ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_supporting_docs->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_remarks ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_remarks->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_rating_above_90 ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_rating_above_90->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_rating_below_90 ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_rating_below_90->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_supporting_docs_comparison ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_supporting_docs_comparison->FldCaption() ?></td>
<?php } ?>
<?php if ($frm_fp_pbb_detail_accomplishment->focal_person_id->Visible) { // a_cutOffDate_remarks ?>
			<td valign="top" style="white-space: nowrap;"><?php echo $frm_fp_pbb_detail_accomplishment->a_cutOffDate_remarks->FldCaption() ?></td>
<?php } ?>
		</tr>
	</thead>
	<tbody><!-- Table body -->
<?php
$frm_fp_pbb_detail_accomplishment_preview->RecCount = 0;
while ($frm_fp_pbb_detail_accomplishment_preview->Recordset && !$frm_fp_pbb_detail_accomplishment_preview->Recordset->EOF) {

	// Init row class and style
	$frm_fp_pbb_detail_accomplishment_preview->RecCount++;
	$frm_fp_pbb_detail_accomplishment->CssClass = "";
	$frm_fp_pbb_detail_accomplishment->CssStyle = "";
	$frm_fp_pbb_detail_accomplishment->LoadListRowValues($frm_fp_pbb_detail_accomplishment_preview->Recordset);

	// Render row
	$frm_fp_pbb_detail_accomplishment->RowType = UP_ROWTYPE_PREVIEW; // Preview record
	$frm_fp_pbb_detail_accomplishment->RenderListRow();
?>
...
<?php
	$frm_fp_pbb_detail_accomplishment_preview->Recordset->MoveNext();
}
?>
	</tbody>
</table>
...
<?php
$frm_fp_pbb_detail_accomplishment_preview->ShowPageFooter();
if (UP_DEBUG_ENABLED)
	echo up_DebugMsg();
?>
<?php
if ($frm_fp_pbb_detail_accomplishment_preview->Recordset)
	$frm_fp_pbb_detail_accomplishment_preview->Recordset->Close();
}
...
?>
<?php
$frm_fp_pbb_detail_accomplishment_preview->Page_Terminate();
?>
<?php
...
// Page class
//
class cfrm_fp_pbb_detail_accomplishment_preview {
	...
	// Page object name
	var $PageObjName = 'frm_fp_pbb_detail_accomplishment_preview';
	...
	//
	function cfrm_fp_pbb_detail_accomplishment_preview() {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('frm_fp_pbb_detail_accomplishment');
	...
	function Page_Main() {
		...
		$frm_fp_pbb_detail_accomplishment->Recordset_Selecting($filter);
		$this->Recordset = $frm_fp_pbb_detail_accomplishment->LoadRs($filter);
		$this->TotalRecs = ($this->Recordset) ? $this->Recordset->RecordCount() : 0;

		// Call Recordset Selected event
		$frm_fp_pbb_detail_accomplishment->Recordset_Selected($this->Recordset);
	}
