...
define("UP_PROJECT_NAME", "db_pbb_2015", TRUE); // Project name
define("UP_RANDOM_KEY", 'T8eUWhdsawxoi9iH', TRUE); // Random key for encryption
define("UP_PROJECT_STYLESHEET_FILENAME", "phpcss/db_pbb_2015.css", TRUE); // Project stylesheet file name
...
define("UP_CONN_DB", 'db_pbb_2015_web', TRUE);
...
// Security
define("UP_ADMIN_USER_NAME", "{460233D7-DEBA-43F3-9F69-06A1B52A688E}", TRUE); // Administrator user name
define("UP_ADMIN_PASSWORD", "{58ECB2D5-E789-47B7-8612-9A8288F442F2}", TRUE); // Administrator password
...
define("UP_USER_ID_FILTER", "(`units_id` = '%u')",  TRUE);
