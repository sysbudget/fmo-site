...
$frm_sam_cu_executive_offices = NULL;

//
// Table class for frm_sam_cu_executive_offices
//
class cfrm_sam_cu_executive_offices {
	var $TableVar = 'frm_sam_cu_executive_offices';
	...
	//
	function cfrm_sam_cu_executive_offices() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// cu_id
		$this->cu_id = new cField('frm_sam_cu_executive_offices', 'frm_sam_cu_executive_offices', 'x_cu_id', 'cu_id', '`cu_id`', 3, -1, FALSE, '`cu_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_id'] =& $this->cu_id;

		// focal_person_id
		$this->focal_person_id = new cField('frm_sam_cu_executive_offices', 'frm_sam_cu_executive_offices', 'x_focal_person_id', 'focal_person_id', '`focal_person_id`', 3, -1, FALSE, '`focal_person_id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->focal_person_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['focal_person_id'] =& $this->focal_person_id;

		// cu_sequence
		$this->cu_sequence = new cField('frm_sam_cu_executive_offices', 'frm_sam_cu_executive_offices', 'x_cu_sequence', 'cu_sequence', '`cu_sequence`', 3, -1, FALSE, '`cu_sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->cu_sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['cu_sequence'] =& $this->cu_sequence;

		// cu_short_name
		$this->cu_short_name = new cField('frm_sam_cu_executive_offices', 'frm_sam_cu_executive_offices', 'x_cu_short_name', 'cu_short_name', '`cu_short_name`', 200, -1, FALSE, '`cu_short_name`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['cu_short_name'] =& $this->cu_short_name;

		// focal_person_office
		$this->focal_person_office = new cField('frm_sam_cu_executive_offices', 'frm_sam_cu_executive_offices', 'x_focal_person_office', 'focal_person_office', '`focal_person_office`', 200, -1, FALSE, '`focal_person_office`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "frm_sam_cu_executive_offices_Highlight";
	}
	...
	function getDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "frm_sam_units") {
			$sDetailUrl = $GLOBALS["frm_sam_units"]->ListUrl() . "?showmaster=" . $this->TableVar;
	...
	function SqlFrom() { // From
		return "`frm_sam_cu_executive_offices`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `frm_sam_cu_executive_offices` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `frm_sam_cu_executive_offices` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `frm_sam_cu_executive_offices` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "frm_sam_cu_executive_officeslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("frm_sam_cu_executive_officesview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "frm_sam_cu_executive_officesadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_sam_cu_executive_officesedit.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_sam_cu_executive_officesedit.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	function CopyUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("frm_sam_cu_executive_officesadd.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("frm_sam_cu_executive_officesadd.php", $this->UrlParm(UP_TABLE_SHOW_DETAIL . "="));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("frm_sam_cu_executive_officesdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=frm_sam_cu_executive_offices" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
