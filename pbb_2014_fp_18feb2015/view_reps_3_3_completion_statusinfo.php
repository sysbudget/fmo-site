...
$view_reps_3_3_completion_status = NULL;

//
// Table class for view_reps_3_3_completion_status
//
class cview_reps_3_3_completion_status {
	var $TableVar = 'view_reps_3_3_completion_status';
	...
	//
	function cview_reps_3_3_completion_status() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// id
		$this->id = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// id_cu
		$this->id_cu = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_id_cu', 'id_cu', '`id_cu`', 3, -1, FALSE, '`id_cu`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_cu->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_cu'] =& $this->id_cu;

		// Sequence
		$this->Sequence = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_Sequence', 'Sequence', '`Sequence`', 21, -1, FALSE, '`Sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sequence'] =& $this->Sequence;

		// Unit
		$this->Unit = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_Unit', 'Unit', '`Unit`', 200, -1, FALSE, '`Unit`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['Unit'] =& $this->Unit;

		// PI Participated
		$this->PI_Participated = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_PI_Participated', 'PI Participated', '`PI Participated`', 20, -1, FALSE, '`PI Participated`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->PI_Participated->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PI Participated'] =& $this->PI_Participated;

		// PI Completed
		$this->PI_Completed = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_PI_Completed', 'PI Completed', '`PI Completed`', 20, -1, FALSE, '`PI Completed`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->PI_Completed->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['PI Completed'] =& $this->PI_Completed;

		// Percentage
		$this->Percentage = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_Percentage', 'Percentage', '`Percentage`', 131, -1, FALSE, '`Percentage`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Percentage->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Percentage'] =& $this->Percentage;

		// focalperson_ID
		$this->focalperson_ID = new cField('view_reps_3_3_completion_status', 'view_reps_3_3_completion_status', 'x_focalperson_ID', 'focalperson_ID', '`focalperson_ID`', 3, -1, FALSE, '`focalperson_ID`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "view_reps_3_3_completion_status_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`view_reps_3_3_completion_status`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `view_reps_3_3_completion_status` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `view_reps_3_3_completion_status` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `view_reps_3_3_completion_status` WHERE ";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_reps_3_3_completion_statuslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("view_reps_3_3_completion_statusview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "view_reps_3_3_completion_statusadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("view_reps_3_3_completion_statusedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("view_reps_3_3_completion_statusadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("view_reps_3_3_completion_statusdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=view_reps_3_3_completion_status" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->PI_Participated->setDbValue($rs->fields('PI Participated'));
		$this->PI_Completed->setDbValue($rs->fields('PI Completed'));
   ...
   // Common render codes
		...
		// PI Participated
		$this->PI_Participated->CellCssStyle = "white-space: nowrap;";

		// PI Completed
		$this->PI_Completed->CellCssStyle = "white-space: nowrap;";

		// Percentage
		$this->Percentage->CellCssStyle = "white-space: nowrap;";
		...
		// PI Participated
		$this->PI_Participated->ViewValue = $this->PI_Participated->CurrentValue;
		$this->PI_Participated->ViewCustomAttributes = "";

		// PI Completed
		$this->PI_Completed->ViewValue = $this->PI_Completed->CurrentValue;
		$this->PI_Completed->ViewCustomAttributes = "";
		...
		// PI Participated
		$this->PI_Participated->LinkCustomAttributes = "";
		$this->PI_Participated->HrefValue = "";
		$this->PI_Participated->TooltipValue = "";

		// PI Completed
		$this->PI_Completed->LinkCustomAttributes = "";
		$this->PI_Completed->HrefValue = "";
		$this->PI_Completed->TooltipValue = "";
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$XmlDoc->AddField('PI_Participated', $this->PI_Participated->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('PI_Completed', $this->PI_Completed->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('Percentage', $this->Percentage->ExportValue($this->Export, $this->ExportOriginalValue));
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->PI_Participated);
				$Doc->ExportCaption($this->PI_Completed);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$Doc->ExportField($this->PI_Participated);
					$Doc->ExportField($this->PI_Completed);
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `view_reps_3_3_completion_status` WHERE " . $this->AddUserIDFilter("");
