 ...
 */
$UPPBB2014_vers = 'PBB2014 V1 University of the Philippines (C) 2014 UP Budget Office';
...
class ADOConnection
{
	...
	/**
	 * Returns floating point version number of UPPBB2014
	 * Usage: $db->Version();
	 * 
	 * @access public 
	 */
	...
	function Version()
	{
		global $UPPBB2014_vers;
		return (float) substr($UPPBB2014_vers,1);
	}
