...
$view_reps_3_4_completion_status_summary = NULL;

//
// Table class for view_reps_3_4_completion_status_summary
//
class cview_reps_3_4_completion_status_summary {
	var $TableVar = 'view_reps_3_4_completion_status_summary';
	...
	var $Started;
	var $No_Data;
	var $Total_No2E_of_Participating_Units;
	var $focalperson_ID;
	var $fields = array();
	...
	//
	function cview_reps_3_4_completion_status_summary() {
		global $Language;
		$this->AllowAddDeleteRow = up_AllowAddDeleteRow(); // Allow add/delete row

		// id
		$this->id = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_id', 'id', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// CU
		$this->CU = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_CU', 'CU', '`CU`', 200, -1, FALSE, '`CU`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['CU'] =& $this->CU;

		// Sequence
		$this->Sequence = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_Sequence', 'Sequence', '`Sequence`', 21, -1, FALSE, '`Sequence`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Sequence->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Sequence'] =& $this->Sequence;

		// Completed
		$this->Completed = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_Completed', 'Completed', '`Completed`', 20, -1, FALSE, '`Completed`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Completed->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Completed'] =& $this->Completed;

		// Started
		$this->Started = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_Started', 'Started', '`Started`', 20, -1, FALSE, '`Started`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Started->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Started'] =& $this->Started;

		// No Data
		$this->No_Data = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_No_Data', 'No Data', '`No Data`', 20, -1, FALSE, '`No Data`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->No_Data->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['No Data'] =& $this->No_Data;

		// Total No. of Participating Units
		$this->Total_No2E_of_Participating_Units = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_Total_No2E_of_Participating_Units', 'Total No. of Participating Units', '`Total No. of Participating Units`', 20, -1, FALSE, '`Total No. of Participating Units`', FALSE, FALSE, 'FORMATTED TEXT');
		$this->Total_No2E_of_Participating_Units->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Total No. of Participating Units'] =& $this->Total_No2E_of_Participating_Units;

		// focalperson_ID
		$this->focalperson_ID = new cField('view_reps_3_4_completion_status_summary', 'view_reps_3_4_completion_status_summary', 'x_focalperson_ID', 'focalperson_ID', '`focalperson_ID`', 3, -1, FALSE, '`focalperson_ID`', FALSE, FALSE, 'FORMATTED TEXT');
	...
	function HighlightName() {
		return "view_reps_3_4_completion_status_summary_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`view_reps_3_4_completion_status_summary`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `view_reps_3_4_completion_status_summary` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `view_reps_3_4_completion_status_summary` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `view_reps_3_4_completion_status_summary` WHERE ";
		$SQL .= up_QuotedName('id') . '=' . up_QuotedValue($rs['id'], $this->id->FldDataType) . ' AND ';
	...
	function KeyFilter() {
		...
		$sKeyFilter = str_replace("@id@", up_AdjustSql($this->id->CurrentValue), $sKeyFilter); // Replace key value
		return $sKeyFilter;
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "view_reps_3_4_completion_status_summarylist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("view_reps_3_4_completion_status_summaryview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "view_reps_3_4_completion_status_summaryadd.php";
...
//			$AddUrl .= "?" . $sUrlParm;
	...
	function EditUrl($parm = "") {
		return $this->KeyUrl("view_reps_3_4_completion_status_summaryedit.php", $this->UrlParm($parm));
	}
	...
	function CopyUrl($parm = "") {
		return $this->KeyUrl("view_reps_3_4_completion_status_summaryadd.php", $this->UrlParm($parm));
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("view_reps_3_4_completion_status_summarydelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=view_reps_3_4_completion_status_summary" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->No_Data->setDbValue($rs->fields('No Data'));
		$this->Total_No2E_of_Participating_Units->setDbValue($rs->fields('Total No. of Participating Units'));
   ...
   // Common render codes
		...
		// Completed
		$this->Completed->ViewValue = $this->Completed->CurrentValue;
		...
		// No Data
		$this->No_Data->ViewValue = $this->No_Data->CurrentValue;
		$this->No_Data->ViewCustomAttributes = "";

		// Total No. of Participating Units
		$this->Total_No2E_of_Participating_Units->ViewValue = $this->Total_No2E_of_Participating_Units->CurrentValue;
		$this->Total_No2E_of_Participating_Units->ViewCustomAttributes = "";
		...
		// No Data
		$this->No_Data->LinkCustomAttributes = "";
		$this->No_Data->HrefValue = "";
		$this->No_Data->TooltipValue = "";

		// Total No. of Participating Units
		$this->Total_No2E_of_Participating_Units->LinkCustomAttributes = "";
		$this->Total_No2E_of_Participating_Units->HrefValue = "";
		$this->Total_No2E_of_Participating_Units->TooltipValue = "";
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$XmlDoc->AddField('Completed', $this->Completed->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('Started', $this->Started->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('No_Data', $this->No_Data->ExportValue($this->Export, $this->ExportOriginalValue));
					$XmlDoc->AddField('Total_No2E_of_Participating_Units', $this->Total_No2E_of_Participating_Units->ExportValue($this->Export, $this->ExportOriginalValue));
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				$Doc->ExportCaption($this->No_Data);
				$Doc->ExportCaption($this->Total_No2E_of_Participating_Units);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					$Doc->ExportField($this->No_Data);
					$Doc->ExportField($this->Total_No2E_of_Participating_Units);
	...
	function GetUserIDSubquery(&$fld, &$masterfld) {
		global $conn;
		$sWrk = "";
		$sSql = "SELECT " . $masterfld->FldExpression . " FROM `view_reps_3_4_completion_status_summary` WHERE " . $this->AddUserIDFilter("");
