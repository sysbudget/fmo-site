        ...
        <body>
                ...
                <?php
                        ...
                        // number of results to show per page
										...
										$query = "SELECT year_cover, tbl_cu.short_name, coll_nm,  scho_nm_list, scho_nm_alt, fund_source, sponsor, pre_bacc, bacc, post_bacc, master, doctor, ni, user_name, sid FROM tbl_main INNER JOIN tbl_cu ON tbl_main.cu = tbl_cu.id WHERE sid = " . $sid ;
