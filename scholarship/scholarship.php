...
<div class="commonbody">
		...
		U.P. Administered Scholarships and Fellowships</strong></div>
	  ...
	  <tr>
		...
		<ul id="MenuBar1" class="MenuBarVertical">
  			<li><a class="MenuBarItemSubmenu" href="#">Scholarships</a>
      			<ul>
              	  <a href="forms/input-scholar.php" target="myFrame"><li>Input Data</li></a>
                  <a href="forms/view-scholar.php" target="myFrame"><li>View Data</li></a>
                </ul>
  			</li>
		</ul>
        </td>
