...
<div class="commonbody">
		...
		U.P. Recognized Research Projects</strong></div>
	  ...
	  <tr>
		...
		<ul id="MenuBar1" class="MenuBarVertical">
  			<li><a class="MenuBarItemSubmenu" href="#">Research</a>
      			<ul>
              	  <a href="research/input.php" target="myFrame"><li>Input Data</li></a>              
                  <a href="research/view.php" target="myFrame"><li>View Data</li></a>             
      			</ul>
  			</li>
		</ul>
        </td>
