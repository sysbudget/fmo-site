...
<div class="commonbody">
		...
		U.P. Recognized Extension Services</strong></div>
    ...
    <table width="990" height="480" border="0" cellpadding="5" cellspacing="0">
	  <tr>
		...
		<ul id="MenuBar1" class="MenuBarVertical">
  			<li><a class="MenuBarItemSubmenu" href="#">Extension</a>
      			<ul>
              	  <a href="extension/input-ext.php" target="myFrame"><li>Input Data</li></a>              
                  <a href="extension/view-ext.php" target="myFrame"><li>View Data</li></a>             
      			</ul>
  			</li>
		</ul>
        </td>
