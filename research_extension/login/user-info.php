        ...
        <body>
				...
				// connect to the database
					include('../connect-db.php');
						...
						$user_name = $_GET['unid'];
						$query = "SELECT tbl_cu.short_name, emp_number, username, first_name, last_name, designation, telephone, office, email FROM tbl_users INNER JOIN tbl_cu ON tbl_users.cu = tbl_cu.id WHERE username = '$user_name' ";
